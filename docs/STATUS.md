...
- Windows HTTP 为 `0.0.0.0:80`，HTTPS 为当前 LAN IPv4 的 443，mDNS 名为 `peach-win.local`。线上服务版本最后核验为 `0.7.0`、`ledger_sync=writer`；`0.7.1` 已进入本次 FANBOX Cookie/Gofile Premium 修复发布流程。
