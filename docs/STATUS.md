...
- 详情身份按名称去重；女优与厂牌在宽度允许时并排，窄宽度自动分行；系列使用无图标的全宽文字条显示全称，不复用内容标签胶囊。反馈操作组固定高度，不再被侧栏内容压成横线。标签可逐项隐藏或手动添加；隐藏只写 profile 覆盖，不破坏原始来源断言。高潮按钮使用 Health Icons 的 CC0 领域图标和独立暖粉强调色。
...
<!-- generated 2026-08-21T18:13Z -->

- 资产 81753 条，其中视频 24873 条。
...
- `asset_tag` 来源分布：`vision_creator` 27004、`pixiv_tag` 19753、`name` 19295、`stash` 15450、`r18` 2451、`performer` 1596、`follow` 1376、`r18:performer` 1204、`javbus:performer` 49。
- 番号 1465 个，其中 1158 个有厂牌（79%）。
