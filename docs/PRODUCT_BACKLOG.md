...
6. **厂牌 Logo 补齐与持续校验**：14 个已确认社交 handle 已有内容缓存、provenance、精确/感知哈希、质量与重复门槛及健康报告；仍有 72 个厂牌没有可信 handle，必须继续从官网/公开来源取证，不能猜账号。
...
合计：**12 项开放需求**，其中 6 项已有骨架，6 项尚未实现。头像人脸取景（2026-08-22 上线，见 STATUS）和 115 大小写路径失败（2026-08-17/18 收尾，2 条失败已定因）已完成，不再计入。本轮设置、5 分钟刷新、搜索历史、播放器统计、动态环境光和 Shorts 风格沉浸模式不再计入开放需求。
