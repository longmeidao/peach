...
32. 封面来源头像逐条复核：78 张仍来自 `cover-fallback`，清单位于 `attic/reviews/20260906-portrait-agency/remaining-cover-avatars.csv`。封面关联单一演员不构成人脸身份核验，采集器只生成候选，不自动安装。日向真凛缓存为 SSIS-135 封面，印刷署名与别名一致，独立官方人像来源仍待补齐。
