...
42. 图库同名多张、却没有可比封面人脸的 93 位女优（ADR-0056 的只读估计，88 位盘上没有单人作品封面）：补头像后继的人脸比对缺参照，仍装不上。可选的参照是片商或事务所资料页人像、单人作品的九宫格抽帧；另有 4 位按贴纸或口罩遮脸的 FC2 封面认定，值得人看一遍（`build/avatar-audit/issue2-face-match-estimate.csv`）。
