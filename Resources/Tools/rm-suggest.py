...
涌现推荐 —— 说一句心情或关键词，从 21 TB 里挑几个给你。
    ...
    python rm-suggest.py 来点快的
    python rm-suggest.py 手机上看的足
    python rm-suggest.py --tag 足交 --len 速食
    python rm-suggest.py 随便            # 什么都不指定，纯涌现
...
MOODS = r"R:\Resources\Tools\moods.json"
N_OUT = 6
