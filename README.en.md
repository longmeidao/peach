...
The interface uses Board styling. “Increase contrast” in Settings disables navigation transparency and refraction; “Home glow” is the coloured wash at the top of the home page. Switch preset palettes from the round button at the bottom of the sidebar; Settings turns the glow off and adjusts strength, grain and each of the three spot colours. It shows in both the light and dark themes. Numeric preferences accept custom values within their supported ranges, with switches for optional features.
