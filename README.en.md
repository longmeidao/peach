...
The interface uses Board styling. “Increase contrast” in Settings disables navigation transparency and refraction; “Home glow” is the coloured wash at the top of the home page — turn it off, switch preset palettes, adjust strength and grain, or pick the three spot colours yourself. It shows in both the light and dark themes. Numeric preferences accept custom values within their supported ranges, with switches for optional features.
