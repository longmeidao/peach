...
The interface uses Board styling. “Increase contrast” in Settings disables navigation transparency and refraction; “Sidebar glow” is the slowly drifting coloured light on the sidebar’s glass. Switch preset palettes from the palette button at the bottom of the sidebar; Settings turns the glow off and adjusts strength, grain and each of the three glow colours. It shows in both the light and dark themes. Numeric preferences accept custom values within their supported ranges, with switches for optional features.
