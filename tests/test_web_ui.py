...
class WebUiSourceTests(unittest.TestCase):
    ...
    def test_player_volume_background_survives_theater_and_fullscreen(self):
        ...
        self.assertPageContains("display:flex!important;align-items:center;align-self:stretch")
        self.assertPageContains("height:2px;margin:0;background:rgba(255,255,255,.3)")
