...
class WebUiSourceTests(unittest.TestCase):
    ...
    def test_detail_player_controls_use_two_rows_and_offer_real_quality_levels(self):
        ...
        self.assertPageContains("border:0;border-radius:50%;background:rgba(0,0,0,.3);box-shadow:none")
        self.assertPageContains(".vjs-peach-right-controls{box-sizing:border-box;position:relative;align-self:flex-end")
        self.assertPageContains("padding:0 4px;display:flex;align-items:center;border:0;border-radius:28px;background:rgba(0,0,0,.3);box-shadow:none")
        ...
        self.assertPageContains(".vwrap .video-js .vjs-current-time{display:flex;margin-left:4px")
        self.assertPageContains(".vwrap .video-js .vjs-duration{display:flex")
        self.assertPageContains("padding-right:8px;border:0;border-radius:0")
    ...
    def test_center_player_controls_are_round_and_toggle_play_pause(self):
        ...
        self.assertPageContains(".vjs-peach-center-controls button{position:relative;width:48px;height:48px")
        self.assertPageContains("border-radius:50%;display:grid;place-items:center;background:rgba(0,0,0,.3)")
        self.assertPageContains(".vjs-peach-center-controls .vjs-peach-center-toggle{width:56px;height:56px}")
    ...
    def test_player_settings_match_real_ambient_speed_and_quality_capabilities(self):
        ...
        self.assertPageContains("min-height:48px;padding:0 8px;border:0;border-radius:8px")
