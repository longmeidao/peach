...
class WebUiSourceTests(unittest.TestCase):
    ...
    def test_detail_player_controls_use_two_rows_and_offer_real_quality_levels(self):
        ...
        self.assertPageContains("volume.insertAdjacentHTML('afterbegin','<span class=\"vjs-peach-hover\"")
        self.assertPageContains("position:relative!important;left:0!important;top:0!important;flex:0 0 40px")
    ...
    def test_center_player_controls_are_round_and_toggle_play_pause(self):
        ...
        self.assertPageContains("animation:peach-player-bezel-fadeout 1s linear both")
        self.assertPageContains("25%,75%{opacity:1;transform:scale(1.33)}")
        self.assertPageContains(".vjs-peach-center-controls button{position:relative;width:78px;height:78px")
        self.assertPageContains("border-radius:50%;display:grid;place-items:center;background:rgba(0,0,0,.6)")
        self.assertPageContains(".vjs-peach-center-controls .vjs-peach-center-toggle{width:78px;height:78px}")
