...
class WebUiSourceTests(unittest.TestCase):
    ...
    def test_detail_player_controls_use_two_rows_and_offer_real_quality_levels(self):
        ...
        self.assertPageContains(".video-js.vjs-paused .vjs-control-bar>.vjs-play-control .vjs-icon-placeholder:before")
        self.assertPageContains(".video-js.vjs-playing .vjs-control-bar>.vjs-play-control .vjs-icon-placeholder:after")
        ...
        self.assertPageContains("width:12px;height:12px")
        ...
        self.assertPageContains("time.textContent=`${shown} / ${fmtClock(duration)}`")
        ...
        self.assertPageContains("const syncFullscreenIcon=()=>fullscreenUse?.setAttribute('href'")
    ...
    def test_center_player_controls_are_round_and_toggle_play_pause(self):
        ...
        self.assertPageContains(".vjs-peach-center-controls button{position:relative;width:68px;height:68px")
        self.assertPageContains("border-radius:50%;display:grid;place-items:center;background:rgba(0,0,0,.6)")
        self.assertPageContains(".vjs-peach-center-controls .vjs-peach-center-toggle{width:68px;height:68px}")
    ...
    def test_player_settings_match_real_ambient_speed_and_quality_capabilities(self):
        ...
        self.assertPageContains(".vjs-peach-settings-menu{box-sizing:border-box;position:absolute;z-index:5;right:-100px;bottom:52px;width:min(274px")
        self.assertPageContains("padding:8px;border:0;border-radius:12px;background:rgba(0,0,0,.6);box-shadow:none")
        ...
        self.assertPageContains(".video-js .vjs-peach-menu-row{display:grid;grid-template-columns:56px minmax(0,1fr) auto 18px")
        self.assertPageContains(".vjs-peach-panel-header{box-sizing:border-box;height:57px;padding:8px;display:flex;align-items:center;gap:8px")
        self.assertPageContains(".video-js .vjs-peach-menu-option{display:flex;align-items:center;justify-content:space-between")
        ...
        self.assertPageContains(".vjs-peach-switch{position:relative;width:40px;height:24px;border-radius:12px")
    ...
    def test_player_volume_background_survives_theater_and_fullscreen(self):
        ...
        self.assertPageContains(".video-js.vjs-fullscreen .vjs-control-bar>.vjs-volume-panel:hover")
