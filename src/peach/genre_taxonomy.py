...
CONTENT_GENRES: dict[str, str] = {
    ...
    "Kiss": "接吻", "キス": "接吻", "キス・接吻": "接吻",
    "Sitting on Face": "颜面骑乘", "顔面騎乗": "颜面骑乘",
    "69": "69", "シックスナイン": "69",
    # 器具的名字分得很细——`バイブ` 是震动棒、`ローター` 是跳蛋、`電マ` 是电动按摩棒
    # ——但馆藏里每种各压一到五条，分成三个标签只会得到三个筛不动的稀标签。
    "Sex Toy": "性玩具", "Sex Toys": "性玩具", "Adult Toys": "性玩具",
    "大人のおもちゃ": "性玩具", "おもちゃ": "性玩具",
    ...
    "Idol & Celebrity": "偶像艺人", "アイドル・芸能人": "偶像艺人", "アイドル": "偶像艺人",
    ...
    "Oil": "油压", "オイル": "油压", "ローション・オイル": "油压", "ローション": "油压",
