...
**不包含凭据。**哪些字段可以跨机同步由 `web_follow.CREDENTIAL_GUIDE` 逐字段声明，
...
PROVIDERS: dict[str, ProviderSpec] = {
    ...
    for spec in (
        ...
        _spec("fanbox", "FANBOX", source_url="https://{ref}.fanbox.cc/",
              priority=1, official_identity=True),
