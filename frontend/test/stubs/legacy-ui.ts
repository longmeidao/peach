...
// @ts-expect-error 汇总行复用正式模板，折叠开合、覆盖式滚动条与滚动判据用正式实现。
export {attachOverlayScrollbar, collectionSummaryHtml, scrollMovesAnchor, setCollapseOpen} from '../../../web/js/ui-components.js';
