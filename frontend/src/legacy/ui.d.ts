...
export declare function confirmModal(options: {title: string; body: string; confirmLabel: string; cancelLabel?: string; onConfirm?: () => Promise<unknown>}): Promise<{confirmed: boolean; result?: unknown}>;
