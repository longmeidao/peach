...
export function CloudDriveGuide() {
  ...
  return <div ref={root} class="cloudguide">
    ...
    <details>
      ...
      <p class="confighelp">上表容量和并发是起步建议，按实际占盘与播放结果调整。直链和代理是不同设置；连接慢时分别比较，不能只看开关是否开启。<a href="https://www.clouddrive2.com/features.html" target="_blank" rel="noreferrer">缓存说明<svg aria-hidden="true" viewBox="0 0 24 24"><use href="#i-external-link" /></svg></a></p>
    </details>
  </div>;
}
