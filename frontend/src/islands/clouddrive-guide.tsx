...
export function CloudDriveGuide() {
  ...
  return <div ref={root} class="cloudguide">
    <p class="confighelp">先在 CloudDrive 登录网盘并挂载，开启「启动时自动挂载」。<a href="https://www.clouddrive2.com/help.html" target="_blank" rel="noreferrer">挂载帮助<svg aria-hidden="true" viewBox="0 0 24 24"><use href="#i-external-link" /></svg></a></p>
    <details>
      ...
      <p class="confighelp">表里的容量和并发是起步值，按实际占盘和播放效果再调。直链和代理是两个开关，连接慢时分别试一次比较，不能只看开关有没有打开。<a href="https://www.clouddrive2.com/features.html" target="_blank" rel="noreferrer">缓存说明<svg aria-hidden="true" viewBox="0 0 24 24"><use href="#i-external-link" /></svg></a></p>
    </details>
  </div>;
}
