...
雪碧图里另有 10 枚自绘 symbol（check-check-outline、shuffle、alert、pics、jav、theater-enter、theater-exit、brand-minnano、brand-javdb、brand-missav）与 16 枚 player-* 前缀的播放器图标，都没有上游可对。
