...
var he = Symbol();
function ge(e, t) {
	return !e.queryFn && t?.initialPromise ? () => t.initialPromise : !e.queryFn || e.queryFn === he ? () => Promise.reject(/* @__PURE__ */ Error(`Missing queryFn: '${e.queryHash}'`)) : e.queryFn;
}
function _e(e, t) {
	return typeof e == "function" ? e(...t) : !!e;
}
...
var Te = we(), Ee = new class extends xe {
	#e = !0;
	#t;
	#n;
	constructor() {
...
function Oe(e) {
	return (e ?? "online") !== "online" || Ee.isOnline();
}
...
function Ae(e) {
	...
	let c = () => i !== "pending", l = (t) => {
		...
		t = !1;
	}, f = () => Se.isFocused() && (e.networkMode === "always" || Ee.isOnline()) && e.canRun(), p = () => Oe(e.networkMode) && e.canRun(), m = (e) => {
		c() || (r?.(), i = "resolved", a(e));
	}, h = (e) => {
		c() || (r?.(), i = "rejected", o(e));
	}, g = () => new Promise((t) => {
		...
		Promise.resolve(r).then(m).catch((r) => {
			if (c()) return;
			let i = e.retry ?? (be() ? 0 : 3), a = e.retryDelay ?? De, o = typeof a == "function" ? a(n, r) : a, s = i === !0 || typeof i == "number" && n < i || typeof i == "function" && i(n, r);
			if (t || !s) {
				h(r);
				return;
			}
...
var je = class {
	...
	updateGcTime(e) {
		this.gcTime = Math.max(this.gcTime || 0, e ?? (be() ? Infinity : 3e5));
	}
	clearGcTimeout() {
...
function Me(e) {
	return { onFetch: (t, n) => {
		let r = t.options, i = t.fetchOptions?.meta?.fetchMore?.direction, a = t.state.data?.pages || [], o = t.state.data?.pageParams || [], s = {
			...
			let n = !1, l = (e) => {
				ve(e, () => t.signal, () => n = !0);
			}, u = ge(t.options, t.fetchOptions), d = async (e, r, i) => {
				...
				let a = (() => {
					...
					return l(e), e;
				})(), o = await u(a), { maxPages: s } = t.options, c = i ? F : P;
				return {
					pages: c(e.pages, o, s),
			...
			if (i && a.length) {
				...
				let t = e ?? a.length;
				do {
					let e = c === 0 ? o[0] ?? r.initialPageParam : Ne(r, s);
					if (c > 0 && e == null) break;
					s = await d(s, e), c++;
				} while (c < t);
			}
...
var Fe = class extends je {
	...
	#s;
	constructor(e) {
		super(), this.#s = !1, this.#o = e.defaultOptions, this.setOptions(e.options), this.observers = [], this.#i = e.client, this.#r = this.#i.getQueryCache(), this.queryKey = e.queryKey, this.queryHash = e.queryHash, this.#t = Re(this.options), this.state = e.state ?? this.#t, this.scheduleGc();
	}
	get meta() {
	...
	setOptions(e) {
		if (this.options = {
			...
			e.data !== void 0 && (this.setState(Le(e.data, e.dataUpdatedAt)), this.#t = e);
		}
	}
	optionalRemove() {
	...
	isDisabled() {
		return this.getObserversCount() > 0 ? !this.isActive() : this.options.queryFn === he || !this.isFetched();
	}
	isFetched() {
	...
	async fetch(e, t) {
		...
		(this.#e === "infinite" ? Me(this.options.pages) : this.options.behavior)?.onFetch(a, this), this.#n = this.state, (this.state.fetchStatus === "idle" || this.state.fetchMeta !== a.fetchOptions?.meta) && this.#c({
			type: "fetch",
		...
		let o = this.#a = Ae({
			...
			fn: a.fetchFn,
			onCancel: (e) => {
				e instanceof ke && e.revert && this.setState({
					...this.#n,
					fetchStatus: "idle"
				}), n.abort();
			},
	...
	#c(e) {
		let t = (t) => {
			switch (e.type) {
				...
				case "fetch": return {
					...t,
					...Ie(t.data, this.options),
					fetchMeta: e.meta ?? null
				};
				case "success":
					let n = {
						...t,
						...Le(e.data, e.dataUpdatedAt),
		...
		this.state = t(this.state), Te.batch(() => {
...
var ze = class extends xe {
	...
	onSubscribe() {
		this.listeners.size === 1 && (this.#t.addObserver(this), Ve(this.#t, this.options) ? this.#m() : this.updateResult(), this.#y());
	}
	onUnsubscribe() {
		this.hasListeners() || this.destroy();
	}
	shouldFetchOnReconnect() {
		return He(this.#t, this.options, this.options.refetchOnReconnect);
	}
	...
	setOptions(e) {
		...
		r && Ue(this.#t, n, this.options, t) && this.#m(), this.updateResult(), r && (this.#t !== n || M(this.options.enabled, this.#t) !== M(t.enabled, this.#t) || M(this.options.staleTime, this.#t) !== M(t.staleTime, this.#t)) && this.#g();
		let i = this.#_();
	...
	#h(e) {
		return !be() && M(this.options.enabled, this.#t) !== !1 && j(e);
	}
	#g() {
		this.#b();
	...
	#v(e) {
		this.#x(), this.#f = e, !(this.#f === 0 || !this.#h(this.#f)) && (this.#d = D.setInterval(() => {
			(this.options.refetchIntervalInBackground || Se.isFocused()) && this.#m();
		}, this.#f));
	}
	#y() {
	...
	createResult(e, t) {
		...
		if (t._optimisticResults) {
			let i = this.hasListeners(), a = !i && Ve(e, t), o = i && Ue(e, n, t, r);
			(a || o) && (l = {
				...l,
				...Ie(c.data, e.options)
...
function Ve(e, t) {
	return Be(e, t) || e.state.data !== void 0 && He(e, t, t.refetchOnMount);
}
function He(e, t, n) {
...
function Ue(e, t, n, r) {
	return (e !== t || M(r.enabled, e) === !1) && (!n.suspense || e.state.status !== "error") && We(e, n);
}
function We(e, t) {
...
var qe = class extends xe {
	...
	resumePausedMutations() {
		...
		return Te.batch(() => Promise.all(e.map((e) => e.continue().catch(A))));
	}
};
function Je(e) {
...
var Ye = class extends xe {
	...
	#s;
	constructor(e = {}) {
		this.#e = e.queryCache || new Xe(), this.#t = e.mutationCache || new qe(), this.#n = e.defaultOptions || {}, this.#r = /* @__PURE__ */ new Map(), this.#i = /* @__PURE__ */ new Map(), this.#a = 0;
	}
	mount() {
		this.#a++, this.#a === 1 && (this.#o = Se.subscribe(async (e) => {
			e && (await this.resumePausedMutations(), this.#e.onFocus());
		}), this.#s = Ee.subscribe(async (e) => {
	...
	setQueriesData(e, t, n) {
		return Te.batch(() => this.#e.findAll(e).map(({ queryKey: e }) => [e, this.setQueryData(e, t, n)]));
	}
	getQueryState(e) {
		let t = this.defaultQueryOptions({ queryKey: e });
	...
	cancelQueries(e, t = {}) {
		let n = {
			revert: !0,
			...t
		}, r = Te.batch(() => this.#e.findAll(e).map((e) => e.cancel(n)));
		return Promise.all(r).then(A).catch(A);
	}
	invalidateQueries(e, t = {}) {
		return Te.batch(() => (this.#e.findAll(e).forEach((e) => {
			e.invalidate();
	...
	refetchQueries(e, t = {}) {
		...
		}, r = Te.batch(() => this.#e.findAll(e).filter((e) => !e.isDisabled() && !e.isStatic()).map((e) => {
	...
	resumePausedMutations() {
		return Ee.isOnline() ? this.#t.resumePausedMutations() : Promise.resolve();
	}
	getQueryCache() {
		return this.#e;
	}
	...
	defaultQueryOptions(e) {
		...
		return t.queryHash ||= re(t.queryKey, t), t.refetchOnReconnect === void 0 && (t.refetchOnReconnect = t.networkMode !== "always"), t.throwOnError === void 0 && (t.throwOnError = !!t.suspense), !t.networkMode && t.persister && (t.networkMode = "offlineFirst"), t.queryFn === he && (t.enabled = !1), t;
	}
...
}, Qe = x.createContext(!1), $e = () => x.useContext(Qe);
Qe.Provider;
//#endregion
...
var tt = x.createContext(et()), nt = () => x.useContext(tt), rt = (e, t, n) => {
	let r = n?.state.error && typeof e.throwOnError == "function" ? _e(e.throwOnError, [n.state.error, n]) : e.throwOnError;
	(e.suspense || r) && (t.isReset() || (e.retryOnMount = !1));
}, it = (e) => {
	x.useEffect(() => {
		e.clearReset();
	}, [e]);
}, at = ({ result: e, errorResetBoundary: t, throwOnError: n, query: r, suspense: i }) => e.isError && !t.isReset() && !e.isFetching && r && (i && e.data === void 0 || _e(n, [e.error, r])), ot = (e) => {
	if (e.suspense) {
...
}, st = (e, t) => e?.suspense && t.isPending, ct = (e, t, n) => t.fetchOptimistic(e).catch(() => {
	n.clearReset();
});
//#endregion
//#region node_modules/@tanstack/react-query/build/modern/useBaseQuery.js
function lt(e, t, n) {
	let r = $e(), i = nt(), a = w(n), o = a.defaultQueryOptions(e), s = a.getQueryCache().get(o.queryHash), c = e.subscribed !== !1;
	o._optimisticResults = r ? "isRestoring" : c ? "optimistic" : void 0, ot(o), rt(o, i, s), it(i);
	let [l] = x.useState(() => new t(a, o)), u = l.getOptimisticResult(o), d = !r && c;
	if (x.useSyncExternalStore(x.useCallback((e) => {
		let t = d ? l.subscribe(Te.batchCalls(e)) : A;
		return l.updateResult(), t;
	}, [l, d]), () => l.getCurrentResult(), () => l.getCurrentResult()), x.useEffect(() => {
		l.setOptions(o);
	}, [o, l]), st(o, u)) throw ct(o, l, i);
	if (at({
		result: u,
...
function dt(e, t) {
	let n = w(t), [r] = x.useState(() => new Ye(n, e));
	x.useEffect(() => {
		r.setOptions(e);
	}, [r, e]);
	let i = x.useSyncExternalStore(x.useCallback((e) => r.subscribe(Te.batchCalls(e)), [r]), () => r.getCurrentResult(), () => r.getCurrentResult()), a = x.useCallback((...e) => {
		r.mutate(e[0], e[1]).catch(A);
	}, [r]);
	if (i.error && _e(r.options.throwOnError, [i.error])) throw i.error;
	return {
		...i,
		mutate: a,
...
var ft = class {
	...
	filter(e, t, n) {
		let [r, i] = _t(e, t, this.firstChildKey, n), a = this.clone();
...
var gt = class {
	...
	*[Symbol.iterator]() {
	...
	filter(e) {
		let t = new this.constructor(), [n, r] = _t(this, t, this.firstKey, e);
...
var vt = class {
	...
	*[Symbol.iterator]() {
	...
	updateCollection() {
		for (let e of this.dirtyNodes) e instanceof yt && (!e.isConnected || e.isHidden) ? this.removeNode(e) : e.updateChildIndices();
		for (let e of this.dirtyNodes) e instanceof yt ? (e.isConnected && !e.isHidden && (e.updateNode(), this.addNode(e)), e.node && this.dirtyNodes.delete(e), e.isMutated = !1) : this.dirtyNodes.delete(e);
...
function xt(e) {
	...
	return (0, x.useMemo)(() => {
		if (n && typeof t == "function") {
			let e = [];
			for (let a of n) {
				let n = St(a) ? a : null, o = n ? s.get(n) : null;
				if (!o) {
					o = t(a);
...
var I = (e) => At(e) ? e.document : jt(e) ? e : e?.ownerDocument ?? (typeof document < "u" ? document : void 0), Ot = (e) => I(e)?.defaultView ?? (typeof window < "u" ? window : void 0);
function kt(e) {
...
function jt(e) {
	return kt(e) && e.nodeType === 9;
}
function Mt(e) {
	return kt(e) && e.nodeType === 11 && "host" in e;
}
function Nt(e, t, n, r) {
...
function L(e, t) {
	...
	for (; n !== null;) {
		if (n === e) return !0;
		n = typeof n.assignedElements != "function" && n.assignedSlot?.parentNode ? n.assignedSlot.parentNode : Mt(n) ? n.host : n.parentNode;
	}
	return !1;
}
var Lt = (e = document) => {
...
function R(e) {
	if (It() && e.target instanceof Element && e.target.shadowRoot) {
...
function Rt(e, t) {
	...
	t ??= Ot(e);
	let n = [t];
	if (!It() || !e || e === t) return n;
	let r = "getRootNode" in t ? t.getRootNode() : null, i = e.getRootNode() ?? null;
	for (; Mt(i) && i !== r;) n.push(i), i = i.host.getRootNode();
	return n;
}
function zt(e) {
	if (!e) return !1;
	let t = e.getRootNode(), n = Ot(e);
...
var Bt = typeof Element < "u" && "checkVisibility" in Element.prototype;
function Vt(e) {
	let t = Ot(e);
	if (!(e instanceof t.HTMLElement) && !(e instanceof t.SVGElement)) return !1;
	let { display: n, visibility: r } = e.style, i = n !== "none" && r !== "hidden" && r !== "collapse";
	if (i) {
		let { getComputedStyle: t } = Ot(e), { display: n, visibility: r } = t(e);
...
function Ut(e, t) {
	return Bt ? e.checkVisibility({ visibilityProperty: !0 }) && !e.closest("[data-react-aria-prevent-focus]") : e.nodeName !== "#comment" && Vt(e) && Ht(e, t) && (!e.parentElement || Ut(e.parentElement, e));
}
//#endregion
...
var z = [
	...
	"permission"
], Wt = z.join(":not([hidden]),") + ",[tabindex]:not([disabled]):not([hidden])";
z.push("[tabindex]:not([tabindex=\"-1\"]):not([disabled])");
var Gt = z.join(":not([hidden]):not([tabindex=\"-1\"]),");
function Kt(e, t) {
	return e.matches(Wt) && !Jt(e) && (t?.skipVisibilityCheck || Ut(e));
}
function qt(e) {
	return e.matches(Gt) && Ut(e) && !Jt(e);
}
function Jt(e) {
	let t = e;
	for (; t != null;) {
		if (t instanceof Ot(t).HTMLElement && t.inert) return !0;
		t = t.parentElement;
	}
	return !1;
}
...
var Qt = !1;
function $t(e) {
	for (; e && !Kt(e, { skipVisibilityCheck: !0 });) e = e.parentElement;
	let t = Lt(Ot(e).document);
	if (!t || t === e) return;
	let n = e?.getRootNode(), r = n != null && Mt(n) ? n : Ot(e), i = (t) => t === e || t != null && L(e, t), a = (e) => e === t || t != null && e != null && L(t, e);
	Qt = !0;
	let o = !1, s = (e) => {
		(a(R(e)) || o) && e.stopImmediatePropagation();
	}, c = (n) => {
		(a(R(n)) || o) && (n.stopImmediatePropagation(), !e && !o && (o = !0, Ct(t), d()));
	}, l = (e) => {
		(i(R(e)) || o) && e.stopImmediatePropagation();
	}, u = (e) => {
		(i(R(e)) || o) && (e.stopImmediatePropagation(), o || (o = !0, Ct(t), d()));
	};
...
var rn = nn(function() {
	...
	return tn(/^iPad/i) || rn() && navigator.maxTouchPoints > 1;
}), sn = nn(function() {
	return an() || on();
}), cn = nn(function() {
	return rn() || sn();
}), ln = nn(function() {
	return en(/AppleWebKit/i) && (sn() || !un());
}), un = nn(function() {
	return en(/Chrome|CriOS|CrMo/i);
}), dn = nn(function() {
	return en(/Android/i);
}), fn = nn(function() {
	return en(/(Firefox|FxiOS)/i);
});
//#endregion
//#region node_modules/react-aria/dist/private/utils/isVirtualEvent.mjs
function pn(e) {
	return e.pointerType === "" && e.isTrusted ? !0 : dn() && e.pointerType ? e.type === "click" && e.buttons === 1 : e.detail === 0 && !e.pointerType;
}
function mn(e) {
	return !dn() && e.width === 0 && e.height === 0 || dn() && e.width === 1 && e.height === 1 && e.pressure === 0 && e.detail === 0 && e.pointerType === "mouse";
}
//#endregion
//#region node_modules/react-aria/dist/private/utils/openLink.mjs
var hn = /*#__PURE__*/ (0, x.createContext)({
	isNative: !0,
	open: yn,
	useHref: (e) => e
});
function gn() {
	return (0, x.useContext)(hn);
}
function _n(e, t, n = !0) {
	let { metaKey: r, ctrlKey: i, altKey: a, shiftKey: o } = t;
	!ln() && fn() && window.event?.type?.startsWith("key") && e.target === "_blank" && (rn() ? r = !0 : i = !0);
	let s = ln() && rn() && !on() ? new KeyboardEvent("keydown", {
		keyIdentifier: "Enter",
		metaKey: r,
		ctrlKey: i,
		altKey: a,
	...
	_n.isOpening = n, Ct(e), e.dispatchEvent(s), _n.isOpening = !1;
}
_n.isOpening = !1;
function vn(e, t) {
...
var xn = {
	...
	current: 0
}, Sn = /*#__PURE__*/ x.createContext(xn), Cn = /*#__PURE__*/ x.createContext(!1);
typeof window < "u" && window.document && window.document.createElement;
var wn = /* @__PURE__ */ new WeakMap();
function Tn(e = !1) {
	let t = (0, x.useContext)(Sn), n = (0, x.useRef)(null);
	if (n.current === null && !e) {
		...
		if (e) {
			...
			}) : e.memoizedState !== n.state && (t.current = n.id, wn.delete(e));
		}
		n.current = ++t.current;
	}
	return n.current;
...
function En(e) {
	let t = (0, x.useContext)(Sn), n = Tn(!!e), r = `react-aria${t.prefix}`;
	return e || `${r}-${n}`;
}
function Dn(e) {
	let t = x.useId(), [n] = (0, x.useState)(Mn()), r = n ? "react-aria" : `react-aria${xn.prefix}`;
	return e || `${r}-${t}`;
}
var On = typeof x.useId == "function" ? Dn : En;
function kn() {
	return !1;
}
function An() {
...
function Mn() {
	return typeof x.useSyncExternalStore == "function" ? x.useSyncExternalStore(jn, kn, An) : (0, x.useContext)(Cn);
}
//#endregion
//#region node_modules/react-aria/dist/private/interactions/useFocusVisible.mjs
var Nn = null, Pn = /* @__PURE__ */ new Set(), Fn = /* @__PURE__ */ new Map(), In = !1, Ln = !1, Rn = {
	Tab: !0,
	Escape: !0
};
function zn(e, t) {
	for (let n of Pn) n(e, t);
}
function Bn(e) {
	return !(e.metaKey || !rn() && e.altKey || e.ctrlKey || e.key === "Control" || e.key === "Shift" || e.key === "Meta");
}
function Vn(e) {
	In = !0, !_n.isOpening && Bn(e) && (Nn = "keyboard", zn("keyboard", e));
}
function Hn(e) {
	Nn = "pointer", "pointerType" in e && e.pointerType, (e.type === "mousedown" || e.type === "pointerdown") && (In = !0, zn("pointer", e));
}
function Un(e) {
	!_n.isOpening && pn(e) && (In = !0, Nn = "virtual");
}
function Wn(e) {
	if (Qt) return;
	let t = R(e), n = Ot(t), r = I(t);
	if (t === n) {
		Ln = !0;
		return;
	}
	t === r || !e.isTrusted || (!In && !Ln && (Nn = "virtual", zn("virtual", e)), In = !1, Ln = !1);
}
function Gn() {
	Qt || (In = !1, Ln = !0);
}
function Kn(e) {
	...
	Reflect.defineProperty(t.HTMLElement.prototype, "focus", {
		...
		writable: !0,
		value: function() {
			In = !0, r.apply(this, arguments);
		}
	}), n.addEventListener("keydown", Vn, !0), n.addEventListener("keyup", Vn, !0), n.addEventListener("click", Un, !0), t.addEventListener("focus", Wn, !0), t.addEventListener("blur", Gn, !1), typeof PointerEvent < "u" && (n.addEventListener("pointerdown", Hn, !0), n.addEventListener("pointermove", Hn, !0), n.addEventListener("pointerup", Hn, !0)), t.addEventListener("beforeunload", () => {
		qn(e);
	}, { once: !0 }), Fn.set(t, { focus: r });
}
var qn = (e, t) => {
	let n = Ot(e), r = I(e);
	t && r.removeEventListener("DOMContentLoaded", t), Fn.has(n) && (Reflect.defineProperty(n.HTMLElement.prototype, "focus", {
		configurable: !0,
		writable: !0,
		value: Fn.get(n).focus
	}), r.removeEventListener("keydown", Vn, !0), r.removeEventListener("keyup", Vn, !0), r.removeEventListener("click", Un, !0), n.removeEventListener("focus", Wn, !0), n.removeEventListener("blur", Gn, !1), typeof PointerEvent < "u" && (r.removeEventListener("pointerdown", Hn, !0), r.removeEventListener("pointermove", Hn, !0), r.removeEventListener("pointerup", Hn, !0)), Fn.delete(n));
};
function Jn(e) {
	let t = I(e), n;
	return t.readyState === "loading" ? (n = () => {
		Kn(e);
	}, t.addEventListener("DOMContentLoaded", n)) : Kn(e), () => qn(e, n);
}
typeof document < "u" && Jn();
function Yn() {
	return Nn !== "pointer";
}
function Xn() {
...
function $n(e, t, n) {
	let r = n ? R(n) : void 0, i = I(r), a = Ot(r), o = a === void 0 ? HTMLInputElement : a.HTMLInputElement, s = a === void 0 ? HTMLTextAreaElement : a.HTMLTextAreaElement, c = a === void 0 ? HTMLElement : a.HTMLElement, l = a === void 0 ? KeyboardEvent : a.KeyboardEvent, u = Lt(i);
	return e = e || u instanceof o && !Qn.has(u.type) || u instanceof s || u instanceof c && u.isContentEditable, !(e && t === "keyboard" && n instanceof l && !Rn[n.key]);
}
function er(e, t, n) {
	Kn(), (0, x.useEffect)(() => {
		if (n?.enabled === !1) return;
		let t = (t, r) => {
			$n(!!n?.isTextInput, t, r) && e(Yn());
		};
		return Pn.add(t), () => {
			Pn.delete(t);
		};
...
var tr = /* @__PURE__ */ new Map(), nr = /* @__PURE__ */ new Set();
function rr() {
...
typeof document < "u" && (document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", rr) : rr());
function ir() {
	for (let [e] of tr) "isConnected" in e && !e.isConnected && tr.delete(e);
}
function ar(e) {
	requestAnimationFrame(() => {
		ir(), tr.size === 0 ? e() : nr.add(e);
	});
}
//#endregion
...
function or(e) {
	...
	if (Xn() === "virtual") {
		...
		ar(() => {
			let r = Lt(t);
			(r === n || r === t.body) && e.isConnected && Ct(e);
		});
	} else Ct(e);
}
//#endregion
...
var lr = !!(typeof window < "u" && window.document && window.document.createElement), ur = /* @__PURE__ */ new Map(), dr;
typeof FinalizationRegistry < "u" && (dr = new FinalizationRegistry((e) => {
	ur.delete(e);
}));
var fr = /* @__PURE__ */ new WeakMap();
function pr(e) {
	let [t, n] = (0, x.useState)(e), r = (0, x.useRef)(null), i = On(t), a = (0, x.useRef)(null), o = fr.get(a);
	if (dr && o !== i && (o != null && dr.unregister(a), dr.register(a, i, a), fr.set(a, i)), lr) {
		let e = ur.get(i);
		e && !e.includes(r) ? e.push(r) : ur.set(i, [r]);
	}
	return B(() => {
		let e = i;
		return () => {
			dr && (dr.unregister(a), fr.delete(a)), ur.delete(e);
		};
	}, [i]), (0, x.useEffect)(() => {
		let e = r.current;
		return e && n(e), () => {
...
function hr(e = []) {
	let t = pr(), [n, r] = cr(t), i = (0, x.useCallback)(() => {
		r(function* () {
...
function gr(...e) {
	return e.length === 1 && e[0] ? e[0] : (t) => {
		...
		if (n) return () => {
			r.forEach((t, n) => {
				typeof t == "function" ? t() : _r(e[n], null);
			});
		};
	};
}
...
function V(...e) {
	...
	for (let n = 1; n < e.length; n++) {
		...
		for (let e in r) {
			let n = t[e], i = r[e];
			typeof n == "function" && typeof i == "function" && e[0] === "o" && e[1] === "n" && e.charCodeAt(2) >= 65 && e.charCodeAt(2) <= 90 ? t[e] = sr(n, i) : (e === "className" || e === "UNSAFE_className") && typeof n == "string" && typeof i == "string" ? t[e] = yr(n, i) : e === "id" && n && i ? t.id = mr(n, i) : e === "ref" && n && i ? t.ref = gr(n, i) : t[e] = i === void 0 ? n : i;
		}
	}
	return t;
}
...
function br(e) {
	...
	}, [r, i]), o = Zt(a), s = (0, x.useCallback)((e) => {
		let t = R(e), r = I(t), a = r ? Lt(r) : Lt();
...
function wr(e) {
	...
	return e.alt && t.add("Alt"), e.shift && t.add("Shift"), e.ctrl && t.add("Control"), e.meta && t.add("Meta"), e.mod && t.add(rn() ? "Meta" : "Control"), t;
}
function Tr(e) {
	let t = /* @__PURE__ */ new Set();
...
function Er(e) {
	return Cr.filter((t) => e.has(t));
}
function Dr(e) {
	let t = e.split("+").reduce((e, t) => {
		let n = t.toLowerCase();
		return Sr.has(n) ? n === "shift" ? e.shift = !0 : n === "alt" ? e.alt = !0 : n === "control" ? e.ctrl = !0 : n === "meta" ? e.meta = !0 : n === "mod" && (e.mod = !0) : e.key = t, e;
	}, {
		shift: !1,
		alt: !1,
		ctrl: !1,
...
function jr(e) {
	let t = Er(wr(e)), n = Ar(e.key);
	return t.length > 0 ? `${t.join("+")}+${n}` : n;
}
function Mr(e) {
	let t = Er(Tr(e)), n = Or(e.key);
...
function Pr(e) {
	...
	if (t) {
		...
		i = e.onKeyDown ? sr(e.onKeyDown, s) : s, a = e.onKeyUp ? sr(e.onKeyUp, c) : c;
	} else i = xr(e.onKeyDown), a = xr(e.onKeyUp);
...
var Lr = /*#__PURE__*/ x.createContext(null);
function Rr(e) {
	let t = (0, x.useContext)(Lr) || {};
	Ir(t, e);
	let { ref: n, ...r } = t;
	return r;
}
function zr(e, t) {
	let { focusProps: n } = br(e), { keyboardProps: r } = Pr(e), i = V(n, r), a = Rr(t), o = e.isDisabled ? {} : a, s = (0, x.useRef)(e.autoFocus);
	(0, x.useEffect)(() => {
		s.current && t.current && or(t.current), s.current = !1;
	}, [t]);
...
var Br = /*#__PURE__*/ (0, x.createContext)(!1);
function Vr(e) {
	if ((0, x.useContext)(Br)) return /*#__PURE__*/ x.createElement(x.Fragment, null, e.children);
	let t = /*#__PURE__*/ x.createElement(Br.Provider, { value: !0 }, e.children);
	return /*#__PURE__*/ x.createElement("template", null, t);
}
function Hr(e) {
	let t = (t, n) => (0, x.useContext)(Br) ? null : e(t, n);
	return t.displayName = e.displayName || e.name, (0, x.forwardRef)(t);
}
function Ur() {
	return (0, x.useContext)(Br);
}
//#endregion
...
var Wr = /* @__PURE__ */ m(((e) => {
	...
	t.exports = Kr();
})), Jr = /* @__PURE__ */ g(Gr(), 1), Yr = qr(), Xr = /*#__PURE__*/ (0, x.createContext)(!1), Zr = /*#__PURE__*/ (0, x.createContext)(null);
function Qr(e) {
	if ((0, x.useContext)(Zr)) return e.content;
	let { collection: t, document: n } = ni(e.createCollection);
	return /*#__PURE__*/ x.createElement(x.Fragment, null, /*#__PURE__*/ x.createElement(Vr, null, /*#__PURE__*/ x.createElement(Zr.Provider, { value: n }, e.content)), /*#__PURE__*/ x.createElement($r, {
		render: e.children,
		collection: t
	}));
}
function $r({ collection: e, render: t }) {
	return t(e);
}
function ei(e, t, n) {
	let r = Mn(), i = (0, x.useRef)(r);
	i.current = r;
	let a = (0, x.useCallback)(() => i.current ? n() : t(), [t, n]);
	return (0, Yr.useSyncExternalStore)(e, a);
}
var ti = typeof x.useSyncExternalStore == "function" ? x.useSyncExternalStore : ei;
function ni(e) {
	let [t] = (0, x.useState)(() => new bt(e?.() || new gt()));
	return {
		collection: ti((0, x.useCallback)((e) => t.subscribe(e), [t]), (0, x.useCallback)(() => {
...
var ri = /*#__PURE__*/ (0, x.createContext)(null);
function ii(e) {
...
function ai(e, t, n, r, i, a) {
	...
	if (s) {
		...
		return o || (o = s.ownerDocument.createElement(e.type), o.setProps(t, n, e, r, a), s.appendChild(o), s.ownerDocument.updateCollection(), s.ownerDocument.nodesByProps.set(t, o)), i ? /*#__PURE__*/ x.createElement(ri.Provider, { value: o }, i) : null;
	}
	return /*#__PURE__*/ x.createElement(e.type, { ref: o }, i);
}
function oi(e, t) {
	let n = ({ node: e }) => t(e.props, e.props.ref, e), r = (0, x.forwardRef)((r, i) => {
		let a = (0, x.useContext)(Lr);
		if (!(0, x.useContext)(Xr)) {
			if (t.length >= 3) throw Error(t.name + " cannot be rendered outside a collection.");
			return t(r, i);
		}
		return ai(e, r, i, "children" in r ? r.children : null, null, (e) => /*#__PURE__*/ x.createElement(Lr.Provider, { value: a }, /*#__PURE__*/ x.createElement(n, { node: e })));
	});
...
var ci = /*#__PURE__*/ (0, x.createContext)(null);
function li(e) {
	let t = (0, x.useContext)(ci), n = (t?.dependencies || []).concat(e.dependencies), r = e.idScope ?? t?.idScope, i = si({
		...e,
		idScope: r,
		dependencies: n
	});
	return (0, x.useContext)(Zr) && (i = /*#__PURE__*/ x.createElement(ui, null, i)), t = (0, x.useMemo)(() => ({
		dependencies: n,
		idScope: r
	}), [r, ...n]), /*#__PURE__*/ x.createElement(ci.Provider, { value: t }, i);
}
function ui({ children: e }) {
	let t = (0, x.useContext)(Zr), n = (0, x.useMemo)(() => /*#__PURE__*/ x.createElement(Zr.Provider, { value: null }, /*#__PURE__*/ x.createElement(Xr.Provider, { value: !0 }, e)), [e]);
	return Mn() ? /*#__PURE__*/ x.createElement(ri.Provider, { value: t }, n) : /*#__PURE__*/ (0, Jr.createPortal)(n, t);
}
//#endregion
//#region node_modules/react-aria/dist/private/utils/constants.mjs
var di = "react-aria-clear-focus", fi = "react-aria-focus";
//#endregion
//#region node_modules/react-aria/dist/private/focus/virtualFocus.mjs
function pi(e) {
	let t = gi(I(e));
	t !== e && (t && mi(t, e), e && hi(e, t));
}
function mi(e, t) {
...
function yi(e) {
	return e instanceof HTMLInputElement && !vi.has(e.type) || e instanceof HTMLTextAreaElement || e instanceof HTMLElement && e.isContentEditable;
}
//#endregion
//#region node_modules/react-aria/dist/private/utils/useEffectEvent.mjs
var bi = x.useInsertionEffect ?? B;
function xi(e) {
...
function Si(e, t, n, r) {
	let i = xi(n), a = n == null;
	(0, x.useEffect)(() => {
		if (!(a || e.current == null)) return Nt(e.current, t, i, r);
	}, [
		e,
		t,
		r,
...
function Ci(e, t) {
	...
	return n = pr(n), i && r ? i = [.../* @__PURE__ */ new Set([n, ...i.trim().split(/\s+/)])].join(" ") : i &&= i.trim().split(/\s+/).join(" "), !r && !i && t && (r = t), {
		id: n,
		"aria-label": r,
		"aria-labelledby": i
	};
...
function Ei(e) {
	if (Intl.Locale) {
		...
		if (t.script) return wi.has(t.script);
	}
	let t = e.split("-")[0];
	return Ti.has(t);
}
...
var Di = Symbol.for("react-aria.i18n.locale");
function Oi() {
	let e = typeof window < "u" && window[Di] || typeof navigator < "u" && (navigator.language || navigator.userLanguage) || "en-US";
	try {
	...
	return {
		locale: e,
		direction: Ei(e) ? "rtl" : "ltr"
	};
}
var ki = Oi(), Ai = /* @__PURE__ */ new Set();
function ji() {
	ki = Oi();
	for (let e of Ai) e(ki);
}
function Mi() {
	let e = Mn(), [t, n] = (0, x.useState)(ki);
	return (0, x.useEffect)(() => (Ai.size === 0 && window.addEventListener("languagechange", ji), Ai.add(n), () => {
		Ai.delete(n), Ai.size === 0 && window.removeEventListener("languagechange", ji);
	}), []), e ? {
		locale: typeof window < "u" && window[Di] || "en-US",
		direction: "ltr"
	} : t;
}
//#endregion
//#region node_modules/react-aria/dist/private/i18n/I18nProvider.mjs
var Ni = /*#__PURE__*/ x.createContext(null);
function Pi() {
	let e = Mi();
	return (0, x.useContext)(Ni) || e;
}
//#endregion
//#region node_modules/@internationalized/string/dist/private/LocalizedStringDictionary.mjs
var Fi = Symbol.for("react-aria.i18n.locale"), Ii = Symbol.for("react-aria.i18n.strings"), Li = void 0, Ri = class e {
	...
	getStringsForLocale(e) {
		...
		return t || (t = zi(e, this.strings, this.defaultLocale), this.strings[e] = t), t;
	}
	static getGlobalDictionaryForPackage(t) {
		...
		if (Li === void 0) {
			...
			if (!t) return null;
			Li = {};
			for (let r in t) Li[r] = new e({ [n]: t[r] }, n);
		}
		let r = Li?.[t];
...
var Hi = /* @__PURE__ */ new Map(), Ui = /* @__PURE__ */ new Map(), Wi = class {
	constructor(e, t) {
	...
	plural(e, t, n = "cardinal") {
		...
		let i = this.locale + ":" + n, a = Hi.get(i);
		return a || (a = new Intl.PluralRules(this.locale, { type: n }), Hi.set(i, a)), r = t[a.select(e)] || t.other, typeof r == "function" ? r() : r;
	}
	number(e) {
		let t = Ui.get(this.locale);
		return t || (t = new Intl.NumberFormat(this.locale), Ui.set(this.locale, t)), t.format(e);
	}
	select(e, t) {
		let n = e[t] || e.other;
...
function Ki(e) {
	let t = Gi.get(e);
	return t || (t = new Ri(e), Gi.set(e, t)), t;
}
function qi(e, t) {
	return t && Ri.getGlobalDictionaryForPackage(t) || Ki(e);
}
function Ji(e, t) {
	let { locale: n } = Pi(), r = qi(e, t);
	return (0, x.useMemo)(() => new Wi(n, r), [n, r]);
}
//#endregion
//#region node_modules/react-aria/dist/private/utils/filterDOMProps.mjs
var Yi = /* @__PURE__ */ new Set(["id"]), Xi = /* @__PURE__ */ new Set([
	"aria-label",
	"aria-labelledby",
	"aria-describedby",
	"aria-details"
	...
	"inert",
	"translate"
]), $i = /* @__PURE__ */ new Set(/* @__PURE__ */ "onClick.onAuxClick.onContextMenu.onDoubleClick.onMouseDown.onMouseEnter.onMouseLeave.onMouseMove.onMouseOut.onMouseOver.onMouseUp.onTouchCancel.onTouchEnd.onTouchMove.onTouchStart.onPointerDown.onPointerMove.onPointerUp.onPointerCancel.onPointerEnter.onPointerLeave.onPointerOver.onPointerOut.onGotPointerCapture.onLostPointerCapture.onScroll.onWheel.onAnimationStart.onAnimationEnd.onAnimationIteration.onTransitionCancel.onTransitionEnd.onTransitionRun.onTransitionStart".split(".")), ea = /^(data-.*)$/;
function H(e, t = {}) {
	let { labelable: n, isLink: r, global: i, events: a = i, propNames: o } = t, s = {};
	for (let t in e) Object.prototype.hasOwnProperty.call(e, t) && (Yi.has(t) || n && Xi.has(t) || r && Zi.has(t) || i && Qi.has(t) || a && ($i.has(t) || t.endsWith("Capture") && $i.has(t.slice(0, -7))) || o?.has(t) || ea.test(t)) && (s[t] = e[t]);
	return s;
}
//#endregion
//#region node_modules/react-aria/dist/private/interactions/textSelection.mjs
var U = "default", ta = "", na = /* @__PURE__ */ new WeakMap();
function ra(e) {
	if (sn() && ln()) {
		if (U === "default") {
			let t = I(e);
			ta = t.documentElement.style.webkitUserSelect, t.documentElement.style.webkitUserSelect = "none";
		}
		U = "disabled";
	} else if (e instanceof HTMLElement || e instanceof SVGElement) {
		let t = "userSelect" in e.style ? "userSelect" : "webkitUserSelect";
		na.set(e, e.style[t]), e.style[t] = "none";
	}
}
function ia(e) {
	if (sn() && ln()) {
		...
		U = "restoring", setTimeout(() => {
			ar(() => {
				if (U === "restoring") {
					let t = I(e);
					t.documentElement.style.webkitUserSelect === "none" && (t.documentElement.style.webkitUserSelect = ta || ""), ta = "", U = "default";
				}
			});
		}, 300);
	} else if ((e instanceof HTMLElement || e instanceof SVGElement) && e && na.has(e)) {
		let t = na.get(e), n = "userSelect" in e.style ? "userSelect" : "webkitUserSelect";
		e.style[n] === "none" && (e.style[n] = t), e.getAttribute("style") === "" && e.removeAttribute("style"), na.delete(e);
	}
}
//#endregion
...
function sa(e) {
	let t = I(e), n = oa.get(t);
	return n ??= aa("csp-nonce", t), n !== void 0 && oa.set(t, n), n;
}
//#endregion
//#region node_modules/react-aria/dist/private/interactions/context.mjs
var ca = x.createContext({ register: () => {} });
...
}, fa = Symbol("linkClicked"), pa = "react-aria-pressable-style", ma = "data-react-aria-pressable";
function ha(e) {
	let { onPress: t, onPressChange: n, onPressStart: r, onPressEnd: i, onPressUp: a, onClick: o, isDisabled: s, isPressed: c, preventFocusOnPress: l, shouldCancelOnPointerExit: u, allowTextSelectionOnPress: d, ref: f, ...p } = ua(e), [m, h] = (0, x.useState)(!1), g = (0, x.useRef)({
		isPressed: !1,
		...
		pointerType: null,
		disposables: []
	}), { addGlobalListener: _, removeAllGlobalListeners: v } = la(), y = (0, x.useCallback)((e, t) => {
		let i = g.current;
		if (s || i.didFirePressStart) return !1;
		let a = !0;
		if (i.isTriggeringEvent = !0, r) {
			let n = new da("pressstart", t, e);
		...
		let c = !0;
		if (i) {
			let t = new da("pressend", r, e);
			i(t), c = t.shouldStopPropagation;
		}
		if (n && n(!1), h(!1), t && a && !s) {
			let n = new da("press", r, e);
		...
		n,
		t
	]), S = xi(b), C = xi((0, x.useCallback)((e, t) => {
		let n = g.current;
		if (s) return !1;
		if (a) {
			n.isTriggeringEvent = !0;
			let r = new da("pressup", t, e);
		...
		if (t.isPressed && t.target) {
			t.didFirePressStart && t.pointerType != null && b(va(t.target, e), t.pointerType, !1), t.isPressed = !1, t.isOverTarget = !1, t.activePointerId = null, t.pointerType = null, v(), d || ia(t.target);
	...
	let E = (0, x.useCallback)((e) => {
		...
		let e = g.current, t = {
			onKeyDown(t) {
				if (_a(t.nativeEvent, t.currentTarget) && L(t.currentTarget, R(t))) {
					ba(R(t), t.key) && t.preventDefault();
					let r = !0;
					!e.isPressed && !t.repeat && (e.target = t.currentTarget, e.isPressed = !0, e.pointerType = "keyboard", r = y(t, "keyboard"));
					let i = t.currentTarget;
					_(I(t.currentTarget), "keyup", sr((t) => {
						_a(t, i) && !t.repeat && L(i, R(t)) && e.target && C(va(e.target, t), "keyboard");
					}, n), !0), r && t.stopPropagation(), t.metaKey && rn() && e.metaKeyEvents?.set(t.key, t.nativeEvent);
				} else t.key === "Meta" && (e.metaKeyEvents = /* @__PURE__ */ new Map());
			},
			onClick(t) {
				if (!(t && !L(t.currentTarget, R(t))) && t && t.button === 0 && !e.isTriggeringEvent && !_n.isOpening) {
					let n = !0;
					if (s && t.preventDefault(), !e.ignoreEmulatedMouseEvents && !e.isPressed && (e.pointerType === "virtual" || pn(t.nativeEvent))) {
						let e = y(t, "virtual"), r = C(t, "virtual"), i = S(t, "virtual");
						D(t), n = e && r && i;
					} else if (e.isPressed && e.pointerType !== "keyboard") {
						let r = e.pointerType || t.nativeEvent.pointerType || "virtual", i = C(va(t.currentTarget, t), r), a = S(va(t.currentTarget, t), r, !0);
			...
			if (e.isPressed && e.target && _a(t, e.target)) {
				ba(R(t), t.key) && t.preventDefault();
				let n = R(t), r = L(e.target, n);
				S(va(e.target, t), "keyboard", r), r && O(t, e.target), v(), t.key !== "Enter" && ga(e.target) && L(e.target, n) && !t[fa] && (t[fa] = !0, _n(e.target, t, !1)), e.isPressed = !1, e.metaKeyEvents?.delete(t.key);
		...
		if (typeof PointerEvent < "u") {
			t.onPointerDown = (t) => {
				...
				let i = !0;
				if (!e.isPressed) {
					e.isPressed = !0, e.isOverTarget = !0, e.activePointerId = t.pointerId, e.target = t.currentTarget, d || ra(e.target), i = y(t, e.pointerType);
					let a = R(t);
				...
				t.pointerId === e.activePointerId && e.target && !e.isOverTarget && e.pointerType != null && (e.isOverTarget = !0, y(va(e.target, t), e.pointerType));
			}, t.onPointerLeave = (t) => {
				t.pointerId === e.activePointerId && e.target && e.isOverTarget && e.pointerType != null && (e.isOverTarget = !1, S(va(e.target, t), e.pointerType, !1), E(t));
			};
			let n = (t) => {
				if (t.pointerId === e.activePointerId && e.isPressed && t.button === 0 && e.target) {
					if (L(e.target, R(t)) && e.pointerType != null) {
						let n = !1, r = setTimeout(() => {
							e.isPressed && e.target instanceof HTMLElement && (n ? T(t) : (Ct(e.target), e.target.click()));
						}, 80);
	...
	return (0, x.useEffect)(() => {
		if (!f) return;
		let e = I(f.current);
		if (!e || !e.head || e.getElementById(pa)) return;
...
@layer {
  [${ma}] {
    ...
    `.trim(), e.head.prepend(t);
		...
		let e = g.current;
		return () => {
			d || ia(e.target ?? void 0);
			for (let t of e.disposables) t();
			e.disposables = [];
		};
	}, [d]), {
		isPressed: c || m,
		pressProps: V(p, k, { [ma]: !0 })
	};
}
function ga(e) {
...
function _a(e, t) {
	...
	return (n === "Enter" || n === " " || n === "Spacebar" || r === "Space") && !(i instanceof Ot(i).HTMLInputElement && !Sa(i, n) || i instanceof Ot(i).HTMLTextAreaElement || i.isContentEditable) && !((a === "link" || !a && ga(i)) && n !== "Enter");
}
function va(e, t) {
...
function ya(e) {
	return e instanceof HTMLInputElement ? !1 : e instanceof HTMLButtonElement ? e.type !== "submit" && e.type !== "reset" : !ga(e);
}
function ba(e, t) {
	return rn() && t === "Enter" ? !1 : e instanceof HTMLInputElement ? t === "Enter" && (e.type === "checkbox" || e.type === "radio") ? !1 : !Sa(e, t) : ya(e);
}
...
function Sa(e, t) {
	return e.type === "checkbox" || e.type === "radio" ? t === " " : xa.has(e.type);
}
//#endregion
...
function Ca(e, t) {
	...
	let { pressProps: _, isPressed: v } = ha({
		onPressStart: a,
		onPressEnd: o,
		onPressChange: c,
		onPress: i,
...
function Ta(e, t, n, r) {
	return It() ? new wa(e, t, n, r) : e.createTreeWalker(t, n, r);
}
//#endregion
//#region node_modules/react-aria/dist/private/focus/FocusScope.mjs
var Ea = /*#__PURE__*/ x.createContext(null), Da = "react-aria-focus-scope-restore", Oa = null;
function ka(e) {
	let { children: t, contain: n, restoreFocus: r, autoFocus: i } = e, a = (0, x.useRef)(null), o = (0, x.useRef)(null), s = (0, x.useRef)([]), { parentNode: c } = (0, x.useContext)(Ea) || {}, l = (0, x.useMemo)(() => new Za({ scopeRef: s }), [s]);
	B(() => {
		let e = c || Qa.root;
		if (Qa.getTreeNode(e.scopeRef) && Oa && !Ba(Oa, e.scopeRef)) {
			let t = Qa.getTreeNode(Oa);
			t && (e = t);
		}
		...
		for (; e && e !== o.current;) t.push(e), e.addEventListener(Da, n), e = e.nextSibling;
		return s.current = t, () => {
			for (let e of t) e.removeEventListener(Da, n);
		};
	}, [t]), Ga(s, r, n), Fa(s, n), qa(s, r, n), Wa(s, i), (0, x.useEffect)(() => {
		let e = Lt(I(s.current ? s.current[0] : void 0)), t = null;
		if (La(e, s.current)) {
			for (let n of Qa.traverse()) n.scopeRef && La(e, n.scopeRef.current) && (t = n);
			t === Qa.getTreeNode(s) && (Oa = t.scopeRef);
		}
	}, [s]), B(() => () => {
		let e = Qa.getTreeNode(s)?.parent?.scopeRef ?? null;
		(s === Oa || Ba(s, Oa)) && (!e || Qa.getTreeNode(e)) && (Oa = e), Qa.removeTreeNode(s);
	}, [s]);
	let u = (0, x.useMemo)(() => Aa(s), []), d = (0, x.useMemo)(() => ({
		focusManager: u,
		parentNode: l
	}), [l, u]);
	return /*#__PURE__*/ x.createElement(Ea.Provider, { value: d }, /*#__PURE__*/ x.createElement("span", {
...
function Aa(e) {
	return {
		focusNext(t = {}) {
			let n = e.current, { from: r, tabbable: i, wrap: a, accept: o } = t, s = r || Lt(I(n[0] ?? void 0)), c = n[0].previousElementSibling, l = Ya(ja(n), {
				tabbable: i,
				accept: o
			}, n);
			l.currentNode = La(s, n) ? s : c;
			let u = l.nextNode();
			return !u && a && (l.currentNode = c, u = l.nextNode()), u && Va(u, !0), u;
		},
		focusPrevious(t = {}) {
			let n = e.current, { from: r, tabbable: i, wrap: a, accept: o } = t, s = r || Lt(I(n[0] ?? void 0)), c = n[n.length - 1].nextElementSibling, l = Ya(ja(n), {
				tabbable: i,
				accept: o
			}, n);
			l.currentNode = La(s, n) ? s : c;
			let u = l.previousNode();
			return !u && a && (l.currentNode = c, u = l.previousNode()), u && Va(u, !0), u;
		},
		focusFirst(t = {}) {
			let n = e.current, { tabbable: r, accept: i } = t, a = Ya(ja(n), {
				tabbable: r,
				accept: i
			}, n);
...
function Na(e) {
	...
	let t = e.form.elements.namedItem(e.name), n = Ot(e);
...
function Fa(e, t) {
	...
	B(() => {
		...
		let a = I(i ? i[0] : void 0), o = (t) => {
			if (t.key !== "Tab" || t.altKey || t.ctrlKey || t.metaKey || !Ma(e) || t.isComposing) return;
			let n = Lt(a), r = e.current;
			if (!r || !La(n, r)) return;
			let i = Ya(ja(r), { tabbable: !0 }, r);
			if (!n) return;
			i.currentNode = n;
			let o = t.shiftKey ? i.previousNode() : i.nextNode();
			o ||= (i.currentNode = t.shiftKey ? r[r.length - 1].nextElementSibling : r[0].previousElementSibling, t.shiftKey ? i.previousNode() : i.nextNode()), t.preventDefault(), o && (Va(o, !0), o instanceof Ot(o).HTMLInputElement && o.select());
		}, s = (t) => {
			(!Oa || Ba(Oa, e)) && La(R(t), e.current) ? (Oa = e, n.current = R(t)) : Ma(e) && !Ra(R(t), e) ? n.current ? Va(n.current) : Oa && Oa.current && Ua(Oa.current) : Ma(e) && (n.current = R(t));
		}, c = (t) => {
			r.current && cancelAnimationFrame(r.current), r.current = requestAnimationFrame(() => {
				let r = Xn(), i = (r === "virtual" || r === null) && dn() && un(), o = Lt(a);
				if (!i && o && Ma(e) && !Ra(o, e)) {
					Oa = e;
					let r = R(t);
					r && r.isConnected ? (n.current = r, Va(n.current)) : Oa.current && Ua(Oa.current);
				}
			});
		};
...
function Ra(e, t = null) {
	...
	for (let { scopeRef: n } of Qa.traverse(Qa.getTreeNode(t))) if (n && La(e, n.current)) return !0;
	return !1;
}
function za(e) {
	return Ra(e, Oa);
...
function Ha(e, t = !0) {
	let n = e[0].previousElementSibling, r = ja(e), i = Ya(r, { tabbable: t }, e);
	i.currentNode = n;
	let a = i.nextNode();
	return t && !a && (r = ja(e), i = Ya(r, { tabbable: !1 }, e), i.currentNode = n, a = i.nextNode()), a;
}
function Ua(e, t = !0) {
	Va(Ha(e, t));
}
function Wa(e, t) {
	let n = x.useRef(t);
	(0, x.useEffect)(() => {
		n.current && (Oa = e, !La(Lt(I(e.current ? e.current[0] : void 0)), Oa.current) && e.current && Ua(e.current)), n.current = !1;
	}, [e]);
}
function Ga(e, t, n) {
	B(() => {
		...
		let r = e.current, i = I(r ? r[0] : void 0), a = (t) => {
			let n = R(t);
			La(n, e.current) ? Oa = e : Ia(n) || (Oa = null);
		};
...
function qa(e, t, n) {
	let r = (0, x.useRef)(typeof document < "u" ? Lt(I(e.current ? e.current[0] : void 0)) : null);
	B(() => {
		let r = e.current, i = I(r ? r[0] : void 0);
		if (!t || n) return;
		let a = () => {
			(!Oa || Ba(Oa, e)) && La(Lt(i), e.current) && (Oa = e);
		};
		return i.addEventListener("focusin", a, !1), r?.forEach((e) => e.addEventListener("focusin", a, !1)), () => {
			i.removeEventListener("focusin", a, !1), r?.forEach((e) => e.removeEventListener("focusin", a, !1));
		};
		...
		let i = (t) => {
			...
			if (!Ra(n, e) || !Ka(e)) return;
			let i = Qa.getTreeNode(e);
			if (!i) return;
			let a = i.nodeToRestore, o = Ya(r.body, { tabbable: !0 });
			o.currentNode = n;
			let s = t.shiftKey ? o.previousNode() : o.nextNode();
			if ((!a || !a.isConnected || a === r.body) && (a = void 0, i.nodeToRestore = void 0), (!s || !Ra(s, e)) && a) {
				o.currentNode = a;
				do
					s = t.shiftKey ? o.previousNode() : o.nextNode();
				while (Ra(s, e));
				t.preventDefault(), t.stopPropagation(), s ? Va(s, !0) : Ia(a) ? Va(a, !0) : n.blur();
			}
		};
		...
		if (i) return i.nodeToRestore = r.current ?? void 0, () => {
			...
			if (!r) return;
			let i = r.nodeToRestore, a = Lt(n);
			if (t && i && (a && Ra(a, e) || a === n.body && Ka(e))) {
				let t = Qa.clone();
				requestAnimationFrame(() => {
...
function Ja(e) {
	e.dispatchEvent(new CustomEvent(Da, {
		bubbles: !0,
		cancelable: !0
	})) && Va(e);
}
function Ya(e, t, n) {
	let r = t?.tabbable ? qt : Kt, i = I(e?.nodeType === Node.ELEMENT_NODE ? e : null), a = Ta(i, e || i, NodeFilter.SHOW_ELEMENT, { acceptNode(e) {
		return L(t?.from, e) || t?.tabbable && e.tagName === "INPUT" && e.getAttribute("type") === "radio" && (!Pa(e) || a.currentNode.tagName === "INPUT" && a.currentNode.type === "radio" && a.currentNode.name === e.name) ? NodeFilter.FILTER_REJECT : r(e) && (!n || La(e, n)) && (!t?.accept || t.accept(e)) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
	} });
	return t?.from && (a.currentNode = t.from), a;
}
var Xa = class e {
	constructor() {
		this.fastMap = /* @__PURE__ */ new Map(), this.root = new Za({ scopeRef: null }), this.fastMap.set(null, this.root);
	}
	get size() {
	...
	removeTreeNode(e) {
		...
		if (!t) return;
		let n = t.parent;
		for (let e of this.traverse()) e !== t && t.nodeToRestore && e.nodeToRestore && t.scopeRef && t.scopeRef.current && La(e.nodeToRestore, t.scopeRef.current) && (e.nodeToRestore = t.nodeToRestore);
		let r = t.children;
...
}, Qa = new Xa(), $a = 7e3, eo = null;
function to(e, t = "assertive", n = $a) {
	eo ? eo.announce(e, t, n) : (eo = new no(), (typeof IS_REACT_ACT_ENVIRONMENT == "boolean" ? IS_REACT_ACT_ENVIRONMENT : typeof jest < "u") ? eo.announce(e, t, n) : setTimeout(() => {
		eo?.isAttached() && eo?.announce(e, t, n);
	}, 100));
}
var no = class {
	constructor() {
...
function oo(e, t, n = {}) {
	e !== t && so(e, t, t.getBoundingClientRect(), n);
}
function so(e, t, n, r = {}) {
	...
	sn() && ln() || u.direction === "ltr" ? oe -= ne : u.direction === "rtl" && (ae += ne);
...
function fo(e) {
	...
	return B(() => {
		...
		if (t) n(t.element.id);
			...
			let r = `react-aria-description-${lo++}`;
			n(r);
		...
		return t.refCount++, () => {
			t && --t.refCount === 0 && (t.element.remove(), uo.delete(e));
		};
...
function mo(e, t, n) {
	...
	B(() => {
		if (r === "native" && n?.current && "setCustomValidity" in n.current && !n.current.disabled) {
			...
			n.current.setCustomValidity(e), n.current.hasAttribute("title") || (n.current.title = ""), t.realtimeValidation.isInvalid || t.updateValidation(go(n.current));
		}
	});
	let a = (0, x.useRef)(!1), o = xi(() => {
		a.current || t.resetValidation();
	}), s = xi((e) => {
		t.displayValidation.isInvalid || t.commitValidation();
		let r = n?.current?.form;
		!e.defaultPrevented && n && r && _o(r) === n.current && (i ? i() : n.current?.focus(), Zn("keyboard")), e.preventDefault();
	}), c = xi(() => {
		t.commitValidation();
	});
	(0, x.useEffect)(() => {
...
var bo = {
	...
	validationErrors: []
}, Co = (0, x.createContext)({}), wo = "__reactAriaFormValidationState";
function To(e) {
...
function Eo(e) {
	...
	}, l = (0, x.useMemo)(() => !o || i == null ? null : ko(Oo(o, i)), [o, i]);
	a?.validationDetails.valid && (a = void 0);
	let u = (0, x.useContext)(Co), d = (0, x.useMemo)(() => r ? Array.isArray(r) ? r.flatMap((e) => Do(u[e])) : Do(u[r]) : [], [u, r]), [f, p] = (0, x.useState)(u), [m, h] = (0, x.useState)(!1);
	u !== f && (p(u), h(!1));
	let g = (0, x.useMemo)(() => ko(m ? [] : d), [m, d]), _ = (0, x.useRef)(So), [v, y] = (0, x.useState)(So), b = (0, x.useRef)(So), S = () => {
		if (!C) return;
		w(!1);
		let e = l || a || _.current;
		Ao(e, b.current) || (b.current = e, y(e));
	}, [C, w] = (0, x.useState)(!1);
	return (0, x.useEffect)(S), {
		realtimeValidation: c || g || l || a || So,
		displayValidation: s === "native" ? c || g || v : c || g || l || a || v,
		updateValidation(e) {
			s === "aria" && !Ao(v, e) ? y(e) : _.current = e;
		},
		resetValidation() {
			let e = So;
			Ao(e, b.current) || (b.current = e, y(e)), s === "native" && w(!1), h(!0);
		},
		commitValidation() {
			s === "native" && w(!0), h(!0);
		}
...
function Oo(e, t) {
	if (typeof e == "function") {
		let n = e(t);
		if (n && typeof n != "boolean") return Do(n);
	}
	return [];
}
function ko(e) {
...
function jo(e, t, n) {
	let { isDisabled: r = !1, isReadOnly: i = !1, value: a, name: o, form: s, children: c, isRequired: l, validationBehavior: u = "aria", "aria-label": d, "aria-labelledby": f, "aria-describedby": p, onPressStart: m, onPressEnd: h, onPressChange: g, onPress: _, onPressUp: v, onClick: y } = e, b = To({
		...e,
		value: t.isSelected
	...
	let T = (e) => {
		...
		onClick: y,
		isDisabled: r
	}), [O, k] = (0, x.useState)(!1), { pressProps: A } = ha({
		onPressStart(e) {
		...
		onPress(r) {
			...
			let { [wo]: i } = e, { commitValidation: a } = i || b;
			a();
		},
		isDisabled: r || i
	}), { focusableProps: ee } = zr(e, n), j = V(E, ee), te = H(e, { labelable: !0 });
	po(n, t.defaultSelected, t.setSelected);
	let M = yo(), ne = yo();
	return {
...
function Mo(e, t, n) {
	let { labelProps: r, inputProps: i, descriptionProps: a, errorMessageProps: o, isSelected: s, isPressed: c, isDisabled: l, isReadOnly: u, isInvalid: d, validationErrors: f, validationDetails: p } = jo(e, t, n), { isIndeterminate: m } = e;
	return (0, x.useEffect)(() => {
...
function Fo(e) {
	let { description: t, errorMessage: n, isInvalid: r, validationState: i } = e, { labelProps: a, fieldProps: o } = Po(e), s = hr([
		!!t,
		!!n,
		r,
		i
...
function Io(e) {
	let { isDisabled: t, onBlurWithin: n, onFocusWithin: r, onFocusWithinChange: i } = e, a = (0, x.useRef)({ isFocusWithin: !1 }), { addGlobalListener: o, removeAllGlobalListeners: s } = la(), c = (0, x.useCallback)((e) => {
		...
		a,
		s
	]), l = Zt(c), u = (0, x.useCallback)((e) => {
		if (!L(e.currentTarget, R(e))) return;
		let t = R(e), n = I(t), s = Lt(n);
...
var Lo = typeof document < "u" ? x.useInsertionEffect ?? x.useLayoutEffect : () => {};
function Ro(e, t, n) {
...
function W(e = {}) {
	let { isReadOnly: t } = e, [n, r] = Ro(e.isSelected, e.defaultSelected || !1, e.onChange), [i] = (0, x.useState)(n);
	function a(e) {
		t || r(e);
	}
	function o() {
...
function zo(e, t, n) {
	...
	}), { name: i, form: a, descriptionId: o, errorMessageId: s, validationBehavior: c } = No.get(t);
	c = e.validationBehavior ?? c;
	let { realtimeValidation: l } = To({
		...e,
		value: r.isSelected,
		name: void 0,
	...
	(0, x.useEffect)(d);
	let f = t.realtimeValidation.isInvalid ? t.realtimeValidation : l, p = c === "native" ? t.displayValidation : f, m = Mo({
		...e,
		isReadOnly: e.isReadOnly || t.isReadOnly,
...
function Bo(e, t = -Infinity, n = Infinity) {
...
function Ho(e = {}) {
	let { style: t, isFocusable: n } = e, [r, i] = (0, x.useState)(!1), { focusWithinProps: a } = Io({
		isDisabled: !n,
...
function Uo(e) {
	let { children: t, elementType: n = "div", isFocusable: r, style: i, ...a } = e, { visuallyHiddenProps: o } = Ho(e);
	return /*#__PURE__*/ x.createElement(n, V(a, o), t);
}
//#endregion
//#region node_modules/react-aria/dist/private/textfield/useTextField.mjs
function Wo(e, t) {
	let { inputElementType: n = "input", isDisabled: r = !1, isRequired: i = !1, isReadOnly: a = !1, type: o = "text", validationBehavior: s = "aria" } = e, [c, l] = Ro(e.value, e.defaultValue || "", e.onChange), { focusableProps: u } = zr(e, t), d = To({
		...e,
		value: c
	}), { isInvalid: f, validationErrors: p, validationDetails: m } = d.displayValidation, { labelProps: h, fieldProps: g, descriptionProps: _, errorMessageProps: v } = Fo({
		...e,
		isInvalid: f,
	...
	return po(t, e.defaultValue ?? S, l), mo(e, d, t), {
		labelProps: h,
...
var Go = typeof HTMLElement < "u" && "inert" in HTMLElement.prototype;
function Ko(e) {
	return e.dataset.liveAnnouncer === "true" || e.dataset.reactAriaTopLayer !== void 0;
}
var qo = /* @__PURE__ */ new WeakMap(), G = [];
function Jo(e, t) {
	let n = Ot(e?.[0]), r = t instanceof n.Element ? { root: t } : t, i = r?.root ?? document.body, a = r?.shouldUseInert && Go, o = new Set(e), s = /* @__PURE__ */ new Set(), c = (e) => a && e instanceof n.HTMLElement ? e.inert : e.getAttribute("aria-hidden") === "true", l = (e, t) => {
	...
	if (It()) {
		...
		for (let n of e) {
			let e = n.getRootNode();
			for (; Mt(e) && e !== t;) u.add(e), e = e.host.getRootNode();
		}
	}
	let d = (e) => {
		...
		}, n = Ta(I(e), e, NodeFilter.SHOW_ELEMENT, { acceptNode: t }), r = t(e);
		...
		let t = qo.get(e) ?? 0;
		c(e) && t === 0 || (t === 0 && l(e, !0), s.add(e), qo.set(e, t + 1));
	};
	G.length && G[G.length - 1].disconnect(), d(i);
	let p = new MutationObserver((e) => {
		for (let t of e) if (t.type === "childList") {
			if (t.target.isConnected && ![...o, ...s].some((e) => L(e, t.target))) for (let e of t.addedNodes) (e instanceof HTMLElement || e instanceof SVGElement) && Ko(e) ? o.add(e) : e instanceof Element && d(e);
			if (It()) {
	...
	return G.push(h), () => {
		if (p.disconnect(), It()) for (let e of m) e.disconnect();
		for (let e of s) {
			let t = qo.get(e);
			t != null && (t === 1 ? (l(e, !1), qo.delete(e)) : qo.set(e, t - 1));
		}
		h === G[G.length - 1] ? (G.pop(), G.length && G[G.length - 1].observe()) : G.splice(G.indexOf(h), 1);
	};
}
function Yo(e) {
	let t = G[G.length - 1];
...
var is = class {
	...
	getItemRect(e) {
		...
		if (!t) return null;
		let n = e == null ? null : es(this.ref, e);
		if (!n) return null;
	...
	constructor(...e) {
		if (e.length === 1) {
			let t = e[0];
			this.collection = t.collection, this.ref = t.ref, this.collator = t.collator, this.disabledKeys = t.disabledKeys || /* @__PURE__ */ new Set(), this.disabledBehavior = t.disabledBehavior || "all", this.orientation = t.orientation || "vertical", this.direction = t.direction, this.layout = t.layout || "stack", this.layoutDelegate = t.layoutDelegate || new is(t.ref);
		} else this.collection = e[0], this.disabledKeys = e[1], this.ref = e[2], this.collator = e[3], this.layout = "stack", this.orientation = "vertical", this.disabledBehavior = "all", this.layoutDelegate = new is(this.ref);
	...
	isReversed(e) {
		let t = this.getNextKey(e), n = es(this.ref, e);
		if (t != null) {
			let e = es(this.ref, t);
...
os = { longPressMessage: "اضغط مطولاً أو اضغط على Alt + السهم لأسفل لفتح القائمة" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/bg-BG.mjs
var ss = {};
ss = { longPressMessage: "Натиснете продължително или натиснете Alt+ стрелка надолу, за да отворите менюто" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/cs-CZ.mjs
var cs = {};
cs = { longPressMessage: "Dlouhým stiskem nebo stisknutím kláves Alt + šipka dolů otevřete nabídku" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/da-DK.mjs
var ls = {};
ls = { longPressMessage: "Langt tryk eller tryk på Alt + pil ned for at åbne menuen" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/de-DE.mjs
var us = {};
us = { longPressMessage: "Drücken Sie lange oder drücken Sie Alt + Nach-unten, um das Menü zu öffnen" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/el-GR.mjs
var ds = {};
ds = { longPressMessage: "Πιέστε παρατεταμένα ή πατήστε Alt + κάτω βέλος για να ανοίξετε το μενού" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/en-US.mjs
var fs = {};
fs = { longPressMessage: "Long press or press Alt + ArrowDown to open menu" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/es-ES.mjs
var ps = {};
ps = { longPressMessage: "Mantenga pulsado o pulse Alt + flecha abajo para abrir el menú" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/et-EE.mjs
var ms = {};
ms = { longPressMessage: "Menüü avamiseks vajutage pikalt või vajutage klahve Alt + allanool" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/fi-FI.mjs
var hs = {};
hs = { longPressMessage: "Avaa valikko painamalla pohjassa tai näppäinyhdistelmällä Alt + Alanuoli" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/fr-FR.mjs
var gs = {};
gs = { longPressMessage: "Appuyez de manière prolongée ou appuyez sur Alt\xA0+\xA0Flèche vers le bas pour ouvrir le menu." };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/he-IL.mjs
var _s = {};
_s = { longPressMessage: "לחץ לחיצה ארוכה או הקש Alt + ArrowDown כדי לפתוח את התפריט" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/hr-HR.mjs
var vs = {};
vs = { longPressMessage: "Dugo pritisnite ili pritisnite Alt + strelicu prema dolje za otvaranje izbornika" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/hu-HU.mjs
var ys = {};
ys = { longPressMessage: "Nyomja meg hosszan, vagy nyomja meg az Alt + lefele nyíl gombot a menü megnyitásához" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/it-IT.mjs
var bs = {};
bs = { longPressMessage: "Premi a lungo o premi Alt + Freccia giù per aprire il menu" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/ja-JP.mjs
var xs = {};
xs = { longPressMessage: "長押しまたは Alt+下矢印キーでメニューを開く" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/ko-KR.mjs
var Ss = {};
Ss = { longPressMessage: "길게 누르거나 Alt + 아래쪽 화살표를 눌러 메뉴 열기" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/lt-LT.mjs
var Cs = {};
Cs = { longPressMessage: "Norėdami atidaryti meniu, nuspaudę palaikykite arba paspauskite „Alt + ArrowDown“." };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/lv-LV.mjs
var ws = {};
ws = { longPressMessage: "Lai atvērtu izvēlni, turiet nospiestu vai nospiediet taustiņu kombināciju Alt + lejupvērstā bultiņa" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/nb-NO.mjs
var Ts = {};
Ts = { longPressMessage: "Langt trykk eller trykk Alt + PilNed for å åpne menyen" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/nl-NL.mjs
var Es = {};
Es = { longPressMessage: "Druk lang op Alt + pijl-omlaag of druk op Alt om het menu te openen" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/pl-PL.mjs
var Ds = {};
Ds = { longPressMessage: "Naciśnij i przytrzymaj lub naciśnij klawisze Alt + Strzałka w dół, aby otworzyć menu" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/pt-BR.mjs
var Os = {};
Os = { longPressMessage: "Pressione e segure ou pressione Alt + Seta para baixo para abrir o menu" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/pt-PT.mjs
var ks = {};
ks = { longPressMessage: "Prima continuamente ou prima Alt + Seta Para Baixo para abrir o menu" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/ro-RO.mjs
var As = {};
As = { longPressMessage: "Apăsați lung sau apăsați pe Alt + săgeată în jos pentru a deschide meniul" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/ru-RU.mjs
var js = {};
js = { longPressMessage: "Нажмите и удерживайте или нажмите Alt + Стрелка вниз, чтобы открыть меню" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/sk-SK.mjs
var Ms = {};
Ms = { longPressMessage: "Ponuku otvoríte dlhým stlačením alebo stlačením klávesu Alt + klávesu so šípkou nadol" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/sl-SI.mjs
var Ns = {};
Ns = { longPressMessage: "Za odprtje menija pritisnite in držite gumb ali pritisnite Alt+puščica navzdol" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/sr-SP.mjs
var Ps = {};
Ps = { longPressMessage: "Dugo pritisnite ili pritisnite Alt + strelicu prema dole da otvorite meni" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/sv-SE.mjs
var Fs = {};
Fs = { longPressMessage: "Håll nedtryckt eller tryck på Alt + pil nedåt för att öppna menyn" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/tr-TR.mjs
var Is = {};
Is = { longPressMessage: "Menüyü açmak için uzun basın veya Alt + Aşağı Ok tuşuna basın" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/uk-UA.mjs
var Ls = {};
Ls = { longPressMessage: "Довго або звичайно натисніть комбінацію клавіш Alt і стрілка вниз, щоб відкрити меню" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/zh-CN.mjs
var Rs = {};
Rs = { longPressMessage: "长按或按 Alt + 向下方向键以打开菜单" };
//#endregion
//#region node_modules/react-aria/dist/private/intl/menu/zh-TW.mjs
var zs = {};
zs = { longPressMessage: "長按或按 Alt+向下鍵以開啟功能表" };
//#endregion
...
var Vs = 500;
function Hs(e) {
	let { isDisabled: t, pointerType: n, onLongPressStart: r, onLongPressEnd: i, onLongPress: a, threshold: o = Vs, accessibilityDescription: s } = e, c = (0, x.useRef)(void 0), { addGlobalListener: l, removeAllGlobalListeners: u } = la(), d = (e) => n ? e.pointerType === n : e.pointerType === "mouse" || e.pointerType === "touch", { pressProps: f } = ha({
		isDisabled: t,
		onPressStart(e) {
			if (e.continuePropagation(), d(e)) {
				r && r({
					...
					e.target.dispatchEvent(new PointerEvent("pointercancel", { bubbles: !0 })), l(e.target, "click", (e) => e.preventDefault(), { once: !0 }), I(e.target).activeElement !== e.target && Ct(e.target), a && a({
						...e,
						type: "longpress"
					}), c.current = void 0;
	...
	return { longPressProps: V(f, fo(a && !t ? s : void 0)) };
}
//#endregion
//#region node_modules/react-aria/dist/private/interactions/useContextMenu.mjs
function Us(e) {
	let { onContextMenu: t } = e, n = (0, x.useRef)(!1), { longPressProps: r } = Hs({
		onLongPressStart() {
			n.current = !1;
		},
		onLongPress(e) {
	...
	return t ? { contextMenuProps: V(sn() ? r : {}, {
		onContextMenu(e) {
...
function Ks(e, t, n) {
	...
	(0, x.useEffect)(() => {
		n && n.current && Ws.set(n.current, t.close);
	});
	let a;
...
function Js(e, t, n) {
	let { type: r = "menu", isDisabled: i, trigger: a = "press" } = e, o = pr(), { triggerProps: s, overlayProps: c } = Ks({ type: r }, t, n), l = (e, n, r = "first") => {
	...
	}), d = Ji(qs(Bs), "@react-aria/menu"), { longPressProps: f } = Hs({
		...
		onPressStart(e) {
			e.pointerType !== "touch" && e.pointerType !== "keyboard" && !i && (Ct(e.target), t.open(e.pointerType === "virtual" ? "first" : null));
		},
		onPress(e) {
			e.pointerType === "touch" && !i && (Ct(e.target), t.toggle());
		}
	};
	delete s.onPress;
	let { contextMenuProps: m } = Us({ onContextMenu(e) {
...
function $s(e) {
	let { selectionManager: t, keyboardDelegate: n, ref: r, autoFocus: i = !1, shouldFocusWrap: a = !1, disallowEmptySelection: o = !1, disallowSelectAll: s = !1, escapeKeyBehavior: c = "clearSelection", selectOnFocus: l = t.selectionBehavior === "replace", disallowTypeAhead: u = !1, shouldUseVirtualFocus: d, allowsTabNavigation: f = !1, scrollRef: p = r, linkBehavior: m = "action", UNSTABLE_focusOnEntry: h } = e, { direction: g } = Pi(), _ = gn(), v = (e, n, i) => {
		...
		if (n.getFirstKey) {
			...
			let r = n.getFirstKey(t.focusedKey, _i(e));
			if (t.setFocusedKey(r), r != null) {
				if (_i(e) && e.shiftKey && t.selectionMode === "multiple") {
					t.extendSelection(r);
					return;
				}
				if (l) {
		...
		if (n.getLastKey) {
			if (t.focusedKey === null && e.shiftKey) return !1;
			let r = n.getLastKey(t.focusedKey, _i(e));
			if (t.setFocusedKey(r), r != null) {
				if (_i(e) && e.shiftKey && t.selectionMode === "multiple") {
					t.extendSelection(r);
					return;
		...
		if (!f && r.current) {
			let e = Ya(r.current, { tabbable: !0 }), t, n;
			do
				n = e.lastChild(), n && (t = n);
			while (n);
			let i = Lt();
		...
		[rn() ? e + "+Shift+Alt" : e + "+Shift+Control"]: t,
		[e + "+Shift"]: t,
		[rn() ? e + "+Alt" : e + "+Control"]: t,
		[e]: t
	}), { keyboardProps: te } = Pr({
		shortcuts: {
			...j("ArrowDown", y),
	...
	let N = (e) => {
		...
		if (t.focusedKey != null && p.current) {
			let e = es(r, t.focusedKey);
			e instanceof HTMLElement && (!zt(e) && !d && Ct(e), (i === "keyboard" || h && i === "virtual") && co(e, { containingElement: r.current }));
		}
	}, re = (e) => {
	...
	Qs(() => {
		if (ie.current) {
			if (ae == null) {
				let e = Lt();
				pi(r.current), hi(e, null), t.collection.size > 0 && (ie.current = !1);
			} else t.setFocusedKey(ae), ie.current = !1;
		}
	}, [ae, t.collection.size]), Qs(() => {
		t.collection.size > 0 && (ie.current = !1);
	}, [t.focusedKey]), Si(r, di, d ? (e) => {
	...
	(0, x.useEffect)(() => {
		if (oe.current) {
			...
			t.setFocused(!0), t.setFocusedKey(e), e != null && l && !a.size && t.canSelectItem(e) && t.replaceSelection(e), e == null && !d && r.current && or(r.current), t.collection.size > 0 && (oe.current = !1, se.current = !0);
		}
	});
	...
	(0, x.useEffect)(() => {
		if (t.isFocused && t.focusedKey != null && (t.focusedKey !== ce.current || se.current) && p.current && r.current) {
			let e = Xn(), n = es(r, t.focusedKey);
			if (!(n instanceof HTMLElement)) return;
			(e === "keyboard" || se.current) && (le.current && cancelAnimationFrame(le.current), le.current = requestAnimationFrame(() => {
				p.current && (oo(p.current, n), e !== "virtual" && co(n, { containingElement: r.current }));
			}));
		}
		!d && t.isFocused && t.focusedKey == null && ce.current != null && r.current && or(r.current), ce.current = t.focusedKey, se.current = !1;
	}), (0, x.useEffect)(() => () => {
		le.current && cancelAnimationFrame(le.current);
	}, []), Si(r, "react-aria-focus-scope-restore", (e) => {
...
function rc(e, t, n) {
	...
	let r = [...ic(e, t), t], i = [...ic(e, n), n], a = r.slice(0, i.length).findIndex((e, t) => e !== i[t]);
...
function oc(e) {
	...
	if (t != null) return t;
	let n = 0, r = (t) => {
		for (let i of t) i.type === "section" ? r(ec(i, e)) : i.type === "item" && n++;
	};
...
function cc(e) {
	let { locale: t } = Pi(), n = t + (e ? Object.entries(e).sort((e, t) => e[0] < t[0] ? -1 : 1).join() : "");
...
function lc({ children: e }) {
	...
	return /*#__PURE__*/ x.createElement(ca.Provider, { value: t }, e);
}
//#endregion
//#region node_modules/react-aria/dist/private/overlays/PortalProvider.mjs
var uc = /*#__PURE__*/ (0, x.createContext)({});
function dc(e) {
	let { getContainer: t } = e, { getContainer: n } = fc();
	return /*#__PURE__*/ x.createElement(uc.Provider, { value: { getContainer: t === null ? void 0 : t ?? n } }, e.children);
}
function fc() {
	return (0, x.useContext)(uc) ?? {};
}
//#endregion
//#region node_modules/react-aria/dist/private/overlays/Overlay.mjs
var pc = /*#__PURE__*/ x.createContext(null);
function mc(e) {
	let t = Mn(), { portalContainer: n = t ? null : document.body, isExiting: r } = e, [i, a] = (0, x.useState)(!1), o = (0, x.useMemo)(() => ({
		contain: i,
		setContain: a
	}), [i, a]), { getContainer: s } = fc();
	if (!e.portalContainer && s && (n = s()), !n) return null;
	let c = e.children;
	return e.disableFocusManagement || (c = /*#__PURE__*/ x.createElement(ka, {
		restoreFocus: !0,
		contain: (e.shouldContainFocus || i) && !r
	}, c)), c = /*#__PURE__*/ x.createElement(pc.Provider, { value: o }, /*#__PURE__*/ x.createElement(lc, null, /*#__PURE__*/ x.createElement(Lr.Provider, { value: null }, c))), /*#__PURE__*/ Jr.createPortal(c, n);
}
function hc() {
	let e = (0, x.useContext)(pc)?.setContain;
	B(() => {
		e?.(!0);
	}, [e]);
}
...
function gc(e, t) {
	let { role: n = "dialog" } = e, r = hr();
	r = e["aria-label"] ? void 0 : r;
	let i = hr();
	i = n === "alertdialog" && !e["aria-describedby"] ? i : void 0;
	let a = (0, x.useRef)(!1);
	(0, x.useEffect)(() => {
		if (t.current && !zt(t.current)) {
			or(t.current);
			let e = setTimeout(() => {
				(Lt() === t.current || Lt() === document.body) && (a.current = !0, t.current && (t.current.blur(), or(t.current)), a.current = !1);
			}, 500);
			return () => {
				clearTimeout(e);
			};
		}
	}, [t]), hc(), (0, x.useRef)(!1), (0, x.useEffect)(() => {});
...
function _c(e = {}) {
	let { autoFocus: t = !1, isTextInput: n, within: r } = e, i = (0, x.useRef)({
		...
		i.current.isFocused = e, i.current.isFocusVisible = Yn(), o(e), l();
	}, [l]);
	er((e) => {
...
function Sc(e) {
	e.pointerType === "touch" && xc();
}
function Cc() {
	let e = I(null);
	if (e !== void 0) return bc === 0 && typeof PointerEvent < "u" && e.addEventListener("pointerup", Sc), bc++, () => {
		bc--, !(bc > 0) && typeof PointerEvent < "u" && e.removeEventListener("pointerup", Sc);
	};
}
function wc(e) {
	...
	(0, x.useEffect)(Cc, []);
	let { addGlobalListener: c, removeAllGlobalListeners: l } = la(), { hoverProps: u, triggerHoverEnd: d } = (0, x.useMemo)(() => {
		let e = (e, r) => {
		...
		return typeof PointerEvent < "u" && (u.onPointerEnter = (t) => {
			yc && t.pointerType === "mouse" || e(t, t.pointerType);
		}, u.onPointerLeave = (e) => {
...
function Tc(e) {
	let { ref: t, onInteractOutside: n, isDisabled: r, onInteractOutsideStart: i } = e, a = (0, x.useRef)({
		...
		n && Ec(e, t) && (i && i(e), a.current.isPointerDown = !0);
	}), s = xi((e) => {
		n && n(e);
	});
	(0, x.useEffect)(() => {
		...
		if (typeof PointerEvent < "u") {
			let n = (n) => {
				e.isPointerDown && Ec(n, t) && s(n), e.isPointerDown = !1;
			};
...
function Dc(e, t) {
	let n = t?.isDisabled, [r, i] = (0, x.useState)(!1);
	return B(() => {
		if (e?.current && !n) {
			let t = () => {
				if (e.current) {
					let t = Ya(e.current, { tabbable: !0 });
					i(!!t.nextNode());
				}
			};
			t();
...
function Oc(e) {
	let { selectionManager: t, collection: n, disabledKeys: r, ref: i, keyboardDelegate: a, layoutDelegate: o, orientation: s } = e, c = cc({
		usage: "search",
		sensitivity: "base"
	}), l = t.disabledBehavior, u = (0, x.useMemo)(() => a || new as({
		collection: n,
		disabledKeys: r,
		disabledBehavior: l,
		ref: i,
...
function kc(e) {
	let { id: t, selectionManager: n, key: r, ref: i, shouldSelectOnPressUp: a, shouldUseVirtualFocus: o, focus: s, isDisabled: c, onAction: l, allowsDifferentPressOrigin: u, linkBehavior: d = "action" } = e, f = gn();
	t = pr(t);
	let p = (e) => {
		if (e.pointerType === "keyboard" && $o(e)) n.toggleSelection(r);
		else {
			...
			n.selectionMode === "single" ? n.isSelected(r) && !n.disallowEmptySelection ? n.toggleSelection(r) : n.replaceSelection(r) : e && e.shiftKey ? n.extendSelection(r) : n.selectionBehavior === "toggle" || e && (_i(e) || e.pointerType === "touch" || e.pointerType === "virtual") ? n.toggleSelection(r) : n.replaceSelection(r);
		}
	};
	(0, x.useEffect)(() => {
		r === n.focusedKey && n.isFocused && (o ? pi(i.current) : s ? s() : Lt() !== i.current && i.current && or(i.current));
	}, [
		i,
		r,
		n.focusedKey,
	...
	a ? (A.onPressStart = (e) => {
		w.current = e.pointerType, E.current = T, e.pointerType === "keyboard" && (!C || jc(e.key)) && p(e);
		...
		if (b || S && e.pointerType !== "mouse") {
			if (e.pointerType === "keyboard" && !Ac(e.key)) return;
			k(e);
		} else e.pointerType !== "keyboard" && v && p(e);
	}) : (A.onPressStart = (e) => {
		w.current = e.pointerType, E.current = T, D.current = b, v && (e.pointerType === "mouse" && !b || e.pointerType === "keyboard" && (!y || jc(e.key))) && p(e);
	}, A.onPress = (e) => {
		(e.pointerType === "touch" || e.pointerType === "pen" || e.pointerType === "virtual" || e.pointerType === "keyboard" && C && Ac(e.key) || e.pointerType === "mouse" && D.current) && (C ? k(e) : v && p(e));
	});
	let ee = rs(n.collection);
	...
	let { pressProps: j, isPressed: te } = ha(A), M = S ? (e) => {
		w.current === "mouse" && (e.stopPropagation(), e.preventDefault(), k(e));
	} : void 0, { longPressProps: ne } = Hs({
		isDisabled: !T,
		onLongPress(e) {
...
function Nc(e) {
	let { heading: t, "aria-label": n } = e, r = pr();
	return {
...
function Pc(e, t, n) {
	let { key: r } = e, i = Xo.get(t), a = e.isDisabled ?? t.selectionManager.isDisabled(r), o = e.isSelected ?? t.selectionManager.isSelected(r), s = e.shouldSelectOnPressUp ?? i?.shouldSelectOnPressUp, c = e.shouldFocusOnHover ?? i?.shouldFocusOnHover, l = e.shouldUseVirtualFocus ?? i?.shouldUseVirtualFocus, u = e.isVirtualized ?? i?.isVirtualized, d = hr(), f = hr(), p = {
		role: "option",
	...
	if (u) {
		...
		p["aria-posinset"] = Number.isNaN(e) ? void 0 : e + 1, p["aria-setsize"] = oc(t.collection);
	}
	let h = i?.onAction ? () => i?.onAction?.(r) : void 0, g = Qo(t, r), { itemProps: _, isPressed: v, isFocused: y, hasAction: b, allowsSelection: x } = kc({
		selectionManager: t.selectionManager,
		key: r,
		ref: n,
		...
		isDisabled: a,
		onAction: h || m?.props?.onAction ? sr(m?.props?.onAction, h) : void 0,
		...
		isDisabled: a || !c,
		onHoverStart() {
			Yn() || (t.selectionManager.setFocused(!0), t.selectionManager.setFocusedKey(r));
		}
	}), C = H(m?.props);
	delete C.id;
	let w = bn(m?.props);
	return {
		...
		isFocused: y,
		isFocusVisible: y && t.selectionManager.isFocused && Yn(),
		isSelected: o,
		isDisabled: a,
		isPressed: v,
		allowsSelection: x,
...
function Ic(e) {
	let { ref: t, box: n, onResize: r } = e, i = xi(r);
	(0, x.useEffect)(() => {
		let e = t?.current;
		if (e) {
			if (Fc()) {
...
function yl(e) {
	let { onDismiss: t, ...n } = e, r = Ci(n, Ji(vl(_l), "@react-aria/overlays").format("dismiss")), i = () => {
		t && t();
	};
	return /*#__PURE__*/ x.createElement(Uo, null, /*#__PURE__*/ x.createElement("button", {
		...r,
		tabIndex: -1,
		onClick: i,
		style: {
...
function xl(e, t) {
	...
	(0, x.useEffect)(() => {
		if (i && !bl.includes(t)) return bl.push(t), () => {
			let e = bl.indexOf(t);
			e >= 0 && bl.splice(e, 1);
		};
	}, [i, t]);
	let l = () => {
		bl[bl.length - 1] === t && n && n();
	}, u = (e) => {
		let n = bl[bl.length - 1];
		c.current = n, (!s || s(R(e))) && n === t && e.stopPropagation();
	}, d = (e) => {
		(!s || s(R(e))) && (bl[bl.length - 1] === t && e.stopPropagation(), c.current === t && l()), c.current = void 0;
	}, { keyboardProps: f } = Pr({ shortcuts: { Escape: () => {
		if (!o) {
			l();
			return;
		}
	...
	let { focusWithinProps: p } = Io({
		isDisabled: !r,
		onBlurWithin: (e) => {
			!e.relatedTarget || za(e.relatedTarget) || (!s || s(e.relatedTarget)) && n?.();
		}
	});
	return {
		overlayProps: {
...
var Sl = typeof document < "u" && window.visualViewport, Cl = 0, wl;
function Tl(e = {}) {
	let { isDisabled: t } = e;
	B(() => {
		if (!t) return Cl++, Cl === 1 && (wl = sn() && ln() ? Dl() : El()), () => {
			Cl--, Cl === 0 && wl();
		};
	}, [t]);
}
function El() {
	...
	return sr(e > 0 && ("scrollbarGutter" in document.documentElement.style ? Pt(document.documentElement, "scrollbar-gutter", "stable") : Pt(document.documentElement, "padding-right", `${e}px`)), Pt(document.documentElement, "overflow", "hidden"));
}
function Dl() {
	let e = Pt(document.documentElement, "overflow", "hidden"), t, n = !1, r = (e) => {
		let r = R(e);
		t = ro(r) ? r : io(r, !0), n = !1;
	...
	}, i = document.createElement("style"), a = sa();
	...
	let o = (e) => {
		...
		n && yi(n) ? (n.focus({ preventScroll: !0 }), Ol(n, yi(t))) : n || (t.parentElement?.closest("[tabindex]"))?.focus({ preventScroll: !0 });
	}, c = HTMLElement.prototype.focus;
	Reflect.defineProperty(HTMLElement.prototype, "focus", {
		configurable: !0,
		writable: !0,
		value: function(e) {
			let t = Lt(), n = t != null && yi(t);
			c.call(this, {
				...e,
				preventScroll: !0
			}), (!e || !e.preventScroll) && Ol(this, n);
		}
	});
	let l = sr(Nt(document, "touchstart", r, {
		passive: !1,
		capture: !0
	}), Nt(document, "touchmove", o, {
		passive: !1,
		capture: !0
	}), Nt(document, "blur", s, !0));
	return () => {
...
function Ol(e, t) {
	t || !Sl ? kl(e) : Sl.addEventListener("resize", () => kl(e), { once: !0 });
}
function kl(e) {
	...
	for (; n && n !== t;) {
		...
		if (e !== document.documentElement && e !== document.body && e !== n) {
			...
			if (r.top < t.top || r.bottom > t.top + n.clientHeight) {
				let n = t.bottom;
				Sl && (n = Math.min(n, Sl.offsetTop + Sl.height));
...
function Al(e, t, n) {
	let { overlayProps: r, underlayProps: i } = xl({
		...e,
		isOpen: t.isOpen,
		onClose: t.close
	}, n);
	return Tl({ isDisabled: !t.isOpen }), hc(), (0, x.useEffect)(() => {
		if (t.isOpen && n.current) return Jo([n.current], { shouldUseInert: !0 });
	}, [t.isOpen, n]), {
		modalProps: V(r),
		underlayProps: i
	};
...
var jl = {
	...
	width: "totalWidth",
	height: "totalHeight"
}, Il = {}, Ll = () => typeof document < "u" ? window.visualViewport : null;
function Rl(e, t) {
	...
	} else ({width: n, height: r, top: o, left: s} = Yl(e, !1)), c.top = e.scrollTop, c.left = e.scrollLeft, i = n, a = r;
...
function Bl(e, t, n, r, i, a, o) {
	let s = i.scroll[e] ?? 0, c = r[Pl[e]], l = o[e] + r.scroll[jl[e]] + a, u = o[e] + r.scroll[jl[e]] + c - a, d = t - s + r.scroll[jl[e]] + o[e] - r[jl[e]], f = t - s + n + r.scroll[jl[e]] + o[e] - r[jl[e]];
...
function Hl(e) {
	if (Il[e]) return Il[e];
	let [t, n] = e.split(" "), r = jl[t] || "right", i = Nl[r];
	jl[n] || (n = "center");
	let a = Pl[r], o = Pl[i];
	return Il[e] = {
		placement: t,
...
function Ul(e, t, n, r, i, a, o, s, c, l, u) {
	...
	if (_[m] = Bo(_[m], v, y), d === p) {
		let t = s ? u[h] : u[Fl[h]];
		_[Ml[p]] = Math.floor(t - e[p] + i);
	} else _[p] = Math.floor(e[p] + e[h] + i);
	return _;
}
function Wl(e, t, n, r, i, a, o, s, c, l, u) {
	let d = (e.top == null ? c[Fl.height] - (e.bottom ?? 0) - o : e.top) - (c.scroll.top ?? 0), f = l ? n.top : 0, p = {
...
function Kl(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _) {
	let v = Hl(e), { size: y, crossAxis: b, crossSize: x, placement: S, crossPlacement: C } = v, w = Ul(t, s, n, v, u, d, l, f, m, h, c), T = u, E = Gl(s, l, t, i, a + u, v, c, g);
	if (o && n[y] > E) {
		let e = Hl(`${Ml[S]} ${C}`), r = Ul(t, s, n, e, u, d, l, f, m, h, c);
		Gl(s, l, t, i, a + u, e, c, g) > E && (v = e, w = r, T = u);
	}
	let D = "bottom";
	...
	let O = Bl(b, w[b], n[x], s, c, a, l);
	w[b] += O;
	let k = Wl(w, s, l, f, i, a, n.height, D, c, g, _);
	p && p < k && (k = p), n.height = Math.min(n.height, k), w = Ul(t, s, n, v, T, d, l, f, m, h, c), O = Bl(b, w[b], n[x], s, c, a, l), w[b] += O;
	let A = {}, ee = t[b] - w[b] - i[jl[b]], j = ee + .5 * t[x], te = m / 2 + h, M = jl[b] === "left" ? (i.left ?? 0) + (i.right ?? 0) : (i.top ?? 0) + (i.bottom ?? 0), ne = n[x] - M - m / 2 - h;
	A[b] = Bo(Bo(j, t[b] + m / 2 - (w[b] + i[jl[b]]), t[b] + t[x] - m / 2 - (w[b] + i[jl[b]])), te, ne), {placement: S, crossPlacement: C} = v, m ? ee = A[b] : C === "right" ? ee += t[x] : C === "center" && (ee += t[x] / 2);
...
function ql(e) {
	let { placement: t, targetNode: n, overlayNode: r, scrollNode: i, padding: a, shouldFlip: o, boundaryElement: s, offset: c, crossOffset: l, maxHeight: u, arrowSize: d = 0, arrowBoundaryOffset: f = 0, targetRect: p } = e, m = Ll(), h = r instanceof HTMLElement ? Zl(r) : document.documentElement, g = h === document.documentElement, _ = window.getComputedStyle(h).position, v = !!_ && _ !== "static", y = g ? Yl(n, !1, p) : Xl(n, h, !1, p);
	if (!g) {
	...
	let S = zl(i), C = Rl(s, m), w = Rl(h, m), T;
	...
	let E = L(s, h);
	return Kl(t, y, b, S, x, a, o, C, w, T, c, l, v, u, d, f, E, m);
}
function Jl(e, t) {
...
function Yl(e, t, n) {
	let { top: r, left: i, width: a, height: o } = n || Jl(e, t), { scrollTop: s, scrollLeft: c, clientTop: l, clientLeft: u } = document.documentElement;
	return {
		top: r + s - l,
		left: i + c - u,
		width: a,
...
function Xl(e, t, n, r) {
	...
	if (i.position === "fixed") a = r || Jl(e, n);
	else {
		a = Yl(e, n, r);
		let i = Yl(t, n), o = window.getComputedStyle(t);
...
function Zl(e) {
	...
	if (t && t === document.body && window.getComputedStyle(t).position === "static" && !Ql(t) && (t = document.documentElement), t == null) for (t = e.parentElement; t && !Ql(t);) t = t.parentElement;
...
var $l = typeof document < "u" ? window.visualViewport : null;
function eu(e) {
	let { direction: t } = Pi(), { arrowSize: n, targetRef: r, overlayRef: i, arrowRef: a, scrollRef: o = i, placement: s = "bottom", containerPadding: c = 12, shouldFlip: l = !0, boundaryElement: u = typeof document < "u" ? document.body : null, offset: d = 0, crossOffset: f = 0, shouldUpdatePosition: p = !0, isOpen: m = !0, onClose: h, maxHeight: g, arrowBoundaryOffset: _ = 0, getTargetRect: v } = e, [y, b] = (0, x.useState)(null), S = [
		p,
		s,
		i.current,
		r.current,
		...
		_,
		n
	], C = (0, x.useRef)($l?.scale);
	(0, x.useEffect)(() => {
		m && (C.current = $l?.scale);
	}, [m]);
	let w = (0, x.useCallback)(() => {
		if (p === !1 || !m || !i.current || !r.current || !u || $l?.scale !== C.current) return;
		let e = null;
		if (o.current && zt(o.current)) {
			let t = Lt()?.getBoundingClientRect(), n = o.current.getBoundingClientRect();
			e = {
				type: "top",
		...
		let y = ql({
			...
			crossOffset: f,
			maxHeight: g,
			arrowSize: n ?? (a?.current ? Jl(a.current, !0).width : 0),
	...
	B(() => {
		...
		$l?.addEventListener("resize", t), $l?.addEventListener("scroll", n);
		let r = Nt(Rt(window), "scroll", n);
		return () => {
			$l?.removeEventListener("resize", t), $l?.removeEventListener("scroll", n), r();
		};
	}, [w]);
...
function ru(e, t) {
	let { triggerRef: n, popoverRef: r, groupRef: i, isNonModal: a, isKeyboardDismissDisabled: o, shouldCloseOnInteractOutside: s, ...c } = e, l = c.trigger === "SubmenuTrigger", { overlayProps: u, underlayProps: d } = xl({
		isOpen: t.isOpen,
		onClose: t.close,
		shouldCloseOnBlur: !0,
		isDismissable: !a || l,
	...
	Tl({ isDisabled: a || !t.isOpen }), (0, x.useEffect)(() => {
		if (t.isOpen && r.current) return a ? Yo(i?.current ?? r.current) : Jo([i?.current ?? r.current], { shouldUseInert: !0 });
	}, [
		a,
		t.isOpen,
		r,
...
function au(e, t, n) {
	...
	}), { focusableProps: b } = zr(V(e, { onFocus: () => t.setLastFocusedValue(r) }), n), S = V(g, b), C = H(e, { labelable: !0 }), w = -1;
	t.selectedValue == null ? (t.lastFocusedValue === r || t.lastFocusedValue == null) && (w = 0) : t.selectedValue === r && (w = 0), p && (w = void 0);
	let { name: T, form: E, descriptionId: D, errorMessageId: O, validationBehavior: k } = iu.get(t);
	po(n, t.defaultSelectedValue, t.setSelectedValue), mo({ validationBehavior: k }, t, n);
	let A = yo();
	return {
...
function ou(e, t) {
	let { name: n, form: r, isReadOnly: i, isRequired: a, isDisabled: o, orientation: s = "vertical", validationBehavior: c = "aria" } = e, { direction: l } = Pi(), { isInvalid: u, validationErrors: d, validationDetails: f } = t.displayValidation, { labelProps: p, fieldProps: m, descriptionProps: h, errorMessageProps: g } = Fo({
		...e,
		labelElementType: "span",
		isInvalid: t.isInvalid,
		errorMessage: e.errorMessage || d
	}), _ = H(e, { labelable: !0 }), { focusWithinProps: v } = Io({
		onBlurWithin(n) {
	...
	function y(e, n) {
		let r = Ya(n.currentTarget, {
			from: R(n),
			accept: (e) => e instanceof Ot(e).HTMLInputElement && e.type === "radio"
		}), i;
...
function cu(e, t, n) {
	let { keyboardDelegate: r, isDisabled: i, isRequired: a, name: o, form: s, validationBehavior: c = "aria" } = e, l = cc({
		usage: "search",
		sensitivity: "base"
	}), u = (0, x.useMemo)(() => r || new as(t.collection, t.disabledKeys, n, l), [
		r,
		t.collection,
		t.disabledKeys,
		l,
		n
	]), { menuTriggerProps: d, menuProps: f } = Js({
		isDisabled: i,
		type: "listbox"
	}, t, n), { keyboardProps: p } = Pr({
		shortcuts: {
			ArrowLeft: () => {
		...
		onKeyUp: e.onKeyUp
	}), { typeSelectProps: m } = Xs({
		keyboardDelegate: u,
		selectionManager: t.selectionManager,
		onTypeSelect(e) {
			t.setSelectedKey(e);
		}
	}), { isInvalid: h, validationErrors: g, validationDetails: _ } = t.displayValidation, { labelProps: v, fieldProps: y, descriptionProps: b, errorMessageProps: S } = Fo({
		...e,
		labelElementType: "span",
		isInvalid: h,
	...
	let C = H(e, { labelable: !0 }), w = V(m, d, y), T = pr();
	return su.set(t, {
		isDisabled: i,
		isRequired: a,
		name: o,
		...
		labelProps: {
			...v,
			onClick: () => {
				e.isDisabled || (n.current?.focus(), Zn("keyboard"));
			}
		},
		triggerProps: V(C, {
			...w,
			isDisabled: i,
			onKeyDown: sr(w.onKeyDown, p.onKeyDown),
			onKeyUp: p.onKeyUp,
			"aria-labelledby": [
				T,
				w["aria-labelledby"],
...
function lu(e, t, n) {
	let r = su.get(t) || {}, { autoComplete: i, name: a = r.name, form: o = r.form, isDisabled: s = r.isDisabled } = e, { validationBehavior: c, isRequired: l } = r, { visuallyHiddenProps: u } = Ho({ style: {
		position: "fixed",
		top: 0,
		left: 0
	} });
	po(e.selectRef, t.defaultValue, t.setValue), mo({
		validationBehavior: c,
...
function uu(e) {
	let { state: t, triggerRef: n, label: r, name: i, form: a, isDisabled: o } = e, s = (0, x.useRef)(null), c = (0, x.useRef)(null), { containerProps: l, selectProps: u } = lu({
		...e,
	...
	if (i) {
		let { validationBehavior: e } = su.get(t) || {};
		d.length === 0 && (d = [null]);
		let n = d.map((t, n) => {
			let r = {
				type: "hidden",
...
function du(e, t, n) {
	let { labelProps: r, inputProps: i, isSelected: a, ...o } = jo(e, t, n);
	return {
		labelProps: r,
		inputProps: {
			...i,
...
function pu(e, t, n) {
	return e ? (typeof t == "string" && (t = t.replace(/\s+/g, "")), `${fu.get(e)}-${n}-${t}`) : "";
}
//#endregion
//#region node_modules/react-aria/dist/private/tabs/useTab.mjs
function mu(e, t, n) {
	let { key: r, isDisabled: i, shouldSelectOnPressUp: a } = e, { selectionManager: o, selectedKey: s } = t, c = r === s, l = i || t.isDisabled || t.selectionManager.isDisabled(r), u = t.collection.getItem(r), { itemProps: d, isPressed: f } = kc({
		selectionManager: o,
		key: r,
		ref: n,
		isDisabled: l,
		...
		linkBehavior: "selection"
	}), p = pu(t, r, "tab"), m = pu(t, r, "tabpanel"), { tabIndex: h } = d, g = H(u?.props, { labelable: !0 });
	delete g.id;
	let _ = bn(u?.props), { focusableProps: v } = zr({
		...u?.props,
		isDisabled: l
	}, n);
	return {
...
var hu = class {
	...
	getNextKey(e) {
		let t = e;
		do
			t = this.collection.getKeyAfter(t), t ??= this.collection.getFirstKey();
		while (t != null && this.isDisabled(t) && t !== e);
		return t;
	}
	getPreviousKey(e) {
		let t = e;
		do
			t = this.collection.getKeyBefore(t), t ??= this.collection.getLastKey();
		while (t != null && this.isDisabled(t) && t !== e);
		return t;
	}
};
...
function gu(e, t, n) {
	let { orientation: r = "horizontal", keyboardActivation: i = "automatic" } = e, { collection: a, selectionManager: o, disabledKeys: s } = t, { direction: c } = Pi(), { collectionProps: l } = $s({
		ref: n,
		selectionManager: o,
		keyboardDelegate: (0, x.useMemo)(() => new hu(a, c, r, s), [
			a,
			s,
			r,
			c
	...
	return fu.set(t, u), { tabListProps: {
		...V(l, Ci({
			...e,
			id: u
		})),
...
function _u(e, t, n) {
	let r = Dc(n) ? void 0 : 0, i = pu(t, e.id ?? t?.selectedKey, "tabpanel");
	return { tabPanelProps: V(Ci({
		...e,
		id: i,
		"aria-labelledby": pu(t, t?.selectedKey, "tab")
	}), {
		tabIndex: r,
		role: "tabpanel",
...
var vu = /* @__PURE__ */ m(((e) => {
	...
	function De(e) {
		var t = e.memoizedState;
		t !== null && (ch._currentValue = t.memoizedState, be(we, e)), t = xe.current;
		var n = fp(t, e.type);
		t !== n && (be(Se, e), be(xe, n));
	}
	function Oe(e) {
		Se.current === e && (ye(xe), ye(Se)), we.current === e && (ye(we), ch._currentValue = he);
	}
	var ke, Ae;
	function je(e) {
		if (ke === void 0) try {
	...
	var St = Math.random().toString(36).slice(2), Ct = "__reactFiber$" + St, wt = "__reactProps$" + St, Tt = "__reactContainer$" + St, Et = "__reactEvents$" + St, Dt = "__reactListeners$" + St, I = "__reactHandles$" + St, Ot = "__reactResources$" + St, kt = "__reactMarker$" + St, At = "__reactLoad$" + St;
	function jt(e) {
		delete e[Ct], delete e[wt], delete e[Dt], delete e[I];
	}
	function Mt(e) {
		var t;
		if (t = e[Ct]) return t;
	...
	var Lt = /* @__PURE__ */ new Set(), R = {};
	function Rt(e, t) {
		zt(e, t), zt(e + "Capture", t);
	}
	function zt(e, t) {
		for (R[e] = t, e = 0; e < t.length; e++) Lt.add(t[e]);
	}
	...
	function Zt(e) {
		...
		if (!t) return !0;
		var n = t.getValue(), r = "";
		return e && (r = B(e) ? e.checked ? "true" : "false" : e.value), e = r, e !== n && (t.setValue(e), !0);
	}
	var Qt = /[\n"\\]/g;
	function $t(e) {
	...
	function on(e, t, n, r) {
		...
		n = Jt(t), e.defaultValue = n, r = e.textContent, r === n && r !== "" && r !== null && (e.value = r), Xt(e);
	}
	function sn(e, t) {
		if (t) {
			var n = e.firstChild;
	...
	function Sn(e, t, n) {
		...
		try {
			...
			if (xn = !1, (vn !== null || yn !== null) && (Vd(), vn && (t = vn, e = yn, yn = vn = null, bn(t), e))) for (t = 0; t < e.length; t++) bn(e[t]);
		}
	}
	function Cn(e, t) {
		var n = e.stateNode;
	...
	function br(e, t, n, r) {
		vn ? yn ? yn.push(r) : yn = [r] : vn = r, t = Jf(t, "onChange"), 0 < t.length && (n = new In("onChange", "change", null, n, r), e.push({
			event: n,
			listeners: t
		}));
	}
	...
	function Zr(e, t, n) {
		...
		Xr || qr == null || qr !== zr(r) || (r = qr, "selectionStart" in r && Wr(r) ? r = {
		...
		}), Yr && Rr(Yr, r) || (Yr = r, r = Jf(Jr, "onSelect"), 0 < r.length && (t = new In("onSelect", "select", null, t, n), e.push({
			event: t,
			listeners: r
		}), t.target = qr)));
	}
	...
	function Ei(e) {
		if (50 < Md) throw Md = 0, J = null, Error(i(185));
	...
	function Ni(e, t, n, r, a, o) {
		...
		else if (typeof r == "string") s = Jm(e, n, xe.current) ? 26 : e === "html" || e === "head" || e === "body" ? 27 : 5;
		else a: switch (r) {
	...
	var ea = null, H = null, U = !1, ta = null, na = !1, ra = Error(i(519));
	function ia(e) {
	...
	function aa(e) {
		...
		n = r.children, typeof n != "string" && typeof n != "number" && typeof n != "bigint" || t.textContent === "" + n || !0 === r.suppressHydrationWarning || ep(t.textContent, n) ? (r.popover != null && (Q("beforetoggle", t), Q("toggle", t)), r.onScroll != null && Q("scroll", t), r.onScrollEnd != null && Q("scrollend", t), r.onClick != null && (t.onclick = hn), t = !0) : t = !1, t || ia(e, !0);
	}
	function oa(e) {
	...
	function sa(e) {
		...
		var t = e.tag, n;
		if ((n = t !== 3 && t !== 27) && ((n = t === 5) && (n = e.type, n = n === "form" || n === "button" || mp(e.type, e.memoizedProps)), n = !n), n && H && ia(e), oa(e), t === 13) {
			if (e = e.memoizedState, e = e === null ? null : e.dehydrated, !e) throw Error(i(317));
			H = fm(e);
		} else if (t === 31) {
			if (e = e.memoizedState, e = e === null ? null : e.dehydrated, !e) throw Error(i(317));
			H = fm(e);
		} else t === 27 ? (t = H, Cp(e.type) ? (e = dm, dm = null, H = e) : H = t) : H = ea ? um(e.stateNode.nextSibling) : null;
		return !0;
	}
	function ca() {
		H = ea = null, U = !1;
	...
	function la() {
		var e = ta;
		return e !== null && (hd === null ? hd = e : hd.push.apply(hd, e), ta = null), e;
	}
	function ua(e) {
	...
	var Ba = P.S;
	P.S = function(e, t) {
		if (vd = Ve(), typeof t == "object" && t && typeof t.then == "function" && La(e, t), ja !== null) for (var n = xf; n !== null;) Aa(n, ja), n = n.next;
		if (n = e.types, n !== null) {
			for (var r = xf; r !== null;) Aa(r, n), r = r.next;
			if (Fa !== 0) {
				r = ja, r === null && (r = ja = []);
	...
	function Ua(e, t) {
		t === null ? be(Va, Va.current) : be(Va, t.pool);
	}
	function Wa() {
		var e = Ha();
		return e === null ? null : {
	...
	function oo(e) {
		...
		function l(e, t, n, r) {
			var i = n.type;
			return i === k ? (e = d(e, t, n.props.children, r, n.key), io(e, n), e) : t !== null && (t.elementType === i || typeof i == "object" && i && i.$$typeof === ie && Za(i) === t.type) ? (t = a(t, n.props), io(t, n), t.return = e, t) : (t = Ni(n.type, n.key, n.props, null, e.mode, r), io(t, n), t.return = e, t);
		}
		function u(e, t, n, r) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				switch (t.$$typeof) {
					case D: return n = Ni(t.type, t.key, t.props, null, e.mode, n), io(n, t), n.return = e, n;
				...
				switch (o.$$typeof) {
					case D:
						a: {
							...
							o.type === k ? (c = Pi(o.props.children, e.mode, c, o.key), io(c, o), c.return = e, e = c) : (c = Ni(o.type, o.key, o.props, null, e.mode, c), io(c, o), c.return = e, e = c);
						}
						return s(e);
					case O:
						a: {
	...
	var So = ve(null), Co = ve(0);
	function wo(e, t) {
		e = sd, be(Co, e), be(So, t), sd = e | t.baseLanes;
	}
	function To() {
		be(Co, sd), be(So, So.current);
	}
	function Eo() {
		sd = Co.current, ye(So), ye(Co);
	}
	var Do = ve(null), Oo = null;
	function ko(e) {
		var t = e.alternate;
		be(Po, Po.current & 1), be(Do, e), Oo === null && (t === null || So.current !== null || t.memoizedState !== null) && (Oo = e);
	}
	function Ao(e) {
		be(Po, Po.current), be(Do, e), Oo === null && (Oo = e);
	}
	function jo(e) {
		e.tag === 22 ? (be(Po, Po.current), be(Do, e), Oo === null && (Oo = e)) : Mo();
	}
	function Mo() {
		be(Po, Po.current), be(Do, Do.current);
	}
	function No(e) {
		ye(Do), Oo === e && (Oo = null), ye(Po);
	}
	var Po = ve(0);
	function Fo(e, t) {
		be(Do, Do.current), be(Po, t);
	}
	function Io(e) {
		ye(Po), ye(Do), Oo === e && (Oo = null);
	}
	function Lo(e) {
		for (var t = e; t !== null;) {
			if (t.tag === 13) {
	...
	function Yo(e, t, n, r, i, a) {
		return Ro = a, W = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, P.H = e === null || e.memoizedState === null ? fc : pc, Uo = !1, a = n(r, i), Uo = !1, Ho && (a = Zo(t, n, r, i)), Xo(e), a;
	}
	function Xo(e) {
		P.H = dc;
	...
	function Qo() {
		...
		return t = typeof t.then == "function" ? as(t) : t, e = e.useState()[0], (zo === null ? null : zo.memoizedState) !== e && (W.flags |= 1024), t;
	}
	function $o() {
		var e = Wo !== 0;
		return Wo = 0, e;
	...
	function as(e) {
		var t = Go;
		return Go += 1, Ko === null && (Ko = []), e = Xa(Ko, e, t), t = W, (Bo === null ? t.memoizedState : Bo.next) === null && (t = t.alternate, P.H = t === null || t.memoizedState === null ? fc : pc), e;
	}
	function os(e) {
		if (typeof e == "object" && e) {
	...
	function ss(e) {
		...
		if (t ??= {
			data: [],
			index: 0
		}, n === null && (n = is(), W.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), r = 0; r < e; r++) n[r] = se;
		return t.index++, n;
	}
	function cs(e, t) {
			...
			do {
				...
				if (f === u.lane ? (Ro & f) === f : (q & f) === f) {
					...
					if (p === 0) l !== null && (l = l.next = {
						...
						eagerState: u.eagerState,
						next: null
					}, l === null ? (c = l = f, s = o) : l = l.next = f, W.lanes |= p, ld |= p;
					...
					eagerState: u.eagerState,
					next: null
				}, l === null ? (c = l = p, s = o) : l = l.next = p, W.lanes |= f, ld |= f;
				u = u.next;
			} while (u !== null && u !== t);
	...
	function fs(e, t, n) {
		...
		var s = !Lr((zo || a).memoizedState, n);
		if (s && (a.memoizedState = n, Ac = !0), a = a.queue, Ls(hs.bind(null, r, a, e), [e]), e = a.getSnapshot !== t || s || Bo !== null && !!(Bo.memoizedState.tag & 1), Ms(e ? 9 : 8, { destroy: void 0 }, ms.bind(null, r, a, n, t), null), e) {
	...
	function ys(e, t, n, r) {
		return e.baseState = n, us(e, zo, typeof r == "function" ? r : cs);
	}
	...
	function Fs(e, t, n, r) {
		...
		zo !== null && r !== null && Jo(r, zo.memoizedState.deps) ? i.memoizedState = Ms(t, a, n, r) : (W.flags |= e, i.memoizedState = Ms(1 | t, a, n, r));
	}
	function Is(e, t) {
		Ps(8390656, 8, e, t);
	}
	...
	function qs(e, t, n) {
		return n === void 0 || Ro & 1073741824 && !(q & 261930) ? e.memoizedState = t : (e.memoizedState = n, e = Pd(), W.lanes |= e, ld |= e, n);
	}
	function Js(e, t, n, r) {
		return Lr(n, t) ? n : So.current === null ? !(Ro & 106) || Ro & 1073741824 && !(q & 261930) ? (Ac = !0, e.memoizedState = n) : (e = Pd(), W.lanes |= e, ld |= e, t) : (e = qs(e, n, r), Lr(e, t) || (Ac = !0), e);
	}
	function Ys(e, t, n, r, i) {
		...
		try {
			var c = i(), l = P.S;
			l !== null && l(s, c), typeof c == "object" && c && typeof c.then == "function" ? oc(e, t, za(c, r), Nd(e)) : oc(e, t, r, Nd(e));
		} catch (n) {
			oc(e, t, {
				then: function() {},
				status: "rejected",
	...
	function $s(e) {
		var t = Qs(e);
		t.next === null && (t = e.alternate.memoizedState), oc(e, t.next.queue, {}, Nd());
	}
	function ec() {
		return xa(ch);
	}
		...
		for (var t = e.return; t !== null;) {
			switch (t.tag) {
				...
				case 3:
					...
					e = po(n);
					var r = mo(t, e, n);
					r !== null && (Id(r, t, n), ho(r, t, n)), t = { cache: Oa() }, e.payload = t;
					return;
			}
			t = t.return;
		}
	...
	function ic(e, t, n) {
		...
		n = {
			...
			eagerState: null,
			next: null
		}, cc(e) ? lc(t, n) : (n = Ci(e, t, n, r), n !== null && (Id(n, e, r), uc(n, t, r)));
	}
	function ac(e, t, n) {
		oc(e, t, n, Nd());
	}
	function oc(e, t, n, r) {
		...
		if (cc(e)) lc(t, i);
			...
			if (n = Ci(e, t, i, r), n !== null) return Id(n, e, r), uc(n, t, r), !0;
		}
		return !1;
	}
	function sc(e, t, n, r) {
		...
		} else t = Ci(e, n, r, 2), t !== null && Id(t, e, 2);
	}
	function cc(e) {
		var t = e.alternate;
	...
	var dc = {
		...
		useDebugValue: Ws,
		useDeferredValue: function(e, t) {
			return Js(rs(), zo.memoizedState, e, t);
		},
		useTransition: function() {
		...
		useDeferredValue: function(e, t) {
			var n = rs();
			return zo === null ? qs(n, e, t) : Js(n, zo.memoizedState, e, t);
		},
		useTransition: function() {
		...
		useOptimistic: function(e, t) {
			var n = rs();
			return zo === null ? (n.baseState = e, [e, n.queue.dispatch]) : ys(n, zo, e, t);
		},
		useMemoCache: ss,
		useCacheRefresh: nc,
		useEffectEvent: zs
	...
	var gc = {
		enqueueSetState: function(e, t, n) {
			e = e._reactInternals;
			var r = Nd(), i = po(r);
			i.payload = t, n != null && (i.callback = n), t = mo(e, i, r), t !== null && (Id(t, e, r), ho(t, e, r));
		},
		enqueueReplaceState: function(e, t, n) {
			e = e._reactInternals;
			var r = Nd(), i = po(r);
			i.tag = 1, i.payload = t, n != null && (i.callback = n), t = mo(e, i, r), t !== null && (Id(t, e, r), ho(t, e, r));
		},
		enqueueForceUpdate: function(e, t) {
			e = e._reactInternals;
			var n = Nd(), r = po(n);
			r.tag = 2, t != null && (r.callback = t), t = mo(e, r, n), t !== null && (Id(t, e, n), ho(t, e, n));
		}
	};
	...
	function Dc(e, t, n, r) {
		...
		o !== null && typeof o.componentDidCatch == "function" && (e.callback = function() {
			wc(t, n, r), typeof i != "function" && (xd === null ? xd = /* @__PURE__ */ new Set([this]) : xd.add(this));
			var e = r.stack;
	...
	function Oc(e, t, n, r, a) {
		if (n.flags |= 32768, typeof r == "object" && r && typeof r.then == "function") {
			if (t = n.alternate, t !== null && va(t, n, a, !0), n = Do.current, n !== null) {
				switch (n.tag) {
					case 31:
					case 13:
					case 19: return Oo === null ? qd() : n.alternate === null && cd === 0 && (cd = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === Ja ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = /* @__PURE__ */ new Set([r]) : t.add(r), hf(e, r, a)), !1;
		...
		if (U) return t = Do.current, t === null ? (r !== ra && (t = Error(i(423), { cause: r }), ua(zi(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = zi(r, n), a = Tc(e.stateNode, r, a), go(e, a), cd !== 4 && (cd = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== ra && (e = Error(i(422), { cause: r }), ua(zi(e, n)))), !1;
		var o = Error(i(520), { cause: r });
		if (o = zi(o, n), md === null ? md = [o] : md.push(o), cd !== 4 && (cd = 2), t === null) return !0;
		r = zi(r, n), n = t;
		do {
			switch (n.tag) {
				case 3: return n.flags |= 65536, e = a & -a, n.lanes |= e, e = Tc(n.stateNode, r, e), go(n, e), !1;
				case 1:
					if (t = n.type, o = n.stateNode, !(n.flags & 128) && (typeof t.getDerivedStateFromError == "function" || o !== null && typeof o.componentDidCatch == "function" && (xd === null || !xd.has(o)))) return n.flags |= 65536, a &= -a, n.lanes |= a, a = Ec(a), Dc(a, e, n, r), go(n, a), !1;
					break;
	...
	function Bc(e, t, n) {
		...
		if (t.flags &= -129, e === null) {
			if (U) {
				...
				if (Ao(t), (e = H) ? (e = om(e, na), e = e !== null && e.data === "&" ? e : null, e !== null && (t.memoizedState = {
					dehydrated: e,
				...
				}, n = Ii(e), n.return = t, t.child = n, ea = t, H = null)) : e = null, e === null) throw ia(t);
		...
		if (o !== null) {
			...
			if (Ao(t), a) {
				...
				if (So.current === null) {
					if (r = td, r !== null && (s = _t(r, n), s !== 0 && s !== o.retryLane)) throw o.retryLane = s, wi(e, s), Id(r, e, s), kc;
					qd();
				}
				t = zc(e, t, n);
			} else e = o.treeContext, H = um(s.nextSibling), ea = t, U = !0, ta = null, na = !1, e !== null && $i(t, e), t = Rc(t, r), t.flags |= 134221824;
			return t;
		}
		return e = ji(e.child, {
			mode: r.mode,
	...
	function Wc(e, t, n, r, i) {
		if (ba(t), t.stateNode === null) {
			...
			typeof o == "object" && o && (a = xa(o)), a = new n(r, a), t.memoizedState = a.state !== null && a.state !== void 0 ? a.state : null, a.updater = gc, t.stateNode = a, a._reactInternals = t, a = t.stateNode, a.props = r, a.state = t.memoizedState, a.refs = {}, uo(t), o = n.contextType, a.context = typeof o == "object" && o ? xa(o) : Di, a.state = t.memoizedState, o = n.getDerivedStateFromProps, typeof o == "function" && (hc(t, n, o, r), a.state = t.memoizedState), typeof n.getDerivedStateFromProps == "function" || typeof a.getSnapshotBeforeUpdate == "function" || typeof a.UNSAFE_componentWillMount != "function" && typeof a.componentWillMount != "function" || (o = a.state, typeof a.componentWillMount == "function" && a.componentWillMount(), typeof a.UNSAFE_componentWillMount == "function" && a.UNSAFE_componentWillMount(), o !== a.state && gc.enqueueReplaceState(a, a.state, null), yo(t, r, a, i), vo(), a.state = t.memoizedState), typeof a.componentDidMount == "function" && (t.flags |= 4194308), r = !0;
		} else if (e === null) {
			a = t.stateNode;
	...
	function Yc(e, t, n) {
		...
		if ((o = a) || (o = e !== null && e.memoizedState === null ? !1 : !!(Po.current & 2)), o && (i = !0, t.flags &= -129), o = !!(t.flags & 32), t.flags &= -33, e === null) {
			if (U) {
				if (i ? ko(t) : Mo(), (e = H) ? (e = om(e, na), e = e !== null && e.data !== "&" ? e : null, e !== null && (t.memoizedState = {
					dehydrated: e,
					treeContext: Ki === null ? null : {
						id: qi,
						overflow: Ji
			...
			return a = r.children, r = r.fallback, i ? (Mo(), i = t.mode, a = Zc({
				mode: "hidden",
				children: a
			}, i), r = Pi(r, i, n, null), a.return = t, r.return = t, a.sibling = r, t.child = a, r = t.child, r.memoizedState = qc(n), r.childLanes = Jc(e, o, n), t.memoizedState = Kc, Ic(null, r)) : (ko(t), Xc(t, a));
		}
		...
		return i ? (Mo(), i = r.fallback, a = t.mode, s = e.child, c = s.sibling, r = ji(s, {
			mode: "hidden",
			children: r.children
		}), r.subtreeFlags = s.subtreeFlags & 1206910976, c === null ? (i = Pi(i, a, n, null), i.flags |= 2) : i = ji(c, i), i.return = t, r.return = t, r.sibling = i, t.child = r, Ic(null, r), r = t.child, i = e.child.memoizedState, i === null ? i = qc(n) : (a = i.cachePool, a === null ? a = Wa() : (s = Da._currentValue, a = a.parent === s ? a : {
			parent: s,
			pool: s
		}), i = {
			baseLanes: i.baseLanes | n,
			cachePool: a
		}), r.memoizedState = i, r.childLanes = Jc(e, o, n), t.memoizedState = Kc, Ic(e.child, r)) : (ko(t), n = e.child, e = n.sibling, n = ji(n, {
			mode: "visible",
			children: r.children
	...
	function $c(e, t, n, r, a, o, s, c) {
		if (n) return t.flags & 256 ? (ko(t), t.flags &= -257, Qc(e, t, c)) : t.memoizedState === null ? (Mo(), o = a.fallback, s = t.mode, a = Zc({
			mode: "visible",
			children: a.children
		}, s), o = Pi(o, s, c, null), o.flags |= 2, a.return = t, o.return = t, a.sibling = o, t.child = a, so(t, e.child, null, c), a = t.child, a.memoizedState = qc(c), a.childLanes = Jc(e, r, c), t.memoizedState = Kc, Ic(null, a)) : (Mo(), t.child = e.child, t.flags |= 128, null);
		if (ko(t), cm(o)) {
		...
		if (Ac || va(e, t, c, !1), r = (c & e.childLanes) !== 0, Ac || r) {
			...
			if (r = td, r !== null && (a = _t(r, c), a !== 0 && a !== s.retryLane)) throw s.retryLane = a, wi(e, a), Id(r, e, a), kc;
			return sm(o) || qd(), Qc(e, t, c);
		}
		return sm(o) ? (t.flags |= 192, t.child = e.child, null) : (e = s.treeContext, H = um(o.nextSibling), ea = t, U = !0, ta = null, na = !1, e !== null && $i(t, e), t = Xc(t, a.children), t.flags |= 134221824, t);
	}
	function el(e, t, n) {
		e.lanes |= t;
		var r = e.alternate;
	...
	function il(e, t, n) {
		...
		var s = !!(o & 2);
		if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, Fo(t, o), i === "backwards" && e !== null ? (rl(e), jc(e, t, r, n), rl(e)) : jc(e, t, r, n), r = U ? Ui : 0, !s && e !== null && e.flags & 128) a: for (e = t.child; e !== null;) {
	...
	function cl(e, t, n) {
		switch (t.tag) {
			case 3:
				Te(t, t.stateNode.containerInfo), ma(t, Da, e.memoizedState.cache), ca();
				break;
			case 27:
			case 5:
				De(t);
	...
	function ll(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			case 16:
				a: {
					var r = t.pendingProps;
					if (e = Za(t.elementType), t.type = e, typeof e == "function") Ai(e) ? (r = yc(e, r), t.tag = 1, t = Wc(null, t, e, r, n)) : (t.tag = 0, t = Hc(null, t, e, r, n));
					else {
						if (e != null) {
							var a = e.$$typeof;
							if (a === M) {
			...
			case 3:
				a: {
					...
					if (r = s.cache, ma(t, Da, r), r !== o.cache && _a(t, [Da], n, !0), vo(), r = s.element, o.isDehydrated) {
						...
						for (H = um(e.firstChild), ea = t, U = !0, ta = null, na = !0, n = co(t, null, r, n), t.child = n; n;) n.flags = n.flags & -3 | 134221824, n = n.sibling;
					} else {
						if (ca(), r === a) {
							t = ol(e, t, n);
							break a;
				...
				return t;
			case 26: return Vc(e, t), e === null ? (n = Pm(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : U || (t.stateNode = pp(t.type, t.pendingProps, Ce.current, t)) : t.memoizedState = Pm(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
			case 27: return De(t), e === null && U && (r = t.stateNode = gm(t.type, t.pendingProps, Ce.current), ea = t, na = !0, a = H, Cp(t.type) ? (dm = a, H = um(r.firstChild)) : H = a), jc(e, t, t.pendingProps.children, n), Vc(e, t), e === null && (t.flags |= 4194304), t.child;
			case 5: return e === null && U && ((a = r = H) && (r = im(r, t.type, t.pendingProps, na), r === null ? a = !1 : (t.stateNode = r, ea = t, H = um(r.firstChild), na = !1, a = !0)), a || ia(t)), De(t), a = t.type, o = t.pendingProps, s = e === null ? null : e.memoizedProps, r = o.children, mp(a, o) ? r = null : s !== null && mp(a, s) && (t.flags |= 32), t.memoizedState !== null && (a = Yo(e, t, Qo, null, null, n), ch._currentValue = a), Vc(e, t), jc(e, t, r, n), t.child;
			case 6: return e === null && U && ((e = n = H) && (n = am(n, t.pendingProps, na), n === null ? e = !1 : (t.stateNode = n, ea = t, H = null, e = !0)), e || ia(t)), null;
			case 13: return Yc(e, t, n);
			case 4: return Te(t, t.stateNode.containerInfo), r = t.pendingProps, e === null ? t.child = so(t, null, r, n) : jc(e, t, r, n), t.child;
			...
			case 24: return ba(t), r = xa(Da), e === null ? (a = Ha(), a === null && (a = td, o = Oa(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
				parent: r,
				cache: a
	...
	function pl(e, t) {
		t !== null && (e.flags |= 4), e.flags & 16384 && (t = e.tag === 22 ? 536870912 : dt(), e.lanes |= t, pd |= t);
	}
	function ml(e, t) {
	...
	function gl(e, t, n) {
		...
		switch (Qi(t), t.tag) {
			...
			case 3: return n = t.stateNode, r = null, e !== null && (r = e.memoizedState.cache), t.memoizedState.cache !== r && (t.flags |= 2048), ha(Da), Ee(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (sa(t) ? ul(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, la())), hl(t), null;
			case 26:
			...
			case 27:
				if (Oe(t), n = Ce.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && ul(t);
					...
					e = xe.current, sa(t) ? aa(t, e) : (e = gm(a, r, n), t.stateNode = e, ul(t));
				}
				return hl(t), t.subtreeFlags &= -33554433, null;
			case 5:
			...
			case 6:
				if (e && t.stateNode != null) e.memoizedProps !== r && ul(t);
					...
					if (e = Ce.current, sa(t)) {
						...
						e[Ct] = t, e = !!(e.nodeValue === n || r !== null && !0 === r.suppressHydrationWarning || ep(e.nodeValue, n)), e || ia(t, !0);
					} else e = up(e).createTextNode(r), e[Ct] = t, t.stateNode = e;
				}
				return hl(t), null;
			case 31:
			...
			case 4: return Ee(), e === null && Wf(t.stateNode.containerInfo), t.flags |= 67108864, hl(t), null;
			case 10: return ha(t.type), hl(t), null;
			case 19:
				if (Io(t), r = t.memoizedState, r === null) return hl(t), null;
					...
					if (a) ml(r, !1);
						...
						if (cd !== 0 || e !== null && e.flags & 128) for (e = t.child; e !== null;) {
							if (o = Lo(e), o !== null) {
								...
								return Fo(t, Po.current & 1 | 2), U && Yi(t, r.treeForkCount), t.child;
							}
							e = e.sibling;
						}
						r.tail !== null && Ve() > yd && (t.flags |= 128, a = !0, ml(r, !1), t.lanes = 4194304);
					}
				} else {
					if (!a) {
						if (e = Lo(o), e !== null) {
						...
						} else 2 * Ve() - r.renderingStartTime > yd && n !== 536870912 && (t.flags |= 128, a = !0, ml(r, !1), t.lanes = 4194304);
					}
				...
				if (r.tail !== null) {
					...
					return r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Ve(), e.sibling = null, o = Po.current, o = a ? o & 1 | 2 : o & 1, r.tailMode === "visible" || r.tailMode === "collapsed" || !n || U ? Fo(t, o) : (n = o, be(Do, t), be(Po, n), Oo === null && (Oo = t)), U && Yi(t, r.treeForkCount), e;
				}
				return hl(t), null;
			case 22:
			case 23: return No(t), Eo(), r = t.memoizedState !== null, e === null ? r && (t.flags |= 8192) : e.memoizedState !== null !== r && (t.flags |= 8192), r ? n & 536870912 && !(t.flags & 128) && (hl(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : hl(t), n = t.updateQueue, n !== null && pl(t, n.retryQueue), n = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (n = e.memoizedState.cachePool.pool), r = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (r = t.memoizedState.cachePool.pool), r !== n && (t.flags |= 2048), e !== null && ye(Va), null;
			case 24: return n = null, e !== null && (n = e.memoizedState.cache), t.memoizedState.cache !== n && (t.flags |= 2048), ha(Da), hl(t), null;
			case 25: return null;
	...
	function _l(e, t) {
		switch (Qi(t), t.tag) {
			...
			case 3: return ha(Da), Ee(), e = t.flags, e & 65536 && !(e & 128) ? (t.flags = e & -65537 | 128, t) : null;
			case 26:
			case 27:
			...
			case 22:
			case 23: return No(t), Eo(), e !== null && ye(Va), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
			...
			if (n !== null) {
				switch (e.tag) {
					...
					case 7:
						if (e.stateNode === null) {
							var o = new Ip(e);
							f(e.child, !1, $p, o, void 0, void 0), e.stateNode = o;
						}
						r = e.stateNode;
						break;
	...
	function Dl(e) {
		for (var t = e.return; t !== null && (kl(t) && nm(e.stateNode, t.stateNode), !Ol(t));) t = t.return;
	}
	function Ol(e) {
	...
	function Pl(e, t, n, r) {
		...
		else if (i !== 4 && (i === 27 && (Tl(e, r), r = null, Cp(e.type) && (n = e.stateNode, t = null)), e = e.child, e !== null)) for (Pl(e, t, n, r), e = e.sibling; e !== null;) Pl(e, t, n, r), e = e.sibling;
	}
	function Fl(e, t, n, r) {
		var i = e.tag;
		if (i === 5 || i === 6) i = e.stateNode, t ? n.insertBefore(i, t) : n.appendChild(i), Tl(e, r), z = !0;
		else if (i !== 4 && (i === 27 && (Tl(e, r), r = null, Cp(e.type) && (n = e.stateNode)), e = e.child, e !== null)) for (Fl(e, t, n, r), e = e.sibling; e !== null;) Fl(e, t, n, r), e = e.sibling;
	}
	function Il(e) {
		var t = e.stateNode, n = e.memoizedProps;
		try {
			for (var r = e.type, i = t.attributes; i.length;) t.removeAttributeNode(i[0]);
			rp(t, r, n), t[Ct] = e, t[wt] = n;
		} catch (t) {
			mf(e, e.return, t);
		}
	}
	...
	function Gl(e, t) {
		for (; e !== null;) e.tag === 5 ? Dp(e.stateNode, e.memoizedProps) : (e.tag !== 22 || e.memoizedState === null) && (e.tag === 30 && t || Gl(e.child, t)), e = e.sibling;
	}
	function Kl(e) {
	...
	function ql(e, t) {
		if (e.tag === 30) {
			...
			a === "none" ? Kl(e) : Ul(e, i, a, null, !1) ? (Kl(e), n.paired || t || Fd(e, r.onEnter)) : Gl(e.child, !1);
					...
					if (e.tag === 30 && e.flags & 18874368) {
						...
						if (r != null && r !== "auto") {
							...
							if (i !== void 0) {
								...
								if (a !== "none" && (Ul(e, r, a, null, !1) ? (a = e.stateNode, i.paired = a, a.paired = i, Fd(e, n.onShare)) : Gl(e.child, !1)), t.delete(r), t.size === 0) break;
							}
						}
					}
					Jl(e);
	...
	function Yl(e) {
		if (e.tag === 30) {
			...
			i !== "none" && (Ul(e, n, i, null, !1) ? r === void 0 ? Fd(e, t.onExit) : (i = e.stateNode, r.paired = i, i.paired = r, Rl.delete(n), Fd(e, t.onShare)) : Gl(e.child, !1)), Rl !== null && Jl(e);
	...
	function eu(e, t, n, r, i, a, o) {
		for (var s = !1; t !== null;) {
			if (t.tag === 5) {
				...
				e.flags & 4 && Ep(c, Hl === 0 ? n : n + "_" + Hl, i), s && e.flags & 4 || (Bl === null && (Bl = []), Bl.push(c, Hl === 0 ? r : r + "_" + Hl, t.memoizedProps)), Hl++;
	...
	function tu(e, t) {
		for (e = e.child; e !== null;) {
			if (e.tag === 30) {
				...
				r = e;
				var s = e.child;
				Hl = 0, i = eu(r, s, i, i, a, o, !1), e.flags & 4 && i && (t || Fd(e, n.onUpdate));
	...
	function fu(e, t, n) {
		if (e = e.containerInfo, cp = _h, e = Ur(e), Wr(e)) {
		...
		for (lp = {
			focusedElem: e,
			selectionRange: r
		}, _h = !1, n = (n & 335544064) === n, su = t, t = n ? 9270 : 1024; su !== null;) {
	...
	function vu(e) {
		var t = e.alternate;
		t !== null && (e.alternate = null, vu(t)), e.child = null, e.deletions = null, e.sibling = null, e.tag === 5 && (t = e.stateNode, t !== null && jt(t)), e.stateNode = null, e.return = null, e.dependencies = null, e.memoizedProps = null, e.memoizedState = null, e.pendingProps = null, e.stateNode = null, e.updateQueue = null;
	}
	var bu = null, xu = !1;
	function Su(e, t, n) {
	...
	function Cu(e, t, n) {
		...
		switch (n.tag) {
			...
			case 27:
				ru || wl(n, t), Dl(n);
				var r = bu, i = xu;
				Cp(n.type) && (bu = n.stateNode, xu = !1), Su(e, t, n), _m(n.stateNode, n.type, n.memoizedProps), bu = r, xu = i;
				break;
			...
			case 6:
				...
				break;
			case 18:
				bu !== null && (xu ? (e = bu, wp(e.nodeType === 9 ? e.body : e.nodeName === "HTML" ? e.ownerDocument.body : e, n.stateNode), Uh(e)) : wp(bu, n.stateNode));
				break;
			case 4:
	...
	function Au(e, t, n) {
		...
		switch (e.tag) {
			...
			case 26:
				if (o = ku, Ou(t, e, n), ju(e), a & 512 && (ru || r === null || wl(r, r.return)), a & 4) {
					if (a = r === null ? null : r.memoizedState, n = e.memoizedState, r === null) {
						if (n === null) {
							if (e.stateNode === null) {
								if (nu) e.stateNode = pp(e.type, e.memoizedProps, t.containerInfo, e);
								else {
									a: {
										t = e.type, n = e.memoizedProps, a = o.ownerDocument || o;
										b: switch (t) {
											case "title":
												r = a.getElementsByTagName("title")[0], (!r || r[kt] || r[Ct] || r.namespaceURI === "http://www.w3.org/2000/svg" || r.hasAttribute("itemprop")) && (r = a.createElement(t), a.head.insertBefore(r, a.querySelector("head > title"))), rp(r, t, n), r[Ct] = e, It(r), t = r;
												break a;
											case "link":
							...
							} else nu || qm(o, e.type, e.stateNode);
						} else e.stateNode = Vm(o, n, e.memoizedProps);
					} else a === n ? n === null && e.stateNode !== null && jl(e, e.memoizedProps, r.memoizedProps) : (a === null ? (t = r.stateNode, t === null || ru || t.parentNode.removeChild(t)) : a.count--, n === null ? nu || qm(o, e.type, e.stateNode) : Vm(o, n, e.memoizedProps));
				}
				break;
			case 27:
			...
			case 6:
				...
				break;
			case 3:
				if (z = !1, Gm = null, o = ku, ku = xm(t.containerInfo), Ou(t, e, n), ku = o, ju(e), a & 4 && r !== null && r.memoizedState.isDehydrated) try {
					Uh(t.containerInfo);
				} catch (t) {
					mf(e, e.return, t);
				}
				...
				break;
			case 4:
				a = iu, iu = nu, r = Wt(), o = ku, ku = xm(e.stateNode.containerInfo), Ou(t, e, n), ju(e), ku = o, z && lu && (uu = !0), z = r, iu = a;
				break;
			case 12:
				Ou(t, e, n), ju(e);
				break;
			case 31:
				...
				break;
			case 13:
				Ou(t, e, n), ju(e), e.child.flags & 8192 && e.memoizedState !== null != (r !== null && r.memoizedState !== null) && (_d = Ve()), a & 4 && (t = e.updateQueue, t !== null && (e.updateQueue = null, Du(e, t)));
				break;
			case 22:
				o = e.memoizedState !== null, s = r !== null && r.memoizedState !== null;
				var c = nu, l = ru, u = iu;
				nu = c || o, iu = u || o, ru = l || s, Ou(t, e, n), ru = l, iu = u, nu = c, ju(e), a & 8192 && (t = e.stateNode, t._visibility = o ? t._visibility & -2 : t._visibility | 1, !o || r === null || s || nu || ru || (t = s || ru, n = nu, r = ru, nu = o || nu, ru = t, Iu(e, 2), nu = n, ru = r), !o && iu || hu(e, o)), a & 4 && (t = e.updateQueue, t !== null && (n = t.retryQueue, n !== null && (t.retryQueue = null, Du(e, n))));
				break;
			case 19:
				Ou(t, e, n), ju(e), a & 4 && (t = e.updateQueue, t !== null && (e.updateQueue = null, Du(e, t)));
				break;
	...
	function Pu(e, t) {
		...
		if (n === null) ql(e, !1);
			...
			case 30:
				...
				s === "none" ? t = !1 : (a = n.memoizedState, n.memoizedState = null, n = e.child, Hl = 0, t = eu(e, n, t, o, s, a, !0), Hl !== (a === null ? 0 : a.length) && (e.flags |= 32)), e.flags & 4 && t ? (Fd(e, e.memoizedProps.onUpdate), Bl = i) : i !== null && (i.push.apply(i, Bl), Bl = i), cu = e.flags & 32 ? !0 : r;
				break;
			default: Nu(t, e);
		}
	}
		...
		for (n = t.subtreeFlags & 8772 ? n : n & -2, t = t.child; t !== null;) {
			...
			switch (a.tag) {
				...
				case 6:
					...
					break;
				case 26:
					c = a.stateNode, a.memoizedState !== null || c === null || nu || qm(xm(c.ownerDocument), a.type, c), Lu(i, a, n), s && r === null && o & 4 && Al(a), Cl(a, a.return);
					break;
				case 12:
					Lu(i, a, n);
					break;
	...
	function Vu(e, t, n, r) {
		...
		switch (t.tag) {
			...
			case 1:
				...
				break;
			case 3:
				Bu(e, t, n, r), i && du && (e = e.containerInfo, e = e.nodeType === 9 ? e.body : e.nodeName === "HTML" ? e.ownerDocument.body : e, e.style.viewTransitionName === "root" && (e.style.viewTransitionName = ""), e = e.ownerDocument.documentElement, e !== null && e.style.viewTransitionName === "none" && (e.style.viewTransitionName = "")), a & 2048 && (a = null, t.alternate !== null && (a = t.alternate.memoizedState.cache), t = t.memoizedState.cache, t !== a && (t.refCount++, a != null && ka(a)));
				break;
			case 12:
				if (a & 2048) {
	...
	}, $u = typeof WeakMap == "function" ? WeakMap : Map, ed = 0, td = null, K = null, q = 0, nd = 0, rd = null, id = !1, ad = !1, od = !1, sd = 0, cd = 0, ld = 0, ud = 0, dd = 0, fd = 0, pd = 0, md = null, hd = null, gd = !1, _d = 0, vd = 0, yd = Infinity, bd = null, xd = null, Sd = 0, Cd = null, wd = null, Td = 0, Ed = 0, Dd = null, Od = null, kd = null, Ad = null, jd = null, Md = 0, J = null;
	function Nd() {
		return ed & 2 && q !== 0 ? q & -q : P.T === null ? bt() : Pf();
	}
	function Pd() {
		if (fd === 0) {
			if (!(q & 536870912) || U) {
		...
		return e = Do.current, e !== null && (e.flags |= 32), fd;
	}
	function Fd(e, t) {
		if (t != null) {
			var n = e.stateNode, r = n.ref;
			r === null && (r = n.ref = Fp(mi(e.memoizedProps, n))), Ad === null && (Ad = []), Ad.push(t.bind(null, r));
		}
	}
	function Id(e, t, n) {
		(e === td && (nd === 2 || nd === 9) || e.cancelPendingCommit !== null) && (Ud(e, 0), Bd(e, q, fd, !1)), pt(e, n), (!(ed & 2) || e !== td) && (e === td && (!(ed & 2) && (ud |= n), cd === 4 && Bd(e, q, fd, !1)), Ef(e));
	}
	function Ld(e, t, n) {
		...
		do {
			...
			if (a === 2) {
				...
				if (s !== 0) {
					...
					a: {
						...
						if (l && (Ud(c, s).flags |= 256), s = Jd(c, s, !1), s !== 2 && s !== 6) {
							if (od && !l) {
			...
			a: {
				...
				if ((t & 62914560) === t && (a = _d + 300 - Ve(), 10 < a)) {
					if (Bd(r, t, fd, !id), st(r, 0, !0) !== 0) break a;
					Td = t, r.timeoutHandle = _p(Rd.bind(null, r, n, hd, bd, gd, t, fd, ud, pd, id, o, "Throttled", -0, 0), a);
					break a;
				}
				Rd(r, n, hd, bd, gd, t, fd, ud, pd, id, o, null, -0, 0);
			}
			break;
		} while (1);
		Ef(e);
	...
	function Rd(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
		...
		if (d = null, (h || m & 8192 || (m & 16785408) == 16785408) && (d = {
			...
			unsuspend: hn
		}, Rl = null, Ku(t, a, d), h && (m = d, h = e.containerInfo, h = (h.nodeType === 9 ? h : h.ownerDocument).__reactViewTransition, h != null && (m.count++, m.waitingForViewTransition = !0, m = rh.bind(m), h.finished.then(m, m))), m = (a & 62914560) === a ? _d - Ve() : (a & 4194048) === a ? vd - Ve() : 0, m = th(d, m), m !== null)) {
			Td = a, e.cancelPendingCommit = m(nf.bind(null, e, t, a, n, r, i, o, s, c, l, u, d, null, f, p)), Bd(e, a, o, !l);
			return;
		}
	...
	function Vd() {
		return ed & 6 ? !0 : (Df(0, !1), !1);
	}
	function Hd() {
		if (K !== null) {
			if (nd === 0) var e = K.return;
			else e = K, pa = fa = null, ts(e), to = null, no = 0, e = K;
	...
	function Ud(e, t) {
		...
		return n !== -1 && (e.timeoutHandle = -1, vp(n)), n = e.cancelPendingCommit, n !== null && (e.cancelPendingCommit = null, n()), Td = 0, Hd(), td = e, K = n = ji(e.current, null), q = t, nd = 0, rd = null, id = !1, ad = ct(e, t), od = !1, pd = fd = dd = ud = ld = cd = 0, hd = md = null, gd = !1, sd = lt(e, t), xi(), n;
	}
	function Y(e, t) {
		W = null, P.H = dc, t === Ga || t === qa ? (t = $a(), nd = 3) : t === Ka ? (t = $a(), nd = 4) : nd = t === kc ? 8 : typeof t == "object" && t && typeof t.then == "function" ? 6 : 1, rd = t, K === null && (cd = 1, Cc(e, zi(t, e.current)));
	}
	function Wd() {
		var e = Do.current;
	...
	function qd() {
		cd = 4, id || (q & 4194048) !== q && Do.current !== null || (ad = !0), !(ld & 134217727) && !(ud & 134217727) || td === null || Bd(td, q, fd, !1);
	}
	function Jd(e, t, n) {
		var r = ed;
		ed |= 2;
		var i = Gd(), a = Kd();
		(td !== e || q !== t) && (bd = null, Ud(e, t)), t = !1;
		var o = cd;
		a: do
			try {
				if (nd !== 0 && K !== null) {
	...
	function Xd(e, t) {
		...
		ed |= 2;
		var r = Gd(), a = Kd();
		td !== e || q !== t ? (bd = null, yd = Ve() + 500, Ud(e, t)) : ad = ct(e, t);
		a: do
			try {
				if (nd !== 0 && K !== null) {
					t = K;
					...
					b: switch (nd) {
						...
						case 4:
							...
							break a;
						case 7:
							Ya(o) ? (nd = 0, rd = null, Qd(t)) : (nd = 0, rd = null, $d(e, t, o, 7));
							break;
						case 5:
							var s = null;
							switch (K.tag) {
	...
	function Qd(e) {
		...
		switch (t.tag) {
			...
			case 5:
				ts(t);
				var r = t;
				r === ea && (U ? (oa(r), r.tag === 5 && r.stateNode != null && (H = r.stateNode)) : (oa(r), U = !0));
	...
	function $d(e, t, n, r) {
		...
		t.flags & 32768 ? (U || r === 1 ? e = !0 : ad || q & 536870912 ? e = !1 : (id = e = !0, (r === 2 || r === 9 || r === 3 || r === 6) && (r = Do.current, r !== null && r.tag === 13 && (r.flags |= 16384))), tf(t, e)) : ef(t);
	}
	function ef(e) {
		var t = e;
		do {
	...
	function nf(e, t, n, r, a, o, s, c, l, u, d, f) {
		...
		if (t !== null) {
			...
			e === td && (K = td = null, q = 0), wd = t, Cd = e, Td = n, Dd = a, Od = r, rf(e, t, n, s, c, l, f);
		}
	}
	function rf(e, t, n, r, i, a, o) {
		var s = t.lanes | t.childLanes;
		if (Ed = s, s |= bi, mt(e, n, s, r, i, a), Ad = null, (n & 335544064) === n ? (jd = Ma(e), r = 10262) : (jd = null, r = 10256), (t.subtreeFlags & r) !== 0 || (t.flags & r) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, bf(Ge, function() {
			return ff(), null;
		...
		Sd = 1, Ll ? kd = Np(o, e.containerInfo, jd, sf, cf, of, lf, ff, af, null, null) : (sf(), cf(), lf());
	}
	function af(e) {
		if (Sd !== 0) {
	...
	function lf() {
		if (Sd === 4 || Sd === 3) {
			...
			if ((n.subtreeFlags & a) !== 0 || (n.flags & a) !== 0 ? Sd = 5 : (Sd = 0, wd = Cd = null, uf(t, t.pendingLanes)), a = t.pendingLanes, a === 0 && (xd = null), yt(r), n = n.stateNode, Ze && typeof Ze.onCommitFiberRoot == "function") try {
			...
			Td & 3 && df(), Ef(t), a = t.pendingLanes, r & 261930 && a & 42 ? t === J ? Md++ : (Md = 0, J = t) : (Md = 0, J = null), Df(0, !1);
		}
	}
	function uf(e, t) {
	...
	function df() {
		return kd !== null && (kd.skipTransition(), kd = null), sf(), cf(), lf(), ff();
	}
	function ff() {
		if (Sd !== 5) return !1;
		var e = Cd, t = Ed;
		Ed = 0;
		var n = yt(Td), r = P.T, a = F.p;
		try {
			F.p = 32 > n ? 32 : n, P.T = null, n = Dd, Dd = null;
			var o = Cd, s = Td;
			if (Sd = 0, wd = Cd = null, Td = 0, ed & 6) throw Error(i(331));
			var c = ed;
			if (ed |= 4, Yu(o.current), Vu(o, o.current, s, n), ed = c, Df(0, !1), Ze && typeof Ze.onPostCommitFiberRoot == "function") try {
	...
	function pf(e, t, n) {
		t = zi(n, t), t = Tc(e.stateNode, t, 2), e = mo(e, t, 2), e !== null && (pt(e, 2), Ef(e));
	}
	function mf(e, t, n) {
		if (e.tag === 3) pf(e, e, n);
		else for (; t !== null;) {
			...
			if (t.tag === 1) {
				...
				if (typeof t.type.getDerivedStateFromError == "function" || typeof r.componentDidCatch == "function" && (xd === null || !xd.has(r))) {
					e = zi(n, e), n = Ec(2), r = mo(t, n, 2), r !== null && (Dc(n, r, t, e), pt(r, 2), Ef(r));
					break;
				}
			}
			t = t.return;
	...
	function gf(e, t, n) {
		var r = e.pingCache;
		r !== null && r.delete(t), e.pingedLanes |= e.suspendedLanes & n, e.warmLanes &= ~n, td === e && (q & n) === n && (cd === 4 || cd === 3 && (q & 62914560) === q && 300 > Ve() - _d ? ed & 2 ? dd |= n : Ud(e, 0) : dd |= n, pd === q && (pd = 0)), Ef(e);
	}
	function _f(e, t) {
		t === 0 && (t = dt()), e = wi(e, t), e !== null && (pt(e, t), Ef(e));
	}
	function vf(e) {
	...
	var xf = null, Sf = null, Cf = !1, Z = !1, wf = !1, Tf = 0;
	function Ef(e) {
		e !== Sf && e.next === null && (Sf === null ? xf = Sf = e : Sf = Sf.next = e), Z = !0, Cf || (Cf = !0, Nf());
	}
	function Df(e, t) {
		if (!wf && Z) {
			wf = !0;
				...
				for (var n = !1, r = xf; r !== null;) {
					if (!t) {
						if (e !== 0) {
							...
							a !== 0 && (n = !0, Mf(r, a));
						} else a = q, a = st(r, r === td ? a : 0, r.cancelPendingCommit !== null || r.timeoutHandle !== -1), !(a & 3) || ct(r, a) || (n = !0, Mf(r, a));
					}
					r = r.next;
				}
			while (n);
	...
	function kf() {
		...
		for (var t = Ve(), n = null, r = xf; r !== null;) {
			...
			a === 0 ? (r.next = null, n === null ? xf = i : n.next = i, i === null && (Sf = n)) : (n = r, (e !== 0 || a & 3) && (Z = !0)), r = i;
		}
	...
	function jf(e, t) {
		...
		var r = q;
		return r = st(e, e === td ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r === 0 ? null : (Ld(e, r, t), Af(e, Ve()), e.callbackNode != null && e.callbackNode === n ? jf.bind(null, e) : null);
	}
	function Mf(e, t) {
		if (df()) return null;
		Ld(e, t, !0);
		...
		Sn(function() {
			...
			a: {
				...
				if (c !== void 0) {
					...
					for (var m = r, h; m !== null;) {
						var g = m;
						if (h = g.stateNode, g = g.tag, g !== 5 && g !== 26 && g !== 27 || h === null || p === null || (g = Cn(m, p), g != null && d.push(qf(m, g, h))), f) break;
						m = m.return;
					}
			...
			if (!(t & 7)) {
				...
				switch (v = r ? Pt(r) : window, e) {
					case "focusin":
						(V(v) || v.contentEditable === "true") && (qr = v, Jr = r, Yr = null);
						break;
					case "focusout":
						Yr = Jr = qr = null;
						break;
				...
				b && (dr && n.locale !== "ko" && (gr || b !== "onCompositionStart" ? b === "onCompositionEnd" && gr && (y = An()) : (Dn = i, On = "value" in Dn ? Dn.value : Dn.textContent, gr = !0)), v = Jf(r, b), 0 < v.length && (b = new Jn(b, e, null, n, i), s.push({
					event: b,
					listeners: v
	...
	function Jf(e, t) {
		for (var n = t + "Capture", r = []; e !== null;) {
			...
			if (i = i.tag, i !== 5 && i !== 26 && i !== 27 || a === null || (i = Cn(e, n), i != null && r.unshift(qf(e, i, a)), i = Cn(e, t), i != null && r.push(qf(e, i, a))), e.tag === 3) return r;
			e = e.return;
		}
		return [];
	}
	...
	function Xf(e, t, n, r, i) {
		for (var a = t._reactName, o = []; n !== null && n !== r;) {
			...
			s !== 5 && s !== 26 && s !== 27 || l === null || (c = l, i ? (l = Cn(n, a), l != null && o.unshift(qf(n, l, c))) : i || (l = Cn(n, a), l != null && o.push(qf(n, l, c)))), n = n.return;
		}
		o.length !== 0 && e.push({
			event: t,
			listeners: o
	...
	function pp(e, t, n, r) {
		return n = up(n).createElement(e), n[Ct] = r, n[wt] = t, rp(n, e, t), It(n), n;
	}
	function mp(e, t) {
		...
		if (!(n != null && typeof n != "boolean" && (r = n.signal || null, r !== null && r.aborted))) {
			...
			if (Vp(a, e, t, n) === -1) {
				...
				n != null && typeof n != "boolean" && !0 === n.once && (s = function(r) {
					...
					attachedListener: s,
					cleanup: i
				}), f(this._fragmentFiber.child, !1, Lp, e, s, r);
			}
	...
	Ip.prototype.removeEventListener = function(e, t, n) {
		...
		if (r !== null && (t = Vp(r, e, t, n), t !== -1)) {
			...
			var a = i.cleanup;
			i = zp(i.optionsOrUseCapture), f(this._fragmentFiber.child, !1, Rp, e, n, i), r.splice(t, 1), a !== null && a();
		}
	};
	function Rp(e, t, n, r) {
	...
	Ip.prototype.dispatchEvent = function(e) {
		...
		f(this._fragmentFiber.child, !0, Hp, e, void 0, void 0);
	};
	function Hp(e, t) {
		return e.tag !== 6 && (e = _(e), mm(e, t));
	}
	Ip.prototype.focusLast = function(e) {
		var t = [];
		f(this._fragmentFiber.child, !0, Up, t, void 0, void 0);
	...
	Ip.prototype.blur = function() {
		...
		e !== null && (e = _(e), e = up(e).activeElement, e !== null && f(this._fragmentFiber.child, !1, Wp, e, void 0, void 0));
	};
	function Wp(e, t) {
		return e.tag !== 6 && (e = _(e), e === t || e.contains(t) ? (t.blur(), !0) : !1);
	}
	Ip.prototype.observeUsing = function(e) {
		this._observers === null && (this._observers = /* @__PURE__ */ new Set()), this._observers.add(e), f(this._fragmentFiber.child, !1, Gp, e, void 0, void 0);
	};
	function Gp(e, t) {
	...
	Ip.prototype.unobserveUsing = function(e) {
		...
		if (t !== null && t.has(e)) {
			t.delete(e), f(this._fragmentFiber.child, !1, Kp, e, void 0, void 0);
	...
	Ip.prototype.getClientRects = function() {
		var e = [];
		return f(this._fragmentFiber.child, !1, Xp, e, void 0, void 0), e;
	};
	function Xp(e, t) {
		if (e.tag === 6) {
			e = e.stateNode;
	...
	Ip.prototype.getRootNode = function(e) {
		...
		var n = [];
		f(this._fragmentFiber.child, !1, Up, n, void 0, void 0);
		var r = _(t);
		if (n.length === 0) {
	...
	Ip.prototype.scrollIntoView = function(e) {
		...
		var t = [];
		f(this._fragmentFiber.child, !1, Up, t, void 0, void 0);
		var n = !1 !== e;
		if (t.length === 0) {
		...
		for (r = n ? t.length - 1 : 0; r !== (n ? -1 : t.length);) {
			var a = t[r];
			a.tag === 6 ? (a = _(a), Qp(a, n)) : _(a).scrollIntoView(e), r += n ? -1 : 1;
		}
	};
	function $p(e, t) {
		return e = _(e), em(e, t), !1;
	}
	function em(e, t) {
	...
	function wm(e) {
		var t = Nt(e);
		t !== null && t.tag === 5 && t.type === "form" ? $s(t) : Sm.r(e);
	}
	...
	function Em(e, t, n) {
		...
		if (r && typeof t == "string" && t) {
			...
			i = "link[rel=\"" + e + "\"][href=\"" + i + "\"]", typeof n == "string" && (i += "[crossorigin=\"" + n + "\"]"), bm.has(i) || (bm.add(i), e = {
				...
				crossOrigin: n,
				href: t
			}, r.querySelector(i) === null && (t = r.createElement("link"), rp(t, "link", e), It(t), r.head.appendChild(t)));
		}
	}
	function Dm(e) {
	...
	function km(e, t, n) {
		...
		if (r && e && t) {
			...
			if (!(ym.has(a) || (e = T({
				...
				rp(o, "link", e), t === "style" && (o[At] = !0, o.onload = o.onerror = function() {
					L(o);
	...
	function Am(e, t) {
		...
		if (n && e) {
			...
			if (!ym.has(a) && (e = T({
				...
				r = n.createElement("link"), rp(r, "link", e), It(r), n.head.appendChild(r);
			}
		}
	}
	function jm(e, t, n) {
		...
		var r = Tm;
		if (r && e) {
			var i = Ft(r).hoistableStyles, a = Fm(e);
			t ||= "default";
			var o = i.get(a);
			if (!o) {
				var s = {
				...
				if (o = r.querySelector(Im(a))) s.loading = 5;
					...
					It(c), rp(c, "link", e), c._p = new Promise(function(e, t) {
	...
	function Mm(e, t) {
		...
		var n = Tm;
		if (n && e) {
			var r = Ft(n).hoistableScripts, i = zm(e), a = r.get(i);
			a || (a = n.querySelector(Bm(i)), a || (e = T({
				src: e,
				async: !0
			}, t), (t = ym.get(i)) && Wm(e, t), a = n.createElement("script"), It(a), rp(a, "link", e), n.head.appendChild(a)), a = {
				type: "script",
				instance: a,
				count: 1,
				state: null
	...
	function Pm(e, t, n, r) {
		var a = (a = Ce.current) ? xm(a) : null;
		if (!a) throw Error(i(446));
		switch (e) {
			case "meta":
			case "title": return null;
			case "style": return typeof n.precedence == "string" && typeof n.href == "string" ? (n = Fm(n.href), t = Ft(a).hoistableStyles, r = t.get(n), r || (r = {
				type: "style",
				instance: null,
				count: 0,
				state: null
			...
			case "link":
				...
				return null;
			case "script": return t = n.async, n = n.src, typeof n == "string" && t && typeof t != "function" && typeof t != "symbol" ? (n = zm(n), t = Ft(a).hoistableScripts, r = t.get(n), r || (r = {
				type: "script",
				instance: null,
				count: 0,
				state: null
	...
	function Rm(e, t, n, r) {
		...
		} else t = e.createElement("link"), t[At] = !0, t.onload = t.onerror = L.bind(null, t), rp(t, "link", n), It(t), e.head.appendChild(t);
	...
	function Vm(e, t, n) {
		if (t.count++, t.instance === null) switch (t.type) {
			case "style":
				...
				return r = (e.ownerDocument || e).createElement("style"), It(r), rp(r, "style", a), Hm(r, n.precedence, e), t.instance = r;
			case "stylesheet":
				a = Fm(n.href);
				var o = e.querySelector(Im(a));
				if (o) return t.state.loading |= 4, t.instance = o, It(o), o;
				r = Lm(n), (a = ym.get(a)) && Um(r, a), o = (e.ownerDocument || e).createElement("link"), It(o);
				var s = o;
				return s._p = new Promise(function(e, t) {
					s.onload = e, s.onerror = t;
				}), rp(o, "link", r), t.state.loading |= 4, Hm(o, n.precedence, e), t.instance = o;
			case "script": return o = zm(n.src), (a = e.querySelector(Bm(o))) ? (t.instance = a, It(a), a) : (r = n, (a = ym.get(o)) && (r = T({}, n), Wm(r, a)), e = e.ownerDocument || e, a = e.createElement("script"), It(a), rp(a, "link", r), e.head.appendChild(a), t.instance = a);
	...
	function $m(e, t, n, r) {
		if (n.type === "stylesheet" && (typeof r.media != "string" || !1 !== matchMedia(r.media).matches) && !(n.state.loading & 4)) {
			if (n.instance === null) {
				...
				if (a) {
					t = a._p, typeof t == "object" && t && typeof t.then == "function" && (e.count++, e = rh.bind(e), t.then(e, e)), n.state.loading |= 4, n.instance = a, It(a);
					return;
				}
				a = t.ownerDocument || t, r = Lm(r), (i = ym.get(i)) && Um(r, i), a = a.createElement("link"), It(a);
				var o = a;
	...
	function uh(e, t, n, r, i, a, o, s, c, l, u, d) {
		return e = new lh(e, t, n, o, c, l, u, d, s), t = 1, !0 === a && (t |= 24), a = ki(3, null, null, t), e.current = a, a.stateNode = e, t = Oa(), t.refCount++, e.pooledCache = t, t.refCount++, a.memoizedState = {
			element: r,
			isDehydrated: n,
			cache: t
		}, uo(a), e;
	...
	function fh(e, t, n, r, i, a) {
		i = dh(i), r.context === null ? r.context = i : r.pendingContext = i, r = po(t), r.payload = { element: n }, a = a === void 0 ? null : a, a !== null && (r.callback = a), n = mo(e, r, t), n !== null && (Id(n, e, t), ho(n, e, t));
	}
	function ph(e, t) {
	...
	function hh(e) {
		if (e.tag === 13 || e.tag === 31) {
			var t = wi(e, 67108864);
			t !== null && Id(t, e, 67108864), mh(e, 67108864);
		}
	}
	function gh(e) {
		if (e.tag === 13 || e.tag === 31) {
	...
	function bh(e, t, n, r) {
		if (_h) {
			var i = xh(r);
			if (i === null) Kf(e, t, r, Sh, n), Nh(e, r);
						...
						case 3:
							if (a = a.stateNode, a.current.memoizedState.isDehydrated) {
								...
								if (o !== 0) {
									...
									Ef(a), !(ed & 6) && (yd = Ve() + 500, Df(0, !1));
								}
							}
							break;
						case 31:
						case 13: s = wi(a, 2), s !== null && Id(s, a, 2), Vd(), mh(a, 2);
					}
					if (a = xh(r), a === null && Kf(e, t, r, Sh, n), a === i) break;
					i = a;
				}
	...
	function Ph(e, t, n, r, i, a) {
		return e === null || e.nativeEvent !== a ? (e = {
			...
			nativeEvent: a,
			targetContainers: [i]
		}, t !== null && (t = Nt(t), t !== null && hh(t)), e) : (e.eventSystemFlags |= r, t = e.targetContainers, i !== null && t.indexOf(i) === -1 && t.push(i), e);
	}
	...
	function Lh(e) {
		...
		for (var t = e.targetContainers; 0 < t.length;) {
			...
			} else return t = Nt(n), t !== null && hh(t), e.blockedOn = n, !1;
			t.shift();
		}
		return !0;
	}
	...
	Kh.prototype.render = Gh.prototype.render = function(e) {
		...
		var n = t.current;
		fh(n, Nd(), e, t, null, null);
	}, Kh.prototype.unmount = Gh.prototype.unmount = function() {
		var e = this._internalRoot;
		if (e !== null) {
			this._internalRoot = null;
			var t = e.containerInfo;
			fh(e.current, 2, null, e, null, null), Vd(), t[Tt] = null;
		}
	};
	function Kh(e) {
		this._internalRoot = e;
	...
	e.createRoot = function(e, t) {
		...
		return t != null && (!0 === t.unstable_strictMode && (n = !0), t.identifierPrefix !== void 0 && (r = t.identifierPrefix), t.onUncaughtError !== void 0 && (o = t.onUncaughtError), t.onCaughtError !== void 0 && (s = t.onCaughtError), t.onRecoverableError !== void 0 && (c = t.onRecoverableError)), t = uh(e, 1, !1, null, null, n, r, null, o, s, c, Wh), e[Tt] = t.current, Wf(e), new Gh(t);
	};
})), xu = (/* @__PURE__ */ m(((e, t) => {
	function n() {
		if (!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ > "u" || typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE != "function")) try {
	...
	n(), t.exports = bu();
})))(), Su = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
...
}, x.createElement("path", { d: "M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z" })), Cu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M11.9999 13.1714L16.9497 8.22168L18.3639 9.63589L11.9999 15.9999L5.63599 9.63589L7.0502 8.22168L11.9999 13.1714Z" })), wu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z" })), Tu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M13.1717 12.0007L8.22192 7.05093L9.63614 5.63672L16.0001 12.0007L9.63614 18.3646L8.22192 16.9504L13.1717 12.0007Z" })), Eu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M11.9997 10.5865L16.9495 5.63672L18.3637 7.05093L13.4139 12.0007L18.3637 16.9504L16.9495 18.3646L11.9997 13.4149L7.04996 18.3646L5.63574 16.9504L10.5855 12.0007L5.63574 7.05093L7.04996 5.63672L11.9997 10.5865Z" })), Du = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM15.5 8.5L13.5 13.5L8.5 15.5L10.5 10.5L15.5 8.5Z" })), Ou = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z" })), Au = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM11 15H13V17H11V15ZM11 7H13V13H11V7Z" })), ju = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M10 6V8H5V19H16V14H18V20C18 20.5523 17.5523 21 17 21H4C3.44772 21 3 20.5523 3 20V7C3 6.44772 3.44772 6 4 6H10ZM21 3V11H19L18.9999 6.413L11.2071 14.2071L9.79289 12.7929L17.5849 5H13V3H21Z" })), Mu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12.0003 3C17.3924 3 21.8784 6.87976 22.8189 12C21.8784 17.1202 17.3924 21 12.0003 21C6.60812 21 2.12215 17.1202 1.18164 12C2.12215 6.87976 6.60812 3 12.0003 3ZM12.0003 19C16.2359 19 19.8603 16.052 20.7777 12C19.8603 7.94803 16.2359 5 12.0003 5C7.7646 5 4.14022 7.94803 3.22278 12C4.14022 16.052 7.7646 19 12.0003 19ZM12.0003 16.5C9.51498 16.5 7.50026 14.4853 7.50026 12C7.50026 9.51472 9.51498 7.5 12.0003 7.5C14.4855 7.5 16.5003 9.51472 16.5003 12C16.5003 14.4853 14.4855 16.5 12.0003 16.5ZM12.0003 14.5C13.381 14.5 14.5003 13.3807 14.5003 12C14.5003 10.6193 13.381 9.5 12.0003 9.5C10.6196 9.5 9.50026 10.6193 9.50026 12C9.50026 13.3807 10.6196 14.5 12.0003 14.5Z" })), Nu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM9.71002 19.6674C8.74743 17.6259 8.15732 15.3742 8.02731 13H4.06189C4.458 16.1765 6.71639 18.7747 9.71002 19.6674ZM10.0307 13C10.1811 15.4388 10.8778 17.7297 12 19.752C13.1222 17.7297 13.8189 15.4388 13.9693 13H10.0307ZM19.9381 13H15.9727C15.8427 15.3742 15.2526 17.6259 14.29 19.6674C17.2836 18.7747 19.542 16.1765 19.9381 13ZM4.06189 11H8.02731C8.15732 8.62577 8.74743 6.37407 9.71002 4.33256C6.71639 5.22533 4.458 7.8235 4.06189 11ZM10.0307 11H13.9693C13.8189 8.56122 13.1222 6.27025 12 4.24799C10.8778 6.27025 10.1811 8.56122 10.0307 11ZM14.29 4.33256C15.2526 6.37407 15.8427 8.62577 15.9727 11H19.9381C19.542 7.8235 17.2836 5.22533 14.29 4.33256Z" })), Pu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M5 14H19V4H5V14ZM5 16V20H19V16H5ZM4 2H20C20.5523 2 21 2.44772 21 3V21C21 21.5523 20.5523 22 20 22H4C3.44772 22 3 21.5523 3 21V3C3 2.44772 3.44772 2 4 2ZM15 17H17V19H15V17Z" })), Fu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12H4C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C9.25022 4 6.82447 5.38734 5.38451 7.50024L8 7.5V9.5H2V3.5H4L3.99989 5.99918C5.82434 3.57075 8.72873 2 12 2ZM13 7L12.9998 11.585L16.2426 14.8284L14.8284 16.2426L10.9998 12.413L11 7H13Z" })), Iu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 11V17H13V11H11ZM11 7V9H13V7H11Z" })), Lu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM11 7H13V9H11V7ZM11 11H13V17H11V11Z" })), Ru = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M10.9042 2.10025L20.8037 3.51446L22.2179 13.414L13.0255 22.6063C12.635 22.9969 12.0019 22.9969 11.6113 22.6063L1.71184 12.7069C1.32131 12.3163 1.32131 11.6832 1.71184 11.2926L10.9042 2.10025ZM11.6113 4.22157L3.83316 11.9997L12.3184 20.485L20.0966 12.7069L19.036 5.28223L11.6113 4.22157ZM13.7327 10.5855C12.9516 9.80448 12.9516 8.53815 13.7327 7.7571C14.5137 6.97606 15.78 6.97606 16.5611 7.7571C17.3421 8.53815 17.3421 9.80448 16.5611 10.5855C15.78 11.3666 14.5137 11.3666 13.7327 10.5855Z" })), zu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M18.031 16.6168L22.3137 20.8995L20.8995 22.3137L16.6168 18.031C15.0769 19.263 13.124 20 11 20C6.032 20 2 15.968 2 11C2 6.032 6.032 2 11 2C15.968 2 20 6.032 20 11C20 13.124 19.263 15.0769 18.031 16.6168ZM16.0247 15.8748C17.2475 14.6146 18 12.8956 18 11C18 7.1325 14.8675 4 11 4C7.1325 4 4 7.1325 4 11C4 14.8675 7.1325 18 11 18C12.8956 18 14.6146 17.2475 15.8748 16.0247L16.0247 15.8748Z" })), Bu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M9.40017 16H3C1.89543 16 1 15.1046 1 14V11.8957C1 11.6344 1.05118 11.3757 1.15064 11.1342L4.24501 3.61925C4.3993 3.24455 4.76447 3 5.16969 3H22C22.5523 3 23 3.44772 23 4V14C23 14.5523 22.5523 15 22 15H18.5182C18.1932 15 17.8886 15.1579 17.7012 15.4233L12.2478 23.149C12.1053 23.3508 11.8367 23.4184 11.6157 23.3078L9.80163 22.4008C8.74998 21.875 8.20687 20.6874 8.49694 19.548L9.40017 16ZM17 13.4125V5H5.83939L3 11.8957V14H9.40017C10.7049 14 11.6602 15.229 11.3384 16.4934L10.4351 20.0414C10.3771 20.2693 10.4857 20.5068 10.6961 20.612L11.3572 20.9425L16.0673 14.27C16.3172 13.9159 16.6366 13.6257 17 13.4125ZM19 13H21V5H19V13Z" })), Vu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M3 19H21V21H3V19ZM13 5.82843V17H11V5.82843L4.92893 11.8995L3.51472 10.4853L12 2L20.4853 10.4853L19.0711 11.8995L13 5.82843Z" })), Uu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M3 3.9934C3 3.44476 3.44495 3 3.9934 3H20.0066C20.5552 3 21 3.44495 21 3.9934V20.0066C21 20.5552 20.5551 21 20.0066 21H3.9934C3.44476 21 3 20.5551 3 20.0066V3.9934ZM5 5V19H19V5H5ZM10.6219 8.41459L15.5008 11.6672C15.6846 11.7897 15.7343 12.0381 15.6117 12.2219C15.5824 12.2658 15.5447 12.3035 15.5008 12.3328L10.6219 15.5854C10.4381 15.708 10.1897 15.6583 10.0672 15.4745C10.0234 15.4088 10 15.3316 10 15.2526V8.74741C10 8.52649 10.1791 8.34741 10.4 8.34741C10.479 8.34741 10.5562 8.37078 10.6219 8.41459Z" })), Gu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	classGroupId: e,
	validator: t
}), Ju = (e = /* @__PURE__ */ new Map(), t = null, n) => ({
	nextPart: e,
	validators: t,
	classGroupId: n
}), Yu = "-", Xu = [], Zu = "arbitrary..", Qu = (e) => {
	let t = td(e), { conflictingClassGroups: n, conflictingClassGroupModifiers: r } = e;
	return {
		getClassGroupId: (e) => {
			if (e.startsWith("[") && e.endsWith("]")) return ed(e);
			let n = e.split(Yu);
	...
	let a = n.validators;
	if (a === null) return;
	let o = t === 0 ? e.join(Yu) : e.slice(t).join(Yu), s = a.length;
	for (let e = 0; e < s; e++) {
		let t = a[e];
	...
	t.validators === null && (t.validators = []), t.validators.push(qu(n, e));
}, ad = (e, t, n, r) => {
	...
	let n = e, r = t.split(Yu), i = r.length;
	for (let e = 0; e < i; e++) {
		let t = r[e], i = n.nextPart.get(t);
		i || (i = Ju(), n.nextPart.set(t, i)), n = i;
	}
	return n;
}, sd = (e) => "isThemeGetter" in e && e.isThemeGetter === !0, cd = (e) => {
	if (e < 1) return {
		get: () => void 0,
		set: () => {}
	};
	...
	let { prefix: t, experimentalParseClassName: n } = e, r = (e) => {
		...
		s.endsWith(ld) ? (c = s.slice(0, -1), l = !0) : s.startsWith(ld) && (c = s.slice(1), l = !0);
		let u = a && a > i ? a - i : void 0;
		return fd(t, l, c, u);
	};
	if (t) {
		let e = t + ud, n = r;
		r = (t) => t.startsWith(e) ? n(t.slice(e.length)) : fd(dd, !1, t, void 0, !0);
	}
	if (n) {
		let e = r;
		r = (t) => n({
	...
	parseClassName: pd(e),
	sortModifiers: md(e),
	postfixLookupClassGroupIds: gd(e),
	...Qu(e)
}), gd = (e) => {
	...
	let { parseClassName: n, getClassGroupId: r, getConflictingClassGroupIds: i, sortModifiers: a, postfixLookupClassGroupIds: o } = t, s = [], c = e.trim().split(_d), l = "";
	for (let e = c.length - 1; e >= 0; --e) {
		...
		let _ = d.length === 0 ? "" : d.length === 1 ? d[0] : a(d).join(":"), v = f ? _ + ld : _, y = v + g;
	...
	let t = 0, n, r, i = "";
	for (; t < e.length;) (n = e[t++]) && (r = bd(n)) && (i && (i += " "), i += r);
	return i;
}, bd = (e) => {
	if (typeof e == "string") return e;
	let t, n = "";
	for (let r = 0; r < e.length; r++) e[r] && (t = bd(e[r])) && (n && (n += " "), n += t);
	return n;
}, xd = (e, ...t) => {
	let n, r, i, a, o = (o) => (n = hd(t.reduce((e, t) => t(e), e())), r = n.cache.get, i = n.cache.set, a = s, s(o)), s = (e) => {
		let t = r(e);
		if (t) return t;
		let a = vd(e, n);
		return i(e, a), a;
...
}, wd = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, Td = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Ed = /^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/, Dd = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Od = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, kd = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix|color|light-dark)\(.+\)$/, Ad = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, jd = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, Md = (e) => Ed.test(e), J = (e) => !!e && !Number.isNaN(Number(e)), Nd = (e) => !!e && Number.isInteger(Number(e)), Pd = (e) => e.endsWith("%") && J(e.slice(0, -1)), Fd = (e) => Dd.test(e), Id = () => !0, Ld = (e) => Od.test(e) && !kd.test(e), Rd = () => !1, zd = (e) => Ad.test(e), Bd = (e) => jd.test(e), Vd = (e) => !Y(e) && !X(e), Hd = (e) => e.startsWith("@container") && (e[10] === "/" && e[11] !== void 0 || e[11] === "s" && e[16] !== void 0 && e.startsWith("-size/", 10) || e[11] === "n" && e[18] !== void 0 && e.startsWith("-normal/", 10)), Ud = (e) => af(e, lf, Rd), Y = (e) => wd.test(e), Wd = (e) => af(e, uf, Ld), Gd = (e) => af(e, df, J), Kd = (e) => af(e, pf, Id), qd = (e) => af(e, ff, Rd), Jd = (e) => af(e, sf, Rd), Yd = (e) => af(e, cf, Bd), Xd = (e) => af(e, mf, zd), X = (e) => Td.test(e), Zd = (e) => of(e, uf), Qd = (e) => of(e, ff), $d = (e) => of(e, sf), ef = (e) => of(e, lf), tf = (e) => of(e, cf), nf = (e) => of(e, mf, !0), rf = (e) => of(e, pf, !0), af = (e, t, n) => {
	let r = wd.exec(e);
	return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, of = (e, t, n = !1) => {
	let r = Td.exec(e);
	return r ? r[1] ? t(r[1]) : n : !1;
}, sf = (e) => e === "position" || e === "percentage", cf = (e) => e === "image" || e === "url", lf = (e) => e === "length" || e === "size" || e === "bg-size", uf = (e) => e === "length", df = (e) => e === "number", ff = (e) => e === "family-name", pf = (e) => e === "number" || e === "weight", mf = (e) => e === "shadow", hf = () => {
	let e = Cd("color"), t = Cd("font"), n = Cd("text"), r = Cd("font-weight"), i = Cd("tracking"), a = Cd("leading"), o = Cd("breakpoint"), s = Cd("container"), c = Cd("spacing"), l = Cd("radius"), u = Cd("shadow"), d = Cd("inset-shadow"), f = Cd("text-shadow"), p = Cd("drop-shadow"), m = Cd("blur"), h = Cd("perspective"), g = Cd("aspect"), _ = Cd("ease"), v = Cd("animate"), y = () => [
		"auto",
		"avoid",
		"all",
		"avoid-page",
...
}, gf = (e, { cacheSize: t, prefix: n, experimentalParseClassName: r, extend: i = {}, override: a = {} }) => (_f(e, "cacheSize", t), _f(e, "prefix", n), _f(e, "experimentalParseClassName", r), vf(e.theme, a.theme), vf(e.classGroups, a.classGroups), vf(e.conflictingClassGroups, a.conflictingClassGroups), vf(e.conflictingClassGroupModifiers, a.conflictingClassGroupModifiers), _f(e, "postfixLookupClassGroups", a.postfixLookupClassGroups), _f(e, "orderSensitiveModifiers", a.orderSensitiveModifiers), yf(e.theme, i.theme), yf(e.classGroups, i.classGroups), yf(e.conflictingClassGroups, i.conflictingClassGroups), yf(e.conflictingClassGroupModifiers, i.conflictingClassGroupModifiers), bf(e, i, "postfixLookupClassGroups"), bf(e, i, "orderSensitiveModifiers"), e), _f = (e, t, n) => {
	n !== void 0 && (e[t] = n);
}, vf = (e, t) => {
	if (t) for (let n in t) _f(e, n, t[n]);
}, yf = (e, t) => {
	if (t) for (let n in t) bf(e, t, n);
}, bf = (e, t, n) => {
	let r = t[n];
	r !== void 0 && (e[n] = e[n] ? e[n].concat(r) : r);
}, xf = (e, ...t) => typeof e == "function" ? xd(hf, e, ...t) : xd(() => gf(hf(), e), ...t), Sf = [
	"large-title",
	"display-1",
	"display-2",
	"display-3",
	...
	"semibold",
	"bold"
], Z = xf({ extend: { classGroups: { "font-size": [{ text: Sf.flatMap((e) => Cf.map((t) => `${e}-${t}`)) }] } } });
function wf(e) {
	return e;
}
//#endregion
...
function Ef({ variant: e = "bold", color: t = "neutral", className: n, ref: r, ...i }) {
	return /* @__PURE__ */ (0, S.jsx)("span", {
		ref: r,
		className: Z(Tf.base, Tf.variant[e], Tf.color[t], n),
		...i
	});
}
//#endregion
...
async function Af(e, t) {
	...
	if (!n.ok) throw new Df(Of(r) || `请求失败（${n.status}）`, n.status);
	return r;
}
async function jf(e, t, n = "POST", r) {
	let i = await fetch(e, {
		method: n,
		...r ? { signal: r } : {},
		headers: {
	...
	if (!i.ok) throw new Df(Of(a) || `请求失败（${i.status}）`, i.status, a);
	return a;
}
//#endregion
//#region src/react/components/empty-state.tsx
function Mf({ icon: e, title: t, actions: n, children: r }) {
...
function Pf({ tone: e, title: t, extra: n, children: r }) {
...
function If({ label: e, value: t, max: n = 100, stops: r = [] }) {
...
var Lf = new Ze({ defaultOptions: { queries: {
	networkMode: "always",
	retry: 0,
	refetchOnWindowFocus: !1,
	refetchOnMount: !1,
	retryOnMount: !1
} } }), Rf = "/api/tasks", zf = ["tasks"], Bf = 2e3, Vf = 1e4, Q = (e) => e?.running.length ? Bf : Vf, Hf = (e) => Af(Rf, e);
async function Uf(e) {
	await Lf.fetchQuery({
		queryKey: zf,
		queryFn: () => Hf(e)
...
function Xf(e) {
	return Object.entries(e || {}).filter(([e, t]) => e !== "blocked_by" && (typeof t == "number" || typeof t == "string") && String(t) !== "").map(([e, t]) => `${qf[e] || e} ${t}`).join(" · ");
}
//#endregion
...
function Qf({ status: e }) {
	return /* @__PURE__ */ (0, S.jsx)(Ef, {
		color: Zf[e] ?? "neutral",
		children: Kf(e)
	});
}
function $f({ run: e, meta: t, children: n, footer: r }) {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, S.jsx)(Qf, { status: e.status })]
				}),
				/* @__PURE__ */ (0, S.jsx)("p", {
...
function ep({ run: e }) {
	let t = e.progress_total || 0, n = e.progress_current || 0, r = e.progress_label || "正在进行", i = Jf(e.elapsed_seconds), a = [Wf[e.trigger] || e.trigger, i && `已跑 ${i}`].filter(Boolean).join(" · ");
	return /* @__PURE__ */ (0, S.jsx)($f, {
		run: e,
		meta: a,
		children: t > 0 ? /* @__PURE__ */ (0, S.jsxs)("div", {
			className: "flex flex-col gap-1.5",
			children: [/* @__PURE__ */ (0, S.jsx)(If, {
				label: r,
				value: n,
				max: t
			}), /* @__PURE__ */ (0, S.jsxs)("p", {
		...
		}) : /* @__PURE__ */ (0, S.jsx)(Nf, { label: r })
	});
}
function tp({ run: e }) {
	let t = Xf(e.result_summary), n = Jf(e.elapsed_seconds), r = [
		Wf[e.trigger] || e.trigger,
		Yf(e.finished_at),
		n && `用时 ${n}`
	].filter(Boolean).join(" · ");
	return /* @__PURE__ */ (0, S.jsx)($f, {
...
function np({ title: e, children: t }) {
	let n = (0, x.useId)();
...
function rp({ live: e = !1, children: t }) {
...
function ip(e) {
	let t = ut({
		queryKey: zf,
		queryFn: ({ signal: e }) => Hf(e),
		refetchInterval: (e) => Q(e.state.data)
	}), n = t.data, r = t.error ? kf(t.error) : "";
	if (!n) return /* @__PURE__ */ (0, S.jsx)(Ff, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
		tone: "error",
		children: r || "读取任务中心失败"
	}) });
	let i = n.running || [], a = n.skipped || [], o = (n.finished || []).filter((e) => !a.some((t) => t.id === e.id)), s = !i.length && !a.length && !o.length;
	return /* @__PURE__ */ (0, S.jsxs)(Ff, { children: [
		r ? /* @__PURE__ */ (0, S.jsx)(Pf, {
			tone: "error",
			children: r
		}) : null,
		n.available === !1 ? /* @__PURE__ */ (0, S.jsx)(Pf, {
			tone: "warning",
		...
		s ? /* @__PURE__ */ (0, S.jsx)(Mf, {
			...
			/* @__PURE__ */ (0, S.jsx)(np, {
				title: "正在进行",
				children: i.length ? /* @__PURE__ */ (0, S.jsx)(rp, {
					live: !0,
					children: i.map((e) => /* @__PURE__ */ (0, S.jsx)(ep, { run: e }, e.id))
				}) : /* @__PURE__ */ (0, S.jsx)("p", {
					className: "text-body-2-regular text-text-secondary",
					children: "没有任务在跑。"
				})
			}),
			a.length ? /* @__PURE__ */ (0, S.jsx)(np, {
				title: "被挡下的",
				children: /* @__PURE__ */ (0, S.jsx)(rp, { children: a.map((e) => /* @__PURE__ */ (0, S.jsx)(tp, { run: e }, e.id)) })
			}) : null,
			o.length ? /* @__PURE__ */ (0, S.jsx)(np, {
				title: "最近完成",
				children: /* @__PURE__ */ (0, S.jsx)(rp, { children: o.map((e) => /* @__PURE__ */ (0, S.jsx)(tp, { run: e }, e.id)) })
			}) : null
		] })
	] });
}
...
var ap = Symbol("default");
function op({ values: e, children: t }) {
...
function lp(e, t, n) {
	let { ref: r, ...i } = cp(n, e.slot) || {}, a = Fr((0, x.useMemo)(() => gr(t, r), [t, r])), o = V(i, e);
...
function fp(e, t, n) {
	let { render: r, ...i } = t, a = (0, x.useRef)(null), o = (0, x.useMemo)(() => gr(n, a), [n, a]);
	B(() => {}, [e, r]);
	let s = {
		...i,
		ref: o
...
var pp = {}, mp = new Proxy({}, { get(e, t) {
	if (typeof t != "string") return;
	let n = pp[t];
	return n || (n = /*#__PURE__*/ (0, x.forwardRef)(fp.bind(null, t)), pp[t] = n), n;
} }), hp = /*#__PURE__*/ (0, x.createContext)(null), gp = /*#__PURE__*/ (0, x.createContext)(null), _p = /*#__PURE__*/ (0, x.createContext)(null), vp = {
...
var xp = /*#__PURE__*/ (0, x.createContext)(vp);
function Sp(e) {
	return (0, x.useMemo)(() => e == null ? null : /* @__PURE__ */ new Set([e]), [e]);
}
//#endregion
//#region node_modules/react-aria-components/dist/private/Label.mjs
var Cp = /*#__PURE__*/ (0, x.createContext)({}), wp = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, Cp);
	let { elementType: n = "label", ...r } = e, i = mp[n];
	return /*#__PURE__*/ x.createElement(i, {
		className: "react-aria-Label",
		...r,
		ref: t
	});
}), Tp = /*#__PURE__*/ (0, x.createContext)(null), Ep = /*#__PURE__*/ (0, x.createContext)({}), Dp = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, Ep);
	let n = e, { isPending: r } = n, { buttonProps: i, isPressed: a } = Ca(e, t);
	i = kp(i, r);
	let { focusProps: o, isFocused: s, isFocusVisible: c } = _c(e), { hoverProps: l, isHovered: u } = wc({
		...e,
	...
	}), p = pr(i.id), m = pr(), h = i["aria-labelledby"];
	r && (h ? h = `${h} ${m}` : i["aria-label"] && (h = `${p} ${m}`));
	let g = (0, x.useRef)(r);
	(0, x.useEffect)(() => {
		let e = { "aria-labelledby": h || p };
		(!g.current && s && r || g.current && s && !r) && to(e, "assertive"), g.current = r;
	}, [
		r,
		s,
		h,
	...
	let _ = H(e, { global: !0 });
	return delete _.onClick, /*#__PURE__*/ x.createElement(mp.button, {
		...V(_, f, i, o, l),
	...
	}, /*#__PURE__*/ x.createElement(Tp.Provider, { value: { id: m } }, f.children));
}), Op = /Focus|Blur|Hover|Pointer(Enter|Leave|Over|Out)|Mouse(Enter|Leave|Over|Out)/;
function kp(e, t) {
	if (t) {
		for (let t in e) t.startsWith("on") && !Op.test(t) && (e[t] = void 0);
...
var Ap = /*#__PURE__*/ (0, x.createContext)({}), jp = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = lp(e, t, Ap);
	let { children: n, level: r = 3, className: i, ...a } = e, o = mp[`h${r}`];
	return /*#__PURE__*/ x.createElement(o, {
		...a,
		ref: t,
		className: i ?? "react-aria-Heading"
	}, n);
}), Mp = /*#__PURE__*/ (0, x.createContext)({}), Np = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, Mp);
	let { elementType: n = "span", ...r } = e, i = mp[n];
	return /*#__PURE__*/ x.createElement(i, {
		className: "react-aria-Text",
		...r,
		ref: t
	});
}), Pp = /*#__PURE__*/ (0, x.createContext)(null), Fp = /*#__PURE__*/ (0, x.createContext)(null), Ip = /*#__PURE__*/ (0, x.createContext)(null), Lp = /*#__PURE__*/ (0, x.createContext)(null), Rp = /*#__PURE__*/ (0, x.createContext)(null);
function zp(e, t) {
	let { validationBehavior: n } = cp(Fp) || {}, r = e.validationBehavior ?? n ?? "native", i = (0, x.useContext)(Lp), a = Fr((0, x.useMemo)(() => gr(t, e.inputRef === void 0 ? null : e.inputRef), [t, e.inputRef])), o = {
		...dp(e),
		children: typeof e.children == "function" || e.children,
		value: e.value,
		validationBehavior: r
	};
	return [i ? zo(o, i, a) : Mo(o, W(e), a), a];
}
var Bp = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { inputRef: n = null, ...r } = e;
	[e, t] = lp(r, t, Ip);
	let [i, a] = zp(e, n);
	return /*#__PURE__*/ x.createElement(Rp.Provider, { value: {
		...i,
		inputRef: a,
		defaultClassName: "react-aria-Checkbox",
		isIndeterminate: e.isIndeterminate,
		isRequired: e.isRequired
	} }, /*#__PURE__*/ x.createElement(Vp, {
		...e,
		ref: t
	}));
}), Vp = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { labelProps: n, inputProps: r, isSelected: i, isDisabled: a, isReadOnly: o, isPressed: s, isInvalid: c, inputRef: l, defaultClassName: u, isIndeterminate: d, isRequired: f } = (0, x.useContext)(Rp), { isFocused: p, isFocusVisible: m, focusProps: h } = _c(), g = a || o, { hoverProps: _, isHovered: v } = wc({
		...e,
		isDisabled: g
	}), y = sp({
		...e,
	...
	return delete b.id, delete b.onClick, /*#__PURE__*/ x.createElement(mp.label, {
		...V(b, n, _, y),
		ref: t,
		slot: e.slot || void 0,
	...
	}, /*#__PURE__*/ x.createElement(Uo, { elementType: "span" }, /*#__PURE__*/ x.createElement("input", {
		...V(r, h),
		ref: l
	})), y.children);
}), Hp = /*#__PURE__*/ (0, x.createContext)({}), Up = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = lp(e, t, Hp);
	...
	let { hoverProps: l, isHovered: u } = wc({
		onHoverStart: a,
		onHoverChange: o,
		onHoverEnd: s,
		isDisabled: n
	}), { isFocused: d, isFocusVisible: f, focusProps: p } = _c({ within: !0 }), m = sp({
		...e,
		values: {
			isHovered: u,
			isFocusWithin: d,
	...
	return /*#__PURE__*/ x.createElement(mp.div, {
		...V(c, p, l),
		...m,
		ref: t,
		role: e.role ?? "group",
...
}), Wp = /*#__PURE__*/ (0, x.createContext)({}), Gp = (e) => {
	let { onHoverStart: t, onHoverChange: n, onHoverEnd: r, ...i } = e;
	return i;
}, Kp = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, Wp);
	let { hoverProps: n, isHovered: r } = wc({
		...e,
		isDisabled: e.disabled
	}), { isFocused: i, isFocusVisible: a, focusProps: o } = _c({
		isTextInput: !0,
		autoFocus: e.autoFocus
	}), s = !!e["aria-invalid"] && e["aria-invalid"] !== "false", c = sp({
		...e,
		values: {
			isHovered: r,
			isFocused: i,
	...
	return /*#__PURE__*/ x.createElement(mp.input, {
		...V(Gp(e), o, n),
		...c,
		ref: t,
...
var Om = /*#__PURE__*/ (0, x.createContext)({}), km = /*#__PURE__*/ (0, x.createContext)(null), Am = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { render: n } = (0, x.useContext)(km);
...
function jm(e, t) {
	let n = e?.renderDropIndicator, r = e?.isVirtualDragging?.(), i = (0, x.useCallback)((e) => {
		if (r || t?.isDropTarget(e)) return n ? n(e) : /*#__PURE__*/ x.createElement(Am, { target: e });
	}, [
		t?.target,
		r,
		n
...
var Nm = /*#__PURE__*/ (0, x.createContext)({}), Pm = /*#__PURE__*/ (0, x.createContext)(null);
function Fm(e) {
	let t = (0, x.useRef)({});
	return /*#__PURE__*/ x.createElement(Pm.Provider, { value: t }, e.children);
}
//#endregion
//#region node_modules/react-aria-components/dist/private/SelectionIndicator.mjs
var Im = /*#__PURE__*/ (0, x.createContext)({ isSelected: !1 }), Lm = /*#__PURE__*/ (0, x.createContext)({});
(class extends ft {
	static {
		this.type = "separator";
	}
...
function Hm(e) {
	let { selectionMode: t = "none", disallowEmptySelection: n = !1, allowDuplicateSelectionEvents: r, selectionBehavior: i = "toggle", disabledBehavior: a = "all" } = e, o = (0, x.useRef)(!1), [, s] = (0, x.useState)(!1), c = (0, x.useRef)(null), l = (0, x.useRef)(null), [, u] = (0, x.useState)(null), [d, f] = Ro((0, x.useMemo)(() => Um(e.selectedKeys), [e.selectedKeys]), (0, x.useMemo)(() => Um(e.defaultSelectedKeys, new Bm()), [e.defaultSelectedKeys]), e.onSelectionChange), p = (0, x.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : /* @__PURE__ */ new Set(), [e.disabledKeys]), [m, h] = (0, x.useState)(i);
...
var Wm = class e {
	...
	get firstSelectedKey() {
		...
		for (let t of this.state.selectedKeys) {
			...
			(!e || n && rc(this.collection, n, e) < 0) && (e = n);
		}
		return e?.key ?? null;
	}
	get lastSelectedKey() {
	...
	getKeyRange(e, t) {
		...
		return n && r ? rc(this.collection, n, r) <= 0 ? this.getKeyRangeInternal(e, t) : this.getKeyRangeInternal(t, e) : [];
	}
		...
		let e = this.fullCollection ?? this.collection, t = [], n = (r) => {
			for (; r != null;) {
				if (this.canSelectItemIn(r, e)) {
					let i = e.getItem(r);
					i?.type === "item" && t.push(r), i?.hasChildNodes && (this.allowsCellSelection || i.type !== "item") && n(tc(ec(i, e))?.key ?? null);
				}
				r = e.getKeyAfter(r);
			}
		};
	...
	build(e, t) {
		return this.context = t, Km(() => this.iterateCollection(e));
	}
	*iterateCollection(e) {
		...
		if (x.isValidElement(i)) {
			...
			for (; !c.done && c.value;) {
				...
				let u = [...this.getFullNode({
					...
					key: l,
					index: s,
					wrapper: qm(e.wrapper, a.wrapper)
				}, this.getChildState(t, a), n ? `${n}${i.key}` : i.key, r)];
				for (let t of u) {
					if (t.value = a.value ?? e.value ?? null, t.value && this.cache.set(t.value, t), e.type && t.type !== e.type) throw Error(`Unsupported type <${Jm(t.type)}> in <${Jm(r?.type ?? "unknown parent type")}>. Only <${Jm(e.type)}> is supported.`);
					s++, yield t;
				}
				c = o.next(u);
			}
...
function Ym(e, t, n) {
	let r = (0, x.useMemo)(() => new Gm(), []), { children: i, items: a, collection: o } = e;
...
function Xm(e) {
	let { filter: t, layoutDelegate: n } = e, r = Hm(e), i = (0, x.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : /* @__PURE__ */ new Set(), [e.disabledKeys]), a = Ym(e, (0, x.useCallback)((e) => t ? new zm(t(e)) : new zm(e), [t]), (0, x.useMemo)(() => ({ suppressTextValueWarning: e.suppressTextValueWarning }), [e.suppressTextValueWarning])), o = (0, x.useMemo)(() => new Wm(a, r, { layoutDelegate: n }), [
		a,
		r,
		n
	]);
...
function $m(e, t) {
	let { collection: n, onLoadMore: r, scrollOffset: i = 1, direction: a = "end" } = e, o = (0, x.useRef)(null), s = xi((e) => {
...
var eh = /*#__PURE__*/ (0, x.createContext)(null), th = /*#__PURE__*/ (0, x.createContext)(null), nh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = lp(e, t, eh);
	let n = (0, x.useContext)(th);
	return n ? /*#__PURE__*/ x.createElement(ih, {
		state: n,
		props: e,
		listBoxRef: t
	}) : /*#__PURE__*/ x.createElement(Qr, { content: /*#__PURE__*/ x.createElement(li, e) }, (n) => /*#__PURE__*/ x.createElement(rh, {
		props: e,
		listBoxRef: t,
		collection: n
	}));
});
function rh({ props: e, listBoxRef: t, collection: n }) {
	e = {
		...e,
		collection: n,
		children: null,
	...
	let { layoutDelegate: r } = (0, x.useContext)(xp), i = Xm({
		...e,
		layoutDelegate: r
	});
...
function ih({ state: e, props: t, listBoxRef: n }) {
	[t, n] = lp(t, n, hp);
	let { dragAndDropHooks: r, layout: i = "stack", orientation: a = "vertical", filter: o } = t, s = Zm(e, o), { collection: c, selectionManager: l } = s, u = !!r?.useDraggableCollectionState, d = !!r?.useDroppableCollectionState, { direction: f } = Pi(), { disabledBehavior: p, disabledKeys: m } = l, h = cc({
		usage: "search",
		sensitivity: "base"
	}), { isVirtualized: g, layoutDelegate: _, dropTargetDelegate: v, CollectionRoot: y } = (0, x.useContext)(xp), b = (0, x.useMemo)(() => t.keyboardDelegate || new as({
		collection: c,
		collator: h,
		ref: n,
		disabledKeys: m,
	...
	let { focusProps: k, isFocused: A, isFocusVisible: ee } = _c(), j = s.collection.size === 0, te = {
		isDropTarget: E,
		isEmpty: j,
		isFocused: A,
		isFocusVisible: ee,
	...
	let N = H(t, { global: !0 });
	return /*#__PURE__*/ x.createElement(ka, null, /*#__PURE__*/ x.createElement(mp.div, {
		...
		"data-orientation": a
	}, /*#__PURE__*/ x.createElement(op, { values: [
		[eh, t],
		[th, s],
		[Om, {
			dragAndDropHooks: r,
	...
	] }, /*#__PURE__*/ x.createElement(Fm, null, /*#__PURE__*/ x.createElement(y, {
		collection: c,
		scrollRef: n,
		persistedKeys: Mm(l, r, w),
		renderDropIndicator: jm(r, w)
	}))), ne, D));
}
function ah(e, t, n, r = "react-aria-ListBoxSection") {
	let i = (0, x.useContext)(th), { dragAndDropHooks: a, dropState: o } = (0, x.useContext)(Om), { CollectionBranch: s } = (0, x.useContext)(xp), [c, l] = up(), { headingProps: u, groupProps: d } = Nc({
		heading: l,
	...
	return delete p.id, /*#__PURE__*/ x.createElement(mp.section, {
		...V(p, f, d),
		ref: t
	}, /*#__PURE__*/ x.createElement(Nm.Provider, { value: {
		...u,
		ref: c
	} }, /*#__PURE__*/ x.createElement(s, {
		collection: i.collection,
		parent: n,
		renderDropIndicator: jm(a, o)
	})));
}
var oh = /*#__PURE__*/ oi(ht, function(e, t, n) {
	let r = Fr(t), i = (0, x.useContext)(th), { dragAndDropHooks: a, dragState: o, dropState: s } = (0, x.useContext)(Om), c = o && !(o.isDisabled || o.selectionManager.isDisabled(n.key)), { optionProps: l, labelProps: u, descriptionProps: d, ...f } = Pc({
		key: n.key,
		"aria-label": e?.["aria-label"]
	}, i, r), { hoverProps: p, isHovered: m } = wc({
	...
	}), { keyboardProps: h } = Pr(e), { focusProps: g } = br(e), _ = null;
	...
	let y = o && o.isDragging(n.key), b = sp({
		...e,
		id: void 0,
		children: e.children,
	...
	let S = e.href ? mp.a : mp.div, C = H(e, { global: !0 });
	...
	}, /*#__PURE__*/ x.createElement(op, { values: [[Mp, { slots: {
		[ap]: u,
		label: u,
		description: d
	} }], [Im, { isSelected: f.isSelected }]] }, b.children));
});
function sh(e, t) {
	t = Fr(t);
	let { dragAndDropHooks: n, dropState: r } = (0, x.useContext)(Om), { dropIndicatorProps: i, isHidden: a, isDropTarget: o } = n.useDropIndicator(e, r, t);
	return a ? null : /*#__PURE__*/ x.createElement(lh, {
		...e,
...
function ch(e, t) {
	let { dropIndicatorProps: n, isDropTarget: r, ...i } = e, a = sp({
		...i,
		defaultClassName: "react-aria-DropIndicator",
		values: { isDropTarget: r }
	});
	return /*#__PURE__*/ x.createElement(x.Fragment, null, /*#__PURE__*/ x.createElement(mp.div, {
		...n,
		...a,
		role: "option",
		ref: t,
...
var lh = /*#__PURE__*/ (0, x.forwardRef)(ch);
oi(mt, function(e, t, n) {
	let r = (0, x.useContext)(th), { isLoading: i, onLoadMore: a, scrollOffset: o, ...s } = e, c = (0, x.useRef)(null);
	$m((0, x.useMemo)(() => ({
		onLoadMore: a,
	...
	})), i && l.children && /*#__PURE__*/ x.createElement(x.Fragment, null, /*#__PURE__*/ x.createElement(mp.div, {
...
var uh = /*#__PURE__*/ (0, x.createContext)({ placement: "bottom" });
//#endregion
//#region node_modules/react-stately/dist/private/overlays/useOverlayTriggerState.mjs
function dh(e) {
	let [t, n] = Ro(e.isOpen, e.defaultOpen || !1, e.onOpenChange), [r, i] = (0, x.useState)(null);
	return {
		isOpen: t,
		setOpen: n,
...
function fh(e, t = !0) {
	...
	}, [e, i]), mh(e, i, (0, x.useCallback)(() => r(!1), [])), i;
}
function ph(e, t) {
...
var hh = /*#__PURE__*/ (0, x.createContext)(null), gh = /*#__PURE__*/ (0, x.createContext)(null), _h = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = lp(e, t, hh);
	let n = (0, x.useContext)(bh), r = dh(e), i = e.isOpen != null || e.defaultOpen != null || !n ? r : n, a = ph(t, i.isOpen), o = e.isExiting || !e.shouldSkipAnimation && a || !1, s = Ur(), { direction: c } = Pi();
	if (s) {
		let t = e.children;
	...
	return i && !i.isOpen && !o ? null : /*#__PURE__*/ x.createElement(vh, {
		...e,
...
function vh({ state: e, isExiting: t, UNSTABLE_portalContainer: n, clearContexts: r, ...i }) {
	let a = (0, x.useRef)(null), o = (0, x.useRef)(null), s = (0, x.useContext)(gh), c = s && i.trigger === "SubmenuTrigger", { popoverProps: l, underlayProps: u, arrowProps: d, placement: f, triggerAnchorPoint: p } = ru({
		...i,
		offset: i.offset ?? 8,
		arrowRef: a,
		groupRef: c ? s : o
	}, e), m = i.popoverRef, h = fh(m, !!f), g = i.isEntering || !i.shouldSkipAnimation && h || !1, _ = sp({
		...i,
	...
	B(() => {
		...
		y && i.trigger !== "PreviewTrigger" && (i.trigger !== "SubmenuTrigger" || Xn() !== "pointer") && m.current && !zt(m.current) && or(m.current);
	}, [
		y,
		m,
		i.trigger
	...
	}, D = /*#__PURE__*/ x.createElement(mp.div, {
		...V(H(i, { global: !0 }), l),
		..._,
		id: y ? i.id : void 0,
	...
	}, !i.isNonModal && /*#__PURE__*/ x.createElement(yl, { onDismiss: e.close }), /*#__PURE__*/ x.createElement(uh.Provider, { value: {
		...d,
		placement: f,
		ref: a
	} }, S), /*#__PURE__*/ x.createElement(yl, { onDismiss: e.close }));
	return c ? /*#__PURE__*/ x.createElement(mc, {
		...i,
		shouldContainFocus: y && i.trigger !== "PreviewTrigger",
		isExiting: t,
		portalContainer: n ?? s?.current ?? void 0
	}, D) : /*#__PURE__*/ x.createElement(mc, {
		...i,
		shouldContainFocus: y && i.trigger !== "PreviewTrigger",
		isExiting: t,
		portalContainer: n
		...
		ref: o,
		style: { display: "contents" }
	}, /*#__PURE__*/ x.createElement(gh.Provider, { value: o }, D)));
}
//#endregion
//#region node_modules/react-aria-components/dist/private/Dialog.mjs
var yh = /*#__PURE__*/ (0, x.createContext)(null), bh = /*#__PURE__*/ (0, x.createContext)(null), xh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let n = e["aria-labelledby"];
	[e, t] = lp(e, t, yh);
	let { dialogProps: r, titleProps: i, contentProps: a } = gc({
		...e,
		"aria-labelledby": n
	}, t), o = (0, x.useContext)(bh);
	...
	return /*#__PURE__*/ x.createElement(mp.section, {
		...V(c, s, r),
		render: e.render,
		ref: t,
		slot: e.slot || void 0
...
}), Sh = typeof document < "u" && window.visualViewport;
function Ch() {
	let e = Mn(), [t, n] = (0, x.useState)(() => e ? {
		width: 0,
		height: 0
	} : wh());
	return (0, x.useEffect)(() => {
		let e = (e) => {
			...
			Sh && Sh.scale > 1 || yi(R(t)) && (r = requestAnimationFrame(() => {
				let t = Lt();
				(!t || !yi(t)) && e({
		...
		return e(wh()), sn() && ln() && window.addEventListener("blur", i, !0), Sh ? Sh.addEventListener("resize", t) : window.addEventListener("resize", t), () => {
			cancelAnimationFrame(r), sn() && ln() && window.removeEventListener("blur", i, !0), Sh ? Sh.removeEventListener("resize", t) : window.removeEventListener("resize", t);
		};
	}, []), t;
}
function wh() {
	return {
		width: Sh ? Math.min(Sh.width * Sh.scale, document.documentElement.clientWidth) : document.documentElement.clientWidth,
		height: Sh ? Sh.height * Sh.scale : document.documentElement.clientHeight
	};
}
//#endregion
//#region node_modules/react-aria-components/dist/private/Modal.mjs
var Th = /*#__PURE__*/ (0, x.createContext)(null), Eh = /*#__PURE__*/ (0, x.createContext)(null), Dh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	if ((0, x.useContext)(Eh)) return /*#__PURE__*/ x.createElement(jh, {
		...e,
		modalRef: t
	}, e.children);
	...
	return /*#__PURE__*/ x.createElement(kh, {
		isDismissable: n,
...
function Oh(e, t) {
	[e, t] = lp(e, t, Th);
	let n = (0, x.useContext)(bh), r = dh(e), i = e.isOpen != null || e.defaultOpen != null || !n ? r : n, a = Fr(t), o = (0, x.useRef)(null), s = ph(a, i.isOpen), c = ph(o, i.isOpen), l = s || c || e.isExiting || !1, u = Mn();
	return !i.isOpen && !l || u ? null : /*#__PURE__*/ x.createElement(Ah, {
		...e,
		state: i,
		isExiting: l,
		overlayRef: a,
...
var kh = /*#__PURE__*/ (0, x.forwardRef)(Oh);
function Ah({ UNSTABLE_portalContainer: e, ...t }) {
	let n = t.modalRef, { state: r } = t, { modalProps: i, underlayProps: a } = Al(t, r, n), o = fh(t.overlayRef) || t.isEntering || !1, s = sp({
		...t,
	...
	return /*#__PURE__*/ x.createElement(mc, {
		isExiting: t.isExiting,
		portalContainer: e
	}, /*#__PURE__*/ x.createElement(mp.div, {
		...V(H(t, { global: !0 }), a),
		...s,
		style: d,
		ref: t.overlayRef,
	...
	}, /*#__PURE__*/ x.createElement(op, { values: [[Eh, {
		modalProps: i,
		modalRef: n,
		isExiting: t.isExiting,
...
function jh(e) {
	let { modalProps: t, modalRef: n, isExiting: r, isDismissable: i } = (0, x.useContext)(Eh), a = (0, x.useContext)(bh), o = Fr((0, x.useMemo)(() => gr(e.modalRef, n), [e.modalRef, n])), s = fh(o), c = sp({
		...e,
	...
	}, i && /*#__PURE__*/ x.createElement(yl, { onDismiss: a.close }), c.children);
}
//#endregion
//#region node_modules/react-stately/dist/private/radio/useRadioGroupState.mjs
var Mh = Math.round(Math.random() * 1e10), Nh = 0;
function Ph(e) {
	let t = (0, x.useMemo)(() => e.name || `radio-group-${Mh}-${++Nh}`, [e.name]), [n, r] = Ro(e.value, e.defaultValue ?? null, e.onChange), [i] = (0, x.useState)(n), [a, o] = (0, x.useState)(null), s = To({
		...e,
		value: n
	}), c = (t) => {
...
var Fh = /*#__PURE__*/ (0, x.createContext)(null), Ih = /*#__PURE__*/ (0, x.createContext)(null), Lh = /*#__PURE__*/ (0, x.createContext)(null), Rh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = lp(e, t, Fh);
	let { validationBehavior: n } = cp(Fp) || {}, r = e.validationBehavior ?? n ?? "native", i = Ph({
		...e,
		validationBehavior: r
	}), [a, o] = up(!e["aria-label"] && !e["aria-labelledby"]), { radioGroupProps: s, labelProps: c, descriptionProps: l, errorMessageProps: u, ...d } = ou({
		...e,
		label: o,
		validationBehavior: r
	}, i), f = sp({
	...
	return /*#__PURE__*/ x.createElement(mp.div, {
		...
		[Pp, d]
	] }, /*#__PURE__*/ x.createElement(Fm, null, f.children)));
}), zh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { inputRef: n = null, ...r } = e;
	[e, t] = lp(r, t, Ih);
	let i = x.useContext(Lh), a = Fr((0, x.useMemo)(() => gr(n, e.inputRef === void 0 ? null : e.inputRef), [n, e.inputRef])), o = au({
		...dp(e),
		children: typeof e.children == "function" || e.children
	}, i, a);
	return /*#__PURE__*/ x.createElement(Bh.Provider, { value: {
		...o,
		inputRef: a,
		defaultClassName: "react-aria-Radio"
	} }, /*#__PURE__*/ x.createElement(Vh, {
		...e,
		ref: t
	}));
}), Bh = /*#__PURE__*/ (0, x.createContext)(null), Vh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { labelProps: n, inputProps: r, isSelected: i, isDisabled: a, isPressed: o, defaultClassName: s, inputRef: c } = (0, x.useContext)(Bh), l = x.useContext(Lh), { isFocused: u, isFocusVisible: d, focusProps: f } = _c(), p = a || l.isReadOnly, { hoverProps: m, isHovered: h } = wc({
		...e,
		isDisabled: p
	}), g = sp({
		...e,
	...
	return delete _.id, delete _.onClick, /*#__PURE__*/ x.createElement(mp.label, {
		...V(_, n, m, g),
		ref: t,
		"data-selected": i || void 0,
...
function Hh(e) {
	let { selectionMode: t = "single", shouldCloseOnSelect: n = t === "single" } = e, r = dh(e), [i, a] = (0, x.useState)(null), o = (0, x.useMemo)(() => e.defaultValue === void 0 ? t === "single" ? e.defaultSelectedKey ?? null : [] : e.defaultValue, [
		e.defaultValue,
		e.defaultSelectedKey,
		t
	]), [s, c] = Ro((0, x.useMemo)(() => e.value === void 0 ? t === "single" ? e.selectedKey : void 0 : e.value, [
		e.value,
		e.selectedKey,
		t
		...
		selectedKeys: (0, x.useMemo)(() => Uh(l), [l]),
		onSelectionChange: (e) => {
			if (e !== "all") {
				if (t === "single") {
	...
	}), f = d.selectionManager.firstSelectedKey, p = (0, x.useMemo)(() => [...d.selectionManager.selectedKeys].map((e) => d.collection.getItem(e)).filter((e) => e != null), [d.selectionManager.selectedKeys, d.collection]), m = To({
		...e,
...
var Gh = /*#__PURE__*/ (0, x.createContext)(null), Kh = /*#__PURE__*/ (0, x.createContext)(null), qh = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, Gh);
	...
	return /*#__PURE__*/ x.createElement(Qr, { content: o }, (n) => /*#__PURE__*/ x.createElement(Yh, {
		props: e,
		collection: n,
		selectRef: t
	}));
...
function Yh({ props: e, selectRef: t, collection: n }) {
	let { validationBehavior: r } = cp(Fp) || {}, i = e.validationBehavior ?? r ?? "native", a = Hh({
		...e,
		collection: n,
		children: void 0,
		validationBehavior: i
	}), { isFocusVisible: o, focusProps: s } = _c({ within: !0 }), c = (0, x.useRef)(null), [l, u] = up(!e["aria-label"] && !e["aria-labelledby"]), { labelProps: d, triggerProps: f, valueProps: p, menuProps: m, descriptionProps: h, errorMessageProps: g, hiddenSelectProps: _, ...v } = cu({
		...dp(e),
		label: u,
		validationBehavior: i
	}, a, c), y = (0, x.useMemo)(() => ({
	...
	return /*#__PURE__*/ x.createElement(op, { values: [
		[Gh, e],
		[Kh, a],
		[Xh, p],
		[Cp, {
	...
	}, b.children, /*#__PURE__*/ x.createElement(uu, {
		..._,
		autoComplete: e.autoComplete
	})));
}
var Xh = /*#__PURE__*/ (0, x.createContext)(null), Zh = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, Xh);
	let n = (0, x.useContext)(Kh), { placeholder: r } = cp(Gh), i = n.selectedItems.map((e) => {
	...
	}), a = vc(), o = (0, x.useMemo)(() => n.selectedItems.map((e) => e?.textValue), [n.selectedItems]), s = n.selectionManager.selectionMode, c = (0, x.useMemo)(() => s === "single" ? o[0] ?? "" : a.format(o), [
		s,
		a,
		o
	]), l = (0, x.useMemo)(() => {
		...
		o,
		i
	]), u = Ji(Wh(Dm), "react-aria-components"), d = sp({
		...e,
	...
	return /*#__PURE__*/ x.createElement(mp.span, {
		ref: t,
		...f,
		...d,
		"data-placeholder": n.selectedItems.length === 0 || void 0
	}, /*#__PURE__*/ x.createElement(Mp.Provider, { value: void 0 }, d.children));
}), Qh = /*#__PURE__*/ (0, x.createContext)(null), $h = /*#__PURE__*/ (0, x.createContext)(null), eg = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { inputRef: n = null, ...r } = e;
	[e, t] = lp(r, t, Qh);
	let i = Fr((0, x.useMemo)(() => gr(n, e.inputRef === void 0 ? null : e.inputRef), [n, e.inputRef])), a = W(e), o = du({
		...dp(e),
		children: typeof e.children == "function" || e.children
	}, a, i);
	return /*#__PURE__*/ x.createElement(op, { values: [[$h, a], [tg, {
		...o,
		inputRef: i,
...
}), tg = /*#__PURE__*/ (0, x.createContext)(null), ng = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { labelProps: n, inputProps: r, isSelected: i, isDisabled: a, isReadOnly: o, isPressed: s, isInvalid: c, inputRef: l, defaultClassName: u, isRequired: d } = (0, x.useContext)(tg), { isFocused: f, isFocusVisible: p, focusProps: m } = _c(), h = a || o, g = (0, x.useContext)($h), { hoverProps: _, isHovered: v } = wc({
		...e,
		isDisabled: h
	}), y = sp({
		...e,
...
function rg(e) {
	let [t, n] = Ro(e.selectedKey, e.defaultSelectedKey ?? null, e.onSelectionChange), r = (0, x.useMemo)(() => t == null ? [] : [t], [t]), { collection: i, disabledKeys: a, selectionManager: o } = Xm({
		...e,
		selectionMode: "single",
		disallowEmptySelection: !0,
		allowDuplicateSelectionEvents: !0,
...
function ig(e) {
	let t = rg({
		...
		defaultSelectedKey: e.defaultSelectedKey ?? ag(e.collection, e.disabledKeys ? new Set(e.disabledKeys) : /* @__PURE__ */ new Set()) ?? void 0
	}), { selectionManager: n, collection: r, selectedKey: i } = t, a = (0, x.useRef)(i);
	return (0, x.useEffect)(() => {
		let o = i;
		e.selectedKey == null && (n.isEmpty || o == null || !r.getItem(o)) && (o = ag(r, t.disabledKeys), o != null && n.setSelectedKeys([o])), (o != null && n.focusedKey == null || !n.isFocused && o !== a.current) && n.setFocusedKey(o), a.current = o;
	}), {
		...t,
		isDisabled: e.isDisabled || !1
	};
...
function ag(e, t) {
	...
	if (e) {
		...
		n != null && (t.has(n) || e.getItem(n)?.props?.isDisabled) && n === e.getLastKey() && (n = e.getFirstKey());
	}
	return n;
}
//#endregion
//#region node_modules/react-aria-components/dist/private/Tabs.mjs
var og = /*#__PURE__*/ (0, x.createContext)(null), sg = /*#__PURE__*/ (0, x.createContext)(null), cg = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = lp(e, t, og);
	let { children: n, orientation: r = "horizontal" } = e;
	return n = (0, x.useMemo)(() => typeof n == "function" ? n({
		orientation: r,
		defaultChildren: null
	}) : n, [n, r]), /*#__PURE__*/ x.createElement(Qr, { content: n }, (n) => /*#__PURE__*/ x.createElement(lg, {
		props: e,
		collection: n,
		tabsRef: t
	}));
});
function lg({ props: e, tabsRef: t, collection: n }) {
	let { orientation: r = "horizontal" } = e, i = ig({
		...e,
		collection: n,
		children: void 0
	}), { focusProps: a, isFocused: o, isFocusVisible: s } = _c({ within: !0 }), c = (0, x.useMemo)(() => ({
		orientation: r,
		isFocusWithin: o,
		isFocusVisible: s
	}), [
	...
	return /*#__PURE__*/ x.createElement(mp.div, {
		...
		"data-disabled": i.isDisabled || void 0
	}, /*#__PURE__*/ x.createElement(op, { values: [[og, e], [sg, i]] }, l.children));
}
var ug = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	return (0, x.useContext)(sg) ? /*#__PURE__*/ x.createElement(dg, {
		props: e,
		forwardedRef: t
	}) : /*#__PURE__*/ x.createElement(li, e);
});
function dg({ props: e, forwardedRef: t }) {
	let n = (0, x.useContext)(sg), { CollectionRoot: r } = (0, x.useContext)(xp), { orientation: i = "horizontal", keyboardActivation: a = "automatic" } = cp(og), o = Fr(t), { tabListProps: s } = gu({
		...e,
		orientation: i,
	...
	return delete l.id, /*#__PURE__*/ x.createElement(mp.div, {
		...V(l, c, s),
		ref: o,
		"data-orientation": i || void 0
	}, /*#__PURE__*/ x.createElement(Fm, null, /*#__PURE__*/ x.createElement(r, {
		collection: n.collection,
		persistedKeys: Sp(n.selectionManager.focusedKey)
	})));
}
var fg = /*#__PURE__*/ oi(class extends ft {
	static {
		this.type = "item";
	}
}, (e, t, n) => {
	let r = (0, x.useContext)(sg), i = Fr(t), { tabProps: a, isSelected: o, isDisabled: s, isPressed: c } = mu({
		key: n.key,
		...e
	}, r, i), { focusProps: l, isFocused: u, isFocusVisible: d } = _c(), { hoverProps: f, isHovered: p } = wc({
		isDisabled: s,
	...
	}), h = n.props.href ? mp.a : mp.div, g = H(e, { global: !0 });
	return delete g.id, delete g.onClick, /*#__PURE__*/ x.createElement(h, {
		...V(g, m, a, l, f),
		ref: i,
	...
	}, /*#__PURE__*/ x.createElement(Im.Provider, { value: { isSelected: o } }, m.children));
}), pg = /*#__PURE__*/ Hr(function(e, t) {
	let n = (0, x.useContext)(sg), r = Fr(t), i = n.selectedKey === e.id, [a, o] = (0, x.useState)(n.selectedKey == null ? null : i);
	a == null && n.selectedKey != null ? o(i) : !i && a && o(!1);
	let s = ph(r, i);
	return !i && !e.shouldForceMount && !s ? null : /*#__PURE__*/ x.createElement(mg, {
		...e,
		tabPanelRef: r,
...
function mg(e) {
	let t = (0, x.useContext)(sg), { id: n, tabPanelRef: r, isInitiallySelected: i, isExiting: a, ...o } = e, { tabPanelProps: s } = _u(e, t, r), { focusProps: c, isFocused: l, isFocusVisible: u } = _c(), d = t.selectedKey === e.id, f = fh(r) && !i, p = sp({
		...e,
	...
	}, /*#__PURE__*/ x.createElement(op, { values: [[og, null], [sg, null]] }, /*#__PURE__*/ x.createElement(xp.Provider, { value: vp }, p.children)));
}
//#endregion
//#region node_modules/react-aria-components/dist/private/TextArea.mjs
var hg = /*#__PURE__*/ (0, x.createContext)({}), gg = /*#__PURE__*/ (0, x.createContext)(null), _g = /*#__PURE__*/ Hr(function(e, t) {
	[e, t] = lp(e, t, gg);
	let { validationBehavior: n } = cp(Fp) || {}, r = e.validationBehavior ?? n ?? "native", i = (0, x.useRef)(null);
	[e, i] = lp(e, i, gp);
	let [a, o] = up(!e["aria-label"] && !e["aria-labelledby"]), [s, c] = (0, x.useState)("input"), { labelProps: l, inputProps: u, descriptionProps: d, errorMessageProps: f, ...p } = Wo({
		...dp(e),
		inputElementType: s,
		label: o,
		validationBehavior: r
	...
	return delete g.id, /*#__PURE__*/ x.createElement(mp.div, {
		...g,
		...h,
		ref: t,
		slot: e.slot || void 0,
...
function $({ variant: e = "primary", size: t = "medium", iconOnly: n = !1, leadingIcon: r, trailingIcon: i, children: a, className: o, type: s = "button", ref: c, ...l }) {
	return /* @__PURE__ */ (0, S.jsxs)("button", {
		ref: c,
		type: s,
		className: Z(vg.base, vg.size[t], vg.variant[e], n && vg.iconOnlySize[t], o),
		...l,
		children: [
...
function bg({ icon: e, size: t = "medium", className: n, type: r = "button", ref: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsx)("button", {
		ref: i,
		type: r,
		className: Z(yg.base, yg.size[t], n),
		...a,
...
function xg({ isRequired: e = !1, isInvalid: t, tooltip: n, className: r, children: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsxs)(wp, {
		"data-label": "true",
		...a,
		className: Z("flex cursor-default items-center gap-0.5", "text-body-medium text-text-primary", r),
		children: [
			i,
...
function Sg({ isInvalid: e = !1, className: t, ...n }) {
	return /* @__PURE__ */ (0, S.jsx)(Np, {
		slot: e ? "errorMessage" : "description",
		...n,
		className: Z("pt-px text-caption-1-medium text-text-secondary", e && "text-text-error-primary", t)
	});
}
//#endregion
//#region src/react/boardui/components/base/input/input.tsx
var Cg = (0, x.createContext)({});
function wg({ size: e = "medium", fieldClassName: t, inputClassName: n, className: r, children: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsx)(Cg.Provider, {
		value: {
			size: e,
			fieldClassName: t,
			inputClassName: n
		},
		children: /* @__PURE__ */ (0, S.jsx)(_g, {
			...a,
			"data-input-size": e,
			className: Z("group flex h-max w-full flex-col items-start gap-1", r),
			children: i
		})
	});
}
wg.displayName = "TextField";
var Tg = wf({
	field: [
...
function Eg({ size: e, leadingIcon: t, trailingIcon: n, leadingAddon: r, fieldClassName: i, className: a, ref: o, groupRef: s, ...c }) {
	let l = (0, x.useContext)(Cg), u = e ?? l.size ?? "medium", d = r != null;
	return /* @__PURE__ */ (0, S.jsx)(Up, {
		ref: s,
		className: ({ isFocusWithin: e, isHovered: t, isDisabled: n, isInvalid: r }) => Z(Tg.field, d ? Tg.fieldWithAddonSize[u] : Tg.fieldSize[u], t && !e && !n && !r && "ring-border-button-hover", e && !n && !r && "ring-border-button-active", n && "bg-input-disabled-background text-input-disabled-foreground", r && "bg-background-tertiary-error text-foreground-icon-error", l.fieldClassName, i),
		children: /* @__PURE__ */ (0, S.jsxs)("div", {
			className: Tg.content,
			children: [/* @__PURE__ */ (0, S.jsxs)("div", {
				className: Tg.leftSection,
				children: [d ? r : t ? /* @__PURE__ */ (0, S.jsx)(t, {
					className: Tg.icon,
					"aria-hidden": !0
				}) : null, /* @__PURE__ */ (0, S.jsx)(Kp, {
					ref: o,
					...c,
					className: Z(Tg.input, l.inputClassName, a)
				})]
...
Eg.displayName = "InputBase";
function Dg({ label: e, hint: t, tooltip: n, placeholder: r, leadingIcon: i, trailingIcon: a, leadingAddon: o, fieldClassName: s, ref: c, groupRef: l, className: u, ...d }) {
	return /* @__PURE__ */ (0, S.jsx)(wg, {
		...d,
		className: u,
...
var Ag = "/api/avatar-choices", jg = "/api/avatar-pick", Mg = "/avatar-choice", Ng = (e, t) => [
	"avatar-choices",
	e,
	t
], Pg = (e, t) => `?kind=${encodeURIComponent(e)}&id=${t}`, Fg = (e, t, n) => `${Mg}${Pg(e, t)}&ref=${encodeURIComponent(n)}`, Ig = (e, t, n) => Af(Ag + Pg(e, t), n);
async function Lg(e, t, n) {
	...
	let r = n.file, i = await fetch(`${jg}${Pg(e, t)}&name=${encodeURIComponent(r.name)}`, {
		method: "POST",
		credentials: "same-origin",
		body: r
	});
	...
	throw new Df(a?.error || `请求失败（${i.status}）`, i.status, a);
}
function Rg(e, t) {
	if (!t) return "正在找可用的图…";
...
var zg = (e) => !!e && e.index_stale && !e.choices.some((e) => e.source === "gfriends"), Bg = {
	gfriends: "图库",
	history: "用过的"
}, Vg = (e) => `${Bg[e.source] || e.source} · ${e.label}` + (e.width ? ` · ${e.width}×${e.height}` : "") + (e.found_by ? ` · 按「${e.found_by}」找到` : "");
//#endregion
//#region src/react/avatar-picker/avatar-picker-page.tsx
function Hg({ kind: e, entityId: t, name: n, onPicked: r }) {
	let [i, a] = (0, x.useState)(!1);
	return /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)("span", {
		className: "absolute right-1 bottom-1",
		children: /* @__PURE__ */ (0, S.jsx)(bg, {
			icon: Su,
			size: "small",
		...
		children: /* @__PURE__ */ (0, S.jsx)(Dh, {
			...
			children: /* @__PURE__ */ (0, S.jsx)(xh, {
				"aria-label": "更换头像",
				className: "flex min-h-0 flex-col outline-none",
				children: /* @__PURE__ */ (0, S.jsx)(Ug, {
					kind: e,
					entityId: t,
					name: n,
					onPicked: r,
...
function Ug({ kind: e, entityId: t, name: n, onPicked: r, close: i }) {
	let a = (0, x.useRef)(null), [o, s] = (0, x.useState)(""), [c, l] = (0, x.useState)(""), u = Ng(e, t), d = (0, x.useRef)(!1), f = ut({
		queryKey: u,
		queryFn: ({ signal: n }) => Ig(e, t, n),
		retryOnMount: !0
	});
	(0, x.useEffect)(() => () => {
		d.current && Lf.removeQueries({ queryKey: Ng(e, t) });
	}, [e, t]);
	let p = dt({
		mutationFn: (n) => Lg(e, t, n),
		onSuccess: () => {
			d.current = !0, i(), r();
		}
	});
	...
	let h = f.data, g = h?.choices ?? [], _ = c || (p.error ? kf(p.error) : "") || (f.error ? kf(f.error) : "");
		...
		/* @__PURE__ */ (0, S.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, S.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, S.jsx)(Uu, { className: "size-6" })
				}),
				/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, S.jsxs)("div", {
							className: "flex flex-wrap items-center gap-2",
							children: [/* @__PURE__ */ (0, S.jsx)(jp, {
								slot: "title",
								className: "text-title-3-semibold text-text-primary",
								children: "更换头像"
							}), g.length ? /* @__PURE__ */ (0, S.jsxs)(Ef, {
								color: "soft",
						...
						zg(h) ? /* @__PURE__ */ (0, S.jsx)(Pf, {
							tone: "neutral",
							children: "图库索引还没取过，只能从用过的图里选。"
						}) : null,
						_ ? /* @__PURE__ */ (0, S.jsx)(Pf, {
							tone: "error",
							children: _
						}) : null
					]
...
var Wg = "/api/library-processing", Gg = ["library-processing"], Kg = (e) => Af(Wg, e);
async function qg(e) {
	await Lf.fetchQuery({
		queryKey: Gg,
		queryFn: () => Kg(e)
...
var Jg = 2e3, Yg = 1e4, Xg = "连接中断，正在重新读取处理进度";
function Zg(e, t) {
	return e?.status === "running" ? Jg : t ? Yg : !1;
}
var Qg = {
...
function e_(e) {
	let t = Object.entries(e).filter(([e, t]) => $g[e] && t > 0).map(([e, t]) => `${$g[e]} ${t} 部`);
	return t.length ? `外部来源${t.join("、")}，7 天内不再问。` : "";
}
function t_(e) {
	let t = Qg[e.current_action || ""] || e.stage || "正在处理", n = e.waited_seconds ? ` · 已等待 ${e.waited_seconds} 秒` : "";
...
var r_ = "peach.library-processing.announced", i_ = 120;
function a_(e, t, n) {
	if (e.status !== "complete") return;
	let r = !!e.job_id && !!e.completed_at && Date.now() / 1e3 - e.completed_at < i_;
	if (!(!n && !r)) {
		try {
			if (e.job_id && localStorage.getItem(r_) === e.job_id) return;
			e.job_id && localStorage.setItem(r_, e.job_id);
		} catch {}
...
function s_({ variant: e = "primary", size: t = "medium", leadingIcon: n, trailingIcon: r, children: i, className: a, disabled: o = !1, ...s }) {
	let c = Z(o_.base, o_.size[t], o_.variant[e], a), l = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [
		n ? /* @__PURE__ */ (0, S.jsx)(n, {
			className: o_.icon[t],
			"aria-hidden": !0
		}) : null,
...
].join(" "), l_ = "w-[266px]", u_ = "flex w-full flex-col gap-1 outline-none", d_ = ["flex w-full cursor-pointer items-center gap-2 rounded-2lg p-2 text-left", "text-text-primary outline-none transition-colors"].join(" "), f_ = "hover:bg-dropdown-item-hover-background focus-visible:bg-dropdown-item-hover-background";
//#endregion
//#region src/react/boardui/components/application/settings/settings-rows.tsx
function p_({ className: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsx)("div", {
		className: Z("flex w-full flex-col rounded-2xl bg-background-secondary-default pl-3", e),
		children: t
	});
}
function m_({ className: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsx)("p", {
		className: Z("w-full px-3 text-body-2-medium text-text-secondary", e),
		children: t
	});
}
function h_({ label: e, description: t, children: n }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: Z("flex min-h-[52px] w-full items-center justify-between gap-4 py-2.5 pr-2.5", "border-b border-separator-border last:border-b-0"),
		children: [/* @__PURE__ */ (0, S.jsxs)("div", {
...
function g_({ title: e, id: t, aside: n, onSubmit: r, children: i }) {
	let a = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [n ? /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex w-full flex-wrap items-center justify-between gap-2",
		children: [/* @__PURE__ */ (0, S.jsx)("div", {
			className: "min-w-0 flex-1",
			children: /* @__PURE__ */ (0, S.jsx)(m_, { children: e })
		}), n]
	}) : /* @__PURE__ */ (0, S.jsx)(m_, { children: e }), /* @__PURE__ */ (0, S.jsx)(p_, { children: i })] });
...
function v_({ divided: e = !1, children: t }) {
...
function y_({ status: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
...
function C_({ href: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsx)(s_, {
		href: e,
		target: "_blank",
...
function E_({ summary: e, defaultOpen: t = !1, children: n }) {
	let r = (0, x.useId)(), i = (0, x.useRef)(null), a = (0, x.useRef)(null), o = (0, x.useRef)(!1), [c, l] = (0, x.useState)(t);
	return /* @__PURE__ */ (0, S.jsxs)("details", {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)("summary", {
			...
			"aria-controls": r,
			onClick: (e) => {
				e.preventDefault(), !(!i.current || !a.current) && (s(i.current, a.current, !c), l(!c));
			},
			...
			children: [/* @__PURE__ */ (0, S.jsx)(Tu, {
				"aria-hidden": !0,
				className: c ? "size-4 shrink-0 rotate-90 transition-transform" : "size-4 shrink-0 transition-transform"
			}), e]
		}), /* @__PURE__ */ (0, S.jsx)("div", {
			ref: a,
			id: r,
...
function O_({ mark: e }) {
	...
	}) : /* @__PURE__ */ (0, S.jsx)(D_, { name: e });
}
//#endregion
//#region src/react/library-processing/use-library-processing.ts
function k_({ toast: e, mode: t, monitor: n }) {
	let r = t === "notice" || !!n, i = ut({
		queryKey: Gg,
		queryFn: ({ signal: e }) => Kg(e),
		refetchInterval: (e) => Zg(e.state.data, r)
...
}], j_ = Z(d_, f_, "text-body-2-medium"), M_ = "扫描媒体文件夹，导入已有资料，采集缺失信息。两段也可以分开跑：新盘刚接上时先只扫描，几万个文件登记完就能用；采集被网络拖住时只重跑采集，不必再扫一遍磁盘。", N_ = "这个项目处理时间较长，暂时没有新进展。可以继续等待，或在任务结束后重试未完成项。", P_ = (e) => `已扫描 ${e.scanned || 0} 个文件，识别 ${e.identified || 0} 个番号，整理 ${e.candidates || 0} 组资料候选。`;
function F_({ busy: e, onRun: t }) {
	...
	return /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsxs)("span", {
		...
		children: /* @__PURE__ */ (0, S.jsx)(xh, {
			...
			children: A_.map(({ label: e, icon: t, command: n }) => /* @__PURE__ */ (0, S.jsxs)("button", {
				type: "button",
				className: j_,
				onClick: () => a(n),
...
function I_({ state: e, problem: t, settled: n, onRetry: r }) {
	let i = n_(e), a = e.status === "failed" && !!e.retryable_asset_ids?.length, o = e_(e.notes || {});
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		"aria-live": "polite",
		className: "flex flex-col gap-4 empty:hidden",
		children: [
			e.status === "running" && e.stalled ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				tone: "warning",
				title: "处理较慢",
				children: N_
			}) : null,
			t || e.status === "failed" ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				tone: "error",
				extra: /* @__PURE__ */ (0, S.jsxs)("div", {
					className: "flex flex-col items-start gap-3 pt-1",
					children: [a ? /* @__PURE__ */ (0, S.jsx)($, {
						variant: "secondary",
						size: "small",
						onClick: r,
						children: "重试未完成项"
					}) : null, i ? /* @__PURE__ */ (0, S.jsxs)(E_, {
						summary: i.label,
			...
			n?.status === "complete" ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				tone: "success",
				title: "处理完成",
				children: P_(n)
			}) : null,
			e.status !== "running" && o ? /* @__PURE__ */ (0, S.jsxs)(Pf, {
				tone: "neutral",
...
function L_(e) {
	let { toast: t, onComplete: n } = e, { job: r, settled: i, forget: a } = k_(e), o = dt({
		mutationFn: (e) => jf(Wg, e),
		onSuccess: (e) => {
			a(), Lf.setQueryData(Gg, e), Lf.invalidateQueries({ queryKey: Gg });
		}
	});
	(0, x.useEffect)(() => {
		i && n?.();
	}, [i, n]);
	let s = r.data ?? { status: "idle" }, c = o.error ? kf(o.error) : r.isError ? r.data ? Xg : kf(r.error) : "", l = o.isPending || s.status === "running", u = s.status === "failed" && !!s.retryable_asset_ids?.length, d = t_(s), f = (e) => {
		l || (o.reset(), o.mutate(e));
	};
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-4",
		children: [/* @__PURE__ */ (0, S.jsxs)(g_, {
			title: "扫描与采集",
			children: [/* @__PURE__ */ (0, S.jsxs)(v_, { children: [/* @__PURE__ */ (0, S.jsx)("p", {
				className: "text-body-2-regular text-text-secondary",
				children: M_
			}), s.status === "running" ? /* @__PURE__ */ (0, S.jsx)("div", {
				className: "flex flex-col gap-1.5",
				children: s.total ? /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(If, {
					label: d,
					value: s.checked || 0,
					max: s.total
				}), /* @__PURE__ */ (0, S.jsxs)("p", {
				...
				})] }) : /* @__PURE__ */ (0, S.jsx)(Nf, { label: d })
			}) : null] }), /* @__PURE__ */ (0, S.jsxs)(y_, { children: [
				/* @__PURE__ */ (0, S.jsx)(s_, {
					href: "/scraping",
					size: "small",
					trailingIcon: wu,
				...
				s.candidates ? /* @__PURE__ */ (0, S.jsx)(s_, {
					href: "/review",
					size: "small",
					trailingIcon: wu,
					children: "复核资料"
				}) : null,
				u ? null : /* @__PURE__ */ (0, S.jsx)(F_, {
					busy: l,
					onRun: f
				})
			] })]
...
function B_(e) {
	let { job: t } = k_(e), n = t.data, r = t.isError ? n ? Xg : kf(t.error) : "", i = n?.status ?? "idle", a = i === "failed", o = i === "running";
	if (!r && !o && !a) return null;
	let s = a ? "error" : r || n?.stalled ? "warning" : "gray", c = n?.checked || 0, l = n?.total || 0, u = r || (a ? "扫描与资料采集未完成" : t_(n) + (l ? ` · ${c} / ${l}` : "")), d = s === "gray" ? Lu : Au;
	return /* @__PURE__ */ (0, S.jsxs)("aside", {
		role: a ? "alert" : "status",
		className: R_[s],
		children: [/* @__PURE__ */ (0, S.jsxs)("div", {
			className: "flex min-w-0 items-center gap-3",
			children: [o && l ? /* @__PURE__ */ (0, S.jsx)(z_, {
				value: c,
				max: l
			}) : /* @__PURE__ */ (0, S.jsx)(d, {
				"aria-hidden": !0,
...
var V_ = "/api/quality-goals?limit=200", H_ = ["quality-goals"], U_ = (e) => Af(V_, e);
async function W_(e) {
	await Lf.fetchQuery({
		queryKey: H_,
		queryFn: () => U_(e)
...
var G_ = (e) => e.has_cover ? `/cover?code=${encodeURIComponent(e.code ?? "")}` : `/poster?id=${e.id}&c=4`;
//#endregion
//#region src/react/quality-goals/quality-goals-page.tsx
function K_({ item: r, openItem: i, javTitleHtml: a, javDisplayName: o, srcBadge: s }) {
	let c = () => i(r.id);
	return /* @__PURE__ */ (0, S.jsxs)("li", {
		"data-goal-id": r.id,
...
function q_(e) {
	let t = ut({
		queryKey: H_,
		queryFn: ({ signal: e }) => U_(e)
	}), n = t.data;
	if (!n) return /* @__PURE__ */ (0, S.jsx)(Ff, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
		tone: "error",
		title: "读取失败",
		children: t.error ? kf(t.error) : "读取高清版目标失败"
	}) });
	let r = n.items || [];
	return r.length ? /* @__PURE__ */ (0, S.jsxs)(Ff, { children: [/* @__PURE__ */ (0, S.jsxs)("p", {
		className: "text-body-2-regular text-text-secondary",
		children: [
		...
		children: r.map((t) => /* @__PURE__ */ (0, S.jsx)(K_, {
			item: t,
			...e
		}, t.id))
	})] }) : /* @__PURE__ */ (0, S.jsx)(Ff, { children: /* @__PURE__ */ (0, S.jsx)(Mf, {
		icon: Gu,
		title: "没有标记中的高清版目标",
...
var Z_ = (0, x.createContext)("md");
function Q_({ className: e, triggerClassName: t, popoverClassName: n, size: r = "md", children: i, items: a, renderValue: o, ref: s, ...c }) {
	...
	return /* @__PURE__ */ (0, S.jsx)(qh, {
		...
		className: Z("group flex flex-col", e),
		children: ({ isOpen: e }) => /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsxs)(Dp, {
			ref: l,
			className: Z("flex w-full cursor-pointer items-center justify-between rounded-2lg", "border border-border-button-default bg-background-primary-default shadow-xs", "text-text-primary", "transition-[background-color,border-color,box-shadow,padding,font-size] duration-200 ease", "hover:bg-background-primary-hover hover:border-border-button-hover", "outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-border-focus-ring", "disabled:cursor-not-allowed disabled:bg-background-primary-disabled disabled:text-text-tertiary disabled:shadow-none", r === "sm" ? "gap-1 px-[7px] py-1 text-body-2-medium" : "gap-1.5 px-2.5 py-2 text-body-medium", t),
			children: [/* @__PURE__ */ (0, S.jsx)(Zh, {
				className: Z("flex min-w-0 items-center truncate", r === "sm" ? "gap-1" : "gap-[5px]"),
				children: o
			}), /* @__PURE__ */ (0, S.jsx)(J_, { className: Z("shrink-0 text-text-secondary transition-transform duration-200 ease", r === "sm" ? "size-3.5" : "size-4", e && "rotate-180") })]
		}), /* @__PURE__ */ (0, S.jsx)(_h, {
			ref: u,
			isNonModal: !0,
			offset: 4,
			className: Z(l_, c_, "p-2", n),
			children: /* @__PURE__ */ (0, S.jsx)(nh, {
				items: a,
				className: Z(u_, "max-h-[240px] overflow-auto"),
				children: /* @__PURE__ */ (0, S.jsx)(Z_.Provider, {
					value: r,
					children: i
				})
			})
...
function $_({ className: e, children: t, ...n }) {
	let r = (0, x.useContext)(Z_);
	return /* @__PURE__ */ (0, S.jsx)(oh, {
		...n,
		className: (t) => Z(d_, r === "sm" ? "px-2 py-1.5 text-body-2-medium" : "text-body-medium", (t.isFocused || t.isSelected) && "bg-dropdown-item-hover-background", t.isDisabled && "cursor-not-allowed text-text-disabled", typeof e == "function" ? e(t) : e),
		children: t
	});
}
//#endregion
//#region src/react/scraping/scraping.ts
var ev = "/api/scraping", tv = "/api/scraping/settings", nv = "/api/scraping/check", rv = "/api/scraping/cover", iv = ["scraping"], av = ["scraping", "cover"], ov = 2e3, sv = (e) => Af(ev, e), cv = (e) => Af(rv, e);
async function lv(e) {
	await Promise.all([Lf.fetchQuery({
		queryKey: iv,
		queryFn: () => sv(e)
	}), Lf.fetchQuery({
		queryKey: av,
...
var dv = [["peach", "Peach 代理"], ["direct", "直接连接"]], fv = [["paste", "粘贴 Cookie"], ["file", "导入文件"]];
function pv({ source: e }) {
...
function mv({ source: e, toast: t }) {
	let [n, r] = (0, x.useState)(e.network), [i, a] = (0, x.useState)(""), [o, s] = (0, x.useState)(""), [c, l] = (0, x.useState)(fv[0][0]), [u, d] = (0, x.useState)(""), [f, p] = (0, x.useState)(""), m = (0, x.useRef)(null);
	function h() {
	...
	let g = dt({
		...
		onSuccess: (e, n) => {
			Lf.setQueryData(iv, (t) => t && {
				...t,
				sources: t.sources.map((t) => t.source === e.saved.source ? e.saved : t)
			}), h(), t(n ? "Cookie 已撤销" : "来源设置已保存");
		}
	}), _ = dt({ mutationFn: () => jf(nv, { source: e.source }) }), v = g.isPending || _.isPending, y = (e) => {
	...
	let T = f || (g.error ? kf(g.error) : "") || (_.error ? kf(_.error) : ""), E = _.data?.results ?? [], D = n === "peach" || e.accepts_cookie || !!T || E.length > 0;
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		title: e.label,
		onSubmit: y,
		aside: /* @__PURE__ */ (0, S.jsxs)("span", {
			className: "flex min-w-0 items-center gap-1",
			children: [/* @__PURE__ */ (0, S.jsx)(pv, { source: e.source }), /* @__PURE__ */ (0, S.jsx)(C_, {
				href: e.login,
				children: e.login
			})]
		}),
		children: [
			/* @__PURE__ */ (0, S.jsx)(__, { children: /* @__PURE__ */ (0, S.jsx)(h_, {
				label: "连接方式",
				children: /* @__PURE__ */ (0, S.jsx)(Q_, {
					"aria-label": "连接方式",
					selectedKey: n,
					onSelectionChange: (e) => {
						e !== null && r(String(e));
					},
					children: dv.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)($_, {
						id: e,
						children: t
					}, e))
				})
			}) }),
			D ? /* @__PURE__ */ (0, S.jsxs)(v_, {
				divided: !0,
				children: [
					...
					e.accepts_cookie ? /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [
						...
						/* @__PURE__ */ (0, S.jsx)(Rh, {
							...
							children: fv.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(zh, {
								value: e,
						...
						c === "paste" ? /* @__PURE__ */ (0, S.jsx)(Dg, {
							...
							children: [
								/* @__PURE__ */ (0, S.jsx)(S_, { children: "Netscape Cookie 文件（.txt）" }),
								/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					T ? /* @__PURE__ */ (0, S.jsx)(x_, { children: T }) : null,
					E.map((t) => /* @__PURE__ */ (0, S.jsx)(Pf, {
						tone: t.ok ? "success" : "error",
						children: uv(t, e.label)
					}, t.label))
				]
			}) : null,
			/* @__PURE__ */ (0, S.jsxs)(y_, { children: [
				e.accepts_cookie && e.cookie_saved ? /* @__PURE__ */ (0, S.jsx)($, {
					variant: "secondary",
					onClick: b,
					...kg(v),
					children: "撤销 Cookie"
...
function hv({ toast: e }) {
	let [t, n] = (0, x.useState)(""), [r, i] = (0, x.useState)(!1), [a, o] = (0, x.useState)(null), s = ut({
		queryKey: av,
		queryFn: ({ signal: e }) => cv(e),
		refetchInterval: (e) => e.state.data?.status === "running" && ov
	}), c = dt({
		mutationFn: () => jf(rv, { code: t }),
		onSuccess: () => {
			i(!0), o(null), Lf.invalidateQueries({ queryKey: av });
		}
	...
	}, d = c.error ? kf(c.error) : a?.status === "failed" ? a.error || "采集未取得" : "";
	return /* @__PURE__ */ (0, S.jsx)(g_, {
		title: "高清封面",
		onSubmit: u,
		children: /* @__PURE__ */ (0, S.jsxs)(v_, { children: [
			/* @__PURE__ */ (0, S.jsxs)("div", {
			...
			l ? /* @__PURE__ */ (0, S.jsx)(Nf, { label: "正在抓取封面" }) : null,
			d ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				tone: "error",
				children: d
			}) : null,
			a?.status === "complete" ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				tone: "success",
...
function gv({ toast: e }) {
	let t = ut({
		queryKey: iv,
		queryFn: ({ signal: e }) => sv(e)
	}), n = t.data;
	return n ? /* @__PURE__ */ (0, S.jsxs)(Ff, { children: [
		/* @__PURE__ */ (0, S.jsx)("p", {
			className: "text-body-2-regular text-text-secondary",
			children: "高清图片可能需要代理才能下载，请先检查连接。"
		}),
		/* @__PURE__ */ (0, S.jsx)(hv, { toast: e }),
		(n.sources || []).map((t) => /* @__PURE__ */ (0, S.jsx)(mv, {
			source: t,
			toast: e
		}, t.source))
	] }) : /* @__PURE__ */ (0, S.jsx)(Ff, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
		tone: "error",
		title: "读取失败",
		children: t.error ? kf(t.error) : "读取采集来源失败"
	}) });
}
//#endregion
//#region src/configuration-endpoints.ts
var _v = "/api/configuration", vv = "/api/pick-folder", yv = ["configuration"], bv = (e) => Af(_v, e);
async function xv(e) {
	await Lf.fetchQuery({
		queryKey: yv,
		queryFn: () => bv(e)
...
function Cv({ state: e, size: t = "md", shape: n = "pill" }) {
	let r = Sv[t];
	return /* @__PURE__ */ (0, S.jsx)("span", {
		"aria-hidden": !0,
		className: Z("relative shrink-0 transition-colors duration-200 ease", r.track, r.trackRadius[n], e.isSelected ? Z("bg-linear-to-b from-accent-500 to-accent-600", r.onShadow) : "bg-background-tertiary-default", e.isDisabled && "opacity-50", e.isFocusVisible && "ring-2 ring-border-focus-ring ring-offset-2"),
		children: /* @__PURE__ */ (0, S.jsx)("span", {
			className: Z("absolute flex items-center justify-center", "bg-linear-to-b from-control-indicator-background from-[43.837%] to-control-indicator-background-subtle", "shadow-[0_3px_3px_0_rgb(0_0_0/0.03),0_0.75px_0_0_rgb(0_0_0/0.05)]", "transition-transform duration-200 ease", r.thumb, r.thumbRadius[n], r.offset, e.isSelected && r.travel),
			children: /* @__PURE__ */ (0, S.jsx)("span", { className: Z("border-solid bg-linear-to-t from-[43.837%]", r.chip, r.chipRadius[n], e.isSelected ? "border-accent-600 from-switch-on-chip-start to-switch-on-chip-end" : "border-border-button-default/50 from-switch-off-chip-start to-switch-off-chip-end") })
		})
	});
}
function wv({ className: e, children: t, size: n = "md", shape: r = "pill", ref: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsx)(eg, {
		ref: i,
		...a,
		className: (t) => Z("group inline-flex items-center gap-2 select-none", t.isDisabled ? "cursor-not-allowed" : "cursor-pointer", typeof e == "function" ? e(t) : e),
		children: (e) => /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Cv, {
			state: e,
			size: n,
			shape: r
...
function Tv({ data: e, receipt: t }) {
	return e.startup ? /* @__PURE__ */ (0, S.jsx)(Ev, {
		startup: e.startup,
		receipt: t
	}) : null;
}
function Ev({ startup: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e.enabled), [i, a] = (0, x.useState)(e.silent), [o, s] = (0, x.useState)(e.desktop), c = Og(), l = e.available && !e.desktop_message;
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		title: "开机自启",
		onSubmit: (r) => {
			r.preventDefault(), e.available && c.run("save", (e) => jf("/api/configuration/startup", {
				enabled: n,
				silent: i,
				desktop: o
			}, "POST", e), () => t("已保存配置"));
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)(__, { children: [
				/* @__PURE__ */ (0, S.jsx)(h_, {
					label: "开机后启动 Peach",
					children: /* @__PURE__ */ (0, S.jsx)(wv, {
			...
			e.message || c.error ? /* @__PURE__ */ (0, S.jsxs)(v_, {
				divided: !0,
				children: [e.message ? /* @__PURE__ */ (0, S.jsx)(b_, { children: e.message }) : null, c.error ? /* @__PURE__ */ (0, S.jsx)(x_, { children: c.error }) : null]
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(y_, { children: /* @__PURE__ */ (0, S.jsx)($, {
				type: "submit",
...
function Ov({ state: e, size: t = "md" }) {
	let { isSelected: n, isIndeterminate: r, isFocusVisible: i, isDisabled: a, isHovered: o } = e, s = Dv[t], c = n || r, l = o && !a;
	return /* @__PURE__ */ (0, S.jsx)("span", {
		"aria-hidden": !0,
		className: Z("flex shrink-0 items-center justify-center rounded-sm", "transition-[background-color,border-color,box-shadow] duration-150 ease", s.box, c ? Z("bg-linear-to-b shadow-checkbox-selected", l ? "from-accent-400 to-accent-500" : "from-accent-500 to-accent-600") : Z("border bg-background-primary-default shadow-xs", l ? "border-border-checkbox-hover" : "border-border-checkbox-default"), a && "opacity-50", i && "ring-2 ring-border-focus-ring ring-offset-2"),
...
function kv({ className: e, children: t, size: n = "md", ref: r, ...i }) {
	let a = Dv[n];
	return /* @__PURE__ */ (0, S.jsx)(Bp, {
		ref: r,
		...i,
		className: (t) => Z("group inline-flex items-center select-none", a.gap, t.isDisabled ? "cursor-not-allowed" : "cursor-pointer", typeof e == "function" ? e(t) : e),
		children: (e) => /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Ov, {
			state: e,
			size: n
		}), t != null && /* @__PURE__ */ (0, S.jsx)("span", {
			className: Z(a.label, "text-text-primary"),
			children: t
		})] })
	});
}
...
var Av = {
	...
	skipped: 0,
	message: ""
}, jv = (e) => Number(e).toLocaleString();
function Mv(e) {
	if (e.status === "running") {
		let t = e.total ? `${jv(e.checked)} / ${jv(e.total)}` : "准备中";
		return e.stage === "修复" && e.message ? `修复 ${t} · ${e.message}` : `${e.stage || "扫描"} ${t}`;
	}
	return e.status === "complete" && (e.repaired || e.failed) ? e.failed ? `修好 ${jv(e.repaired)} 部，${jv(e.failed)} 部修不了` : `修好 ${jv(e.repaired)} 部` : "";
}
function Nv({ initial: e }) {
	let [t, n] = (0, x.useState)(e || Av), [r, i] = (0, x.useState)(!1), a = Og(), o = t.status === "running";
	(0, x.useEffect)(() => {
		let e = new AbortController(), t, r = async () => {
			try {
				let i = await Af("/api/media-repair", e.signal);
	...
	let s = () => void a.run("start", (e) => jf("/api/media-repair", {
		allow_metered: r,
		restart: !0
	}, "POST", e), n), c = () => void a.run("stop", (e) => jf("/api/media-repair", { stop: !0 }, "POST", e), n), l = t.total ? Math.round(t.checked / t.total * 100) : 0;
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		title: "播放兼容修复",
		children: [/* @__PURE__ */ (0, S.jsxs)(v_, { children: [
			/* @__PURE__ */ (0, S.jsx)(b_, { children: "有些 MP4 少了一张时间戳表，浏览器按容器给的时刻排帧，会把其中一部分丢掉，看着就是卡顿。 修好之后这类片子起播直接用原片，不再实时转码。原始文件不改动，修好的头另存在缓存里。" }),
			/* @__PURE__ */ (0, S.jsx)(kv, {
				isSelected: r,
				isDisabled: o,
				onChange: i,
			...
			o ? /* @__PURE__ */ (0, S.jsx)(If, {
				label: "修复进度",
				value: l
			}) : null,
			t.status === "complete" && !t.repaired && !t.failed ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				tone: "info",
				title: "没有要修的",
				children: "库里的片子都能直接播，没找到缺时间戳表的。"
			}) : null,
			a.error || t.error ? /* @__PURE__ */ (0, S.jsx)(x_, { children: a.error || t.error }) : null
		] }), /* @__PURE__ */ (0, S.jsx)(y_, {
			status: Mv(t) ? /* @__PURE__ */ (0, S.jsx)("p", {
				role: "status",
				children: Mv(t)
			}) : null,
			children: o ? /* @__PURE__ */ (0, S.jsx)($, {
				onClick: c,
				...kg(a.busy === "stop"),
				children: "停止"
			}) : /* @__PURE__ */ (0, S.jsx)($, {
...
function Lv({ initial: e, initialJob: t }) {
	let [n, r] = (0, x.useState)(e), [i, a] = (0, x.useState)(t || {
		state: "idle",
		progress: 0
	}), [s, c] = (0, x.useState)(""), l = Og(), u = (0, x.useRef)(!1), d = (0, x.useRef)(!0), f = Pv.has(i.state);
	(0, x.useEffect)(() => (d.current = !0, () => {
		d.current = !1;
	}), []);
	let p = async () => {
		let e = await jf("/api/configuration/update-restart", {});
		d.current && a(e);
	}, m = () => void o({
		title: "更新已准备好",
	...
	(0, x.useEffect)(() => {
		...
		let e = new AbortController(), t = Pv.has(i.state) ? 1e3 : 3e4, n, o = 0, s = async () => {
			try {
				let t = await Af("/api/configuration/update-status", e.signal);
				if (e.signal.aborted) return;
				...
				let n = await Af("/api/configuration/automatic-updates", e.signal);
				!e.signal.aborted && n.result && r(n.result);
			} catch {
				o += 1, o >= Iv && !e.signal.aborted && c("尚未连接到 Peach，请检查托盘后刷新页面。");
			}
			!e.signal.aborted && o < Iv && (n = setTimeout(s, t));
		};
	...
	let h = () => {
		f || (u.current = !1, c(""), l.run("download", (e) => jf("/api/configuration/update", {}, "POST", e), a));
	}, g = () => void l.run("check", (e) => Af("/api/configuration/updates", e), r, (t) => {
		r({
			...e,
			state: "error"
		}), l.setError(kf(t));
	...
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		...
		children: [
			...
			/* @__PURE__ */ (0, S.jsxs)(v_, {
				divided: !0,
				children: [
					n.checked_at ? /* @__PURE__ */ (0, S.jsxs)(b_, { children: ["检查于 ", (/* @__PURE__ */ new Date(n.checked_at * 1e3)).toLocaleString()] }) : null,
					n.state === "available" && !_ ? /* @__PURE__ */ (0, S.jsx)(Pf, {
						tone: "info",
						title: "有可用更新",
						children: n.message
					}) : _ || n.state === "error" ? /* @__PURE__ */ (0, S.jsx)(x_, { children: _ || n.message }) : /* @__PURE__ */ (0, S.jsx)(b_, {
						role: "status",
						children: n.message
					}),
					i.state === "error" ? /* @__PURE__ */ (0, S.jsx)(x_, { children: i.message }) : null,
					i.state !== "idle" && i.state !== "error" ? /* @__PURE__ */ (0, S.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, S.jsxs)(b_, { children: ["下载 → 校验 → 解压 → 准备安装 · ", i.message] }),
							/* @__PURE__ */ (0, S.jsx)(b_, { children: v })
						]
					}) : null
				]
			}),
			/* @__PURE__ */ (0, S.jsxs)(y_, {
				status: /* @__PURE__ */ (0, S.jsx)(C_, {
					href: n.release_url,
					children: "查看发布页"
				}),
				children: [
					i.state === "ready" ? /* @__PURE__ */ (0, S.jsx)($, {
						onClick: m,
						children: "重启安装"
					}) : null,
					n.state === "available" && n.installation === "独立测试包" && i.state !== "ready" ? /* @__PURE__ */ (0, S.jsx)($, {
						onClick: h,
						...kg(f || l.busy === "download"),
						children: "下载并安装"
					}) : null,
					/* @__PURE__ */ (0, S.jsx)($, {
						disabled: f,
...
function zv({ data: e, receipt: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-6",
		children: [
			e.automatic_updates ? /* @__PURE__ */ (0, S.jsx)(Bv, {
				initial: e.automatic_updates,
				receipt: t
			}) : null,
			e.updates ? /* @__PURE__ */ (0, S.jsx)(Lv, {
				initial: e.updates,
				initialJob: e.update_job
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(Nv, {}),
			/* @__PURE__ */ (0, S.jsx)(Vv, { facts: e.facts }),
			e.uninstall ? /* @__PURE__ */ (0, S.jsx)(Hv, { uninstall: e.uninstall }) : null
		]
	});
}
function Bv({ initial: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e.mode), [i, a] = (0, x.useState)(e.interval_hours), o = Og(e.error), s = (r) => {
		r.preventDefault(), e.available && o.run("save", (e) => jf("/api/configuration/automatic-updates", {
			mode: n,
			interval_hours: i
		}, "POST", e), () => t("已保存配置"));
	...
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)(__, { children: [
				...
				/* @__PURE__ */ (0, S.jsx)(h_, {
					...
					children: /* @__PURE__ */ (0, S.jsx)(Q_, {
						...
						children: Rv.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)($_, {
							id: e,
							children: t
						}, e))
					})
			...
			o.error ? /* @__PURE__ */ (0, S.jsx)(v_, {
				divided: !0,
				children: /* @__PURE__ */ (0, S.jsx)(x_, { children: o.error })
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(y_, { children: /* @__PURE__ */ (0, S.jsx)($, {
				type: "submit",
				disabled: !e.available,
...
function Vv({ facts: e }) {
	return /* @__PURE__ */ (0, S.jsx)(g_, {
		title: "运行信息",
		children: /* @__PURE__ */ (0, S.jsx)(w_, { children: e.map((e) => /* @__PURE__ */ (0, S.jsxs)(T_, {
			term: e.term,
			children: [e.value, e.download_url ? /* @__PURE__ */ (0, S.jsx)(C_, {
				href: e.download_url,
...
function Hv({ uninstall: e }) {
	let [t, n] = (0, x.useState)(!1), [r, i] = (0, x.useState)(""), a = () => void o({
		...
		onConfirm: async () => {
			let e = await jf("/api/configuration/uninstall", {
				delete_data: t,
	...
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		...
		title: "卸载 Peach",
		children: [/* @__PURE__ */ (0, S.jsxs)(v_, { children: [
			e.available ? /* @__PURE__ */ (0, S.jsx)(b_, { children: "卸载会退出 Peach、移除程序、开机自启和桌面图标。原始媒体文件保留。" }) : null,
			/* @__PURE__ */ (0, S.jsx)(kv, {
				isSelected: t,
...
function Gv() {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)(b_, { children: ["先在 CloudDrive 登录网盘并挂载，开启「启动时自动挂载」。", /* @__PURE__ */ (0, S.jsx)(C_, {
			href: "https://www.clouddrive2.com/help.html",
			children: "挂载帮助"
		})] }), /* @__PURE__ */ (0, S.jsxs)(E_, {
			summary: "CloudDrive 缓存建议",
			children: [
				/* @__PURE__ */ (0, S.jsx)(b_, { children: "看缓存放在哪块硬盘上，照那一档填。这是起步值，填得越大不一定越快。" }),
				/* @__PURE__ */ (0, S.jsx)("ul", {
					"aria-label": "按缓存所在硬盘分档",
					className: "flex flex-col gap-2",
					children: Uv.map((e) => /* @__PURE__ */ (0, S.jsxs)("li", {
						...
						children: [/* @__PURE__ */ (0, S.jsx)("p", {
							...
							children: Wv.map(([t, n]) => /* @__PURE__ */ (0, S.jsxs)("div", {
								className: "flex flex-col",
								children: [/* @__PURE__ */ (0, S.jsx)("dt", {
									className: "text-caption-1-regular text-text-secondary",
									children: n
...
function Yv({ value: e, label: t, kind: n = "local", onChange: r }) {
	let i = (0, x.useRef)(null), [a, o] = (0, x.useState)(!1), [s, c] = (0, x.useState)(e), [l, u] = qv(n);
	return /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)($, {
		ref: i,
		variant: "secondary",
		className: "self-start",
		"aria-label": t,
		...
		children: /* @__PURE__ */ (0, S.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, S.jsx)(O_, { mark: e || l }), ((e) => e && Kv.find(([t]) => t === e)?.[1] || u)(e)]
		})
	}), /* @__PURE__ */ (0, S.jsx)(_h, {
		triggerRef: i,
		isOpen: a,
		...
		children: /* @__PURE__ */ (0, S.jsxs)(xh, {
			...
			children: [
				...
				/* @__PURE__ */ (0, S.jsx)(Rh, {
					...
					children: Kv.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(zh, {
						value: e || Jv,
						"aria-label": e ? t : u,
						...
						children: /* @__PURE__ */ (0, S.jsx)(O_, { mark: e || l })
					}, e || Jv))
				}),
				/* @__PURE__ */ (0, S.jsxs)("div", {
...
], $v = (e) => Qv.find(([t]) => t === e)?.[1] ?? e, ey = (e) => a[e] || "database", ty = (e = "") => ({
	path: e,
	location: "local",
	root: "",
	library: "",
...
function ny(e) {
	let t = e.media_sources?.filter((e) => Qv.some(([t]) => t === e.location));
	...
	})) : (e.media_dirs.length ? e.media_dirs : [""]).map((e) => ty(e));
}
var ry = (e) => !(e instanceof Df) || e.status !== 400 ? null : e.body?.errors ?? null;
function iy({ data: e, receipt: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-6",
		children: [e.editable ? /* @__PURE__ */ (0, S.jsx)(ay, {
			data: e,
			receipt: t
		}) : /* @__PURE__ */ (0, S.jsx)(Pf, {
			tone: "neutral",
			title: "只读",
			children: e.notice
		}), /* @__PURE__ */ (0, S.jsx)(sy, { data: e })]
	});
}
function ay({ data: e, receipt: t }) {
	let [n, r] = (0, x.useState)(() => ny(e)), [i, a] = (0, x.useState)(String(e.port)), [o, s] = (0, x.useState)(!1), [c, l] = (0, x.useState)([]), [u, d] = (0, x.useState)(""), [f, p] = (0, x.useState)(""), [m, h] = (0, x.useState)(null), [g, _] = (0, x.useState)(null), [v, y] = (0, x.useState)(null), b = (0, x.useRef)(!1), C = (0, x.useRef)(e.revision), w = (0, x.useRef)([]), T = Og();
	(0, x.useLayoutEffect)(() => {
		g !== null && (w.current[g]?.focus(), _(null));
	}, [g]), (0, x.useEffect)(() => {
		if (!m) return;
		let e = setTimeout(() => location.assign(m.url), Xv);
	...
	let E = (e, t) => r((n) => n.map((n, r) => r === e ? {
		...
		if (!b.current) {
			b.current = !0, y(e);
			try {
				let { path: t } = await jf(vv, { initial: n[e]?.path ?? "" });
				t && (E(e, { path: t }), D(e, ""));
			} catch (t) {
				D(e, kf(t));
			} finally {
		...
		r.preventDefault(), p(""), T.run("save", (t) => jf(_v, {
			revision: C.current,
			...
			let t = ry(e);
			l(t?.media_dirs ?? []), d(t?.port ?? ""), t || p(kf(e));
		});
	};
	if (m) return /* @__PURE__ */ (0, S.jsx)(g_, {
		title: "这台电脑",
		children: /* @__PURE__ */ (0, S.jsx)(v_, { children: /* @__PURE__ */ (0, S.jsxs)(Pf, {
			tone: "success",
			title: "配置已保存",
			children: [
	...
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)(v_, { children: [
			/* @__PURE__ */ (0, S.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, S.jsx)(S_, { children: "媒体文件夹" }),
					/* @__PURE__ */ (0, S.jsx)("div", {
						role: "group",
						"aria-label": "媒体文件夹",
						className: "flex flex-col gap-3",
						children: n.map((t, r) => /* @__PURE__ */ (0, S.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, S.jsxs)("div", {
								...
								children: [
									...
									n.length > 1 ? /* @__PURE__ */ (0, S.jsx)(bg, {
										icon: Eu,
										"aria-label": "移除这个文件夹",
										onClick: () => k(r)
									}) : null
								...
								children: [
									...
									/* @__PURE__ */ (0, S.jsxs)("div", {
										className: "flex flex-col gap-1.5",
										children: [/* @__PURE__ */ (0, S.jsx)(S_, { children: "媒体库图标" }), /* @__PURE__ */ (0, S.jsx)(Yv, {
											label: `媒体库图标 ${r + 1}`,
									...
									/* @__PURE__ */ (0, S.jsxs)("div", {
										className: "flex flex-col gap-1.5",
										children: [/* @__PURE__ */ (0, S.jsx)(S_, { children: "媒体来源" }), /* @__PURE__ */ (0, S.jsx)(Q_, {
											"aria-label": `媒体来源 ${r + 1}`,
											selectedKey: t.location,
											onSelectionChange: (e) => {
												e !== null && E(r, { location: String(e) });
											},
											children: Qv.map(([e, t]) => /* @__PURE__ */ (0, S.jsxs)($_, {
												id: e,
												textValue: t,
												children: [/* @__PURE__ */ (0, S.jsx)(O_, { mark: ey(e) }), t]
											}, e))
										})]
									}),
									e.windows === !1 ? /* @__PURE__ */ (0, S.jsx)(Dg, {
			...
			j ? /* @__PURE__ */ (0, S.jsx)(Gv, {}) : null,
			te.map((e) => /* @__PURE__ */ (0, S.jsxs)(b_, { children: [
				"未检测到 ",
				e.name,
				"。",
				/* @__PURE__ */ (0, S.jsxs)(C_, {
					href: e.download_url,
					children: ["下载 ", e.name]
				})
			] }, e.name)),
			e.windows === !1 ? /* @__PURE__ */ (0, S.jsx)(b_, { children: "本机文件夹是这台电脑读取媒体的位置。Windows 中的对应路径用于匹配馆藏中已有的路径，例如 B:\\ 对应本机挂载文件夹。" }) : null,
			e.port_editable === !1 ? null : /* @__PURE__ */ (0, S.jsx)(Dg, {
				id: "configPort",
				label: "本机访问端口",
				inputMode: "numeric",
				value: i,
...
function sy({ data: e }) {
	let t = e.media_sources, n = Og();
	return t ? /* @__PURE__ */ (0, S.jsxs)(g_, {
		title: "挂载状态",
		children: [
			/* @__PURE__ */ (0, S.jsx)(w_, { children: t.map((e, t) => /* @__PURE__ */ (0, S.jsxs)(T_, {
				term: /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(O_, { mark: ey(e.location) }), $v(e.location)] }),
				children: [e.path || "未配置挂载点", /* @__PURE__ */ (0, S.jsx)(oy, { online: e.online })]
			}, t)) }),
			n.error ? /* @__PURE__ */ (0, S.jsx)(v_, {
				divided: !0,
				children: /* @__PURE__ */ (0, S.jsx)(x_, { children: n.error })
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(y_, { children: /* @__PURE__ */ (0, S.jsx)($, {
				onClick: () => void n.run("refresh", (e) => bv(e), (e) => Lf.setQueryData(yv, e)),
				...kg(n.busy === "refresh"),
				children: "刷新挂载状态"
			}) })
		]
...
function ly({ initial: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e), [i, a] = (0, x.useState)(""), [o, s] = (0, x.useState)(""), [c, l] = (0, x.useState)(""), [u, d] = (0, x.useState)(!1), [f, p] = (0, x.useState)({}), m = (0, x.useRef)(null), h = Og(), g = (e) => {
		e.preventDefault();
		let f = {};
		...
		h.run("save", (e) => jf("/api/configuration/access", {
			revision: n.revision,
			...
			let t = e instanceof Df ? e.body : null, n = t?.errors || t?.detail?.errors;
			n ? p(n) : h.setError(kf(e));
		});
	}, _ = cy[n.mode], v = n.mode !== "locked";
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		title: "访问密码",
		onSubmit: g,
		children: [/* @__PURE__ */ (0, S.jsx)("div", {
			ref: m,
			children: /* @__PURE__ */ (0, S.jsxs)(v_, { children: [
				_ ? /* @__PURE__ */ (0, S.jsx)(b_, { children: _ }) : null,
				n.mode === "open" ? /* @__PURE__ */ (0, S.jsx)(Pf, {
					tone: "warning",
					title: "未设置访问密码",
					children: "能连接到 Peach 的设备打开地址就能看馆藏，不需要登录。"
				}) : null,
				n.mode === "password" || n.mode === "legacy" ? /* @__PURE__ */ (0, S.jsx)(kv, {
					isSelected: u,
					onChange: d,
					children: "关闭访问密码，允许能连接到 Peach 的设备直接访问"
				}) : null,
				n.mode === "password" ? /* @__PURE__ */ (0, S.jsx)(Dg, {
					id: "access-current",
					type: "password",
					label: "当前访问密码",
				...
				v ? /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Dg, {
					id: "access-password",
					type: "password",
				...
				u ? /* @__PURE__ */ (0, S.jsx)(Pf, {
					tone: "warning",
					title: "访问范围",
					children: "保存后，能连接到 Peach 的设备将直接访问馆藏。"
				}) : null,
				h.error ? /* @__PURE__ */ (0, S.jsx)(x_, { children: h.error }) : null
			] })
		}), v ? /* @__PURE__ */ (0, S.jsx)(y_, {
			status: "保存后立即生效。",
			children: /* @__PURE__ */ (0, S.jsx)($, {
				type: "submit",
				...kg(h.busy === "save"),
...
function dy({ data: e, receipt: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-6",
		children: [e.peach_proxy ? /* @__PURE__ */ (0, S.jsx)(fy, {
			initial: e.peach_proxy,
			receipt: t
		}) : null, e.access ? /* @__PURE__ */ (0, S.jsx)(ly, {
			initial: e.access,
			receipt: t
		}) : null]
	});
}
function fy({ initial: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e), [i, a] = (0, x.useState)(e.mode), [o, s] = (0, x.useState)(""), c = Og();
	return /* @__PURE__ */ (0, S.jsxs)(g_, {
		id: "peachProxy",
		title: "Peach 代理",
		onSubmit: (e) => {
			e.preventDefault(), c.run("save", (e) => jf("/api/configuration/peach-proxy", {
				mode: i,
				proxy: o
			}, "POST", e), (e) => {
				r(e), s(""), t("已保存配置");
		...
		children: [
			/* @__PURE__ */ (0, S.jsx)(__, { children: /* @__PURE__ */ (0, S.jsx)(h_, {
				...
				children: /* @__PURE__ */ (0, S.jsx)(Q_, {
					...
					children: uy.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)($_, {
						id: e,
						children: t
					}, e))
				})
			}) }),
			i === "proxy" || n.needs_selection || c.error ? /* @__PURE__ */ (0, S.jsxs)(v_, {
				divided: !0,
				children: [
					i === "proxy" ? /* @__PURE__ */ (0, S.jsx)(Dg, {
					...
					n.needs_selection ? /* @__PURE__ */ (0, S.jsx)(Pf, {
						tone: "warning",
						title: "需要选择连接方式",
						children: "已有来源的代理地址不同，请选择公共连接方式。"
					}) : null,
					c.error ? /* @__PURE__ */ (0, S.jsx)(x_, { children: c.error }) : null
				]
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(y_, { children: /* @__PURE__ */ (0, S.jsx)($, {
				type: "submit",
...
function py({ receipt: e }) {
	let t = ut({
		queryKey: yv,
		queryFn: ({ signal: e }) => bv(e)
	}), n = t.data;
	if (!n) return /* @__PURE__ */ (0, S.jsx)("div", {
		className: "configpage",
		children: /* @__PURE__ */ (0, S.jsx)(Pf, {
			tone: "error",
			title: "打不开配置",
			children: t.error ? kf(t.error) : "没有读到配置"
		})
	});
	let r = {
		data: n,
	...
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		...
		children: [
			...
			n.startup ? /* @__PURE__ */ (0, S.jsx)(Tv, { ...r }) : null,
			/* @__PURE__ */ (0, S.jsx)("h2", {
				className: "configgroup",
				children: "媒体"
			}),
			/* @__PURE__ */ (0, S.jsx)(iy, { ...r }),
			i ? /* @__PURE__ */ (0, S.jsx)("h2", {
				className: "configgroup",
				children: "网络与访问"
			}) : null,
			i ? /* @__PURE__ */ (0, S.jsx)(dy, { ...r }) : null,
			/* @__PURE__ */ (0, S.jsx)("h2", {
				className: "configgroup",
				children: "更新与维护"
			}),
			/* @__PURE__ */ (0, S.jsx)(zv, { ...r })
		]
	});
}
//#endregion
//#region src/react/stats/stats.ts
var my = "/api/stats", hy = ["stats"], gy = (e) => Af(my, e);
async function _y(e) {
	await Lf.fetchQuery({
		queryKey: hy,
		queryFn: () => gy(e)
...
var vy = (e, t) => t ? Math.round(e / t * 100) : 0, yy = (e) => e >= 3600 ? `${(e / 3600).toFixed(1)} 小时` : `${Math.round(e / 60)} 分钟`, by = (e) => e.duration ? Math.min(e.play_seconds / e.duration, 1) * 100 : 0, xy = (e) => (e.max_reached || 0) * 100, Sy = (e) => e.kind === "online" ? "在线直接观看" : by(e) < xy(e) - 25 ? "快进扫过" : e.o_count ? `高潮 ${e.o_count}` : "正常观看", Cy = (e) => `${e.kind === "online" ? "/follow/item/" : "/item/"}${e.id}`;
function wy(e) {
	let t = Math.max(1, ...e) * 1.1, n = Math.min(22, 110 / Math.max(1, e.length)), r = Math.min(15, n * .68);
	return e.map((e, i) => ({
		radius: 32 + i * n,
		width: r,
		length: e / t * 100
...
function Dy({ title: e, rows: t, unit: n = "个视频" }) {
	let [r, i] = (0, x.useState)(-1), [a, o] = (0, x.useState)(-1), s = t.filter((e) => Number.isFinite(e.value) && e.value >= 0);
	if (!s.length) return null;
	let c = a >= 0 ? a : r, l = s.reduce((e, t) => e + t.value, 0), u = wy(s.map((e) => e.value)), d = s[c], f = (e) => i((t) => t === e ? -1 : e);
	return /* @__PURE__ */ (0, S.jsxs)("section", {
		className: "flex min-w-0 flex-col gap-4 rounded-2xl border border-separator-border p-5",
		children: [
			/* @__PURE__ */ (0, S.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, S.jsx)("span", {
					...
					children: [/* @__PURE__ */ (0, S.jsx)("b", {
						className: "text-title-1-medium tabular-nums text-text-primary",
						children: (d ? d.value : l).toLocaleString()
			...
			/* @__PURE__ */ (0, S.jsx)("svg", {
				...
				onPointerLeave: () => o(-1),
				children: s.map((e, t) => /* @__PURE__ */ (0, S.jsxs)("g", {
					onPointerEnter: () => o(t),
					onClick: () => f(t),
					children: [
						/* @__PURE__ */ (0, S.jsx)("title", { children: `${e.name}：${e.value.toLocaleString()} ${n}` }),
						/* @__PURE__ */ (0, S.jsx)("circle", {
							cx: "160",
							cy: "160",
							r: u[t].radius,
							strokeWidth: u[t].width,
							strokeLinecap: "round",
						...
						/* @__PURE__ */ (0, S.jsx)("circle", {
							...
							strokeDasharray: `${u[t].length} ${100 - u[t].length}`,
							className: c >= 0 && c !== t ? `cursor-pointer opacity-30 transition-opacity ${Ty[t % 6]}` : `cursor-pointer transition-opacity ${Ty[t % 6]}`
						})
					]
				}, e.name))
			}),
			/* @__PURE__ */ (0, S.jsx)("div", {
				...
				children: s.map((e, t) => /* @__PURE__ */ (0, S.jsxs)("button", {
					type: "button",
					"aria-pressed": r === t,
					onClick: () => f(t),
					onPointerEnter: () => o(t),
					...
					children: [
						/* @__PURE__ */ (0, S.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, S.jsx)("i", {
								"aria-hidden": !0,
								className: `size-3 shrink-0 rounded-sm ${Ey[t % 6]}`
							}), e.name]
						}),
						/* @__PURE__ */ (0, S.jsx)("b", {
							className: "text-headline-medium tabular-nums text-text-primary",
							children: e.value.toLocaleString()
						}),
						e.detail ? /* @__PURE__ */ (0, S.jsx)("small", {
							className: "text-caption-1-regular text-text-secondary",
							children: e.detail
						}) : null
					]
...
var Oy = 10, ky = "flex min-w-0 flex-col gap-4 rounded-2xl border border-separator-border p-5", Ay = "relative cursor-pointer py-3 text-body-2-regular text-text-secondary outline-none hover:text-text-primary focus-visible:ring-2 focus-visible:ring-border-focus-ring data-selected:text-text-primary", jy = "添加媒体文件夹或关注来源，开始建立你的馆藏。", My = "补全资料或添加标签后，这里会显示馆藏中的内容标签。", Ny = "开始播放后，这里会显示最近的真实观看证据。", Py = "刮削或手动打标之后，这里会显示每个来源覆盖了多少视频。", Fy = "添加媒体文件夹后，这里会显示存储空间。";
function Iy({ term: e, value: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex min-w-0 flex-col gap-1.5 rounded-xl bg-background-tertiary-default p-3",
		children: [/* @__PURE__ */ (0, S.jsx)("span", {
			className: "text-caption-1-regular text-text-secondary",
			children: e
		}), /* @__PURE__ */ (0, S.jsx)("b", {
...
function Ly({ term: e, value: t, total: n }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-1.5 border-b border-separator-border py-3 last:border-b-0",
		children: [/* @__PURE__ */ (0, S.jsxs)("p", {
			className: "flex items-baseline justify-between gap-3 text-body-2-regular text-text-primary",
			children: [/* @__PURE__ */ (0, S.jsx)("span", { children: e }), /* @__PURE__ */ (0, S.jsxs)("b", {
				className: "tabular-nums",
				children: [t.toLocaleString(), /* @__PURE__ */ (0, S.jsxs)("span", {
...
function Ry({ term: e, figure: t, unit: n }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex shrink-0 flex-col gap-0.5 border-b border-separator-border pb-5 md:w-64 md:border-b-0 md:border-r md:pr-6 md:pb-0",
		children: [
			/* @__PURE__ */ (0, S.jsx)("span", {
				className: "text-caption-1-regular text-text-secondary",
				children: e
...
function zy({ headline: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: `${ky} md:flex-row md:gap-6`,
		children: [e, /* @__PURE__ */ (0, S.jsx)("div", {
...
function By({ data: t, configurable: r, openMediaSettings: i }) {
	return t.by_loc.reduce((e, t) => e + t.videos, 0) ? /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "inline-grid w-full gap-5 md:grid-cols-2",
		children: [/* @__PURE__ */ (0, S.jsx)(Dy, {
			title: "网盘与本地",
			rows: t.by_loc.map((t) => ({
				name: e[t.k] ?? t.k,
				value: t.videos,
		...
		icon: Wu,
		title: "还没有视频",
		actions: /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [r ? /* @__PURE__ */ (0, S.jsx)($, {
			size: "small",
			onClick: i,
			children: "添加媒体文件夹"
		}) : null, /* @__PURE__ */ (0, S.jsx)(s_, {
	...
	return /* @__PURE__ */ (0, S.jsxs)("article", {
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, S.jsx)("h3", {
					className: "min-w-0 text-body-2-medium break-words text-text-primary",
					children: e.label
				}), /* @__PURE__ */ (0, S.jsx)("b", {
					className: "text-body-2-medium whitespace-nowrap text-text-primary",
					children: t == null ? e.online ? "容量未取得" : "离线" : `${vy(r, t)}%`
				})]
			}),
			/* @__PURE__ */ (0, S.jsx)("small", {
				className: "text-caption-1-regular break-words text-text-secondary",
				children: e.root ?? "未映射"
			}),
			t == null ? null : /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(If, {
				label: `${e.label}空间使用率`,
				value: r,
				max: Math.max(t, 1)
			}), /* @__PURE__ */ (0, S.jsxs)("p", {
				className: "flex justify-between gap-3 text-caption-1-regular text-text-secondary",
				children: [/* @__PURE__ */ (0, S.jsxs)("span", { children: ["已用 ", /* @__PURE__ */ (0, S.jsx)("b", {
					className: "font-normal text-text-primary",
					children: n(r)
				})] }), /* @__PURE__ */ (0, S.jsxs)("span", { children: ["可用 ", /* @__PURE__ */ (0, S.jsx)("b", {
					className: "font-normal text-text-primary",
					children: n(e.free ?? 0)
				})] })]
			})] })
...
function Uy({ volumes: e, configurable: t, openMediaSettings: n }) {
	return e.length ? /* @__PURE__ */ (0, S.jsx)("div", {
		className: "flex flex-col gap-5",
		children: e.map((e) => /* @__PURE__ */ (0, S.jsx)(Hy, { volume: e }, `${e.kind}:${e.label}`))
	}) : /* @__PURE__ */ (0, S.jsx)(Mf, {
		icon: Pu,
		title: "还没有存储来源",
		actions: t ? /* @__PURE__ */ (0, S.jsx)($, {
			size: "small",
			onClick: n,
			children: "添加媒体文件夹"
		}) : void 0,
...
function Wy({ tags: e, tagLabel: t, onTag: n }) {
	let [r, i] = (0, x.useState)(!1);
	if (!e.length) return /* @__PURE__ */ (0, S.jsx)(Mf, {
		icon: Ru,
		title: "还没有内容标签",
		actions: /* @__PURE__ */ (0, S.jsx)(s_, {
			href: "/data-cleanup",
			size: "small",
			children: "补全资料"
		}),
	...
	let a = r ? e : e.slice(0, Oy);
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-3",
		children: [/* @__PURE__ */ (0, S.jsx)("ol", {
			className: "inline-grid w-full gap-1 sm:grid-cols-2",
			children: a.map((e, r) => /* @__PURE__ */ (0, S.jsx)("li", {
				className: "min-w-0",
				children: /* @__PURE__ */ (0, S.jsxs)("button", {
					type: "button",
					onClick: () => n(e.k),
					...
					children: [
						...
						/* @__PURE__ */ (0, S.jsx)("span", {
							className: "min-w-0 grow text-body-2-regular break-words text-text-primary",
							children: t(e.k)
						}),
						/* @__PURE__ */ (0, S.jsx)("b", {
							className: "text-body-2-medium tabular-nums text-text-secondary",
							children: e.n.toLocaleString()
						})
					]
				})
			}, e.k))
		}), e.length > Oy ? /* @__PURE__ */ (0, S.jsx)("div", {
			className: "flex justify-center",
			children: /* @__PURE__ */ (0, S.jsx)($, {
				variant: "secondary",
				size: "small",
				onClick: () => i(!r),
				children: r ? "收起排名" : "展开更多排名"
			})
		}) : null]
	});
}
			...
			return /* @__PURE__ */ (0, S.jsxs)("article", {
				...
				children: [/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, S.jsx)("h3", {
						...
						children: [/* @__PURE__ */ (0, S.jsx)("span", { children: e.creator ?? "" }), /* @__PURE__ */ (0, S.jsx)("span", { children: Sy(e) })]
					})]
				}), /* @__PURE__ */ (0, S.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, S.jsx)(If, {
						...
						children: `真实 ${t.toFixed(0)}% · 到达 ${xy(e).toFixed(0)}%`
					})]
				})]
			}, `${e.kind}:${e.id}`);
		})
...
function Ky({ sources: e, videos: t }) {
	return e.length ? /* @__PURE__ */ (0, S.jsx)("div", {
		className: "inline-grid w-full gap-x-8 gap-y-6 sm:grid-cols-2",
		children: e.map((e) => /* @__PURE__ */ (0, S.jsxs)("article", {
			className: "flex min-w-0 flex-col gap-1.5",
			children: [
				/* @__PURE__ */ (0, S.jsxs)("header", {
					className: "flex items-baseline justify-between gap-3",
					children: [/* @__PURE__ */ (0, S.jsx)("h3", {
						...
						className: "text-body-2-medium whitespace-nowrap text-text-primary",
						children: [e.assets.toLocaleString(), /* @__PURE__ */ (0, S.jsx)("small", {
							className: "ml-1 text-caption-1-regular font-normal text-text-secondary",
							children: "个视频"
						})]
					})]
				}),
				...
				/* @__PURE__ */ (0, S.jsxs)("small", {
					className: "text-caption-1-regular text-text-secondary",
					children: [e.n.toLocaleString(), " 条标签"]
				})
			]
		}, e.k))
	}) : /* @__PURE__ */ (0, S.jsx)(Mf, {
...
function qy({ id: e, label: t, figure: n, detail: r, icon: i }) {
	return /* @__PURE__ */ (0, S.jsxs)(fg, {
		id: e,
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)("span", {
				className: "flex min-w-0 items-center gap-2 text-body-2-regular text-text-secondary",
				children: [/* @__PURE__ */ (0, S.jsx)(i, {
					"aria-hidden": !0,
					className: "size-4 shrink-0"
				}), t]
			...
			/* @__PURE__ */ (0, S.jsx)("small", {
				className: "min-w-0 overflow-hidden text-caption-1-regular text-ellipsis whitespace-nowrap text-text-secondary",
				children: r
			})
		]
	});
...
function Jy(e) {
	let t = ut({
		queryKey: hy,
		queryFn: ({ signal: e }) => gy(e)
	}), r = t.data;
	if (!r) return /* @__PURE__ */ (0, S.jsx)(Ff, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
		tone: "error",
		title: "读取失败",
		children: t.error ? kf(t.error) : "读取统计失败"
	}) });
	let i = r.consumption, a = r.storage_summary, o = r.by_loc.reduce((e, t) => e + t.videos, 0), s = r.by_loc.reduce((e, t) => e + t.bytes, 0), c = vy(r.tag_cov, r.attribution.videos);
	return /* @__PURE__ */ (0, S.jsxs)(Ff, { children: [
		/* @__PURE__ */ (0, S.jsx)("p", {
			className: "text-caption-1-regular text-text-secondary",
			children: `账本当前快照 · ${o.toLocaleString()} 个视频 · ${n(s)}`
		}),
		/* @__PURE__ */ (0, S.jsxs)(cg, {
			className: "flex flex-col gap-4",
			children: [
				/* @__PURE__ */ (0, S.jsxs)(ug, {
					"aria-label": "统计视图",
					className: "inline-grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-4",
					children: [
						/* @__PURE__ */ (0, S.jsx)(qy, {
							id: "inventory",
							label: "馆藏视频",
						...
						/* @__PURE__ */ (0, S.jsx)(qy, {
							...
							icon: Ru,
							figure: `${c}%`,
							detail: `${r.tag_cov.toLocaleString()} / ${r.attribution.videos.toLocaleString()}`
						}),
						/* @__PURE__ */ (0, S.jsx)(qy, {
							id: "storage",
							label: "使用空间",
							icon: Pu,
							figure: `${a.online} 个卷`,
							detail: a.measured ? `已用 ${n(a.used)}` : "容量未取得"
						})
					]
				}),
				/* @__PURE__ */ (0, S.jsx)(pg, {
					id: "inventory",
					children: /* @__PURE__ */ (0, S.jsx)(By, {
						data: r,
						...e
					})
				}),
				/* @__PURE__ */ (0, S.jsx)(pg, {
					id: "viewing",
					children: /* @__PURE__ */ (0, S.jsx)(zy, {
						headline: /* @__PURE__ */ (0, S.jsx)(Ry, {
							term: "观看",
							figure: i.played.toLocaleString(),
							unit: "个作品有播放记录"
						}),
						children: /* @__PURE__ */ (0, S.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, S.jsx)(Iy, {
									term: "馆藏观看",
									value: i.library_played
								}),
								/* @__PURE__ */ (0, S.jsx)(Iy, {
									term: "在线直接观看",
									value: i.online_played
								}),
								/* @__PURE__ */ (0, S.jsx)(Iy, {
									term: "高潮计数",
									value: i.o_total
				...
				/* @__PURE__ */ (0, S.jsx)(pg, {
					...
					children: /* @__PURE__ */ (0, S.jsx)(zy, {
						...
						children: /* @__PURE__ */ (0, S.jsx)(Vy, { attribution: r.attribution })
					})
				}),
				/* @__PURE__ */ (0, S.jsx)(pg, {
					id: "storage",
		...
		/* @__PURE__ */ (0, S.jsxs)(cg, {
			...
			children: [
				...
				/* @__PURE__ */ (0, S.jsx)(pg, {
					id: "recent",
					className: "p-4",
					children: /* @__PURE__ */ (0, S.jsx)(Gy, { rows: r.recent })
				}),
				/* @__PURE__ */ (0, S.jsx)(pg, {
					id: "sources",
					className: "p-4",
					children: /* @__PURE__ */ (0, S.jsx)(Ky, {
...
function eb(e, t) {
	return nb(e.source, t.source) || e.index - t.index;
}
function tb(e, t) {
	return nb(e.target, t.target) || e.index - t.index;
}
function nb(e, t) {
	return e.y0 - t.y0;
}
...
function lb() {
	let e = 0, t = 0, n = 1, r = 1, i = 24, a = 8, o, s = ib, c = Qy, l, u, d = ab, f = ob, p = 6;
	function m() {
		let e = {
			nodes: d.apply(null, arguments),
			links: f.apply(null, arguments)
		};
		return h(e), g(e), _(e), v(e), x(e), cb(e), e;
	}
	m.update = function(e) {
		return cb(e), e;
	}, m.nodeId = function(e) {
		return arguments.length ? (s = typeof e == "function" ? e : $y(e), m) : s;
	}, m.nodeAlign = function(e) {
		return arguments.length ? (c = typeof e == "function" ? e : $y(e), m) : c;
		...
		return arguments.length ? (d = typeof e == "function" ? e : $y(e), m) : d;
	}, m.links = function(e) {
		return arguments.length ? (f = typeof e == "function" ? e : $y(e), m) : f;
	...
	function h({ nodes: e, links: t }) {
		...
		for (let [e, r] of t.entries()) {
			...
			typeof t != "object" && (t = r.source = sb(n, t)), typeof i != "object" && (i = r.target = sb(n, i)), t.sourceLinks.push(r), i.targetLinks.push(r);
		}
		if (u != null) for (let { sourceLinks: t, targetLinks: n } of e) t.sort(u), n.sort(u);
	}
	function g({ nodes: e }) {
		for (let t of e) t.value = t.fixedValue === void 0 ? Math.max(Zy(t.sourceLinks, rb), Zy(t.targetLinks, rb)) : t.fixedValue;
	}
	function _({ nodes: e }) {
	...
	function y({ nodes: t }) {
		let r = Yy(t, (e) => e.depth) + 1, a = (n - e - i) / (r - 1), o = Array(r);
		for (let n of t) {
	...
	function b(e) {
		let n = Xy(e, (e) => (r - t - (e.length - 1) * o) / Zy(e, rb));
		for (let i of e) {
			let e = t;
			for (let t of i) {
	...
	function x(e) {
		let n = y(e);
		o = Math.min(a, (r - t) / (Yy(n, (e) => e.length) - 1)), b(n);
		for (let e = 0; e < p; ++e) {
	...
	function D({ sourceLinks: e, targetLinks: t }) {
		if (u === void 0) {
			for (let { source: { sourceLinks: e } } of t) e.sort(tb);
			for (let { target: { targetLinks: t } } of e) t.sort(eb);
		}
	}
	function O(e) {
		if (u === void 0) for (let { sourceLinks: t, targetLinks: n } of e) t.sort(tb), n.sort(eb);
	}
	function k(e, t) {
...
var ub = Math.PI, db = 2 * ub, fb = 1e-6, pb = db - fb;
function mb() {
...
mb.prototype = hb.prototype = {
	...
	arcTo: function(e, t, n, r, i) {
		...
		if (this._x1 === null) this._ += "M" + (this._x1 = e) + "," + (this._y1 = t);
			...
			if (!(Math.abs(u * s - c * l) > fb) || !i) this._ += "L" + (this._x1 = e) + "," + (this._y1 = t);
			else {
				var f = n - a, p = r - o, m = s * s + c * c, h = f * f + p * p, g = Math.sqrt(m), _ = Math.sqrt(d), v = i * Math.tan((ub - Math.acos((m + d - h) / (2 * g * _))) / 2), y = v / _, b = v / g;
				Math.abs(y - 1) > fb && (this._ += "L" + (e + y * l) + "," + (t + y * u)), this._ += "A" + i + "," + i + ",0,0," + +(u * f > l * p) + "," + (this._x1 = e + b * s) + "," + (this._y1 = t + b * c);
			}
		}
	},
	arc: function(e, t, n, r, i, a) {
		...
		this._x1 === null ? this._ += "M" + c + "," + l : (Math.abs(this._x1 - c) > fb || Math.abs(this._y1 - l) > fb) && (this._ += "L" + c + "," + l), n && (d < 0 && (d = d % db + db), d > pb ? this._ += "A" + n + "," + n + ",0,1," + u + "," + (e - o) + "," + (t - s) + "A" + n + "," + n + ",0,1," + u + "," + (this._x1 = c) + "," + (this._y1 = l) : d > fb && (this._ += "A" + n + "," + n + ",0," + +(d >= ub) + "," + u + "," + (this._x1 = e + n * Math.cos(i)) + "," + (this._y1 = t + n * Math.sin(i))));
	},
...
function Sb(e) {
	var t = bb, n = xb, r = _b, i = vb, a = null;
	function o() {
		var o, s = yb.call(arguments), c = t.apply(this, s), l = n.apply(this, s);
		if (a ||= o = hb(), e(a, +r.apply(this, (s[0] = c, s)), +i.apply(this, s), +r.apply(this, (s[0] = l, s)), +i.apply(this, s)), o) return a = null, o + "" || null;
	}
	return o.source = function(e) {
		...
		return arguments.length ? (r = typeof e == "function" ? e : gb(+e), o) : r;
	}, o.y = function(e) {
		return arguments.length ? (i = typeof e == "function" ? e : gb(+e), o) : i;
...
function Db() {
	return wb().source(Tb).target(Eb);
}
//#endregion
//#region src/react/taste/taste.ts
var Ob = "/api/taste", kb = "/api/taste/refresh", Ab = "/api/taste/import", jb = "/api/taste/source", Mb = (e) => ["taste", e], Nb = ["taste", "refresh"], Pb = [
	["7d", "最近 7 天"],
	["30d", "最近 30 天"],
	["90d", "最近 90 天"],
	["365d", "最近一年"],
	["all", "全部时间"]
], Fb = (e, t) => Af(`${Ob}?window=${e}`, t), Ib = (e) => Af(kb, e);
...
async function Bb(e) {
	let t = await fetch(Ab, {
		method: "POST",
		credentials: "same-origin",
		headers: {
			"Content-Type": "application/octet-stream",
			"X-Peach-Filename": encodeURIComponent(e.name)
		},
		body: e
	}), n = null;
	try {
	...
	if (!t.ok) {
		let e = n?.error;
		throw new Df(e || `导入失败（${t.status}）`, t.status, n);
	}
	return n;
}
var Vb = 2e3, Hb = 1e4, Ub = (e) => e?.status === "running" ? Vb : Hb, Wb = (e) => e ? new Date(e).toLocaleDateString("zh-CN") : "—", Gb = (e) => e >= 3600 ? `${(e / 3600).toFixed(1)} 小时` : `${Math.round(e / 60)} 分钟`, Kb = (e) => Number(e.web_visits ?? e.score ?? e.visits ?? e.peach_items ?? 0);
function qb(e) {
...
var Yb = {
	...
	return [Yb.x + Math.cos(r) * n, Yb.y + Math.sin(r) * n];
};
function Qb(e) {
	let t = e.filter((e) => Number.isFinite(Number(e.score)) && Number(e.score) > 0).slice().sort((e, t) => Number(t.score) - Number(e.score)).slice(0, 6);
	if (t.length < 3) return [];
	let n = Math.max(...t.map((e) => Number(e.score)));
	return t.map((e, r) => {
		let [i, a] = Zb(r, t.length, Number(e.score) / n * 100), [o, s] = Zb(r, t.length, 116);
		return {
			name: e.name,
			x: i,
			y: a,
...
var $b = (e, t) => Array.from({ length: t }, (n, r) => Zb(r, t, e).map((e) => e.toFixed(2)).join(",")).join(" "), ex = (e) => e.map((e) => `${e.x.toFixed(2)},${e.y.toFixed(2)}`).join(" "), tx = [
	"周一",
	"周二",
	"周三",
	"周四",
	...
	"周六",
	"周日"
], nx = (e, t) => e ? Math.max(.12, e / t) : 0;
function rx(e) {
	let t = Array.from({ length: 7 }, () => Array(24).fill(0));
	for (let n of e?.hours || []) {
		let { weekday: e, hour: r, count: i } = n;
		!Number.isInteger(e) || e < 0 || e > 6 || !Number.isInteger(r) || r < 0 || r > 23 || !Number.isFinite(i) || i < 0 || (t[e][r] = (t[e][r] || 0) + i);
	}
	let n = t.flat(), r = Math.max(1, ...n);
	return {
...
function ix(e) {
	...
	let r = /* @__PURE__ */ new Date(`${t.at(-1).date}T00:00:00Z`), i = new Date(r);
	i.setUTCDate(i.getUTCDate() - 90);
	let a = new Map(t.map((e) => [e.date, e.count])), o = Math.max(1, ...t.map((e) => e.count)), s = Array.from({ length: 91 }, (e, t) => {
		let n = new Date(i);
		n.setUTCDate(i.getUTCDate() + t);
		let r = n.toISOString().slice(0, 10), s = a.get(r) || 0;
		return {
			key: r,
			label: r,
			count: s,
	...
	return {
		cells: s,
		total: s.reduce((e, t) => e + t.count, 0),
		start: i.toISOString().slice(0, 10),
		end: t.at(-1).date
	};
}
var ax = {
...
function sx(e = []) {
	...
	let n = [...new Set(t.map((e) => e.source))], r = [...new Set(t.map((e) => e.target))], i = lb().nodeId((e) => e.id).nodeWidth(10).nodePadding(22).extent([[155, 16], [535, 404]])({
		nodes: [...n.map((e) => ({
			id: `source:${e}`,
			name: e,
			side: "source"
	...
	}), a = t.reduce((e, t) => e + t.value, 0), o = Db();
	return {
		nodes: i.nodes.map((e) => ({
			id: e.id,
			name: e.name,
			...
			x: e.x0 ?? 0,
			y: e.y0 ?? 0,
			height: Math.max(1, (e.y1 ?? 0) - (e.y0 ?? 0)),
			value: e.value ?? 0,
			share: (e.value ?? 0) / a * 100,
			color: n.indexOf(e.name) % 6
		})),
		links: i.links.map((e, t) => {
			let r = e.source, i = e.target;
			return {
				key: `${r.id}->${i.id}:${t}`,
				d: o(e) || "",
				width: Math.max(.5, e.width || 0),
				color: n.indexOf(r.name) % 6,
				source: r.index ?? 0,
				target: i.index ?? 0,
				value: e.value,
				label: `${r.name} → ${i.name}`
...
var cx = (e) => e.length > 18 ? `${e.slice(0, 16)}…` : e, lx = [
	"stroke-chart-1",
	"stroke-chart-2",
	"stroke-chart-3",
	"stroke-chart-4",
	...
	"fill-chart-5",
	"fill-chart-6"
], dx = "flex min-w-0 flex-col gap-4 rounded-2xl border border-separator-border p-5";
function fx({ title: e, figure: t, note: n }) {
	return /* @__PURE__ */ (0, S.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, S.jsx)("span", {
			...
			children: [/* @__PURE__ */ (0, S.jsx)("b", {
				...
				className: "min-w-0 text-caption-1-regular break-words text-text-secondary",
				children: n
			})]
		})]
	});
}
function px({ rows: e, label: t }) {
	let n = Qb(e);
	...
	return /* @__PURE__ */ (0, S.jsxs)("svg", {
		...
		children: [
			/* @__PURE__ */ (0, S.jsx)("title", { children: n.map((e) => e.name).join("，") }),
			Xb.map((e) => /* @__PURE__ */ (0, S.jsx)("polygon", {
				points: $b(e, r),
				fill: "none",
				className: "stroke-separator-border",
				strokeWidth: 1
			}, e)),
			/* @__PURE__ */ (0, S.jsx)("polygon", {
				points: ex(n),
				strokeWidth: 2,
				strokeLinejoin: "round",
				fillOpacity: .18,
			...
			n.map((e) => /* @__PURE__ */ (0, S.jsx)("text", {
				x: e.labelX,
				y: e.labelY,
				dominantBaseline: "middle",
				textAnchor: e.labelX < 145 ? "end" : e.labelX > 175 ? "start" : "middle",
...
function mx({ rows: e, label: t }) {
	let n = e.filter((e) => Number.isFinite(Number(e.score)) && Number(e.score) > 0).slice().sort((e, t) => Number(t.score) - Number(e.score)).slice(0, 8);
	if (!n.length) return null;
	let r = Jb(n);
	return /* @__PURE__ */ (0, S.jsx)("ol", {
		"aria-label": t,
		className: "flex flex-col gap-2",
		children: n.map((e, t) => /* @__PURE__ */ (0, S.jsxs)("li", {
			className: "flex min-w-0 flex-col gap-1.5",
			children: [/* @__PURE__ */ (0, S.jsxs)("p", {
				className: "flex items-baseline justify-between gap-3 text-body-2-regular text-text-primary",
				children: [/* @__PURE__ */ (0, S.jsx)("span", {
					...
					className: "tabular-nums",
					children: Number(e.score).toLocaleString()
				})]
...
function hx({ title: e, unit: t, cells: n, total: r, columns: i, rows: a, axis: o, footer: s }) {
	let [c, l] = (0, x.useState)(null), u = o ? 30 : 0, d = o ? 18 : 0;
	return /* @__PURE__ */ (0, S.jsxs)("section", {
		className: dx,
		children: [
			/* @__PURE__ */ (0, S.jsx)(fx, {
				title: e,
				figure: (c ? c.count : r).toLocaleString(),
				note: c ? c.label : t
			}),
			/* @__PURE__ */ (0, S.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, S.jsxs)("svg", {
					...
					viewBox: `0 0 ${u + i * 17} ${d + a * 17}`,
					className: "block h-auto min-w-80 w-full",
					children: [o, n.map((e, t) => {
						let n = t % i, r = Math.floor(t / i);
						return /* @__PURE__ */ (0, S.jsx)("rect", {
							tabIndex: 0,
							role: "img",
							"aria-label": `${e.label}，${e.count} 次访问`,
							x: u + n * 17,
							y: d + r * 17,
							width: 14,
							height: 14,
							...
							className: e.share ? "fill-chart-4 outline-none focus-visible:stroke-border-focus-ring" : "fill-chart-track outline-none focus-visible:stroke-border-focus-ring",
							onPointerEnter: () => l(e),
							onFocus: () => l(e),
							onBlur: () => l(null)
						}, e.key);
			...
			/* @__PURE__ */ (0, S.jsx)("footer", {
				className: "flex flex-wrap justify-between gap-3 text-caption-1-regular text-text-secondary",
				children: s
			})
		]
	});
...
var gx = "口味网站访问";
function _x({ activity: e }) {
	let t = rx(e), n = ix(e);
	if (!n.cells.length) return /* @__PURE__ */ (0, S.jsxs)("section", {
		className: dx,
		children: [/* @__PURE__ */ (0, S.jsx)("h3", {
			className: "text-headline-medium text-text-primary",
			children: "浏览活跃时间"
			...
			className: "text-body-2-regular text-text-secondary",
			children: "还没有可用于分析的口味网站访问记录。"
		})]
	});
	let r = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [tx.map((e, t) => /* @__PURE__ */ (0, S.jsx)("text", {
		x: 0,
		y: 18 + t * 17 + 7,
		dominantBaseline: "middle",
		className: "fill-text-secondary text-caption-1-regular",
		children: e
	}, e)), Array.from({ length: 24 }, (e, t) => t % 2 ? null : /* @__PURE__ */ (0, S.jsx)("text", {
		x: 30 + t * 17,
		y: 8,
		dominantBaseline: "middle",
		className: "fill-text-secondary text-caption-1-regular",
	...
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, S.jsx)(hx, {
			...
			rows: 7,
			axis: r,
			footer: /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)("span", { children: "星期 × 小时" }), /* @__PURE__ */ (0, S.jsx)("span", { children: e?.timezone || "UTC+08:00" })] })
		}), /* @__PURE__ */ (0, S.jsx)(hx, {
			title: "每日活跃",
			unit: gx,
			cells: n.cells,
			...
			columns: 13,
			rows: 7,
			footer: /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)("span", { children: n.start }), /* @__PURE__ */ (0, S.jsx)("span", { children: n.end })] })
		})]
	});
}
function vx({ flows: e }) {
	let [t, n] = (0, x.useState)(null), r = sx(e);
	if (!r) return null;
	...
	return /* @__PURE__ */ (0, S.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, S.jsx)("div", {
				className: "min-w-0 overflow-x-auto",
				children: /* @__PURE__ */ (0, S.jsxs)("svg", {
					viewBox: `0 0 ${ax.width} ${ax.height}`,
					fill: "none",
					role: "img",
					"aria-label": "来源网站与创作者线索",
					className: "block h-auto min-w-160 w-full",
					onPointerLeave: () => n(null),
					children: [/* @__PURE__ */ (0, S.jsx)("g", { children: r.links.map((e) => /* @__PURE__ */ (0, S.jsx)("path", {
						d: e.d,
						strokeWidth: e.width,
						tabIndex: 0,
						role: "img",
						...
						fillOpacity: 0,
						strokeOpacity: a(e, e.label) ? .7 : .08,
						className: `outline-none transition-opacity ${lx[e.color]}`,
						onPointerEnter: () => n({
							value: e.value,
							label: e.label,
							node: null
						...
						onBlur: () => n(null)
					}, e.key)) }), /* @__PURE__ */ (0, S.jsx)("g", { children: r.nodes.map((e) => /* @__PURE__ */ (0, S.jsxs)("g", {
						tabIndex: 0,
						role: "img",
						"aria-label": `${e.name}：${e.value} 条线索`,
						...
						children: [/* @__PURE__ */ (0, S.jsx)("rect", {
							...
							height: e.height,
							rx: 5,
							className: e.side === "source" ? ux[e.color] : "fill-text-secondary"
						}), /* @__PURE__ */ (0, S.jsxs)("text", {
							x: ox[e.side],
							y: e.y + e.height / 2,
							textAnchor: e.side === "source" ? "end" : "start",
							dominantBaseline: "middle",
							className: "fill-text-secondary text-caption-1-regular",
							children: [cx(e.name), /* @__PURE__ */ (0, S.jsx)("tspan", {
								x: ox[e.side],
								dy: 15,
			...
			/* @__PURE__ */ (0, S.jsxs)("footer", {
				className: "flex justify-between gap-3 text-caption-1-regular text-text-secondary",
				children: [/* @__PURE__ */ (0, S.jsx)("span", { children: "来源网站" }), /* @__PURE__ */ (0, S.jsx)("span", { children: "创作者 · 线索占比" })]
			})
		]
	});
}
...
var yx = 10, bx = Z(d_, f_, "text-body-2-medium"), xx = "flex min-w-0 flex-col gap-4 rounded-2xl border border-separator-border p-5", Sx = "relative cursor-pointer py-3 text-body-2-regular text-text-secondary outline-none hover:text-text-primary focus-visible:ring-2 focus-visible:ring-border-focus-ring data-selected:text-text-primary", Cx = "flex cursor-pointer items-center rounded-lg px-3 py-1.5 text-body-2-medium text-text-secondary outline-none hover:text-text-primary focus-visible:ring-2 focus-visible:ring-border-focus-ring data-selected:bg-background-tertiary-default data-selected:text-text-primary", wx = "读取运行 Peach 的这台电脑上的浏览记录", Tx = "导入或读取浏览记录后，这里会列出已采集设备。", Ex = "馆藏里暂时没有对得上浏览信号的标签。", Dx = "采集浏览记录后，这里会显示聚合后的口味证据。", Ox = "这些词在浏览记录中出现，但 Peach 观看记录还没有对应证据", kx = "在运行 Peach 的电脑上使用浏览器：点上面的「读取浏览器历史」。", Ax = "记录在其他设备上：导出文件后，点上面的「导入历史文件」。多台设备的文件分别导入。", jx = "需要刷新时再次读取或导入；数据源可在页面底部移除。", Mx = "这个数据源将不再用于口味分析。原始导出文件保留。", Nx = "peach-taste-guide-dismissed";
function Px({ icon: e, term: t, figure: n, detail: r }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex min-w-0 flex-col gap-2 rounded-2xl border border-separator-border p-4",
		children: [
			/* @__PURE__ */ (0, S.jsxs)("span", {
				className: "flex min-w-0 items-center gap-2 text-body-2-regular text-text-secondary",
				children: [/* @__PURE__ */ (0, S.jsx)(e, {
...
function Fx({ name: e, domain: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("span", {
		...
		children: [e.slice(0, 1).toUpperCase(), /* @__PURE__ */ (0, S.jsx)("img", {
			src: i({ domain: t }),
			alt: "",
			loading: "lazy",
			width: 20,
...
function Lx({ rows: e, kind: t, visual: n, empty: r, onSignal: i, avatarInner: a }) {
	...
	let c = Jb(e), l = o ? e : e.slice(0, yx);
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-3",
		children: [/* @__PURE__ */ (0, S.jsx)("ol", {
			className: "inline-grid w-full gap-1 sm:grid-cols-2",
			children: l.map((e, r) => {
				let o = !!t && !!e.peach_items, s = String(e.source_domain || ""), l = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [
					/* @__PURE__ */ (0, S.jsx)("span", {
						className: "w-6 shrink-0 text-caption-1-regular tabular-nums text-text-secondary",
						children: r + 1
					}),
					n === "domain" ? /* @__PURE__ */ (0, S.jsx)(Fx, {
						name: e.name,
						domain: e.name
					}) : null,
					n === "creator" && !e.entity_id && !e.has_avatar && s ? /* @__PURE__ */ (0, S.jsx)(Fx, {
						name: e.name,
						domain: s
					}) : null,
					n !== "none" && n !== "domain" && (e.entity_id || e.has_avatar || !s) ? /* @__PURE__ */ (0, S.jsx)(Ix, { html: a(e.name, e.entity_id ? {
						id: e.entity_id,
						has_image: !!e.has_image,
						avatar_focus: e.avatar_focus
					} : null, e.has_avatar ? e.representative_asset_id ?? null : null, n === "creator" ? "creator" : t || "performer") }) : null,
					/* @__PURE__ */ (0, S.jsxs)("span", {
					...
					o ? /* @__PURE__ */ (0, S.jsx)(Tu, {
						"aria-hidden": !0,
						className: "size-4 shrink-0 text-text-tertiary"
					}) : null
				] }), u = "flex w-full min-w-0 items-center gap-2.5 rounded-lg px-3 py-2 text-left";
				return /* @__PURE__ */ (0, S.jsx)("li", {
					className: "min-w-0",
					children: o ? /* @__PURE__ */ (0, S.jsx)("button", {
						type: "button",
						onClick: () => i(t, e.name),
						className: `${u} cursor-pointer outline-none hover:bg-background-primary-hover focus-visible:ring-2 focus-visible:ring-border-focus-ring`,
						children: l
					}) : /* @__PURE__ */ (0, S.jsx)("div", {
						className: u,
						children: l
		...
		}), e.length > yx ? /* @__PURE__ */ (0, S.jsx)("div", {
			className: "flex justify-center",
			children: /* @__PURE__ */ (0, S.jsx)($, {
				variant: "secondary",
				size: "small",
				onClick: () => s(!o),
				children: o ? "收起排名" : "展开更多排名"
			})
		}) : null]
	});
}
function Rx({ label: e, panels: t, onSignal: n, avatarInner: r }) {
	return /* @__PURE__ */ (0, S.jsxs)(cg, {
		className: "flex flex-col rounded-2xl border border-separator-border",
		children: [/* @__PURE__ */ (0, S.jsx)(ug, {
			"aria-label": e,
			className: "flex gap-6 overflow-x-auto border-b border-separator-border px-4",
			children: t.map((e) => /* @__PURE__ */ (0, S.jsx)(fg, {
				id: e.id,
				className: Sx,
				children: e.name
			}, e.id))
		}), t.map((e) => /* @__PURE__ */ (0, S.jsx)(pg, {
			id: e.id,
			className: "p-4",
			children: /* @__PURE__ */ (0, S.jsx)(Lx, {
				...e.props,
				onSignal: n,
				avatarInner: r
			})
...
function zx({ data: e, onSignal: t, navigate: n }) {
	let r = e.analysis;
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, S.jsx)("h3", {
					...
					className: "flex flex-wrap items-baseline gap-2.5 text-body-2-regular text-text-secondary",
					children: [/* @__PURE__ */ (0, S.jsx)("span", {
						className: i.level === "high" ? "shrink-0 rounded-md bg-status-lime-background px-2 py-0.5 text-caption-1-medium text-status-lime-text" : i.level === "medium" ? "shrink-0 rounded-md bg-status-yellow-background px-2 py-0.5 text-caption-1-medium text-status-yellow-text" : "shrink-0 rounded-md bg-background-tertiary-default px-2 py-0.5 text-caption-1-medium text-text-secondary",
						children: i.label || "仍在学习"
					}), /* @__PURE__ */ (0, S.jsx)("span", {
						className: "min-w-0",
						children: r.headline
					})]
			...
			r.points?.length ? /* @__PURE__ */ (0, S.jsx)("div", {
				className: "inline-grid w-full gap-3 sm:grid-cols-2",
				children: r.points.map((e) => /* @__PURE__ */ (0, S.jsxs)("div", {
					className: "flex min-w-0 flex-col gap-1 rounded-xl bg-background-tertiary-default p-3",
					children: [/* @__PURE__ */ (0, S.jsx)("span", {
						className: "text-caption-1-regular text-text-secondary",
						children: e.label
					}), /* @__PURE__ */ (0, S.jsx)("b", {
			...
			a.length ? /* @__PURE__ */ (0, S.jsx)("div", {
				className: "flex flex-col gap-2",
				children: a.map((e) => /* @__PURE__ */ (0, S.jsxs)("button", {
					type: "button",
					onClick: e.act,
					className: "flex w-full min-w-0 cursor-pointer items-center gap-3 rounded-xl bg-background-tertiary-default p-3 text-left outline-none hover:bg-background-primary-hover focus-visible:ring-2 focus-visible:ring-border-focus-ring",
					children: [/* @__PURE__ */ (0, S.jsxs)("span", {
						className: "flex min-w-0 grow flex-col gap-1",
						children: [/* @__PURE__ */ (0, S.jsx)("b", {
...
function Bx({ onboarding: e, done: t }) {
	let [n, r] = (0, x.useState)(() => {
		try {
			return localStorage.getItem(Nx) === "1";
		} catch {
			return !1;
		}
	});
	return t || n ? null : /* @__PURE__ */ (0, S.jsx)("div", {
		className: "rounded-2xl border border-separator-border p-4",
		children: /* @__PURE__ */ (0, S.jsxs)(E_, {
			summary: "浏览器历史记录导入指南",
			defaultOpen: e,
			children: [
				/* @__PURE__ */ (0, S.jsx)("p", {
				...
				/* @__PURE__ */ (0, S.jsxs)("ul", {
					className: "flex list-disc flex-col gap-1 pl-5 text-body-2-regular text-text-secondary",
					children: [/* @__PURE__ */ (0, S.jsxs)("li", { children: [
						"Chrome：在 ",
						/* @__PURE__ */ (0, S.jsx)("a", {
							...
							children: "Google Takeout"
						}),
						" ",
						"选择 Chrome 历史记录，下载 ZIP 后直接导入。"
					] }), /* @__PURE__ */ (0, S.jsxs)("li", { children: [
						"其他浏览器：用 ",
						/* @__PURE__ */ (0, S.jsx)("a", {
							href: "https://github.com/purarue/browserexport",
							target: "_blank",
							rel: "noopener noreferrer",
							className: "text-text-primary underline-offset-4 hover:underline",
							children: "browserexport"
						}),
						" ",
						"导出历史记录，再导入导出文件。"
					] })]
...
function Vx({ busy: e, onRefresh: t, onImport: n }) {
	let r = (0, x.useRef)(null), [i, a] = (0, x.useState)(!1), o = (e) => {
		a(!1), e();
	};
	return /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsxs)("span", {
		className: "flex items-center gap-1",
...
function Hx({ sources: e, window: t, toast: n }) {
	let r = dt({
		mutationFn: (e) => zb(e, t),
		onSuccess: (e) => {
			Lf.setQueryData(Mb(t), e.dashboard), n("已移除口味数据源");
		}
	});
	return /* @__PURE__ */ (0, S.jsxs)("section", {
		className: xx,
		...
		children: [
			...
			e.length ? /* @__PURE__ */ (0, S.jsx)("div", {
				...
				children: e.map((e) => /* @__PURE__ */ (0, S.jsxs)("div", {
					className: "flex min-w-0 items-center gap-3 rounded-xl bg-background-tertiary-default p-3",
					children: [
						/* @__PURE__ */ (0, S.jsx)("span", {
							className: "inline-grid size-8 shrink-0 place-items-center rounded-lg text-text-secondary",
							children: e.browser === "browserexport" ? /* @__PURE__ */ (0, S.jsx)(Hu, {
								"aria-hidden": !0,
								className: "size-4"
							}) : /* @__PURE__ */ (0, S.jsx)(Ou, {
								"aria-hidden": !0,
						...
						/* @__PURE__ */ (0, S.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, S.jsx)("b", {
								...
								className: "min-w-0 text-caption-1-regular break-words text-text-secondary",
								children: `${e.browser} · ${e.host} · ${Number(e.visits || 0).toLocaleString()} 条`
							})]
						}),
						/* @__PURE__ */ (0, S.jsx)($, {
							variant: "secondary",
...
function Ux(e) {
	let { onSignal: t, navigate: r, toast: i, avatarInner: a, onboarding: o } = e, [s, c] = (0, x.useState)("all"), [l, u] = (0, x.useState)("browser"), [d, f] = (0, x.useState)(!1), [p, m] = (0, x.useState)(null), h = (0, x.useRef)(null), g = ut({
		queryKey: Mb(s),
		queryFn: ({ signal: e }) => Fb(s, e),
		placeholderData: me
	}), _ = ut({
		queryKey: Nb,
		queryFn: ({ signal: e }) => Ib(e),
		refetchInterval: (e) => Ub(e.state.data)
	}), v = dt({
		mutationFn: () => Rb(s),
		onSuccess: () => {
			f(!0), m(null), Lf.invalidateQueries({ queryKey: Nb });
		}
	}), y = dt({
		mutationFn: (e) => Bb(e),
		onSuccess: (e) => {
	...
	(0, x.useEffect)(() => {
		...
		if (e) {
			...
			d && (f(!1), m(e), e.status !== "failed" && (Lf.invalidateQueries({ queryKey: ["taste"] }), i("已更新口味分析")));
		}
	}, [
		_.data,
		d,
	...
	let C = (e) => {
		...
		e.currentTarget.value = "", !(!t || y.isPending) && (y.reset(), y.mutate(t));
	}, w = () => {
		b || v.isPending || (v.reset(), v.mutate());
	}, T = g.data;
	if (!T) return /* @__PURE__ */ (0, S.jsx)(Ff, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
		tone: "error",
		title: "读取失败",
		children: g.error ? kf(g.error) : "读取口味分析失败"
	}) });
	let E = T.summary || {}, D = T.coverage || {}, O = T.rankings || {}, k = T.storage || {}, A = O.browser_categories || [], ee = T.gaps || [], j = D.tagged || 0, te = D.identified || 0, M = v.error ? kf(v.error) : y.error ? kf(y.error) : p?.status === "failed" ? p.error || "读取未取得" : "";
	return /* @__PURE__ */ (0, S.jsxs)(Ff, { children: [
		/* @__PURE__ */ (0, S.jsxs)(cg, {
			selectedKey: l,
			...
			children: [
				/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, S.jsxs)(ug, {
						"aria-label": "口味证据来源",
						className: "flex flex-wrap gap-1",
						children: [/* @__PURE__ */ (0, S.jsx)(fg, {
							id: "browser",
							className: Cx,
							children: "浏览器记录"
						}), /* @__PURE__ */ (0, S.jsx)(fg, {
						...
						children: [
							/* @__PURE__ */ (0, S.jsx)(Q_, {
								...
								children: Pb.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)($_, {
									id: e,
									children: t
								}, e))
							}),
							/* @__PURE__ */ (0, S.jsx)(Vx, {
								busy: b || v.isPending || y.isPending,
								onRefresh: w,
				...
				/* @__PURE__ */ (0, S.jsx)(Bx, {
					onboarding: o,
					done: !!(E.history_sources || T.updated_at)
				}),
				/* @__PURE__ */ (0, S.jsxs)("div", {
					"aria-live": "polite",
					className: "flex flex-col gap-3 empty:hidden",
					children: [
						b ? _.data?.total ? /* @__PURE__ */ (0, S.jsxs)("div", {
							className: "flex flex-col gap-1.5",
							children: [/* @__PURE__ */ (0, S.jsx)(If, {
								label: _.data.message || "正在读取浏览记录",
								value: _.data.checked || 0,
								max: _.data.total
							}), /* @__PURE__ */ (0, S.jsx)("p", {
								className: "text-caption-1-regular text-text-secondary",
								children: `${_.data.message || "正在读取浏览记录"} · ${_.data.checked || 0} / ${_.data.total}`
							})]
						}) : /* @__PURE__ */ (0, S.jsx)(Nf, { label: _.data?.message || "正在读取浏览记录并更新口味分析" }) : null,
						y.isPending ? /* @__PURE__ */ (0, S.jsx)(Nf, { label: "正在导入历史文件" }) : null,
						M ? /* @__PURE__ */ (0, S.jsx)(Pf, {
							tone: "error",
							children: M
						}) : null
					]
				}),
				/* @__PURE__ */ (0, S.jsxs)(pg, {
					id: "browser",
					className: "flex flex-col gap-5",
					children: [
						/* @__PURE__ */ (0, S.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Fu,
									term: "浏览记录",
									figure: Number(E.history_visits || 0).toLocaleString(),
									detail: `${E.history_sources || 0} 个数据源 · ${Wb(E.range_start)}—${Wb(E.range_end)}`
								}),
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Ru,
									term: "口味维度",
									figure: A.length.toLocaleString(),
									detail: A[0]?.name || "尚无主维度"
								}),
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: zu,
									term: "浏览候选",
									figure: ee.length.toLocaleString()
								}),
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Ou,
									term: "私有导出",
									figure: Number(k.exports || 0).toLocaleString(),
									detail: n(k.bytes || 0)
								})
							]
						}),
						/* @__PURE__ */ (0, S.jsxs)("section", {
							className: `${xx} md:flex-row md:gap-6`,
							"aria-label": "浏览器画像",
							children: [/* @__PURE__ */ (0, S.jsxs)("div", {
								className: "flex shrink-0 flex-col gap-2 border-b border-separator-border pb-5 md:w-72 md:border-b-0 md:border-r md:pr-6 md:pb-0",
								children: [
									/* @__PURE__ */ (0, S.jsx)("span", {
										className: "text-caption-1-regular text-text-secondary",
										children: "浏览器画像"
									...
									/* @__PURE__ */ (0, S.jsx)("small", {
										className: "text-caption-1-regular text-text-secondary",
										children: T.updated_at ? `更新于 ${Wb(T.updated_at)}` : "尚未采集浏览记录"
									})
								]
							}), /* @__PURE__ */ (0, S.jsx)("div", {
								className: "min-w-0 grow",
								children: A.length ? /* @__PURE__ */ (0, S.jsx)(mx, {
									rows: A,
									label: "口味维度排名"
								}) : /* @__PURE__ */ (0, S.jsx)(Mf, {
									icon: zu,
						...
						/* @__PURE__ */ (0, S.jsx)(_x, { activity: T.activity }),
						/* @__PURE__ */ (0, S.jsx)(vx, { flows: T.creator_flows }),
						/* @__PURE__ */ (0, S.jsx)(Rx, {
							label: "浏览器口味维度",
							onSignal: t,
							avatarInner: a,
						...
						/* @__PURE__ */ (0, S.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Mu,
									term: "Peach 看过",
									figure: Number(E.peach_items || 0).toLocaleString(),
									detail: Gb(E.peach_seconds || 0)
								}),
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Vu,
									term: "喜欢",
									figure: Number(E.liked || 0).toLocaleString()
								}),
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Bu,
									term: "不合口味",
									figure: Number(E.disliked || 0).toLocaleString()
								}),
								/* @__PURE__ */ (0, S.jsx)(Px, {
									icon: Ru,
									term: "有标签",
									figure: j.toLocaleString()
								})
							]
						}),
						/* @__PURE__ */ (0, S.jsxs)("section", {
							...
							"aria-label": "Peach 观看",
							children: [/* @__PURE__ */ (0, S.jsxs)("div", {
								className: "flex shrink-0 flex-col gap-0.5 border-b border-separator-border pb-5 md:w-72 md:border-b-0 md:border-r md:pr-6 md:pb-0",
								children: [
									/* @__PURE__ */ (0, S.jsx)("span", {
										className: "text-caption-1-regular text-text-secondary",
										children: "Peach 观看"
									...
									/* @__PURE__ */ (0, S.jsx)("b", {
										className: "text-display-4-medium tabular-nums text-text-primary",
										children: Number(E.peach_items || 0).toLocaleString()
									}),
									/* @__PURE__ */ (0, S.jsx)("span", {
										className: "text-body-2-regular text-text-secondary",
										children: "个作品有内部行为证据"
...
function Wx({ term: e, value: t, rest: n }) {
	...
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)("p", {
			...
			children: [/* @__PURE__ */ (0, S.jsx)("span", { children: e }), /* @__PURE__ */ (0, S.jsxs)("b", {
				className: "tabular-nums",
				children: [t.toLocaleString(), /* @__PURE__ */ (0, S.jsx)("span", {
					className: "ml-1.5 text-caption-1-regular text-text-secondary",
					children: `${n} 项待补`
				})]
			})]
...
var Gx = null;
function Kx() {
	return Gx?.isConnected || (Gx = document.createElement("div"), Gx.className = "peach-react", Gx.dataset.reactOverlays = "", document.body.append(Gx)), Gx;
}
function qx(e) {
	return (t, n) => {
		let r = (0, xu.createRoot)(t), i = (t) => r.render(/* @__PURE__ */ (0, S.jsx)(T, {
			client: Lf,
			children: /* @__PURE__ */ (0, S.jsx)(dc, {
				getContainer: Kx,
				children: /* @__PURE__ */ (0, S.jsx)(e, { ...t })
			})
		}));
		return (0, Jr.flushSync)(() => i(n)), {
			update: i,
			unmount: () => r.unmount()
		};
	};
...
var Jx = {
	...
	"library-processing": {
		prefetch: (e, t) => qg(t),
		mount: qx((e) => e.mode === "notice" ? /* @__PURE__ */ (0, S.jsx)(B_, { ...e }) : /* @__PURE__ */ (0, S.jsx)(L_, { ...e }))
	},
	"quality-goals": {
		prefetch: (e, t) => W_(t),
		mount: qx(q_)
