...
var Dl = {
	...
	width: "totalWidth",
	height: "totalHeight"
}, Ml = {}, Nl = () => typeof document < "u" ? window.visualViewport : null;
function Pl(e, t) {
	...
	} else ({width: n, height: r, top: o, left: s} = Gl(e, !1)), c.top = e.scrollTop, c.left = e.scrollLeft, i = n, a = r;
...
function Il(e, t, n, r, i, a, o) {
	let s = i.scroll[e] ?? 0, c = r[Al[e]], l = o[e] + r.scroll[Dl[e]] + a, u = o[e] + r.scroll[Dl[e]] + c - a, d = t - s + r.scroll[Dl[e]] + o[e] - r[Dl[e]], f = t - s + n + r.scroll[Dl[e]] + o[e] - r[Dl[e]];
...
function Rl(e) {
	if (Ml[e]) return Ml[e];
	let [t, n] = e.split(" "), r = Dl[t] || "right", i = kl[r];
	Dl[n] || (n = "center");
	let a = Al[r], o = Al[i];
	return Ml[e] = {
		placement: t,
...
function zl(e, t, n, r, i, a, o, s, c, l, u) {
	...
	if (_[m] = Lo(_[m], v, y), d === p) {
		let t = s ? u[h] : u[jl[h]];
		_[Ol[p]] = Math.floor(t - e[p] + i);
	} else _[p] = Math.floor(e[p] + e[h] + i);
	return _;
}
function Bl(e, t, n, r, i, a, o, s, c, l, u) {
	let d = (e.top == null ? c[jl.height] - (e.bottom ?? 0) - o : e.top) - (c.scroll.top ?? 0), f = l ? n.top : 0, p = {
...
function Vl(e, t, n, r, i, a, o, s) {
	...
	return c === l ? Math.max(0, n[l] - (o.scroll[l] ?? 0) - (e[l] + (s ? t[l] : 0)) - (r[l] ?? 0) - r[Ol[l]] - i) : Math.max(0, e[u] + e[l] + (s ? t[l] : 0) - n[l] - n[u] + (o.scroll[l] ?? 0) - (r[l] ?? 0) - r[Ol[l]] - i);
}
function Hl(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _) {
	let v = Rl(e), { size: y, crossAxis: b, crossSize: x, placement: S, crossPlacement: C } = v, w = zl(t, s, n, v, u, d, l, f, m, h, c), T = u, E = Vl(s, l, t, i, a + u, v, c, g);
	if (o && n[y] > E) {
		let e = Rl(`${Ol[S]} ${C}`), r = zl(t, s, n, e, u, d, l, f, m, h, c);
		Vl(s, l, t, i, a + u, e, c, g) > E && (v = e, w = r, T = u);
	}
	let D = "bottom";
	...
	let O = Il(b, w[b], n[x], s, c, a, l);
	w[b] += O;
	let k = Bl(w, s, l, f, i, a, n.height, D, c, g, _);
	p && p < k && (k = p), n.height = Math.min(n.height, k), w = zl(t, s, n, v, T, d, l, f, m, h, c), O = Il(b, w[b], n[x], s, c, a, l), w[b] += O;
	let A = {}, ee = t[b] - w[b] - i[Dl[b]], j = ee + .5 * t[x], te = m / 2 + h, M = Dl[b] === "left" ? (i.left ?? 0) + (i.right ?? 0) : (i.top ?? 0) + (i.bottom ?? 0), ne = n[x] - M - m / 2 - h;
	A[b] = Lo(Lo(j, t[b] + m / 2 - (w[b] + i[Dl[b]]), t[b] + t[x] - m / 2 - (w[b] + i[Dl[b]])), te, ne), {placement: S, crossPlacement: C} = v, m ? ee = A[b] : C === "right" ? ee += t[x] : C === "center" && (ee += t[x] / 2);
...
function Ul(e) {
	let { placement: t, targetNode: n, overlayNode: r, scrollNode: i, padding: a, shouldFlip: o, boundaryElement: s, offset: c, crossOffset: l, maxHeight: u, arrowSize: d = 0, arrowBoundaryOffset: f = 0, targetRect: p } = e, m = Nl(), h = r instanceof HTMLElement ? ql(r) : document.documentElement, g = h === document.documentElement, _ = window.getComputedStyle(h).position, v = !!_ && _ !== "static", y = g ? Gl(n, !1, p) : Kl(n, h, !1, p);
	if (!g) {
	...
	let S = Fl(i), C = Pl(s, m), w = Pl(h, m), T;
	...
	let E = R(s, h);
	return Hl(t, y, b, S, x, a, o, C, w, T, c, l, v, u, d, f, E, m);
}
function Wl(e, t) {
...
function Gl(e, t, n) {
	let { top: r, left: i, width: a, height: o } = n || Wl(e, t), { scrollTop: s, scrollLeft: c, clientTop: l, clientLeft: u } = document.documentElement;
	return {
		top: r + s - l,
		left: i + c - u,
		width: a,
...
function Kl(e, t, n, r) {
	...
	if (i.position === "fixed") a = r || Wl(e, n);
	else {
		a = Gl(e, n, r);
		let i = Gl(t, n), o = window.getComputedStyle(t);
...
function ql(e) {
	...
	if (t && t === document.body && window.getComputedStyle(t).position === "static" && !Jl(t) && (t = document.documentElement), t == null) for (t = e.parentElement; t && !Jl(t);) t = t.parentElement;
...
var Yl = typeof document < "u" ? window.visualViewport : null;
function Xl(e) {
	let { direction: t } = Mi(), { arrowSize: n, targetRef: r, overlayRef: i, arrowRef: a, scrollRef: o = i, placement: s = "bottom", containerPadding: c = 12, shouldFlip: l = !0, boundaryElement: u = typeof document < "u" ? document.body : null, offset: d = 0, crossOffset: f = 0, shouldUpdatePosition: p = !0, isOpen: m = !0, onClose: h, maxHeight: g, arrowBoundaryOffset: _ = 0, getTargetRect: v } = e, [y, b] = (0, x.useState)(null), S = [
		...
		_,
		n
	], C = (0, x.useRef)(Yl?.scale);
	(0, x.useEffect)(() => {
		m && (C.current = Yl?.scale);
	}, [m]);
	let w = (0, x.useCallback)(() => {
		if (p === !1 || !m || !i.current || !r.current || !u || Yl?.scale !== C.current) return;
		let e = null;
		...
		let y = Ul({
			...
			crossOffset: f,
			maxHeight: g,
			arrowSize: n ?? (a?.current ? Wl(a.current, !0).width : 0),
	...
	V(() => {
		...
		Yl?.addEventListener("resize", t), Yl?.addEventListener("scroll", n);
		let r = jt(It(window), "scroll", n);
		return () => {
			Yl?.removeEventListener("resize", t), Yl?.removeEventListener("scroll", n), r();
		};
	}, [w]);
...
function $l(e, t) {
	...
	}, i ?? r), { overlayProps: f, arrowProps: p, placement: m, triggerAnchorPoint: h } = Xl({
		...c,
		targetRef: n,
		overlayRef: r,
		isOpen: t.isOpen,
...
function tu(e, t, n) {
	...
	let { name: T, form: E, descriptionId: D, errorMessageId: O, validationBehavior: k } = eu.get(t);
...
function au(e, t, n) {
	let r = ru.get(t) || {}, { autoComplete: i, name: a = r.name, form: o = r.form, isDisabled: s = r.isDisabled } = e, { validationBehavior: c, isRequired: l } = r, { visuallyHiddenProps: u } = zo({ style: {
		position: "fixed",
		top: 0,
		left: 0
	} });
...
function ou(e) {
	let { state: t, triggerRef: n, label: r, name: i, form: a, isDisabled: o } = e, s = (0, x.useRef)(null), c = (0, x.useRef)(null), { containerProps: l, selectProps: u } = au({
		...e,
	...
	if (i) {
		let { validationBehavior: e } = ru.get(t) || {};
		d.length === 0 && (d = [null]);
		let n = d.map((t, n) => {
			let r = {
				type: "hidden",
...
var cu = /* @__PURE__ */ m(((e) => {
	...
	var Ra = F.S;
	F.S = function(e, t) {
		if (hd = Be(), typeof t == "object" && t && typeof t.then == "function" && Fa(e, t), ka !== null) for (var n = yf; n !== null;) Oa(n, ka), n = n.next;
		if (n = e.types, n !== null) {
	...
	function So(e, t) {
		e = X, ye(xo, e), ye(bo, t), X = e | t.baseLanes;
	}
	function Co() {
		ye(xo, X), ye(bo, bo.current);
	}
	function wo() {
		X = xo.current, ve(bo), ve(xo);
	}
			...
			do {
				...
				if (f === u.lane ? (Io & f) === f : (Y & f) === f) {
					...
					if (p === 0) l !== null && (l = l.next = {
						...
						eagerState: u.eagerState,
						next: null
					}, l === null ? (c = l = f, s = o) : l = l.next = f, K.lanes |= p, od |= p;
					...
					eagerState: u.eagerState,
					next: null
				}, l === null ? (c = l = p, s = o) : l = l.next = p, K.lanes |= f, od |= f;
				u = u.next;
			} while (u !== null && u !== t);
	...
	function Ks(e, t, n) {
		return n === void 0 || Io & 1073741824 && !(Y & 261930) ? e.memoizedState = t : (e.memoizedState = n, e = Ad(), K.lanes |= e, od |= e, n);
	}
	function qs(e, t, n, r) {
		return Ir(n, t) ? n : bo.current === null ? !(Io & 106) || Io & 1073741824 && !(Y & 261930) ? (kc = !0, e.memoizedState = n) : (e = Ad(), K.lanes |= e, od |= e, t) : (e = Ks(e, n, r), Ir(e, t) || (kc = !0), e);
	}
	...
	function rc(e, t, n) {
		...
		n = {
			...
			eagerState: null,
			next: null
		}, sc(e) ? cc(t, n) : (n = Si(e, t, n, r), n !== null && (Md(n, e, r), lc(n, t, r)));
	}
	function ic(e, t, n) {
		ac(e, t, n, kd());
	}
	function ac(e, t, n, r) {
		...
		if (sc(e)) cc(t, i);
			...
			if (e.lanes === 0 && (a === null || a.lanes === 0) && (a = t.lastRenderedReducer, a !== null)) try {
				...
				if (i.hasEagerState = !0, i.eagerState = s, Ir(s, o)) return xi(e, t, i, 0), $u === null && bi(), !1;
			} catch {}
			if (n = Si(e, t, i, r), n !== null) return Md(n, e, r), lc(n, t, r), !0;
		}
		return !1;
	}
	function oc(e, t, n, r) {
	...
	function Dc(e, t, n, r, a) {
		if (n.flags |= 32768, typeof r == "object" && r && typeof r.then == "function") {
			if (t = n.alternate, t !== null && _a(t, n, a, !0), n = To.current, n !== null) {
				switch (n.tag) {
					case 31:
					case 13:
					case 19: return Eo === null ? Wd() : n.alternate === null && ad === 0 && (ad = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === Ka ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = /* @__PURE__ */ new Set([r]) : t.add(r), pf(e, r, a)), !1;
		...
		if (W) return t = To.current, t === null ? (r !== na && (t = Error(i(423), { cause: r }), la(Ri(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = Ri(r, n), a = wc(e.stateNode, r, a), mo(e, a), ad !== 4 && (ad = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== na && (e = Error(i(422), { cause: r }), la(Ri(e, n)))), !1;
	...
	function zc(e, t, n) {
		...
		if (o !== null) {
			...
			if (Oo(t), a) {
				...
				if (bo.current === null) {
					if (r = $u, r !== null && (s = gt(r, n), s !== 0 && s !== o.retryLane)) throw o.retryLane = s, Ci(e, s), Md(r, e, s), Oc;
					Wd();
				}
				t = Rc(e, t, n);
	...
	function Qc(e, t, n, r, a, o, s, c) {
		...
		if (kc || _a(e, t, c, !1), r = (c & e.childLanes) !== 0, kc || r) {
			...
			if (r = $u, r !== null && (a = gt(r, c), a !== 0 && a !== s.retryLane)) throw s.retryLane = a, Ci(e, a), Md(r, e, a), Oc;
	...
	function cl(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 24: return ya(t), r = ba(G), e === null ? (a = Ba(), a === null && (a = $u, o = Ea(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
				parent: r,
				cache: a
			...
			case 19:
				...
				if (a = !!(t.flags & 128), o = r.rendering, o === null) {
					if (a) pl(r, !1);
						...
						r.tail !== null && Be() > Z && (t.flags |= 128, a = !0, pl(r, !1), t.lanes = 4194304);
					}
				} else {
					if (!a) {
						if (e = Fo(o), e !== null) {
						...
						} else 2 * Be() - r.renderingStartTime > Z && n !== 536870912 && (t.flags |= 128, a = !0, pl(r, !1), t.lanes = 4194304);
					}
	...
	var tu = !1, nu = !1, ru = !1, iu = !1, au = typeof WeakSet == "function" ? WeakSet : Set, ou = null, su = !1, cu = !1, uu = !1, du = !1;
	function fu(e, t, n) {
	...
	function ku(e, t, n) {
		...
		switch (e.tag) {
			...
			case 3:
				...
				break;
			case 4:
				a = ru, ru = tu, r = Ut(), o = Ou, Ou = bm(e.stateNode.containerInfo), Du(t, e, n), Au(e), Ou = o, B && cu && (uu = !0), B = r, ru = a;
				break;
			case 12:
				Du(t, e, n), Au(e);
				break;
			case 31:
				...
				break;
			case 13:
				Du(t, e, n), Au(e), e.child.flags & 8192 && e.memoizedState !== null != (r !== null && r.memoizedState !== null) && (md = Be()), a & 4 && (t = e.updateQueue, t !== null && (e.updateQueue = null, Eu(e, t)));
				break;
			case 22:
	...
	function Nu(e, t) {
		...
		if (n === null) Kl(e, !1);
			...
			case 30:
				...
				s === "none" ? t = !1 : (a = n.memoizedState, n.memoizedState = null, n = e.child, Vl = 0, t = $l(e, n, t, o, s, a, !0), Vl !== (a === null ? 0 : a.length) && (e.flags |= 32)), e.flags & 4 && t ? (jd(e, e.memoizedProps.onUpdate), zl = i) : i !== null && (i.push.apply(i, zl), zl = i), su = e.flags & 32 ? !0 : r;
				break;
			default: Mu(t, e);
		}
	}
	...
	}, Qu = typeof WeakMap == "function" ? WeakMap : Map, q = 0, $u = null, J = null, Y = 0, ed = 0, td = null, nd = !1, rd = !1, id = !1, X = 0, ad = 0, od = 0, sd = 0, cd = 0, ld = 0, ud = 0, dd = null, fd = null, pd = !1, md = 0, hd = 0, Z = Infinity, gd = null, _d = null, vd = 0, yd = null, bd = null, xd = 0, Sd = 0, Q = null, Cd = null, wd = null, Td = null, Ed = null, Dd = 0, Od = null;
	function kd() {
		return q & 2 && Y !== 0 ? Y & -Y : F.T === null ? yt() : Nf();
	}
	function Ad() {
		if (ld === 0) {
			if (!(Y & 536870912) || W) {
	...
	function Md(e, t, n) {
		(e === $u && (ed === 2 || ed === 9) || e.cancelPendingCommit !== null) && (zd(e, 0), Id(e, Y, ld, !1)), ft(e, n), (!(q & 2) || e !== $u) && (e === $u && (!(q & 2) && (sd |= n), ad === 4 && Id(e, Y, ld, !1)), Tf(e));
	}
	function Nd(e, t, n) {
		...
		do {
			...
			a: {
				...
				if ((t & 62914560) === t && (a = md + 300 - Be(), 10 < a)) {
					if (Id(r, t, ld, !nd), ot(r, 0, !0) !== 0) break a;
					xd = t, r.timeoutHandle = gp(Pd.bind(null, r, n, fd, gd, pd, t, ld, sd, ud, nd, o, "Throttled", -0, 0), a);
					break a;
				}
				Pd(r, n, fd, gd, pd, t, ld, sd, ud, nd, o, null, -0, 0);
			}
			break;
		} while (1);
		Tf(e);
	...
	function Pd(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
		...
		if (d = null, (h || m & 8192 || (m & 16785408) == 16785408) && (d = {
			...
			unsuspend: mn
		}, Ll = null, Gu(t, a, d), h && (m = d, h = e.containerInfo, h = (h.nodeType === 9 ? h : h.ownerDocument).__reactViewTransition, h != null && (m.count++, m.waitingForViewTransition = !0, m = nh.bind(m), h.finished.then(m, m))), m = (a & 62914560) === a ? md - Be() : (a & 4194048) === a ? hd - Be() : 0, m = eh(d, m), m !== null)) {
			xd = a, e.cancelPendingCommit = m(ef.bind(null, e, t, a, n, r, i, o, s, c, l, u, d, null, f, p)), Id(e, a, o, !l);
			return;
		}
	...
	function Ld() {
		return q & 6 ? !0 : (Ef(0, !1), !1);
	}
	function Rd() {
		if (J !== null) {
			if (ed === 0) var e = J.return;
			else e = J, fa = da = null, es(e), $a = null, eo = 0, e = J;
	...
	function zd(e, t) {
		...
		return n !== -1 && (e.timeoutHandle = -1, _p(n)), n = e.cancelPendingCommit, n !== null && (e.cancelPendingCommit = null, n()), xd = 0, Rd(), $u = e, J = n = Ai(e.current, null), Y = t, ed = 0, td = null, nd = !1, rd = st(e, t), id = !1, ud = ld = cd = sd = od = ad = 0, fd = dd = null, pd = !1, X = ct(e, t), bi(), n;
	}
	function Bd(e, t) {
		K = null, F.H = uc, t === Ua || t === Ga ? (t = Za(), ed = 3) : t === Wa ? (t = Za(), ed = 4) : ed = t === Oc ? 8 : typeof t == "object" && t && typeof t.then == "function" ? 6 : 1, td = t, J === null && (ad = 1, Sc(e, Ri(t, e.current)));
	}
	function Vd() {
		var e = To.current;
	...
	function Wd() {
		ad = 4, nd || (Y & 4194048) !== Y && To.current !== null || (rd = !0), !(od & 134217727) && !(sd & 134217727) || $u === null || Id($u, Y, ld, !1);
	}
	function Gd(e, t, n) {
		var r = q;
		q |= 2;
		var i = Hd(), a = Ud();
		($u !== e || Y !== t) && (gd = null, zd(e, t)), t = !1;
		var o = ad;
		a: do
			try {
				if (ed !== 0 && J !== null) {
					...
					switch (ed) {
						...
						case 6:
							To.current === null && (t = !0);
							var l = ed;
							if (ed = 0, td = null, Zd(e, s, c, l), n && rd) {
								o = 0;
								break a;
							}
							break;
						default: l = ed, ed = 0, td = null, Zd(e, s, c, l);
					}
				}
				Kd(), o = ad;
				break;
		...
		while (1);
		return t && e.shellSuspendCounter++, fa = da = null, q = r, F.H = i, F.A = a, J === null && ($u = null, Y = 0, bi()), o;
	}
	function Kd() {
		for (; J !== null;) Yd(J);
	}
	function qd(e, t) {
		...
		q |= 2;
		var r = Hd(), a = Ud();
		$u !== e || Y !== t ? (gd = null, Z = Be() + 500, zd(e, t)) : rd = st(e, t);
		a: do
			try {
				if (ed !== 0 && J !== null) {
					t = J;
					...
					b: switch (ed) {
						...
						case 4:
							...
							break a;
						case 7:
							qa(o) ? (ed = 0, td = null, Xd(t)) : (ed = 0, td = null, Zd(e, t, o, 7));
							break;
						case 5:
							var s = null;
							switch (J.tag) {
							...
							ed = 0, td = null, Zd(e, t, o, 5);
							break;
						case 6:
							ed = 0, td = null, Zd(e, t, o, 6);
							break;
						case 8:
							Rd(), ad = 6;
							break a;
		...
		while (1);
		return fa = da = null, F.H = r, F.A = a, q = n, J === null ? ($u = null, Y = 0, bi(), ad) : 0;
	}
	function Jd() {
		for (; J !== null && !Re();) Yd(J);
	}
	function Yd(e) {
		var t = cl(e.alternate, e, X);
	...
	function Xd(e) {
		...
		switch (t.tag) {
			...
			default: _l(n, t), t = J = ji(t, X), t = cl(n, t, X);
		}
		e.memoizedProps = e.pendingProps, t === null ? Qd(e) : J = t;
	}
	function Zd(e, t, n, r) {
		...
		try {
			if (Dc(e, i, t, n, Y)) {
				ad = 1, Sc(e, Ri(n, e.current)), J = null;
				return;
			}
		} catch (t) {
		...
		t.flags & 32768 ? (W || r === 1 ? e = !0 : rd || Y & 536870912 ? e = !1 : (nd = e = !0, (r === 2 || r === 9 || r === 3 || r === 6) && (r = To.current, r !== null && r.tag === 13 && (r.flags |= 16384))), $d(t, e)) : Qd(t);
	}
	function Qd(e) {
		var t = e;
		do {
	...
	function ef(e, t, n, r, a, o, s, c, l, u, d, f) {
		...
		if (t !== null) {
			...
			e === $u && (J = $u = null, Y = 0), bd = t, yd = e, xd = n, Q = a, Cd = r, tf(e, t, n, s, c, l, f);
		}
	}
	function tf(e, t, n, r, i, a, o) {
		var s = t.lanes | t.childLanes;
		if (Sd = s, s |= yi, pt(e, n, s, r, i, a), Td = null, (n & 335544064) === n ? (Ed = Aa(e), r = 10262) : (Ed = null, r = 10256), (t.subtreeFlags & r) !== 0 || (t.flags & r) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, vf(We, function() {
			return uf(), null;
	...
	function sf() {
		if (vd === 4 || vd === 3) {
			...
			var e = wd;
			wd = null, ze();
			var t = yd, n = bd, r = xd, i = Cd, a = (r & 335544064) === r ? 10262 : 10256;
			if ((n.subtreeFlags & a) !== 0 || (n.flags & a) !== 0 ? vd = 5 : (vd = 0, bd = yd = null, cf(t, t.pendingLanes)), a = t.pendingLanes, a === 0 && (_d = null), vt(r), n = n.stateNode, Xe && typeof Xe.onCommitFiberRoot == "function") try {
			...
			xd & 3 && lf(), Tf(t), a = t.pendingLanes, r & 261930 && a & 42 ? t === Od ? Dd++ : (Dd = 0, Od = t) : (Dd = 0, Od = null), Ef(0, !1);
		}
	}
	function cf(e, t) {
	...
	function uf() {
		...
		var e = yd, t = Sd;
		Sd = 0;
		var n = vt(xd), r = F.T, a = I.p;
		try {
			I.p = 32 > n ? 32 : n, F.T = null, n = Q, Q = null;
			var o = yd, s = xd;
			if (vd = 0, bd = yd = null, xd = 0, q & 6) throw Error(i(331));
			var c = q;
			if (q |= 4, Ju(o.current), Bu(o, o.current, s, n), q = c, Ef(0, !1), Xe && typeof Xe.onPostCommitFiberRoot == "function") try {
	...
	function pf(e, t, n) {
		...
		i.has(n) || (id = !0, i.add(n), e = mf.bind(null, e, t, n), t.then(e, e));
	}
	function mf(e, t, n) {
		var r = e.pingCache;
		r !== null && r.delete(t), e.pingedLanes |= e.suspendedLanes & n, e.warmLanes &= ~n, $u === e && (Y & n) === n && (ad === 4 || ad === 3 && (Y & 62914560) === Y && 300 > Be() - md ? q & 2 ? cd |= n : zd(e, 0) : cd |= n, ud === Y && (ud = 0)), Tf(e);
	}
	function hf(e, t) {
				...
				for (var n = !1, r = yf; r !== null;) {
					if (!t) {
						if (e !== 0) {
							...
							a !== 0 && (n = !0, jf(r, a));
						} else a = Y, a = ot(r, r === $u ? a : 0, r.cancelPendingCommit !== null || r.timeoutHandle !== -1), !(a & 3) || st(r, a) || (n = !0, jf(r, a));
					}
					r = r.next;
				}
			while (n);
	...
	function kf(e, t) {
		...
		if (t = $u, n = Y, n = ot(e, e === t ? n : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r = e.callbackNode, n === 0 || e === t && (ed === 2 || ed === 9) || e.cancelPendingCommit !== null) return r !== null && r !== null && Le(r), e.callbackNode = null, e.callbackPriority = 0;
		if (!(n & 3) || st(e, n)) {
	...
	function Af(e, t) {
		...
		var r = Y;
		return r = ot(e, e === $u ? r : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), r === 0 ? null : (Nd(e, r, t), kf(e, Be()), e.callbackNode != null && e.callbackNode === n ? Af.bind(null, e) : null);
	}
	function jf(e, t) {
		if (lf()) return null;
		Nd(e, t, !0);
	...
	n(), t.exports = uu();
})))(), fu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
...
}, x.createElement("path", { d: "M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z" })), pu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M13.1717 12.0007L8.22192 7.05093L9.63614 5.63672L16.0001 12.0007L9.63614 18.3646L8.22192 16.9504L13.1717 12.0007Z" })), mu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M11.9997 10.5865L16.9495 5.63672L18.3637 7.05093L13.4139 12.0007L18.3637 16.9504L16.9495 18.3646L11.9997 13.4149L7.04996 18.3646L5.63574 16.9504L10.5855 12.0007L5.63574 7.05093L7.04996 5.63672L11.9997 10.5865Z" })), hu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M10 6V8H5V19H16V14H18V20C18 20.5523 17.5523 21 17 21H4C3.44772 21 3 20.5523 3 20V7C3 6.44772 3.44772 6 4 6H10ZM21 3V11H19L18.9999 6.413L11.2071 14.2071L9.79289 12.7929L17.5849 5H13V3H21Z" })), gu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12H4C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C9.25022 4 6.82447 5.38734 5.38451 7.50024L8 7.5V9.5H2V3.5H4L3.99989 5.99918C5.82434 3.57075 8.72873 2 12 2ZM13 7L12.9998 11.585L16.2426 14.8284L14.8284 16.2426L10.9998 12.413L11 7H13Z" })), _u = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	...r,
	className: "remixicon " + (n || "")
}, x.createElement("path", { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 11V17H13V11H11ZM11 7V9H13V7H11Z" })), vu = ({ color: e = "currentColor", size: t = 24, className: n, ...r }) => x.createElement("svg", {
	viewBox: "0 0 24 24",
	xmlns: "http://www.w3.org/2000/svg",
	width: t,
	height: t,
	...
	classGroupId: e,
	validator: t
}), xu = (e = /* @__PURE__ */ new Map(), t = null, n) => ({
	nextPart: e,
	validators: t,
	classGroupId: n
}), Su = "-", Cu = [], wu = "arbitrary..", Tu = (e) => {
	let t = Ou(e), { conflictingClassGroups: n, conflictingClassGroupModifiers: r } = e;
	return {
		getClassGroupId: (e) => {
			if (e.startsWith("[") && e.endsWith("]")) return Du(e);
			let n = e.split(Su);
	...
	let a = n.validators;
	if (a === null) return;
	let o = t === 0 ? e.join(Su) : e.slice(t).join(Su), s = a.length;
	for (let e = 0; e < s; e++) {
		let t = a[e];
		if (t.validator(o)) return t.classGroupId;
	}
}, Du = (e) => e.slice(1, -1).indexOf(":") === -1 ? void 0 : (() => {
	let t = e.slice(1, -1), n = t.indexOf(":"), r = t.slice(0, n);
	return r ? wu + r : void 0;
})(), Ou = (e) => {
	...
	let n = e, r = t.split(Su), i = r.length;
	for (let e = 0; e < i; e++) {
		let t = r[e], i = n.nextPart.get(t);
		i || (i = xu(), n.nextPart.set(t, i)), n = i;
	}
	return n;
	...
	let { prefix: t, experimentalParseClassName: n } = e, r = (e) => {
		...
		s.endsWith(Ru) ? (c = s.slice(0, -1), l = !0) : s.startsWith(Ru) && (c = s.slice(1), l = !0);
		let u = a && a > i ? a - i : void 0;
		return Vu(t, l, c, u);
	};
	if (t) {
		let e = t + zu, n = r;
		r = (t) => t.startsWith(e) ? n(t.slice(e.length)) : Vu(Bu, !1, t, void 0, !0);
	}
	if (n) {
		let e = r;
		r = (t) => n({
	...
	parseClassName: Hu(e),
	sortModifiers: Uu(e),
	postfixLookupClassGroupIds: Gu(e),
	...Tu(e)
}), Gu = (e) => {
	...
	let { parseClassName: n, getClassGroupId: r, getConflictingClassGroupIds: i, sortModifiers: a, postfixLookupClassGroupIds: o } = t, s = [], c = e.trim().split(Ku), l = "";
	for (let e = c.length - 1; e >= 0; --e) {
		...
		let _ = d.length === 0 ? "" : d.length === 1 ? d[0] : a(d).join(":"), v = f ? _ + Ru : _, y = v + g;
	...
	let t = 0, n, r, i = "";
	for (; t < e.length;) (n = e[t++]) && (r = Yu(n)) && (i && (i += " "), i += r);
	return i;
}, Yu = (e) => {
	if (typeof e == "string") return e;
	let t, n = "";
	for (let r = 0; r < e.length; r++) e[r] && (t = Yu(e[r])) && (n && (n += " "), n += t);
	return n;
}, Xu = (e, ...t) => {
	let n, r, i, a, o = (o) => (n = Wu(t.reduce((e, t) => t(e), e())), r = n.cache.get, i = n.cache.set, a = s, s(o)), s = (e) => {
		let t = r(e);
		if (t) return t;
		let a = qu(e, n);
		return i(e, a), a;
...
}, q = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, $u = /^\((?:(\w[\w-]*):)?(.+)\)$/i, J = /^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/, Y = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, ed = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, td = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix|color|light-dark)\(.+\)$/, nd = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, rd = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, id = (e) => J.test(e), X = (e) => !!e && !Number.isNaN(Number(e)), ad = (e) => !!e && Number.isInteger(Number(e)), od = (e) => e.endsWith("%") && X(e.slice(0, -1)), sd = (e) => Y.test(e), cd = () => !0, ld = (e) => ed.test(e) && !td.test(e), ud = () => !1, dd = (e) => nd.test(e), fd = (e) => rd.test(e), pd = (e) => !Z(e) && !Q(e), md = (e) => e.startsWith("@container") && (e[10] === "/" && e[11] !== void 0 || e[11] === "s" && e[16] !== void 0 && e.startsWith("-size/", 10) || e[11] === "n" && e[18] !== void 0 && e.startsWith("-normal/", 10)), hd = (e) => Ad(e, Pd, ud), Z = (e) => q.test(e), gd = (e) => Ad(e, Fd, ld), _d = (e) => Ad(e, Id, X), vd = (e) => Ad(e, Rd, cd), yd = (e) => Ad(e, Ld, ud), bd = (e) => Ad(e, Md, ud), xd = (e) => Ad(e, Nd, fd), Sd = (e) => Ad(e, zd, dd), Q = (e) => $u.test(e), Cd = (e) => jd(e, Fd), wd = (e) => jd(e, Ld), Td = (e) => jd(e, Md), Ed = (e) => jd(e, Pd), Dd = (e) => jd(e, Nd), Od = (e) => jd(e, zd, !0), kd = (e) => jd(e, Rd, !0), Ad = (e, t, n) => {
	let r = q.exec(e);
	return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, jd = (e, t, n = !1) => {
	let r = $u.exec(e);
	return r ? r[1] ? t(r[1]) : n : !1;
}, Md = (e) => e === "position" || e === "percentage", Nd = (e) => e === "image" || e === "url", Pd = (e) => e === "length" || e === "size" || e === "bg-size", Fd = (e) => e === "length", Id = (e) => e === "number", Ld = (e) => e === "family-name", Rd = (e) => e === "number" || e === "weight", zd = (e) => e === "shadow", Bd = () => {
	let e = Qu("color"), t = Qu("font"), n = Qu("text"), r = Qu("font-weight"), i = Qu("tracking"), a = Qu("leading"), o = Qu("breakpoint"), s = Qu("container"), c = Qu("spacing"), l = Qu("radius"), u = Qu("shadow"), d = Qu("inset-shadow"), f = Qu("text-shadow"), p = Qu("drop-shadow"), m = Qu("blur"), h = Qu("perspective"), g = Qu("aspect"), _ = Qu("ease"), v = Qu("animate"), y = () => [
		"auto",
		"avoid",
		"all",
		"avoid-page",
	...
	return {
		...
		classGroups: {
			...
			"ring-color": [{ ring: N() }],
			"ring-offset-w": [{ "ring-offset": [X, gd] }],
...
}, Vd = (e, { cacheSize: t, prefix: n, experimentalParseClassName: r, extend: i = {}, override: a = {} }) => (Hd(e, "cacheSize", t), Hd(e, "prefix", n), Hd(e, "experimentalParseClassName", r), Ud(e.theme, a.theme), Ud(e.classGroups, a.classGroups), Ud(e.conflictingClassGroups, a.conflictingClassGroups), Ud(e.conflictingClassGroupModifiers, a.conflictingClassGroupModifiers), Hd(e, "postfixLookupClassGroups", a.postfixLookupClassGroups), Hd(e, "orderSensitiveModifiers", a.orderSensitiveModifiers), Wd(e.theme, i.theme), Wd(e.classGroups, i.classGroups), Wd(e.conflictingClassGroups, i.conflictingClassGroups), Wd(e.conflictingClassGroupModifiers, i.conflictingClassGroupModifiers), Gd(e, i, "postfixLookupClassGroups"), Gd(e, i, "orderSensitiveModifiers"), e), Hd = (e, t, n) => {
	n !== void 0 && (e[t] = n);
}, Ud = (e, t) => {
	if (t) for (let n in t) Hd(e, n, t[n]);
}, Wd = (e, t) => {
	if (t) for (let n in t) Gd(e, t, n);
}, Gd = (e, t, n) => {
	let r = t[n];
	r !== void 0 && (e[n] = e[n] ? e[n].concat(r) : r);
}, Kd = (e, ...t) => typeof e == "function" ? Xu(Bd, e, ...t) : Xu(() => Vd(Bd(), e), ...t), qd = [
	"large-title",
	"display-1",
	"display-2",
	"display-3",
	...
	"semibold",
	"bold"
], Yd = Kd({ extend: { classGroups: { "font-size": [{ text: qd.flatMap((e) => Jd.map((t) => `${e}-${t}`)) }] } } });
function Xd(e) {
	return e;
}
//#endregion
...
function Qd({ variant: e = "bold", color: t = "neutral", className: n, ref: r, ...i }) {
	return /* @__PURE__ */ (0, S.jsx)("span", {
		ref: r,
		className: Yd(Zd.base, Zd.variant[e], Zd.color[t], n),
		...i
	});
}
//#endregion
...
async function nf(e, t) {
	...
	if (!n.ok) throw new $d(ef(r) || `请求失败（${n.status}）`, n.status);
	return r;
}
async function rf(e, t, n = "POST", r) {
	let i = await fetch(e, {
		method: n,
		...r ? { signal: r } : {},
		headers: {
	...
	if (!i.ok) throw new $d(ef(a) || `请求失败（${i.status}）`, i.status, a);
	return a;
}
//#endregion
//#region src/react/components/empty-state.tsx
function af({ icon: e, title: t, children: n }) {
...
function sf({ tone: e, title: t, children: n }) {
	let r = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [t ? /* @__PURE__ */ (0, S.jsx)("p", {
		className: "text-body-medium",
		children: t
	}) : null, /* @__PURE__ */ (0, S.jsx)("p", {
...
function lf({ label: e, value: t, max: n = 100, stops: r = [] }) {
...
var uf = new Ye({ defaultOptions: { queries: {
	networkMode: "always",
	retry: 0,
	refetchOnWindowFocus: !1,
	refetchOnMount: !1,
	retryOnMount: !1
} } }), df = "/api/tasks", ff = ["tasks"], pf = 2e3, mf = 1e4, hf = (e) => e?.running.length ? pf : mf, gf = (e) => nf(df, e);
async function _f(e) {
	await uf.fetchQuery({
		queryKey: ff,
		queryFn: () => gf(e)
...
function wf(e) {
	return Object.entries(e || {}).filter(([e, t]) => e !== "blocked_by" && (typeof t == "number" || typeof t == "string") && String(t) !== "").map(([e, t]) => `${xf[e] || e} ${t}`).join(" · ");
}
//#endregion
...
function Ef({ status: e }) {
	return /* @__PURE__ */ (0, S.jsx)(Qd, {
		color: Tf[e] ?? "neutral",
		children: bf(e)
	});
}
function Df({ run: e, meta: t, children: n, footer: r }) {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, S.jsx)(Ef, { status: e.status })]
				}),
				/* @__PURE__ */ (0, S.jsx)("p", {
...
function Of({ run: e }) {
	let t = e.progress_total || 0, n = e.progress_current || 0, r = e.progress_label || "正在进行", i = Sf(e.elapsed_seconds), a = [vf[e.trigger] || e.trigger, i && `已跑 ${i}`].filter(Boolean).join(" · ");
	return /* @__PURE__ */ (0, S.jsx)(Df, {
		run: e,
		meta: a,
		...
		}) : /* @__PURE__ */ (0, S.jsx)(of, { label: r })
	});
}
function kf({ run: e }) {
	let t = wf(e.result_summary), n = Sf(e.elapsed_seconds), r = [
		vf[e.trigger] || e.trigger,
		Cf(e.finished_at),
		n && `用时 ${n}`
	].filter(Boolean).join(" · ");
	return /* @__PURE__ */ (0, S.jsx)(Df, {
...
function Af({ title: e, children: t }) {
	let n = (0, x.useId)();
...
function jf({ live: e = !1, children: t }) {
...
function Mf(e) {
	let t = ct({
		...
		refetchInterval: (e) => hf(e.state.data)
	}), n = t.data, r = t.error ? tf(t.error) : "";
	if (!n) return /* @__PURE__ */ (0, S.jsx)(cf, { children: /* @__PURE__ */ (0, S.jsx)(sf, {
		tone: "error",
		children: r || "读取任务中心失败"
	}) });
	let i = n.running || [], a = n.skipped || [], o = (n.finished || []).filter((e) => !a.some((t) => t.id === e.id)), s = !i.length && !a.length && !o.length;
	return /* @__PURE__ */ (0, S.jsxs)(cf, { children: [
		r ? /* @__PURE__ */ (0, S.jsx)(sf, {
			tone: "error",
			children: r
		}) : null,
		n.available === !1 ? /* @__PURE__ */ (0, S.jsx)(sf, {
			tone: "warning",
			children: n.message || "账本上还没有任务中心的表"
		}) : null,
		s ? /* @__PURE__ */ (0, S.jsx)(af, {
			icon: gu,
			title: "还没有任务记录",
			...
			/* @__PURE__ */ (0, S.jsx)(Af, {
				title: "正在进行",
				children: i.length ? /* @__PURE__ */ (0, S.jsx)(jf, {
					live: !0,
					children: i.map((e) => /* @__PURE__ */ (0, S.jsx)(Of, { run: e }, e.id))
				}) : /* @__PURE__ */ (0, S.jsx)("p", {
					className: "text-body-2-regular text-text-secondary",
					children: "没有任务在跑。"
				})
			}),
			a.length ? /* @__PURE__ */ (0, S.jsx)(Af, {
				title: "被挡下的",
				children: /* @__PURE__ */ (0, S.jsx)(jf, { children: a.map((e) => /* @__PURE__ */ (0, S.jsx)(kf, { run: e }, e.id)) })
			}) : null,
			o.length ? /* @__PURE__ */ (0, S.jsx)(Af, {
				title: "最近完成",
				children: /* @__PURE__ */ (0, S.jsx)(jf, { children: o.map((e) => /* @__PURE__ */ (0, S.jsx)(kf, { run: e }, e.id)) })
			}) : null
		] })
	] });
}
...
function Pf({ variant: e = "primary", size: t = "medium", iconOnly: n = !1, leadingIcon: r, trailingIcon: i, children: a, className: o, type: s = "button", ref: c, ...l }) {
	return /* @__PURE__ */ (0, S.jsxs)("button", {
		ref: c,
		type: s,
		className: Yd(Nf.base, Nf.size[t], Nf.variant[e], n && Nf.iconOnlySize[t], o),
		...l,
		children: [
...
var Ff = "/api/quality-goals?limit=200", If = ["quality-goals"], Lf = (e) => nf(Ff, e);
async function Rf(e) {
	await uf.fetchQuery({
		queryKey: If,
		queryFn: () => Lf(e)
...
var zf = (e) => e.has_cover ? `/cover?code=${encodeURIComponent(e.code ?? "")}` : `/poster?id=${e.id}&c=4`;
//#endregion
//#region src/react/quality-goals/quality-goals-page.tsx
function Bf({ item: r, openItem: i, javTitleHtml: a, javDisplayName: o, srcBadge: s }) {
	let c = () => i(r.id);
	return /* @__PURE__ */ (0, S.jsxs)("li", {
		"data-goal-id": r.id,
...
function $(e) {
	let t = ct({
		queryKey: If,
		queryFn: ({ signal: e }) => Lf(e)
	}), n = t.data;
	if (!n) return /* @__PURE__ */ (0, S.jsx)(cf, { children: /* @__PURE__ */ (0, S.jsx)(sf, {
		tone: "error",
		title: "读取失败",
		children: t.error ? tf(t.error) : "读取高清版目标失败"
	}) });
	let r = n.items || [];
	return r.length ? /* @__PURE__ */ (0, S.jsxs)(cf, { children: [/* @__PURE__ */ (0, S.jsxs)("p", {
		className: "text-body-2-regular text-text-secondary",
		children: [
		...
		children: r.map((t) => /* @__PURE__ */ (0, S.jsx)(Bf, {
			item: t,
			...e
		}, t.id))
	})] }) : /* @__PURE__ */ (0, S.jsx)(cf, { children: /* @__PURE__ */ (0, S.jsx)(af, {
		icon: vu,
		title: "没有标记中的高清版目标",
...
function $m({ state: e, isExiting: t, UNSTABLE_portalContainer: n, clearContexts: r, ...i }) {
	let a = (0, x.useRef)(null), o = (0, x.useRef)(null), s = (0, x.useContext)(Zm), c = s && i.trigger === "SubmenuTrigger", { popoverProps: l, underlayProps: u, arrowProps: d, placement: f, triggerAnchorPoint: p } = $l({
		...i,
		offset: i.offset ?? 8,
		arrowRef: a,
		groupRef: c ? s : o
...
}), rh = Math.round(Math.random() * 1e10), ih = 0;
function ah(e) {
	let t = (0, x.useMemo)(() => e.name || `radio-group-${rh}-${++ih}`, [e.name]), [n, r] = Fo(e.value, e.defaultValue ?? null, e.onChange), [i] = (0, x.useState)(n), [a, o] = (0, x.useState)(null), s = So({
		...e,
		value: n
	}), c = (t) => {
...
var oh = /*#__PURE__*/ (0, x.createContext)(null), sh = /*#__PURE__*/ (0, x.createContext)(null), ch = /*#__PURE__*/ (0, x.createContext)(null), lh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	[e, t] = Gf(e, t, oh);
	let { validationBehavior: n } = Wf(gp) || {}, r = e.validationBehavior ?? n ?? "native", i = ah({
		...e,
		validationBehavior: r
	}), [a, o] = Kf(!e["aria-label"] && !e["aria-labelledby"]), { radioGroupProps: s, labelProps: c, descriptionProps: l, errorMessageProps: u, ...d } = nu({
		...e,
		label: o,
		validationBehavior: r
	}, i), f = Uf({
...
}), uh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { inputRef: n = null, ...r } = e;
	[e, t] = Gf(r, t, sh);
	let i = x.useContext(ch), a = Nr((0, x.useMemo)(() => mr(n, e.inputRef === void 0 ? null : e.inputRef), [n, e.inputRef])), o = tu({
		...qf(e),
		children: typeof e.children == "function" || e.children
	}, i, a);
	return /*#__PURE__*/ x.createElement(dh.Provider, { value: {
		...o,
		inputRef: a,
...
}), dh = /*#__PURE__*/ (0, x.createContext)(null), fh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { labelProps: n, inputProps: r, isSelected: i, isDisabled: a, isPressed: o, defaultClassName: s, inputRef: c } = (0, x.useContext)(dh), l = x.useContext(ch), { isFocused: u, isFocusVisible: d, focusProps: f } = hc(), p = a || l.isReadOnly, { hoverProps: m, isHovered: h } = Sc({
		...e,
		isDisabled: p
	}), g = Uf({
		...e,
...
function ph(e) {
	let { selectionMode: t = "single", shouldCloseOnSelect: n = t === "single" } = e, r = Km(e), [i, a] = (0, x.useState)(null), o = (0, x.useMemo)(() => e.defaultValue === void 0 ? t === "single" ? e.defaultSelectedKey ?? null : [] : e.defaultValue, [
		...
		selectedKeys: (0, x.useMemo)(() => mh(l), [l]),
		onSelectionChange: (e) => {
			if (e !== "all") {
				if (t === "single") {
...
var gh = /*#__PURE__*/ (0, x.createContext)(null), _h = /*#__PURE__*/ (0, x.createContext)(null), vh = /*#__PURE__*/ Br(function(e, t) {
	[e, t] = Gf(e, t, gh);
	...
	return /*#__PURE__*/ x.createElement(Xr, { content: o }, (n) => /*#__PURE__*/ x.createElement(bh, {
		props: e,
		collection: n,
		selectRef: t
	}));
...
function bh({ props: e, selectRef: t, collection: n }) {
	let { validationBehavior: r } = Wf(gp) || {}, i = e.validationBehavior ?? r ?? "native", a = ph({
		...e,
		collection: n,
		children: void 0,
		validationBehavior: i
	}), { isFocusVisible: o, focusProps: s } = hc({ within: !0 }), c = (0, x.useRef)(null), [l, u] = Kf(!e["aria-label"] && !e["aria-labelledby"]), { labelProps: d, triggerProps: f, valueProps: p, menuProps: m, descriptionProps: h, errorMessageProps: g, hiddenSelectProps: _, ...v } = iu({
		...qf(e),
		label: u,
		validationBehavior: i
	}, a, c), y = (0, x.useMemo)(() => ({
	...
	}, b.children, /*#__PURE__*/ x.createElement(ou, {
		..._,
		autoComplete: e.autoComplete
	})));
}
var xh = /*#__PURE__*/ (0, x.createContext)(null), Sh = /*#__PURE__*/ Br(function(e, t) {
	[e, t] = Gf(e, t, xh);
	let n = (0, x.useContext)(_h), { placeholder: r } = Wf(gh), i = n.selectedItems.map((e) => {
		...
		o,
		i
	]), u = Ki(hh(cm), "react-aria-components"), d = Uf({
		...e,
...
}), Ch = /*#__PURE__*/ (0, x.createContext)(null), wh = /*#__PURE__*/ (0, x.createContext)(null), Th = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { inputRef: n = null, ...r } = e;
	[e, t] = Gf(r, t, Ch);
	let i = Nr((0, x.useMemo)(() => mr(n, e.inputRef === void 0 ? null : e.inputRef), [n, e.inputRef])), a = Io(e), o = su({
		...qf(e),
		children: typeof e.children == "function" || e.children
	}, a, i);
	return /*#__PURE__*/ x.createElement(Hf, { values: [[wh, a], [Eh, {
		...o,
		inputRef: i,
...
}), Eh = /*#__PURE__*/ (0, x.createContext)(null), Dh = /*#__PURE__*/ (0, x.forwardRef)(function(e, t) {
	let { labelProps: n, inputProps: r, isSelected: i, isDisabled: a, isReadOnly: o, isPressed: s, isInvalid: c, inputRef: l, defaultClassName: u, isRequired: d } = (0, x.useContext)(Eh), { isFocused: f, isFocusVisible: p, focusProps: m } = hc(), h = a || o, g = (0, x.useContext)(wh), { hoverProps: _, isHovered: v } = Sc({
		...e,
		isDisabled: h
	}), y = Uf({
		...e,
...
}), Oh = /*#__PURE__*/ (0, x.createContext)({}), kh = /*#__PURE__*/ (0, x.createContext)(null), Ah = /*#__PURE__*/ Br(function(e, t) {
	[e, t] = Gf(e, t, kh);
...
function jh({ className: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsx)("div", {
		className: Yd("flex w-full flex-col rounded-2xl bg-background-secondary-default pl-3", e),
		children: t
	});
}
function Mh({ className: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsx)("p", {
		className: Yd("w-full px-3 text-body-2-medium text-text-secondary", e),
		children: t
	});
}
function Nh({ label: e, description: t, children: n }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: Yd("flex min-h-[52px] w-full items-center justify-between gap-4 py-2.5 pr-2.5", "border-b border-separator-border last:border-b-0"),
		children: [/* @__PURE__ */ (0, S.jsxs)("div", {
...
function Fh({ variant: e = "primary", size: t = "medium", leadingIcon: n, trailingIcon: r, children: i, className: a, disabled: o = !1, ...s }) {
	let c = Yd(Ph.base, Ph.size[t], Ph.variant[e], a), l = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [
...
function Ih({ isRequired: e = !1, isInvalid: t, tooltip: n, className: r, children: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsxs)(ap, {
		"data-label": "true",
		...a,
		className: Yd("flex cursor-default items-center gap-0.5", "text-body-medium text-text-primary", r),
		children: [
			i,
...
function Lh({ isInvalid: e = !1, className: t, ...n }) {
	return /* @__PURE__ */ (0, S.jsx)(mp, {
		slot: e ? "errorMessage" : "description",
		...n,
		className: Yd("pt-px text-caption-1-medium text-text-secondary", e && "text-text-error-primary", t)
	});
}
//#endregion
//#region src/react/boardui/components/base/input/input.tsx
var Rh = (0, x.createContext)({});
function zh({ size: e = "medium", fieldClassName: t, inputClassName: n, className: r, children: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsx)(Rh.Provider, {
		value: {
			size: e,
			fieldClassName: t,
			inputClassName: n
		},
		children: /* @__PURE__ */ (0, S.jsx)(Ah, {
			...a,
			"data-input-size": e,
			className: Yd("group flex h-max w-full flex-col items-start gap-1", r),
			children: i
		})
	});
}
zh.displayName = "TextField";
var Bh = Xd({
	field: [
...
function Vh({ size: e, leadingIcon: t, trailingIcon: n, leadingAddon: r, fieldClassName: i, className: a, ref: o, groupRef: s, ...c }) {
	let l = (0, x.useContext)(Rh), u = e ?? l.size ?? "medium", d = r != null;
	return /* @__PURE__ */ (0, S.jsx)(wp, {
		ref: s,
		className: ({ isFocusWithin: e, isHovered: t, isDisabled: n, isInvalid: r }) => Yd(Bh.field, d ? Bh.fieldWithAddonSize[u] : Bh.fieldSize[u], t && !e && !n && !r && "ring-border-button-hover", e && !n && !r && "ring-border-button-active", n && "bg-input-disabled-background text-input-disabled-foreground", r && "bg-background-tertiary-error text-foreground-icon-error", l.fieldClassName, i),
		children: /* @__PURE__ */ (0, S.jsxs)("div", {
			className: Bh.content,
			children: [/* @__PURE__ */ (0, S.jsxs)("div", {
				className: Bh.leftSection,
				children: [d ? r : t ? /* @__PURE__ */ (0, S.jsx)(t, {
					...
					ref: o,
					...c,
					className: Yd(Bh.input, l.inputClassName, a)
				})]
			}), n ? /* @__PURE__ */ (0, S.jsx)(n, {
				className: Bh.icon,
				"aria-hidden": !0
...
Vh.displayName = "InputBase";
function Hh({ label: e, hint: t, tooltip: n, placeholder: r, leadingIcon: i, trailingIcon: a, leadingAddon: o, fieldClassName: s, ref: c, groupRef: l, className: u, ...d }) {
...
].join(" "), Wh = "w-[266px]", Gh = "flex w-full flex-col gap-1 outline-none", Kh = ["flex w-full cursor-pointer items-center gap-2 rounded-2lg p-2 text-left", "text-text-primary outline-none transition-colors"].join(" ");
//#endregion
...
var Xh = (0, x.createContext)("md");
function Zh({ className: e, triggerClassName: t, popoverClassName: n, size: r = "md", children: i, items: a, renderValue: o, ref: s, ...c }) {
	let l = (0, x.useRef)(null), u = (0, x.useRef)(null), [d, f] = (0, x.useState)(!1);
	Jh(d, () => f(!1), [l, u]);
	let p = Yh(d, l);
	return /* @__PURE__ */ (0, S.jsx)(vh, {
		ref: s,
		...c,
		isOpen: d,
		onOpenChange: (e) => p(e) && f(e),
		className: Yd("group flex flex-col", e),
		children: ({ isOpen: e }) => /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsxs)(cp, {
			ref: l,
			className: Yd("flex w-full cursor-pointer items-center justify-between rounded-2lg", "border border-border-button-default bg-background-primary-default shadow-xs", "text-text-primary", "transition-[background-color,border-color,box-shadow,padding,font-size] duration-200 ease", "hover:bg-background-primary-hover hover:border-border-button-hover", "outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-border-focus-ring", "disabled:cursor-not-allowed disabled:bg-background-primary-disabled disabled:text-text-tertiary disabled:shadow-none", r === "sm" ? "gap-1 px-[7px] py-1 text-body-2-medium" : "gap-1.5 px-2.5 py-2 text-body-medium", t),
			children: [/* @__PURE__ */ (0, S.jsx)(Sh, {
				className: Yd("flex min-w-0 items-center truncate", r === "sm" ? "gap-1" : "gap-[5px]"),
				children: o
			}), /* @__PURE__ */ (0, S.jsx)(qh, { className: Yd("shrink-0 text-text-secondary transition-transform duration-200 ease", r === "sm" ? "size-3.5" : "size-4", e && "rotate-180") })]
		}), /* @__PURE__ */ (0, S.jsx)(Qm, {
			ref: u,
			isNonModal: !0,
			offset: 4,
			className: Yd(Wh, Uh, "p-2", n),
			children: /* @__PURE__ */ (0, S.jsx)(Lm, {
				items: a,
				className: Yd(Gh, "max-h-[240px] overflow-auto"),
				children: /* @__PURE__ */ (0, S.jsx)(Xh.Provider, {
					value: r,
					children: i
				})
			})
...
function Qh({ className: e, children: t, ...n }) {
	let r = (0, x.useContext)(Xh);
	return /* @__PURE__ */ (0, S.jsx)(Vm, {
		...n,
		className: (t) => Yd(Kh, r === "sm" ? "px-2 py-1.5 text-body-2-medium" : "text-body-medium", (t.isFocused || t.isSelected) && "bg-dropdown-item-hover-background", t.isDisabled && "cursor-not-allowed text-text-disabled", typeof e == "function" ? e(t) : e),
		children: t
	});
}
//#endregion
//#region src/react/settings/section.tsx
function $h({ title: e, id: t, aside: n, onSubmit: r, children: i }) {
	let a = /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [n ? /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex w-full flex-wrap items-center justify-between gap-2",
		children: [/* @__PURE__ */ (0, S.jsx)("div", {
			className: "min-w-0 flex-1",
			children: /* @__PURE__ */ (0, S.jsx)(Mh, { children: e })
		}), n]
	}) : /* @__PURE__ */ (0, S.jsx)(Mh, { children: e }), /* @__PURE__ */ (0, S.jsx)(jh, { children: i })] });
...
function tg({ divided: e = !1, children: t }) {
...
function ng({ status: e, children: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
...
function lg({ summary: e, children: t }) {
...
var mg = "/api/scraping", hg = "/api/scraping/settings", gg = "/api/scraping/check", _g = "/api/scraping/cover", vg = ["scraping"], yg = ["scraping", "cover"], bg = 2e3, xg = (e) => nf(mg, e), Sg = (e) => nf(_g, e);
async function Cg(e) {
	await Promise.all([uf.fetchQuery({
		queryKey: vg,
		queryFn: () => xg(e)
	}), uf.fetchQuery({
		queryKey: yg,
...
var Tg = [["peach", "Peach 代理"], ["direct", "直接连接"]], Eg = [["paste", "粘贴 Cookie"], ["file", "导入文件"]];
function Dg({ source: e }) {
...
function Og({ source: e, toast: t }) {
	let [n, r] = (0, x.useState)(e.network), [i, a] = (0, x.useState)(""), [o, s] = (0, x.useState)(""), [c, l] = (0, x.useState)(Eg[0][0]), [u, d] = (0, x.useState)(""), [f, p] = (0, x.useState)(""), m = (0, x.useRef)(null);
	function h() {
	...
	let g = lt({
		...
		onSuccess: (e, n) => {
			uf.setQueryData(vg, (t) => t && {
				...t,
				sources: t.sources.map((t) => t.source === e.saved.source ? e.saved : t)
			}), h(), t(n ? "Cookie 已撤销" : "来源设置已保存");
		}
	}), _ = lt({ mutationFn: () => rf(gg, { source: e.source }) }), v = g.isPending || _.isPending, y = (e) => {
	...
	let T = f || (g.error ? tf(g.error) : "") || (_.error ? tf(_.error) : ""), E = _.data?.results ?? [], D = n === "peach" || e.accepts_cookie || !!T || E.length > 0;
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		title: e.label,
		onSubmit: y,
		aside: /* @__PURE__ */ (0, S.jsxs)("span", {
			className: "flex min-w-0 items-center gap-1",
			children: [/* @__PURE__ */ (0, S.jsx)(Dg, { source: e.source }), /* @__PURE__ */ (0, S.jsx)(og, {
				href: e.login,
				children: e.login
			})]
		}),
		children: [
			/* @__PURE__ */ (0, S.jsx)(eg, { children: /* @__PURE__ */ (0, S.jsx)(Nh, {
				label: "连接方式",
				children: /* @__PURE__ */ (0, S.jsx)(Zh, {
					...
					children: Tg.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(Qh, {
						id: e,
						children: t
					}, e))
				})
			}) }),
			D ? /* @__PURE__ */ (0, S.jsxs)(tg, {
				divided: !0,
				children: [
					...
					e.accepts_cookie ? /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [
						...
						/* @__PURE__ */ (0, S.jsx)(lh, {
							...
							children: Eg.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(uh, {
								value: e,
						...
						c === "paste" ? /* @__PURE__ */ (0, S.jsx)(Hh, {
							...
							children: [
								/* @__PURE__ */ (0, S.jsx)(ag, { children: "Netscape Cookie 文件（.txt）" }),
								/* @__PURE__ */ (0, S.jsxs)("div", {
					...
					T ? /* @__PURE__ */ (0, S.jsx)(ig, { children: T }) : null,
					E.map((t) => /* @__PURE__ */ (0, S.jsx)(sf, {
						tone: t.ok ? "success" : "error",
						children: wg(t, e.label)
					}, t.label))
				]
			}) : null,
			/* @__PURE__ */ (0, S.jsxs)(ng, { children: [
				e.accepts_cookie && e.cookie_saved ? /* @__PURE__ */ (0, S.jsx)(Pf, {
					variant: "secondary",
					onClick: b,
					...pg(v),
					children: "撤销 Cookie"
...
function kg({ toast: e }) {
	let [t, n] = (0, x.useState)(""), [r, i] = (0, x.useState)(!1), [a, o] = (0, x.useState)(null), s = ct({
		queryKey: yg,
		queryFn: ({ signal: e }) => Sg(e),
		refetchInterval: (e) => e.state.data?.status === "running" && bg
	}), c = lt({
		mutationFn: () => rf(_g, { code: t }),
		onSuccess: () => {
			i(!0), o(null), uf.invalidateQueries({ queryKey: yg });
		}
	...
	}, d = c.error ? tf(c.error) : a?.status === "failed" ? a.error || "采集未取得" : "";
	return /* @__PURE__ */ (0, S.jsx)($h, {
		title: "高清封面",
		onSubmit: u,
		children: /* @__PURE__ */ (0, S.jsxs)(tg, { children: [
			/* @__PURE__ */ (0, S.jsxs)("div", {
			...
			l ? /* @__PURE__ */ (0, S.jsx)(of, { label: "正在抓取封面" }) : null,
			d ? /* @__PURE__ */ (0, S.jsx)(sf, {
				tone: "error",
				children: d
			}) : null,
			a?.status === "complete" ? /* @__PURE__ */ (0, S.jsx)(sf, {
				tone: "success",
...
function Ag({ toast: e }) {
	let t = ct({
		queryKey: vg,
		queryFn: ({ signal: e }) => xg(e)
	}), n = t.data;
	return n ? /* @__PURE__ */ (0, S.jsxs)(cf, { children: [
		/* @__PURE__ */ (0, S.jsx)("p", {
			className: "text-body-2-regular text-text-secondary",
			children: "高清图片可能需要代理才能下载，请先检查连接。"
		}),
		/* @__PURE__ */ (0, S.jsx)(kg, { toast: e }),
		(n.sources || []).map((t) => /* @__PURE__ */ (0, S.jsx)(Og, {
			source: t,
			toast: e
		}, t.source))
	] }) : /* @__PURE__ */ (0, S.jsx)(cf, { children: /* @__PURE__ */ (0, S.jsx)(sf, {
		tone: "error",
		title: "读取失败",
		children: t.error ? tf(t.error) : "读取采集来源失败"
	}) });
}
//#endregion
...
function Mg({ state: e, size: t = "md", shape: n = "pill" }) {
	let r = jg[t];
	return /* @__PURE__ */ (0, S.jsx)("span", {
		"aria-hidden": !0,
		className: Yd("relative shrink-0 transition-colors duration-200 ease", r.track, r.trackRadius[n], e.isSelected ? Yd("bg-linear-to-b from-accent-500 to-accent-600", r.onShadow) : "bg-background-tertiary-default", e.isDisabled && "opacity-50", e.isFocusVisible && "ring-2 ring-border-focus-ring ring-offset-2"),
		children: /* @__PURE__ */ (0, S.jsx)("span", {
			className: Yd("absolute flex items-center justify-center", "bg-linear-to-b from-control-indicator-background from-[43.837%] to-control-indicator-background-subtle", "shadow-[0_3px_3px_0_rgb(0_0_0/0.03),0_0.75px_0_0_rgb(0_0_0/0.05)]", "transition-transform duration-200 ease", r.thumb, r.thumbRadius[n], r.offset, e.isSelected && r.travel),
			children: /* @__PURE__ */ (0, S.jsx)("span", { className: Yd("border-solid bg-linear-to-t from-[43.837%]", r.chip, r.chipRadius[n], e.isSelected ? "border-accent-600 from-switch-on-chip-start to-switch-on-chip-end" : "border-border-button-default/50 from-switch-off-chip-start to-switch-off-chip-end") })
		})
	});
}
function Ng({ className: e, children: t, size: n = "md", shape: r = "pill", ref: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsx)(Th, {
		ref: i,
		...a,
		className: (t) => Yd("group inline-flex items-center gap-2 select-none", t.isDisabled ? "cursor-not-allowed" : "cursor-pointer", typeof e == "function" ? e(t) : e),
		children: (e) => /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Mg, {
			state: e,
			size: n,
			shape: r
...
function Pg({ data: e, receipt: t }) {
	return e.startup ? /* @__PURE__ */ (0, S.jsx)(Fg, {
		startup: e.startup,
		receipt: t
	}) : null;
}
function Fg({ startup: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e.enabled), [i, a] = (0, x.useState)(e.silent), [o, s] = (0, x.useState)(e.desktop), c = fg(), l = e.available && !e.desktop_message;
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		title: "开机自启",
		onSubmit: (r) => {
			r.preventDefault(), e.available && c.run("save", (e) => rf("/api/configuration/startup", {
				enabled: n,
				silent: i,
				desktop: o
			}, "POST", e), () => t("已保存配置"));
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)(eg, { children: [
				/* @__PURE__ */ (0, S.jsx)(Nh, {
					label: "开机后启动 Peach",
					children: /* @__PURE__ */ (0, S.jsx)(Ng, {
			...
			e.message || c.error ? /* @__PURE__ */ (0, S.jsxs)(tg, {
				divided: !0,
				children: [e.message ? /* @__PURE__ */ (0, S.jsx)(rg, { children: e.message }) : null, c.error ? /* @__PURE__ */ (0, S.jsx)(ig, { children: c.error }) : null]
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(ng, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
				type: "submit",
...
function Lg({ state: e, size: t = "md" }) {
	let { isSelected: n, isIndeterminate: r, isFocusVisible: i, isDisabled: a, isHovered: o } = e, s = Ig[t], c = n || r, l = o && !a;
	return /* @__PURE__ */ (0, S.jsx)("span", {
		"aria-hidden": !0,
		className: Yd("flex shrink-0 items-center justify-center rounded-sm", "transition-[background-color,border-color,box-shadow] duration-150 ease", s.box, c ? Yd("bg-linear-to-b shadow-checkbox-selected", l ? "from-accent-400 to-accent-500" : "from-accent-500 to-accent-600") : Yd("border bg-background-primary-default shadow-xs", l ? "border-border-checkbox-hover" : "border-border-checkbox-default"), a && "opacity-50", i && "ring-2 ring-border-focus-ring ring-offset-2"),
...
function Rg({ className: e, children: t, size: n = "md", ref: r, ...i }) {
	let a = Ig[n];
	return /* @__PURE__ */ (0, S.jsx)(xp, {
		ref: r,
		...i,
		className: (t) => Yd("group inline-flex items-center select-none", a.gap, t.isDisabled ? "cursor-not-allowed" : "cursor-pointer", typeof e == "function" ? e(t) : e),
		children: (e) => /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Lg, {
			state: e,
			size: n
		}), t != null && /* @__PURE__ */ (0, S.jsx)("span", {
			className: Yd(a.label, "text-text-primary"),
			children: t
		})] })
	});
}
...
var zg = {
	...
	skipped: 0,
	message: ""
}, Bg = (e) => Number(e).toLocaleString();
function Vg(e) {
	if (e.status === "running") {
		let t = e.total ? `${Bg(e.checked)} / ${Bg(e.total)}` : "准备中";
		return e.stage === "修复" && e.message ? `修复 ${t} · ${e.message}` : `${e.stage || "扫描"} ${t}`;
	}
	return e.status === "complete" && (e.repaired || e.failed) ? e.failed ? `修好 ${Bg(e.repaired)} 部，${Bg(e.failed)} 部修不了` : `修好 ${Bg(e.repaired)} 部` : "";
}
function Hg({ initial: e }) {
	let [t, n] = (0, x.useState)(e || zg), [r, i] = (0, x.useState)(!1), a = fg(), o = t.status === "running";
	(0, x.useEffect)(() => {
		let e = new AbortController(), t, r = async () => {
			try {
				let i = await nf("/api/media-repair", e.signal);
	...
	let s = () => void a.run("start", (e) => rf("/api/media-repair", {
		allow_metered: r,
		restart: !0
	}, "POST", e), n), c = () => void a.run("stop", (e) => rf("/api/media-repair", { stop: !0 }, "POST", e), n), l = t.total ? Math.round(t.checked / t.total * 100) : 0;
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		title: "播放兼容修复",
		children: [/* @__PURE__ */ (0, S.jsxs)(tg, { children: [
			/* @__PURE__ */ (0, S.jsx)(rg, { children: "有些 MP4 少了一张时间戳表，浏览器按容器给的时刻排帧，会把其中一部分丢掉，看着就是卡顿。 修好之后这类片子起播直接用原片，不再实时转码。原始文件不改动，修好的头另存在缓存里。" }),
			/* @__PURE__ */ (0, S.jsx)(Rg, {
				isSelected: r,
				isDisabled: o,
				onChange: i,
			...
			o ? /* @__PURE__ */ (0, S.jsx)(lf, {
				label: "修复进度",
				value: l
			}) : null,
			t.status === "complete" && !t.repaired && !t.failed ? /* @__PURE__ */ (0, S.jsx)(sf, {
				tone: "info",
				title: "没有要修的",
				children: "库里的片子都能直接播，没找到缺时间戳表的。"
			}) : null,
			a.error || t.error ? /* @__PURE__ */ (0, S.jsx)(ig, { children: a.error || t.error }) : null
		] }), /* @__PURE__ */ (0, S.jsx)(ng, {
			status: Vg(t) ? /* @__PURE__ */ (0, S.jsx)("p", {
				role: "status",
				children: Vg(t)
			}) : null,
			children: o ? /* @__PURE__ */ (0, S.jsx)(Pf, {
				onClick: c,
				...pg(a.busy === "stop"),
				children: "停止"
			}) : /* @__PURE__ */ (0, S.jsx)(Pf, {
...
function Kg({ initial: e, initialJob: t }) {
	let [n, r] = (0, x.useState)(e), [i, a] = (0, x.useState)(t || {
		state: "idle",
		progress: 0
	}), [s, c] = (0, x.useState)(""), l = fg(), u = (0, x.useRef)(!1), d = (0, x.useRef)(!0), f = Ug.has(i.state);
	(0, x.useEffect)(() => (d.current = !0, () => {
		d.current = !1;
	}), []);
	let p = async () => {
		let e = await rf("/api/configuration/update-restart", {});
		d.current && a(e);
	}, m = () => void o({
		title: "更新已准备好",
	...
	(0, x.useEffect)(() => {
		...
		let e = new AbortController(), t = Ug.has(i.state) ? 1e3 : 3e4, n, o = 0, s = async () => {
			try {
				let t = await nf("/api/configuration/update-status", e.signal);
				if (e.signal.aborted) return;
				...
				let n = await nf("/api/configuration/automatic-updates", e.signal);
				!e.signal.aborted && n.result && r(n.result);
			} catch {
				o += 1, o >= Gg && !e.signal.aborted && c("尚未连接到 Peach，请检查托盘后刷新页面。");
			}
			!e.signal.aborted && o < Gg && (n = setTimeout(s, t));
		};
	...
	let h = () => {
		f || (u.current = !1, c(""), l.run("download", (e) => rf("/api/configuration/update", {}, "POST", e), a));
	}, g = () => void l.run("check", (e) => nf("/api/configuration/updates", e), r, (t) => {
		r({
			...e,
			state: "error"
		}), l.setError(tf(t));
	...
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		...
		children: [
			...
			/* @__PURE__ */ (0, S.jsxs)(tg, {
				divided: !0,
				children: [
					n.checked_at ? /* @__PURE__ */ (0, S.jsxs)(rg, { children: ["检查于 ", (/* @__PURE__ */ new Date(n.checked_at * 1e3)).toLocaleString()] }) : null,
					n.state === "available" && !_ ? /* @__PURE__ */ (0, S.jsx)(sf, {
						tone: "info",
						title: "有可用更新",
						children: n.message
					}) : _ || n.state === "error" ? /* @__PURE__ */ (0, S.jsx)(ig, { children: _ || n.message }) : /* @__PURE__ */ (0, S.jsx)(rg, {
						role: "status",
						children: n.message
					}),
					i.state === "error" ? /* @__PURE__ */ (0, S.jsx)(ig, { children: i.message }) : null,
					i.state !== "idle" && i.state !== "error" ? /* @__PURE__ */ (0, S.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, S.jsxs)(rg, { children: ["下载 → 校验 → 解压 → 准备安装 · ", i.message] }),
							/* @__PURE__ */ (0, S.jsx)(rg, { children: v })
						]
					}) : null
				]
			}),
			/* @__PURE__ */ (0, S.jsxs)(ng, {
				status: /* @__PURE__ */ (0, S.jsx)(og, {
					href: n.release_url,
					children: "查看发布页"
				}),
				children: [
					i.state === "ready" ? /* @__PURE__ */ (0, S.jsx)(Pf, {
						onClick: m,
						children: "重启安装"
					}) : null,
					n.state === "available" && n.installation === "独立测试包" && i.state !== "ready" ? /* @__PURE__ */ (0, S.jsx)(Pf, {
						onClick: h,
						...pg(f || l.busy === "download"),
						children: "下载并安装"
					}) : null,
					/* @__PURE__ */ (0, S.jsx)(Pf, {
						disabled: f,
...
function Jg({ data: e, receipt: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-6",
		children: [
			e.automatic_updates ? /* @__PURE__ */ (0, S.jsx)(Yg, {
				initial: e.automatic_updates,
				receipt: t
			}) : null,
			e.updates ? /* @__PURE__ */ (0, S.jsx)(Kg, {
				initial: e.updates,
				initialJob: e.update_job
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(Hg, {}),
			/* @__PURE__ */ (0, S.jsx)(Xg, { facts: e.facts }),
			e.uninstall ? /* @__PURE__ */ (0, S.jsx)(Zg, { uninstall: e.uninstall }) : null
		]
	});
}
function Yg({ initial: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e.mode), [i, a] = (0, x.useState)(e.interval_hours), o = fg(e.error), s = (r) => {
		r.preventDefault(), e.available && o.run("save", (e) => rf("/api/configuration/automatic-updates", {
			mode: n,
			interval_hours: i
		}, "POST", e), () => t("已保存配置"));
	...
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		...
		children: [
			/* @__PURE__ */ (0, S.jsxs)(eg, { children: [
				...
				/* @__PURE__ */ (0, S.jsx)(Nh, {
					...
					children: /* @__PURE__ */ (0, S.jsx)(Zh, {
						...
						children: qg.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(Qh, {
							id: e,
							children: t
						}, e))
					})
			...
			o.error ? /* @__PURE__ */ (0, S.jsx)(tg, {
				divided: !0,
				children: /* @__PURE__ */ (0, S.jsx)(ig, { children: o.error })
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(ng, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
				type: "submit",
				disabled: !e.available,
...
function Xg({ facts: e }) {
	return /* @__PURE__ */ (0, S.jsx)($h, {
		title: "运行信息",
		children: /* @__PURE__ */ (0, S.jsx)(sg, { children: e.map((e) => /* @__PURE__ */ (0, S.jsxs)(cg, {
			term: e.term,
			children: [e.value, e.download_url ? /* @__PURE__ */ (0, S.jsx)(og, {
				href: e.download_url,
...
function Zg({ uninstall: e }) {
	let [t, n] = (0, x.useState)(!1), [r, i] = (0, x.useState)(""), a = () => void o({
		...
		onConfirm: async () => {
			let e = await rf("/api/configuration/uninstall", {
				delete_data: t,
	...
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		...
		title: "卸载 Peach",
		children: [/* @__PURE__ */ (0, S.jsxs)(tg, { children: [
			e.available ? /* @__PURE__ */ (0, S.jsx)(rg, { children: "卸载会退出 Peach、移除程序、开机自启和桌面图标。原始媒体文件保留。" }) : null,
			/* @__PURE__ */ (0, S.jsx)(Rg, {
				isSelected: t,
...
function $g({ icon: e, size: t = "medium", className: n, type: r = "button", ref: i, ...a }) {
	return /* @__PURE__ */ (0, S.jsx)("button", {
		ref: i,
		type: r,
		className: Yd(Qg.base, Qg.size[t], n),
		...a,
...
var e_ = "/api/configuration", t_ = "/api/pick-folder", n_ = [
	{
...
function i_() {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)(rg, { children: ["先在 CloudDrive 登录网盘并挂载，开启「启动时自动挂载」。", /* @__PURE__ */ (0, S.jsx)(og, {
			href: "https://www.clouddrive2.com/help.html",
			children: "挂载帮助"
		})] }), /* @__PURE__ */ (0, S.jsxs)(lg, {
			summary: "CloudDrive 缓存建议",
			children: [
				/* @__PURE__ */ (0, S.jsx)(rg, { children: "看缓存放在哪块硬盘上，照那一档填。这是起步值，填得越大不一定越快。" }),
				/* @__PURE__ */ (0, S.jsx)("ul", {
					"aria-label": "按缓存所在硬盘分档",
					className: "flex flex-col gap-2",
					children: n_.map((e) => /* @__PURE__ */ (0, S.jsxs)("li", {
...
var s_ = "auto";
function c_({ value: e, label: t, kind: n = "local", onChange: r }) {
	let i = (0, x.useRef)(null), [a, o] = (0, x.useState)(!1), [s, c] = (0, x.useState)(e), [l, u] = o_(n);
	return /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Pf, {
		ref: i,
		variant: "secondary",
		className: "self-start",
		"aria-label": t,
		...
		children: /* @__PURE__ */ (0, S.jsxs)("span", {
			...
			children: [/* @__PURE__ */ (0, S.jsx)(dg, { mark: e || l }), ((e) => e && a_.find(([t]) => t === e)?.[1] || u)(e)]
		})
	}), /* @__PURE__ */ (0, S.jsx)(Qm, {
		triggerRef: i,
		isOpen: a,
		...
		children: /* @__PURE__ */ (0, S.jsxs)(nh, {
			...
			children: [
				...
				/* @__PURE__ */ (0, S.jsx)(lh, {
					...
					children: a_.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(uh, {
						value: e || s_,
						"aria-label": e ? t : u,
						...
						children: /* @__PURE__ */ (0, S.jsx)(dg, { mark: e || l })
					}, e || s_))
				}),
				/* @__PURE__ */ (0, S.jsxs)("div", {
...
], f_ = (e) => d_.find(([t]) => t === e)?.[1] ?? e, p_ = (e) => a[e] || "database", m_ = (e = "") => ({
	path: e,
	location: "local",
	root: "",
	library: "",
...
function h_(e) {
	let t = e.media_sources?.filter((e) => d_.some(([t]) => t === e.location));
	...
	})) : (e.media_dirs.length ? e.media_dirs : [""]).map((e) => m_(e));
}
var g_ = (e) => !(e instanceof $d) || e.status !== 400 ? null : e.body?.errors ?? null;
function __({ data: e, receipt: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-6",
		children: [e.editable ? /* @__PURE__ */ (0, S.jsx)(v_, {
			data: e,
			receipt: t
		}) : /* @__PURE__ */ (0, S.jsx)(sf, {
			tone: "neutral",
			title: "只读",
			children: e.notice
		}), /* @__PURE__ */ (0, S.jsx)(b_, { data: e })]
	});
}
function v_({ data: e, receipt: t }) {
	let [n, r] = (0, x.useState)(() => h_(e)), [i, a] = (0, x.useState)(String(e.port)), [o, s] = (0, x.useState)(!1), [c, l] = (0, x.useState)([]), [u, d] = (0, x.useState)(""), [f, p] = (0, x.useState)(""), [m, h] = (0, x.useState)(null), [g, _] = (0, x.useState)(null), [v, y] = (0, x.useState)(null), b = (0, x.useRef)(!1), C = (0, x.useRef)(e.revision), w = (0, x.useRef)([]), T = fg();
	(0, x.useLayoutEffect)(() => {
		g !== null && (w.current[g]?.focus(), _(null));
	}, [g]), (0, x.useEffect)(() => {
		if (!m) return;
		let e = setTimeout(() => location.assign(m.url), l_);
	...
	let E = (e, t) => r((n) => n.map((n, r) => r === e ? {
		...
		if (!b.current) {
			b.current = !0, y(e);
			try {
				let { path: t } = await rf(t_, { initial: n[e]?.path ?? "" });
				t && (E(e, { path: t }), D(e, ""));
			} catch (t) {
				D(e, tf(t));
			} finally {
		...
		r.preventDefault(), p(""), T.run("save", (t) => rf(e_, {
			revision: C.current,
			...
			let t = g_(e);
			l(t?.media_dirs ?? []), d(t?.port ?? ""), t || p(tf(e));
		});
	};
	if (m) return /* @__PURE__ */ (0, S.jsx)($h, {
		title: "这台电脑",
		children: /* @__PURE__ */ (0, S.jsx)(tg, { children: /* @__PURE__ */ (0, S.jsxs)(sf, {
			tone: "success",
			title: "配置已保存",
			children: [
	...
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		...
		children: [/* @__PURE__ */ (0, S.jsxs)(tg, { children: [
			/* @__PURE__ */ (0, S.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, S.jsx)(ag, { children: "媒体文件夹" }),
					/* @__PURE__ */ (0, S.jsx)("div", {
						role: "group",
						"aria-label": "媒体文件夹",
						className: "flex flex-col gap-3",
						children: n.map((t, r) => /* @__PURE__ */ (0, S.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, S.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, S.jsxs)("div", {
										className: "flex flex-col gap-1.5",
										children: [/* @__PURE__ */ (0, S.jsx)(ag, { children: "媒体库图标" }), /* @__PURE__ */ (0, S.jsx)(c_, {
											label: `媒体库图标 ${r + 1}`,
									...
									/* @__PURE__ */ (0, S.jsxs)("div", {
										className: "flex flex-col gap-1.5",
										children: [/* @__PURE__ */ (0, S.jsx)(ag, { children: "媒体来源" }), /* @__PURE__ */ (0, S.jsx)(Zh, {
											"aria-label": `媒体来源 ${r + 1}`,
											selectedKey: t.location,
											onSelectionChange: (e) => {
												e !== null && E(r, { location: String(e) });
											},
											children: d_.map(([e, t]) => /* @__PURE__ */ (0, S.jsxs)(Qh, {
												id: e,
												textValue: t,
												children: [/* @__PURE__ */ (0, S.jsx)(dg, { mark: p_(e) }), t]
											}, e))
										})]
									}),
									e.windows === !1 ? /* @__PURE__ */ (0, S.jsx)(Hh, {
			...
			j ? /* @__PURE__ */ (0, S.jsx)(i_, {}) : null,
			te.map((e) => /* @__PURE__ */ (0, S.jsxs)(rg, { children: [
				"未检测到 ",
				e.name,
				"。",
				/* @__PURE__ */ (0, S.jsxs)(og, {
					href: e.download_url,
					children: ["下载 ", e.name]
				})
			] }, e.name)),
			e.windows === !1 ? /* @__PURE__ */ (0, S.jsx)(rg, { children: "本机文件夹是这台电脑读取媒体的位置。Windows 中的对应路径用于匹配馆藏中已有的路径，例如 B:\\ 对应本机挂载文件夹。" }) : null,
			e.port_editable === !1 ? null : /* @__PURE__ */ (0, S.jsx)(Hh, {
				id: "configPort",
				label: "本机访问端口",
				inputMode: "numeric",
				value: i,
...
function b_({ data: e }) {
	let [t, n] = (0, x.useState)(e.media_sources), r = fg();
	return t ? /* @__PURE__ */ (0, S.jsxs)($h, {
		title: "挂载状态",
		children: [
			/* @__PURE__ */ (0, S.jsx)(sg, { children: t.map((e, t) => /* @__PURE__ */ (0, S.jsxs)(cg, {
				term: /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(dg, { mark: p_(e.location) }), f_(e.location)] }),
				children: [e.path || "未配置挂载点", /* @__PURE__ */ (0, S.jsx)(y_, { online: e.online })]
			}, t)) }),
			r.error ? /* @__PURE__ */ (0, S.jsx)(tg, {
				divided: !0,
				children: /* @__PURE__ */ (0, S.jsx)(ig, { children: r.error })
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(ng, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
				onClick: () => void r.run("refresh", (e) => nf(e_, e), (e) => n(e.media_sources)),
				...pg(r.busy === "refresh"),
				children: "刷新挂载状态"
			}) })
		]
...
function S_({ initial: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e), [i, a] = (0, x.useState)(""), [o, s] = (0, x.useState)(""), [c, l] = (0, x.useState)(""), [u, d] = (0, x.useState)(!1), [f, p] = (0, x.useState)({}), m = (0, x.useRef)(null), h = fg(), g = (e) => {
		e.preventDefault();
		let f = {};
		...
		h.run("save", (e) => rf("/api/configuration/access", {
			revision: n.revision,
			...
			let t = e instanceof $d ? e.body : null, n = t?.errors || t?.detail?.errors;
			n ? p(n) : h.setError(tf(e));
		});
	}, _ = x_[n.mode], v = n.mode !== "locked";
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		title: "访问密码",
		onSubmit: g,
		children: [/* @__PURE__ */ (0, S.jsx)("div", {
			ref: m,
			children: /* @__PURE__ */ (0, S.jsxs)(tg, { children: [
				_ ? /* @__PURE__ */ (0, S.jsx)(rg, { children: _ }) : null,
				n.mode === "open" ? /* @__PURE__ */ (0, S.jsx)(sf, {
					tone: "warning",
					title: "未设置访问密码",
					children: "能连接到 Peach 的设备打开地址就能看馆藏，不需要登录。"
				}) : null,
				n.mode === "password" || n.mode === "legacy" ? /* @__PURE__ */ (0, S.jsx)(Rg, {
					isSelected: u,
					onChange: d,
					children: "关闭访问密码，允许能连接到 Peach 的设备直接访问"
				}) : null,
				n.mode === "password" ? /* @__PURE__ */ (0, S.jsx)(Hh, {
					id: "access-current",
					type: "password",
					label: "当前访问密码",
				...
				v ? /* @__PURE__ */ (0, S.jsxs)(S.Fragment, { children: [/* @__PURE__ */ (0, S.jsx)(Hh, {
					id: "access-password",
					type: "password",
				...
				u ? /* @__PURE__ */ (0, S.jsx)(sf, {
					tone: "warning",
					title: "访问范围",
					children: "保存后，能连接到 Peach 的设备将直接访问馆藏。"
				}) : null,
				h.error ? /* @__PURE__ */ (0, S.jsx)(ig, { children: h.error }) : null
			] })
		}), v ? /* @__PURE__ */ (0, S.jsx)(ng, {
			status: "保存后立即生效。",
			children: /* @__PURE__ */ (0, S.jsx)(Pf, {
				type: "submit",
				...pg(h.busy === "save"),
...
function w_({ data: e, receipt: t }) {
	return /* @__PURE__ */ (0, S.jsxs)("div", {
		className: "flex flex-col gap-6",
		children: [e.peach_proxy ? /* @__PURE__ */ (0, S.jsx)(T_, {
			initial: e.peach_proxy,
			receipt: t
		}) : null, e.access ? /* @__PURE__ */ (0, S.jsx)(S_, {
			initial: e.access,
			receipt: t
		}) : null]
	});
...
function T_({ initial: e, receipt: t }) {
	let [n, r] = (0, x.useState)(e), [i, a] = (0, x.useState)(e.mode), [o, s] = (0, x.useState)(""), c = fg();
	return /* @__PURE__ */ (0, S.jsxs)($h, {
		id: "peachProxy",
		title: "Peach 代理",
		onSubmit: (e) => {
			e.preventDefault(), c.run("save", (e) => rf("/api/configuration/peach-proxy", {
				mode: i,
				proxy: o
			}, "POST", e), (e) => {
				r(e), s(""), t("已保存配置");
		...
		children: [
			/* @__PURE__ */ (0, S.jsx)(eg, { children: /* @__PURE__ */ (0, S.jsx)(Nh, {
				...
				children: /* @__PURE__ */ (0, S.jsx)(Zh, {
					...
					children: C_.map(([e, t]) => /* @__PURE__ */ (0, S.jsx)(Qh, {
						id: e,
						children: t
					}, e))
				})
			}) }),
			i === "proxy" || n.needs_selection || c.error ? /* @__PURE__ */ (0, S.jsxs)(tg, {
				divided: !0,
				children: [
					i === "proxy" ? /* @__PURE__ */ (0, S.jsx)(Hh, {
					...
					n.needs_selection ? /* @__PURE__ */ (0, S.jsx)(sf, {
						tone: "warning",
						title: "需要选择连接方式",
						children: "已有来源的代理地址不同，请选择公共连接方式。"
					}) : null,
					c.error ? /* @__PURE__ */ (0, S.jsx)(ig, { children: c.error }) : null
				]
			}) : null,
			/* @__PURE__ */ (0, S.jsx)(ng, { children: /* @__PURE__ */ (0, S.jsx)(Pf, {
				type: "submit",
...
var E_ = null;
function D_() {
	return E_?.isConnected || (E_ = document.createElement("div"), E_.className = "peach-react", E_.dataset.reactOverlays = "", document.body.append(E_)), E_;
}
function O_(e) {
	return (t, n) => {
		let r = (0, du.createRoot)(t), i = (t) => r.render(/* @__PURE__ */ (0, S.jsx)(T, {
			client: uf,
...
}, A_ = O_(Pg), j_ = O_(__), M_ = O_(w_), N_ = O_(Jg);
//#endregion
export { A_ as mountGeneralSettings, N_ as mountMaintenanceSettings, j_ as mountMediaSettings, M_ as mountNetworkSettings, k_ as pages };
