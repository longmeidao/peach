...
function pe(e) {
	if (e.__P && e.__d) {
		...
		a.__v = t.__v + 1, w.vnode && w.vnode(a), we(e.__P, a, t, e.__n, e.__P.namespaceURI, 32 & t.__u ? [n] : null, r, n ?? fe(t), !!(32 & t.__u), i), a.__v = t.__v, a.__.__k[a.__i] = a, Ee(r, a, i), t.__e = t.__ = null, a.__e != n && me(a);
	}
}
function me(e) {
...
function he(e) {
	(!e.__d && (e.__d = !0) && D.push(e) && !ge.__r++ || O != w.debounceRendering) && ((O = w.debounceRendering) || k)(ge);
}
function ge() {
	try {
		for (var e, t = 1; D.length;) D.length > t && D.sort(A), e = D.shift(), t = D.length, pe(e);
	} finally {
		D.length = ge.__r = 0;
	}
}
function _e(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (c = ve(n, t, _, c, v), d = 0; d < v; d++) (p = n.__k[d]) != null && (f = p.__i != -1 && _[p.__i] || ie, p.__i = d, g = we(e, p, f, i, a, o, s, c, l, u), m = p.__e, p.ref && f.ref != p.ref && (f.ref && ke(f.ref, null, p), u.push(p.ref, p.__c || m, p)), h == null && m != null && (h = m), 4 & p.__u ? (c = ye(p, c, e), f.__e && (f.__e = null)) : typeof p.type == "function" && g !== void 0 ? c = g : m && (c = m.nextSibling), p.__u &= -7);
	return n.__e = h, c;
}
function ve(e, t, n, r, i) {
	var a, o, s, c, l, u = n.length, d = u, f = 0;
	for (e.__k = Array(i), a = 0; a < i; a++) (o = t[a]) != null && typeof o != "boolean" && typeof o != "function" ? (typeof o == "string" || typeof o == "number" || typeof o == "bigint" || o.constructor == String ? o = e.__k[a] = ue(null, o, null, null, null) : se(o) ? o = e.__k[a] = ue(F, { children: o }, null, null, null) : o.constructor === void 0 && o.__b > 0 ? o = e.__k[a] = ue(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : e.__k[a] = o, c = a + f, o.__ = e, o.__b = e.__b + 1, s = null, (l = o.__i = be(o, n, c, d)) != -1 && (d--, (s = n[l]) && (s.__u |= 2)), s == null || s.__v == null ? (l == -1 && (i > u ? f-- : i < u && f++), typeof o.type != "function" && (o.__u |= 4)) : l != c && (l == c - 1 ? f-- : l == c + 1 ? f++ : (l > c ? f-- : f++, o.__u |= 4))) : e.__k[a] = null;
	if (d) for (a = 0; a < u; a++) (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = fe(s)), Ae(s, s));
	return r;
}
function ye(e, t, n) {
	var r, i;
	if (typeof e.type == "function") {
		for (r = e.__k, i = 0; r && i < r.length; i++) r[i] && (r[i].__ = e, t = ye(r[i], t, n));
		return t;
	}
...
function we(e, t, n, r, i, a, o, s, c, l) {
	...
	n: if (typeof D == "function") {
		d = o.length;
		try {
			if (v = t.props, y = D.prototype && D.prototype.render, b = (u = D.contextType) && r[u.__c], x = u ? b ? b.props.value : u.__ : r, n.__c ? _ = (f = t.__c = n.__c).__ = f.__E : (y ? t.__c = f = new D(v, x) : (t.__c = f = new de(v, x), f.constructor = D, f.render = je), b && b.sub(f), f.state || (f.state = {}), f.__n = r, p = f.__d = !0, f.__h = [], f._sb = []), y && f.__s == null && (f.__s = f.state), y && D.getDerivedStateFromProps != null && (f.__s == f.state && (f.__s = P({}, f.__s)), P(f.__s, D.getDerivedStateFromProps(v, f.__s))), m = f.props, h = f.state, f.__v = t, p) y && D.getDerivedStateFromProps == null && f.componentWillMount != null && f.componentWillMount(), y && f.componentDidMount != null && f.__h.push(f.componentDidMount);
			else {
				if (y && D.getDerivedStateFromProps == null && v !== m && f.componentWillReceiveProps != null && f.componentWillReceiveProps(v, x), t.__v == n.__v || !f.__e && f.shouldComponentUpdate != null && !1 === f.shouldComponentUpdate(v, f.__s, x)) {
					t.__v != n.__v && (f.props = v, f.state = f.__s, f.__d = !1), t.__e = n.__e, t.__k = n.__k, t.__k.some(function(e) {
						e && (e.__ = t);
					}), ae.push.apply(f.__h, f._sb), f._sb = [], f.__h.length && o.push(f), s = fe(n);
					break n;
				}
			...
			while (f.__d && ++C < 25);
			f.state = f.__s, f.getChildContext != null && (r = P(P({}, r), f.getChildContext())), y && !p && f.getSnapshotBeforeUpdate != null && (g = f.getSnapshotBeforeUpdate(m, h)), T = u != null && u.type === F && u.key == null ? De(u.props.children) : u, s = _e(e, se(T) ? T : [T], t, n, r, i, a, o, s, c, l), f.base = t.__e, t.__u &= -161, f.__h.length && o.push(f), _ && (f.__E = f.__ = null);
		} catch (e) {
			...
			t.__k ??= n.__k || [], e.then || Te(t), w.__e(e, t, n);
		}
	} else a == null && t.__v == n.__v ? (t.__k = n.__k, t.__e = n.__e) : s = t.__e = Oe(n.__e, t, n, r, i, a, o, c, l);
...
function De(e) {
	return typeof e != "object" || !e || e.__b > 0 ? e : se(e) ? e.map(De) : e.constructor === void 0 ? P({}, e) : null;
}
function Oe(e, t, n, r, i, a, o, s, c) {
	...
	if (v == null) g === _ || s && e.data == _ || (e.data = _);
		...
		for (l in g) p = g[l], l == "dangerouslySetInnerHTML" ? d = p : l == "children" || l in _ || l == "value" && "defaultValue" in _ || l == "checked" && "defaultChecked" in _ || Se(e, l, null, p, i);
		for (l in _) p = _[l], l == "children" ? f = p : l == "dangerouslySetInnerHTML" ? u = p : l == "value" ? m = p : l == "checked" ? h = p : s && typeof p != "function" || g[l] === p || Se(e, l, p, g[l], i);
		if (u) s || d && (u.__html == d.__html || u.__html == e.innerHTML) || (e.innerHTML = u.__html), t.__k = [];
		else if (d && (e.innerHTML = ""), _e(t.type == "template" ? e.content : e, se(f) ? f : [f], t, n, r, v == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, a, o, a ? a[0] : n.__k && fe(n, 0), s, c), a != null) for (l = a.length; l--;) ce(a[l]);
		s && v != "textarea" || (l = "value", v == "progress" && m == null ? e.removeAttribute("value") : m != null && (m !== e[l] || v == "progress" && !m || v == "option" && m != g[l]) && Se(e, l, m, g[l], i), l = "checked", h != null && h != e[l] && Se(e, l, h, g[l], i));
	}
	return e;
}
function ke(e, t, n) {
...
function Ae(e, t, n) {
	var r, i;
	if (w.unmount && w.unmount(e), (r = e.ref) && (r.current && r.current != e.__e || ke(r, null, t)), (r = e.__c) != null) {
	...
	if (r = e.__k) for (i = 0; i < r.length; i++) r[i] && Ae(r[i], t, n || typeof e.type != "function");
...
function Me(e, t, n) {
	var r, i, a, o;
	t == document && (t = document.documentElement), w.__ && w.__(e, t), i = (r = typeof n == "function") ? null : n && n.__k || t.__k, a = [], o = [], we(t, e = (!r && n || t).__k = le(F, null, [e]), i || ie, ie, t.namespaceURI, !r && n ? [n] : i ? null : t.firstChild ? C.call(t.childNodes) : null, a, !r && n ? n : i ? i.__e : t.firstChild, r, o), Ee(a, e, o), e.props.children = null;
}
C = ae.slice, w = { __e: function(e, t, n, r) {
	...
	typeof e == "function" && (e = e(P({}, n), this.props)), e && P(n, e), e != null && this.__v && (t && this._sb.push(t), he(this));
...
}, ge.__r = 0, j = Math.random().toString(8), ee = "__d" + j, M = "__a" + j, te = /(PointerCapture)$|Capture$/i, ne = 0, re = Ce(!1), N = Ce(!0);
//#endregion
...
function Le(e, t, n, r, i) {
	let a = Pe[t];
	if (!a) return !1;
	let { min: o, max: s, unit: c, optional: l, fallback: u } = a, d = `peach.number.${t}`, f = Fe(Number(localStorage.getItem(d)), o, s, r > 0 ? r : u), p = document.createElement("div");
...
function Re(e, t, n, r = "chart-no-axes-combined") {
...
var Ue, L, We, Ge, Ke = 0, qe = [], R = w, Je = R.__b, Ye = R.__r, Xe = R.diffed, Ze = R.__c, Qe = R.unmount, $e = R.__;
function et(e, t) {
	R.__h && R.__h(L, e, Ke || t), Ke = 0;
	var n = L.__H || (L.__H = {
		__: [],
		__h: []
	});
...
R.__b = function(e) {
	...
	})) : (t.__h.some(st), t.__h.some(ct), t.__h = [], Ue = 0)), We = L;
}, R.diffed = function(e) {
	Xe && Xe(e);
	var t = e.__c;
	t && t.__H && (t.__H.__h.length && (qe.push(t) !== 1 && Ge === R.requestAnimationFrame || ((Ge = R.requestAnimationFrame) || ot)(it)), t.__H.__.some(function(e) {
...
async function pt(e, t, n = "POST", r) {
	let i = await fetch(e, {
		method: n,
		...r ? { signal: r } : {},
		headers: {
...
//#endregion
//#region src/jobs.ts
function mt(e, t = 0, n = 0) {
	return n > 0 ? ze(e, t, n) : p(e);
}
async function ht(e) {
...
function gt(e) {
	let t = e.note || ((e) => h(e, {
		label: "任务状态",
		variant: "error"
	})), n = e.loading || p, r = e.progress || ((e, t, n) => mt(n || `已处理 ${e} / ${t}`, e, t)), i = e.container || ((e) => `<section class="followtask" data-geist-fieldset aria-label="任务进度"><div class="geist-fieldset-content">${e}</div></section>`), a = document.createElement("div");
...
function yt({ id: e, label: t, actions: n, busy: r }) {
	let i = V(null), a = V();
	nt(() => {
		let e = i.current;
...
var bt = (e, t) => U("/api/library-processing", t), xt = {
...
function Ct(e) {
	let t = Object.entries(e).filter(([e, t]) => St[e] && t > 0).map(([e, t]) => `${St[e]} ${t} 部`);
	return t.length ? `外部来源${t.join("、")}，7 天内不再问。` : "";
}
function wt(e) {
	let t = xt[e.current_action || ""] || e.stage || "正在处理", n = e.waited_seconds ? ` · 已等待 ${e.waited_seconds} 秒` : "";
	return e.current_asset_name ? `当前：${e.current_asset_name} · ${t}${n}` : t + n;
}
var Tt = "peach.library-processing.announced", Et = 120;
function Dt(e, t, n) {
	if (e.status !== "complete") return;
	let r = !!e.job_id && !!e.completed_at && Date.now() / 1e3 - e.completed_at < Et;
	if (!(!n && !r)) {
		try {
			if (e.job_id && localStorage.getItem(Tt) === e.job_id) return;
			e.job_id && localStorage.setItem(Tt, e.job_id);
		} catch {}
		t(`扫描与资料采集已完成：识别 ${e.identified || 0} 个番号，整理 ${e.candidates || 0} 组资料候选`);
	}
}
function Ot({ data: e, error: t, toast: n, onComplete: r, mode: i, monitor: a, preview: o }) {
	let [s, c] = z(e || { status: "idle" }), [l, u] = z(t), [d, p] = z(!1), [m, _] = z(!1), v = V(new AbortController()), y = V(0), b = V(s.status), S = V(null);
	B(() => {
	...
	async function w() {
		...
		await ht({
			...
			render: (e) => {
				...
				t && i !== "notice" && _(!0), (t || i === "notice") && Dt(e, n, t), b.current === "running" && (e.status === "complete" || e.status === "failed") && r?.(), b.current = e.status;
			},
	...
	async function T(e) {
		if (!(C || o)) {
			p(!0), u(""), _(!1);
			try {
				let t = await pt("/api/library-processing", e, "POST", v.current.signal);
	...
	if (i === "notice") {
		...
		let e = l || (s.status === "failed" ? "扫描与资料采集未完成" : wt(s) + (s.total ? ` · ${s.checked || 0} / ${s.total}` : ""));
		return /* @__PURE__ */ W("div", { dangerouslySetInnerHTML: { __html: g(e, {
	...
	let O = s.issue_preview || [], k = Ct(s.notes || {}), A = s.status === "failed" && !!s.retryable_asset_ids?.length, j = O.length ? {
	...
	return /* @__PURE__ */ W(F, { children: [/* @__PURE__ */ W("section", {
		...
		children: [/* @__PURE__ */ W("div", {
			...
			children: [
				...
				s.status === "running" && /* @__PURE__ */ W("div", {
					"aria-live": "polite",
					dangerouslySetInnerHTML: { __html: mt(s.total ? `${wt(s)} · ${s.checked || 0} / ${s.total} 个视频` : wt(s), s.checked, s.total) }
				})
			]
		}), /* @__PURE__ */ W("footer", {
			...
			children: [
				...
				!!s.candidates && /* @__PURE__ */ W(vt, {
					href: "/review",
					children: "复核资料"
				}),
				(s.status !== "failed" || !A) && /* @__PURE__ */ W(yt, {
		...
		children: [
			...
			s.status !== "running" && !!k && /* @__PURE__ */ W("div", { dangerouslySetInnerHTML: { __html: h(k + (s.issues_log ? ` 完整记录：${s.issues_log}` : ""), { variant: "secondary" }) } })
		]
	})] });
}
//#endregion
...
var Nt = "peach-taste-guide-dismissed";
function Pt(e, t) {
...
function It() {
	...
	return /* @__PURE__ */ W("main", {
		...
		children: [
			...
			/* @__PURE__ */ W("nav", {
				"aria-label": "演示状态",
				children: Ft.map(([i, a]) => /* @__PURE__ */ W("button", {
					class: "geist-button",
					"aria-pressed": e === i,
					onClick: () => {
						t(i), r(n + 1);
			...
			/* @__PURE__ */ W("section", { children: [
				...
				e === "loading" ? /* @__PURE__ */ W(G, { html: jt() }) : /* @__PURE__ */ W("div", {
					class: "cleanupgrid",
					children: /* @__PURE__ */ W("div", {
			...
			/* @__PURE__ */ W("section", { children: [/* @__PURE__ */ W("h2", { children: "关注检查与资源同步" }), /* @__PURE__ */ W("div", {
				...
				children: [/* @__PURE__ */ W("article", { children: [/* @__PURE__ */ W("h3", { children: "检查更新" }), /* @__PURE__ */ W(G, { html: e === "disconnected" ? h("暂时无法读取进度，正在重新连接…", { label: "任务状态" }) : e === "failed" ? h("检查失败：来源连接超时", {
					variant: "error",
					actionLabel: "重试"
				}) : e === "running" || e === "retrying" || e === "reconnected" ? ze(`${e === "retrying" ? "第 2/3 次尝试，8 秒后重试 · " : ""}已完成 ${o}/100 个来源`, o, 100) : e === "preparing" ? p("正在准备检查任务…") : h(e === "complete" ? "已完成检查" : e === "paused" ? "已暂停自动检查" : e === "expired" ? "任务状态已失效，请重新发起任务" : "等待开始", { variant: e === "complete" ? "success" : "secondary" }) })] }), /* @__PURE__ */ W("article", { children: [
					/* @__PURE__ */ W("h3", { children: "连接与恢复" }),
					/* @__PURE__ */ W(G, { html: g(e === "disconnected" ? "暂时无法连接服务器，正在重连" : e === "reconnected" ? "连接已恢复，继续读取任务进度" : "连接正常", {
...
function zt() {
	let e = (e) => {
		e.querySelectorAll("input[type=range]").forEach(Rt), Ut(e), Vt(e), Wt(e);
	};
	e(document), new MutationObserver((t) => {
		for (let n of t) for (let t of n.addedNodes) t instanceof Element && (t.matches("input[type=range]") && Rt(t), e(t));
	}).observe(document.body, {
		subtree: !0,
		childList: !0
	}), document.addEventListener("input", (e) => {
		e.target instanceof HTMLInputElement && e.target.type === "range" && Rt(e.target);
	});
...
function Ut(e) {
	...
	e instanceof HTMLElement && e.matches(t) && n.push(e), n.forEach((e) => {
		...
		let n = e.className + (e.getAttribute("aria-label") ?? ""), r = Ht.get(n) ?? null, i = () => {
...
function Zt(e, t) {
	return $t(e.source, t.source) || e.index - t.index;
}
function Qt(e, t) {
	return $t(e.target, t.target) || e.index - t.index;
}
function $t(e, t) {
	return e.y0 - t.y0;
}
...
function sn() {
	let e = 0, t = 0, n = 1, r = 1, i = 24, a = 8, o, s = tn, c = Yt, l, u, d = nn, f = rn, p = 6;
	function m() {
		let e = {
			nodes: d.apply(null, arguments),
			links: f.apply(null, arguments)
		};
		return h(e), g(e), _(e), v(e), x(e), on(e), e;
	}
	m.update = function(e) {
		return on(e), e;
	}, m.nodeId = function(e) {
		return arguments.length ? (s = typeof e == "function" ? e : Xt(e), m) : s;
	}, m.nodeAlign = function(e) {
		return arguments.length ? (c = typeof e == "function" ? e : Xt(e), m) : c;
		...
		return arguments.length ? (d = typeof e == "function" ? e : Xt(e), m) : d;
	}, m.links = function(e) {
		return arguments.length ? (f = typeof e == "function" ? e : Xt(e), m) : f;
	...
	function h({ nodes: e, links: t }) {
		...
		for (let [e, r] of t.entries()) {
			...
			typeof t != "object" && (t = r.source = an(n, t)), typeof i != "object" && (i = r.target = an(n, i)), t.sourceLinks.push(r), i.targetLinks.push(r);
		}
		if (u != null) for (let { sourceLinks: t, targetLinks: n } of e) t.sort(u), n.sort(u);
	}
	function g({ nodes: e }) {
		for (let t of e) t.value = t.fixedValue === void 0 ? Math.max(Jt(t.sourceLinks, en), Jt(t.targetLinks, en)) : t.fixedValue;
	}
	function _({ nodes: e }) {
	...
	function b(e) {
		let n = qt(e, (e) => (r - t - (e.length - 1) * o) / Jt(e, en));
		for (let i of e) {
			let e = t;
			for (let t of i) {
	...
	function D({ sourceLinks: e, targetLinks: t }) {
		if (u === void 0) {
			for (let { source: { sourceLinks: e } } of t) e.sort(Qt);
			for (let { target: { targetLinks: t } } of e) t.sort(Zt);
		}
	}
	function O(e) {
		if (u === void 0) for (let { sourceLinks: t, targetLinks: n } of e) t.sort(Qt), n.sort(Zt);
	}
	function k(e, t) {
...
var cn = Math.PI, ln = 2 * cn, K = 1e-6, un = ln - K;
function dn() {
...
dn.prototype = fn.prototype = {
	...
	arcTo: function(e, t, n, r, i) {
		...
		if (this._x1 === null) this._ += "M" + (this._x1 = e) + "," + (this._y1 = t);
			...
			if (!(Math.abs(u * s - c * l) > K) || !i) this._ += "L" + (this._x1 = e) + "," + (this._y1 = t);
				...
				var f = n - a, p = r - o, m = s * s + c * c, h = f * f + p * p, g = Math.sqrt(m), _ = Math.sqrt(d), v = i * Math.tan((cn - Math.acos((m + d - h) / (2 * g * _))) / 2), y = v / _, b = v / g;
	...
	arc: function(e, t, n, r, i, a) {
		...
		this._x1 === null ? this._ += "M" + c + "," + l : (Math.abs(this._x1 - c) > K || Math.abs(this._y1 - l) > K) && (this._ += "L" + c + "," + l), n && (d < 0 && (d = d % ln + ln), d > un ? this._ += "A" + n + "," + n + ",0,1," + u + "," + (e - o) + "," + (t - s) + "A" + n + "," + n + ",0,1," + u + "," + (this._x1 = c) + "," + (this._y1 = l) : d > K && (this._ += "A" + n + "," + n + ",0," + +(d >= cn) + "," + u + "," + (this._x1 = e + n * Math.cos(i)) + "," + (this._y1 = t + n * Math.sin(i))));
	},
...
function yn(e) {
	var t = _n, n = vn, r = mn, i = hn, a = null;
	function o() {
		var o, s = gn.call(arguments), c = t.apply(this, s), l = n.apply(this, s);
		if (a ||= o = fn(), e(a, +r.apply(this, (s[0] = c, s)), +i.apply(this, s), +r.apply(this, (s[0] = l, s)), +i.apply(this, s)), o) return a = null, o + "" || null;
	}
	return o.source = function(e) {
		...
		return arguments.length ? (r = typeof e == "function" ? e : pn(+e), o) : r;
	}, o.y = function(e) {
		return arguments.length ? (i = typeof e == "function" ? e : pn(+e), o) : i;
...
function Tn(e = []) {
	...
	if (!n.length) return "";
	let r = [...new Set(n.map((e) => e.source))], i = [...new Set(n.map((e) => e.target))], a = sn().nodeId((e) => e.id).nodeWidth(10).nodePadding(22).extent([[155, 16], [535, 404]])({
		nodes: [...r.map((e) => ({
			id: `source:${e}`,
			name: e,
			side: "source"
	...
	}), o = n.reduce((e, t) => e + t.value, 0), s = wn(), c = a.links.map((e) => {
...
function jn(e) {
	...
	let r = Math.max(1, ...n.flat()), i = n.flat().reduce((e, t) => e + t, 0), a = n.map((e, t) => `<span class="board-heat-axis">${An[t]}</span>${e.map((e, n) => `<button type="button" data-heat-value="${e}" data-heat-label="${An[t]} ${n}:00" aria-label="${An[t]} ${n}:00，${e} 次访问" style="--heat:${e ? Math.max(12, e / r * 100) : 0}%"></button>`).join("")}`).join(""), o = e.days.filter((e) => /^\d{4}-\d{2}-\d{2}$/.test(e.date) && Dn(e.count)).sort((e, t) => e.date.localeCompare(t.date));
	if (!o.length) return "";
...
function Pn(e, t, n = "", r = "") {
	...
	return `<details class="sec${r ? " cat-" + Nn(r) : ""}" data-sidebar-group="${Nn(e)}"><summary role="button" class="board-section-toggle"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="#i-chevron-right"/></svg><span>${Nn(e)}</span></summary><div class="board-sidebar-body" id="${i}">${t}${n}</div></details>`;
}
function Fn(e) {
...
async function Ln(e, t) {
	...
	try {
		...
		delete s.dataset.themeSnapshot, o.remove(), In = !1;
	}
}
//#endregion
//#region src/configuration-endpoints.ts
var Rn = "/api/configuration";
//#endregion
...
var Bn = (e, t) => U(Rn, t);
function Vn({ receipt: e, data: t, error: n }) {
	...
	return /* @__PURE__ */ W("div", {
		...
		children: [
			...
			t.peach_proxy || t.access ? /* @__PURE__ */ W(zn, {
...
var qn = void 0, J = 0, Jn = 0, Yn = 0, Xn = 0, Zn = void 0, Qn = 0;
function $n(e) {
	if (q !== void 0) {
		var t = e.n;
...
Y.prototype.brand = Hn, Y.prototype.h = function() {
	return !0;
}, Y.prototype.S = function(e) {
	var t = this, n = this.t;
	n !== e && e.e === void 0 && (e.x = n, this.t = e, n === void 0 ? Kn(function() {
		var e;
		(e = t.W) == null || e.call(t);
	}) : n.e = e);
	...
	if (this.t !== void 0) {
		var n = e.e, r = e.x;
		n !== void 0 && (n.x = r, e.e = void 0), r !== void 0 && (r.e = n, e.x = void 0), e === this.t && (this.t = r, r === void 0 && Kn(function() {
			var e;
			(e = t.Z) == null || e.call(t);
		}));
	}
	...
	set: function(e) {
		if (e !== this.v) {
			if (Jn > 100) throw Error("Cycle detected");
			(function(e) {
				J !== 0 && Jn === 0 && e.l !== Xn && (e.l = Xn, Zn = {
					S: e,
					v: e.v,
					i: e.i,
					o: Zn
				});
			})(this), this.v = e, this.i++, Qn++, J++;
			try {
...
function X(e, t) {
	Y.call(this, void 0, t), this.x = e, this.s = void 0, this.g = Qn - 1, this.f = 4;
}
X.prototype = new Y(), X.prototype.h = function() {
	if (this.f &= -3, 1 & this.f) return !1;
	if ((36 & this.f) == 32 || (this.f &= -5, this.g === Qn)) return !0;
	if (this.g = Qn, this.f |= 1, this.i > 0 && !tr(this)) return this.f &= -2, !0;
	var e = q;
	try {
		nr(this), q = this;
		var t = this.x();
...
function sr(e) {
	...
	rr(this), q = e, this.f &= -2, 8 & this.f && or(this), Un();
}
function cr(e, t) {
	this.x = e, this.m = void 0, this.s = void 0, this.u = void 0, this.f = 32, this.name = t?.name, Gn && Gn.push(this);
}
cr.prototype.c = function() {
	...
	if (1 & this.f) throw Error("Cycle detected");
	this.f |= 1, this.f &= -9, ar(this), nr(this), J++;
	var e = q;
	return q = this, sr.bind(this, e);
}, cr.prototype.N = function() {
	2 & this.f || (this.f |= 2, this.u = qn, qn = this);
...
var ur, dr, fr = typeof window < "u" && !!window.__PREACT_SIGNALS_DEVTOOLS__, pr = [];
lr(function() {
	ur = this.N;
})();
function mr(e, t) {
...
gr.displayName = "ReactiveTextNode", Object.defineProperties(Y.prototype, {
	constructor: {
		configurable: !0,
		value: void 0
	},
	...
	if (e(t), t.type !== F) {
		...
		r && (r.__$f &= -2, (n = r.__$u) === void 0 && (r.__$u = n = function(e, t) {
			...
			return function() {
				var t;
				fr && ((t = this.y) == null || t.call(this)), e.__$f |= 1, e.setState({});
			};
		}(r), typeof t.type == "function" ? t.type.displayName || t.type.name : ""))), hr(n);
	}
	...
	if (typeof t.type == "string" && (n = t.__e)) {
		...
		if (r) for (var c in a || (a = {}, n.U = a), r) {
			var l = a[c], u = r[c];
			l === void 0 ? (l = _r(n, c, u, i), a[c] = l) : l.o(u, i);
		}
	}
	e(t);
});
function _r(e, t, n, r) {
	var i = t in e && e.ownerSVGElement === void 0, a = er(n);
	return {
		o: function(e, t) {
			a.value = e, r = t;
		},
...
function br() {
	Wn(function() {
		for (var e; e = pr.shift();) ur.call(e);
	});
}
function xr() {
	pr.push(this) === 1 && (w.requestAnimationFrame || yr)(br);
}
//#endregion
//#region src/state/quality-goals.ts
var Sr = "/api/quality-goals?limit=200", Cr = {
	data: null,
	error: ""
}, wr = er(Cr), Tr = 0, Er = ir(() => wr.value);
ir(() => wr.value.data?.total ?? null);
function Dr() {
	Tr += 1, wr.value = Cr;
}
async function Or(e) {
	...
	try {
		let n = await U(Sr, e);
		return t === Tr && (wr.value = {
			data: n,
			error: ""
		}), n;
	} catch (n) {
		throw !e?.aborted && t === Tr && (wr.value = {
			data: null,
			error: H(n)
		}), n;
	}
...
var kr = (e, t) => Or(t), Ar = (e) => e.has_cover ? `/cover?code=${encodeURIComponent(e.code ?? "")}` : `/poster?id=${e.id}&c=4`;
function jr({ openItem: t, javTitleHtml: i, javDisplayName: a, srcBadge: o }) {
	let { data: s, error: c } = Er.value;
...
var Mr = (e, t) => U("/api/scraping", t);
function Nr({ value: e, onChange: t }) {
	let n = V(null), r = V(t);
	return r.current = t, nt(() => {
		let t = n.current;
...
function Pr({ source: e, toast: t }) {
	let [n, r] = z(e), [i, a] = z(e.network), [s, c] = z(""), [l, u] = z(""), [d, p] = z("paste"), [m, g] = z(""), [_, v] = z(!1), [b, x] = z(""), [S, C] = z([]), w = V(null), T = V(null);
	nt(() => {
	...
	async function D(n) {
		if (!_) {
			...
			try {
				if (n === "check") {
					let t = await pt("/api/scraping/check", { source: e.source }, "POST", E.current.signal);
					E.current.signal.aborted || C(t.results);
				} else {
					let a = await pt("/api/scraping/settings", {
						source: e.source,
						network: i,
						cookie: s,
						cookies_text: l,
			...
			children: [/* @__PURE__ */ W("div", {
				...
				children: [
					...
					/* @__PURE__ */ W("div", {
						...
						children: ["连接方式", /* @__PURE__ */ W(Nr, {
							value: i,
							onChange: a
						})]
					}),
					i === "peach" && /* @__PURE__ */ W(vt, {
...
function Fr({ data: e, error: t, toast: n }) {
	...
	async function v() {
		if (!a) {
			g.current++, o(!0), c(""), u("");
			try {
				await pt("/api/scraping/cover", { code: r }, "POST", m.current.signal), await _();
			} catch (e) {
...
var zr = (e = "") => /^https?:\/\//i.test(e) ? e : "";
function Br(e = "") {
	let n = zr(e) || (e.startsWith("/") && !e.startsWith("//") ? e : "");
...
function Vr(e) {
	let n = zr(e.profile_url), r = (e.preview_assets || []).slice(0, 6), i = Math.max(0, Number(e.video_count || e.videos || 0));
...
function Ur(e, t, n, r, i, a = i || !e.has(r)) {
...
function Kr({ count: e, label: t, all: n, summary: r, actions: i, locked: a = !1 }) {
...
function Zr(e, t, n, r, i) {
	e.anchor = Ur(e.selected, t, e.anchor, n, r, i);
}
...
function ei(e, t) {
	...
	let o = t.catalog || t.rows, s = Yr(o, t.metadata);
	s.some((e) => e[0] === r.groupBy) || (r.groupBy = "candidates", r.filter = "");
	let c = Xr(o, r.groupBy);
	...
	for (let e of c) {
		...
		f.className = "reviewlist", s.append(c, d), o.append(s, f), n.append(o), d.onclick = () => {
			...
			Gr(r.selected, e, !e.every((e) => r.selected.has(e))), N();
		}, ne.push(() => {
		...
		for (let e of t) {
			...
			let o = (e, n) => {
				Zr(r, u().map((e) => e.dataset.reviewKey), t, e, n), N();
			};
			if (i.addEventListener("mousedown", (e) => {
				...
				if (!(r.busy || !n.shiftKey)) {
					if (n.key === " ") n.preventDefault(), o(!0, !0);
						...
						a && (r.anchor === null && (r.anchor = t), Zr(r, i.map((e) => e.dataset.reviewKey), a.dataset.reviewKey, !0, !0), N(), a.querySelector(".reviewpickitem input")?.focus());
					}
				}
			}), ne.push(() => {
	...
	function N() {
		...
		w.innerHTML = i(n ? "check-check-outline" : "check-check") + (n ? "清空当前选择" : r.filter ? "全选当前分类" : "全选本页"), w.setAttribute("aria-pressed", String(n)), j.hidden = !e.length, Kr({
			count: D,
			label: `已选 ${e.length} 项`,
			summary: Wr(r.selected, u().map((e) => e.dataset.reviewKey)),
			actions: [T, E]
		...
		if (s !== re) {
			...
			e.disabled = !a.length, e.addEventListener("change", () => {
				if (!(r.busy || !$r(f()).includes(e.value))) {
					for (let n of d()) {
...
function ii(e, t, n) {
	if (t <= 1) return "";
	let r = ti(e, t).map((t) => t === "…" ? "<li class=\"board-page-dots\" aria-hidden=\"true\">…</li>" : `<li><button type="button" class="board-page" data-page="${t}" aria-label="第 ${t} 页"${t === e ? " aria-current=\"page\"" : ""}>${t}</button></li>`).join("");
...
function ci({ kind: e, id: t, name: n, onPicked: r }) {
	...
	}, x = (n) => b(() => pt("/api/avatar-pick", {
		kind: e,
		id: t,
		ref: n.ref
	}), n.ref), S = () => b(() => pt("/api/avatar-pick", {
		kind: e,
		id: t,
		url: m.trim()
				...
				children: [/* @__PURE__ */ W("div", {
					...
					children: /* @__PURE__ */ W("div", {
						...
						children: w.map((n) => /* @__PURE__ */ W("button", {
							...
							title: `${si[n.source] || n.source} · ${n.label}` + (n.width ? ` · ${n.width}×${n.height}` : "") + (n.found_by ? ` · 按「${n.found_by}」找到` : ""),
							onClick: () => x(n),
							children: [
								/* @__PURE__ */ W("img", {
									loading: "lazy",
...
var Z = (e = "60%") => `<span class="skeleton" style="width:${e}"></span>`, fi = () => `${Z("80%")}${Z("48%")}`, Q = (e, t) => e.repeat(t), pi = (e, t = "metricstrip") => `<div class="${t}">${e.map((e) => `<div class="tastesummary"><span class="board-stat-label">${e}</span><b class="board-stat-value">${Z("45%")}</b><small class="board-stat-footer">${Z("60%")}</small></div>`).join("")}</div>`, mi = (e, t = "skeleton-tabs") => `<div class="${t}">${e.map((e) => `<span>${e}</span>`).join("")}</div>`, hi = (e, t) => `<div class="${t} skeleton-segments" data-board-segments="true">${e.map((e, t) => `<span${t === 0 ? " class=\"skeleton-segment-selected\"" : ""}>${e}</span>`).join("")}</div>`, gi = (e) => `<section class="board-radial-card"><header><span>${e}</span><b>${Z()}</b></header><div class="board-rings skeleton-rings"><span class="skeleton skeleton-ring"></span></div><div class="skeleton-lines">${fi()}</div></section>`, _i = (e) => `<section class="insightpanel"><header>${e}</header><div class="insightpanelbody skeleton-lines">${Q(fi(), 3)}</div></section>`, vi = (e) => `<button class="fbtn" type="button" disabled>${e}</button>`, yi = (e) => `<div class="fsechead" data-collapse-toolbar><h3>关注列表</h3><span class="fmeta">${Z("100px")}</span><div class="followtoolbaractions"><button class="fbtn primary followcheckall" disabled>${i("refresh-cw")}<span data-collapse-label>检查全部</span></button><div class="iconswitch" data-board-segments="true"><label>${i("layout-grid")}</label><label>${i("table")}</label></div><span class="fmanagesort" data-collapse-field>${i("sort")}${_([["checked", "检查时间"]], "checked", {
	label: "关注列表排序",
	attr: "disabled"
})}</span><button class="fbtn fmanagedir" disabled>${i("arrow-down")}</button>${e ? "" : vi(i("chevron-up") + "<span data-collapse-label>全部收起</span>")}</div></div>`, bi = () => `<div class="fsource frow"><span class="fchannelcheck">${Z("18px")}</span><b>${Z("85%")}</b><span class="fprovider">${Z("54px")}</span><span class="fmeta fchecked">${Z("40px")}</span><span class="fsourceactions"><span class="skeleton skeleton-icon"></span><span class="skeleton skeleton-icon"></span></span></div>`, xi = () => `<details class="fauthor" open><summary class="fauthorhead"><span class="favatar skeleton"></span><b>${Z("90px")}</b><span class="skeleton skeleton-icon"></span><span class="fmeta">${Z("40px")}</span><span class="board-author-actions"><button type="button" class="fbtn small" data-follow-author-select disabled>${i("check-check")}<span data-author-select-label>全选</span></button><span class="skeleton skeleton-icon"></span></span></summary><div class="fauthorsources">${Q(bi(), 3)}</div></details>`;
function Si() {
	return `<div data-skeleton="detail" role="status" aria-label="正在读取作品详情"><div class="sgrid" aria-hidden="true"><div class="vwrap skeleton-detail-media skeleton"></div><aside class="side"><div class="sidecontent skeleton-lines">${Z("85%")}${Z("65%")}${Q(fi(), 4)}</div></aside></div></div>`;
}
function Ci(e, t = {}) {
	let n = "";
	if (e === "/stats") n = `<div class="insightpage statsdashboard"><header class="insighttoolbar">${Z("38%")}</header>${pi([
		"馆藏视频",
		"看过",
		"内容标签",
		"使用空间"
	])}<section class="insightdetail"><div class="insightdetailbody"><div class="board-inventory-charts">${gi("网盘与本地")}${gi("媒体库")}</div></div></section>${_i("内容标签")}</div>`;
	else if (e === "/taste") n = `<div class="tastepage"><header class="tastehead">${hi(["浏览器记录", "Peach 内部"], "insightswitch")}${Z("24%")}</header><div class="tastestate"></div>${pi([
		"浏览记录",
		"口味维度",
		"浏览候选",
		"私有导出"
	], "tastesummaries")}<section class="tastehero"><div class="insightcopy"><span>浏览器画像</span><div class="skeleton skeleton-radar"></div></div><div class="tastebars skeleton-lines">${Q(fi(), 4)}</div></section>${_i("口味分析")}<div class="board-activity-charts">${_i("浏览活动")}${_i("时间分布")}</div>${_i("标签")}</div>`;
		...
		let e = t.followLayout === "table", r = e ? `<div class="ftableframe"><div class="ftablewrap"><table class="ftable"><thead><tr>${[
			...
			"100px",
			"60px"
		].map((e) => `<td>${Z(e)}</td>`).join("")}</tr>`, 6)}</tbody></table></div></div>` : `<div class="board-follow-list">${Q(xi(), 4)}</div>`;
		n = `<div class="follow followmanage"><div class="fmanageoverview">${[
			"关注创作者",
			"启用来源",
			"检查失败",
			"未看更新"
		].map((e) => `<div><span>${e}</span><b>${Z()}</b></div>`).join("")}</div>${hi([
			"关注列表",
			"添加关注",
			"来源和凭证"
		], "follow-workspace-switch")}<div class="fmain"><section class="fsec" data-follow-workspace-panel="list">${yi(e)}<div class="board-follow-selection"${e ? " hidden" : ""}><label>${l("disabled")}全选本页</label></div><div class="frows fsources" data-layout="${e ? "table" : "default"}">${r}<div class="followpagefooter"><div class="followpageinfo">${Z("120px")}${Z("100px")}</div></div></div></section></div></div>`;
	} else if (e === "/configuration") n = `<div class="configpage">${mi([
		"通用",
		"媒体",
		"网络与访问",
		"更新与维护"
		...
		"被挡下的",
		"最近完成"
	].map((e) => `<section class="activitysection"><h3 class="geist-fieldset-title">${e}</h3><div class="activity-runs"><article class="cleanupfieldset activity-run"><div class="geist-fieldset-content skeleton-lines">${Z("35%")}${fi()}</div></article></div></section>`).join("")}</div>`;
	...
	else if (e === "/quality-goals") n = `<div class="quality-workspace"><div class="collection-summary"><strong>待升级</strong>${Z("20%")}</div><div class="qualitylist">${Q(`<article class="qualityitem"><span class="qualitycover skeleton"></span><div class="qualitybody skeleton-lines">${fi()}</div><footer class="qualityactions">${Z("80%")}</footer></article>`, 6)}</div></div>`;
	else if (e === "/playlists") n = `<section class="playlistpage"><header><div><h2>播放列表</h2><p>保存 Mix，按自己的顺序继续播放。</p></div><div class="playlistcreate skeleton-lines"><span>新播放列表</span>${Z("200px")}</div></header><div class="playlistcards">${Q(`<article class="card playlistcard"><div class="mixstack"><div class="pic skeleton"></div></div><div class="mixmeta"><span class="mav skeleton"></span><div class="mixcopy skeleton-lines">${fi()}</div></div></article>`, 6)}</div></section>`;
	else return "";
...
var $ = (e = 0) => Number(e).toLocaleString(), ji = {
	...
	115: "115",
	pikpak: "PikPak"
}, Mi = (e) => v(s[e] ?? "database"), Ni = (e, t, n) => `<article class="board-plain-stat resourcestat">
...
function Ii(e) {
	return {
		javLayout: Fi(e.javLayout),
		javImage: Li(e.javLayout === "preview" ? "thumbnail" : e.javImage)
	};
}
function Li(e) {
...
function Ri(e, t) {
	return e.is_jav && e.code && e.has_cover && (Li(t) === "cover" || !e.has_thumb) ? "cover" : e.has_thumb ? "thumbnail" : "";
}
function zi(e, t) {
...
function Bi(e, t) {
	e.querySelectorAll("img[data-jav-image]").forEach((e) => {
		let n = e.dataset.javCover || "", r = e.dataset.javThumb || "", i = !!(n && (Li(t) === "cover" || !r)), a = i ? n : r;
...
}, Hi = () => Object.keys(Vi), Ui = /* @__PURE__ */ new Map();
async function Wi(e, t, n, r = {}) {
	...
	if (Ui.set(t, a), "react" in i) return Ki(i, t, n, a, r);
	let o;
	try {
		o = {
	...
	Me(le(i.component, s), t);
}
function Gi(e, t, n) {
	return Ui.get(e) === t ? n.isCurrent && !n.isCurrent() ? (Ui.delete(e), !1) : (e.textContent = "", t.painted = !0, !0) : !1;
}
...
function Ji(e) {
	let t = Ui.get(e);
	t && (t.controller.abort(), Ui.delete(e), t.dispose ? t.dispose() : t.painted && Me(null, e));
}
//#endregion
export { Nt as TASTE_GUIDE_KEY, jn as activityChartsHtml, Ci as boardPageSkeleton, Fe as boundedPreference, Di as catalogEmptyHtml, Ei as catalogSuggestions, ri as clampPage, jt as cleanupSkeletonHtml, kt as cloudLocations, At as cloudPreferenceLocations, qr as createReviewSelection, Tn as creatorSankeyHtml, Si as detailSkeletonHtml, Be as distributionChart, Ti as emptyCatalogLayout, di as entitySkeletonHtml, gt as followJobProgress, Xr as groupReviewRows, Vr as identityEvidenceHtml, zt as initBoardControls, qi as islandMounted, Hi as islandNames, Ri as javImageKind, mt as jobActivityHtml, ze as jobProgressHtml, ai as matchesFaceSource, li as mountAvatarPicker, Lt as mountBoardStatePreview, Wi as mountIsland, Le as mountNumberSetting, oi as nativeImageFit, Li as normalizeJavImage, Fi as normalizeJavLayout, Ii as normalizeJavPreferences, ni as pageCount, ii as paginationHtml, zi as panelFrame, Ne as preferredDirection, He as radarChart, On as radialCardHtml, Ve as rankedChart, Rr as refreshStore, Pi as resourceScanHtml, Br as reviewImageHtml, Gr as selectGroup, Ur as selectRange, Wr as selectionSummary, Oi as sidebarHasCatalogContent, Pn as sidebarSectionHtml, Ai as sidebarTagCounts, Re as statCardBody, Lr as storeNames, Rt as syncBoardRange, Bi as syncJavImages, Ie as syncNumberSetting, Kr as syncSelectionToolbar, ki as syncSidebarSurface, Mt as tasteHistoryGuideHtml, Ln as transitionTheme, ui as unmountAvatarPicker, Ji as unmountIsland, Jr as updateReviewSticky, ht as watchJob, Mn as wireActivityCharts, En as wireCreatorSankey, Gt as wireExpandableRanks, Wt as wireGrowingCharts, kn as wireRadialCards, Hr as wireReviewPictures, ei as wireReviewSelection, Fn as wireSidebarGroups, Pt as wireTasteHistoryGuide };
