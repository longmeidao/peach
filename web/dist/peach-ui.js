...
import { MEDIA_SOURCE_ICONS as s, checkboxHtml as c, collectionSummaryHtml as l, confirmModal as u, emptyStateHtml as d, fieldsetTitle as f, loadingDotsHtml as p, noteHtml as m, progressHtml as h, projectBannerHtml as g, selectFieldHtml as _, selectOptionIconHtml as v, setActionBusy as y, wireCollapse as b, wireSelectField as x } from "/js/ui-components.js";
//#region node_modules/preact/dist/preact.module.js
var S, C, w, T, E, D, O, k, A, j, M, ee, N, te, P, F = {}, ne = [], re = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, ie = Array.isArray;
function I(e, t) {
...
function ue(e) {
	if (e.__P && e.__d) {
		...
		a.__v = t.__v + 1, C.vnode && C.vnode(a), xe(e.__P, a, t, e.__n, e.__P.namespaceURI, 32 & t.__u ? [n] : null, r, n ?? le(t), !!(32 & t.__u), i), a.__v = t.__v, a.__.__k[a.__i] = a, Ce(r, a, i), t.__e = t.__ = null, a.__e != n && de(a);
	}
}
function de(e) {
...
function fe(e) {
	(!e.__d && (e.__d = !0) && E.push(e) && !pe.__r++ || D != C.debounceRendering) && ((D = C.debounceRendering) || O)(pe);
}
function pe() {
	try {
		for (var e, t = 1; E.length;) E.length > t && E.sort(k), e = E.shift(), t = E.length, ue(e);
	} finally {
		E.length = pe.__r = 0;
	}
}
function me(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (c = he(n, t, _, c, v), d = 0; d < v; d++) (p = n.__k[d]) != null && (f = p.__i != -1 && _[p.__i] || F, p.__i = d, g = xe(e, p, f, i, a, o, s, c, l, u), m = p.__e, p.ref && f.ref != p.ref && (f.ref && Ee(f.ref, null, p), u.push(p.ref, p.__c || m, p)), h == null && m != null && (h = m), 4 & p.__u ? (c = ge(p, c, e), f.__e && (f.__e = null)) : typeof p.type == "function" && g !== void 0 ? c = g : m && (c = m.nextSibling), p.__u &= -7);
	return n.__e = h, c;
}
function he(e, t, n, r, i) {
	var a, o, s, c, l, u = n.length, d = u, f = 0;
	for (e.__k = Array(i), a = 0; a < i; a++) (o = t[a]) != null && typeof o != "boolean" && typeof o != "function" ? (typeof o == "string" || typeof o == "number" || typeof o == "bigint" || o.constructor == String ? o = e.__k[a] = se(null, o, null, null, null) : ie(o) ? o = e.__k[a] = se(L, { children: o }, null, null, null) : o.constructor === void 0 && o.__b > 0 ? o = e.__k[a] = se(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : e.__k[a] = o, c = a + f, o.__ = e, o.__b = e.__b + 1, s = null, (l = o.__i = _e(o, n, c, d)) != -1 && (d--, (s = n[l]) && (s.__u |= 2)), s == null || s.__v == null ? (l == -1 && (i > u ? f-- : i < u && f++), typeof o.type != "function" && (o.__u |= 4)) : l != c && (l == c - 1 ? f-- : l == c + 1 ? f++ : (l > c ? f-- : f++, o.__u |= 4))) : e.__k[a] = null;
	if (d) for (a = 0; a < u; a++) (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = le(s)), De(s, s));
	return r;
}
function ge(e, t, n) {
	var r, i;
	if (typeof e.type == "function") {
		for (r = e.__k, i = 0; r && i < r.length; i++) r[i] && (r[i].__ = e, t = ge(r[i], t, n));
		return t;
	}
	e.__e != t && (t && e.type && !t.parentNode && (t = le(e)), t = n.insertBefore(e.__e, t || null));
	do
		t &&= t.nextSibling;
...
function ye(e, t, n, r, i) {
	...
	} else if (t[0] == "o" && t[1] == "n") a = t != (t = t.replace(ee, "$1")), o = t.toLowerCase(), t = o in e || t == "onFocusOut" || t == "onFocusIn" ? o.slice(2) : t.slice(2), e.l ||= {}, e.l[t + a] = n, n ? r ? n[M] = r[M] : (n[M] = N, e.addEventListener(t, a ? P : te, a)) : e.removeEventListener(t, a ? P : te, a);
	else {
...
function xe(e, t, n, r, i, a, o, s, c, l) {
	var u, d, f, p, m, h, g, _, v, y, b, x, S, w, T, E, D = t.type;
	if (t.constructor !== void 0) return null;
	128 & n.__u && (c = !!(32 & n.__u), a = [s = t.__e = n.__e]), (u = C.__b) && u(t);
	n: if (typeof D == "function") {
		d = o.length;
		try {
			if (v = t.props, y = D.prototype && D.prototype.render, b = (u = D.contextType) && r[u.__c], x = u ? b ? b.props.value : u.__ : r, n.__c ? _ = (f = t.__c = n.__c).__ = f.__E : (y ? t.__c = f = new D(v, x) : (t.__c = f = new ce(v, x), f.constructor = D, f.render = Oe), b && b.sub(f), f.state || (f.state = {}), f.__n = r, p = f.__d = !0, f.__h = [], f._sb = []), y && f.__s == null && (f.__s = f.state), y && D.getDerivedStateFromProps != null && (f.__s == f.state && (f.__s = I({}, f.__s)), I(f.__s, D.getDerivedStateFromProps(v, f.__s))), m = f.props, h = f.state, f.__v = t, p) y && D.getDerivedStateFromProps == null && f.componentWillMount != null && f.componentWillMount(), y && f.componentDidMount != null && f.__h.push(f.componentDidMount);
			else {
				if (y && D.getDerivedStateFromProps == null && v !== m && f.componentWillReceiveProps != null && f.componentWillReceiveProps(v, x), t.__v == n.__v || !f.__e && f.shouldComponentUpdate != null && !1 === f.shouldComponentUpdate(v, f.__s, x)) {
					t.__v != n.__v && (f.props = v, f.state = f.__s, f.__d = !1), t.__e = n.__e, t.__k = n.__k, t.__k.some(function(e) {
						e && (e.__ = t);
					}), ne.push.apply(f.__h, f._sb), f._sb = [], f.__h.length && o.push(f), s = le(n);
					break n;
				}
			...
			if (f.context = x, f.props = v, f.__P = e, f.__e = !1, S = C.__r, w = 0, y) f.state = f.__s, f.__d = !1, S && S(t), u = f.render(f.props, f.state, f.context), ne.push.apply(f.__h, f._sb), f._sb = [];
			else do
				f.__d = !1, S && S(t), u = f.render(f.props, f.state, f.context), f.state = f.__s;
			while (f.__d && ++w < 25);
			f.state = f.__s, f.getChildContext != null && (r = I(I({}, r), f.getChildContext())), y && !p && f.getSnapshotBeforeUpdate != null && (g = f.getSnapshotBeforeUpdate(m, h)), T = u != null && u.type === L && u.key == null ? we(u.props.children) : u, s = me(e, ie(T) ? T : [T], t, n, r, i, a, o, s, c, l), f.base = t.__e, t.__u &= -161, f.__h.length && o.push(f), _ && (f.__E = f.__ = null);
		} catch (e) {
			...
			t.__k ??= n.__k || [], e.then || Se(t), C.__e(e, t, n);
		}
	} else a == null && t.__v == n.__v ? (t.__k = n.__k, t.__e = n.__e) : s = t.__e = Te(n.__e, t, n, r, i, a, o, c, l);
	return (u = C.diffed) && u(t), 128 & t.__u ? void 0 : s;
}
function Se(e) {
...
function we(e) {
	return typeof e != "object" || !e || e.__b > 0 ? e : ie(e) ? e.map(we) : e.constructor === void 0 ? I({}, e) : null;
}
function Te(e, t, n, r, i, a, o, s, c) {
	...
	if (e == null) {
		...
		e = document.createElementNS(i, v, _.is && _), s &&= (C.__m && C.__m(t, a), !1), a = null;
	}
	if (v == null) g === _ || s && e.data == _ || (e.data = _);
	else {
		if (a = v == "textarea" && _.defaultValue != null ? null : a && S.call(e.childNodes), !s && a != null) for (g = {}, l = 0; l < e.attributes.length; l++) g[(p = e.attributes[l]).name] = p.value;
		for (l in g) p = g[l], l == "dangerouslySetInnerHTML" ? d = p : l == "children" || l in _ || l == "value" && "defaultValue" in _ || l == "checked" && "defaultChecked" in _ || ye(e, l, null, p, i);
		for (l in _) p = _[l], l == "children" ? f = p : l == "dangerouslySetInnerHTML" ? u = p : l == "value" ? m = p : l == "checked" ? h = p : s && typeof p != "function" || g[l] === p || ye(e, l, p, g[l], i);
		if (u) s || d && (u.__html == d.__html || u.__html == e.innerHTML) || (e.innerHTML = u.__html), t.__k = [];
		else if (d && (e.innerHTML = ""), me(t.type == "template" ? e.content : e, ie(f) ? f : [f], t, n, r, v == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, a, o, a ? a[0] : n.__k && le(n, 0), s, c), a != null) for (l = a.length; l--;) ae(a[l]);
		s && v != "textarea" || (l = "value", v == "progress" && m == null ? e.removeAttribute("value") : m != null && (m !== e[l] || v == "progress" && !m || v == "option" && m != g[l]) && ye(e, l, m, g[l], i), l = "checked", h != null && h != e[l] && ye(e, l, h, g[l], i));
	}
	return e;
}
function Ee(e, t, n) {
...
function De(e, t, n) {
	var r, i;
	if (C.unmount && C.unmount(e), (r = e.ref) && (r.current && r.current != e.__e || Ee(r, null, t)), (r = e.__c) != null) {
...
function ke(e, t, n) {
	var r, i, a, o;
	t == document && (t = document.documentElement), C.__ && C.__(e, t), i = (r = typeof n == "function") ? null : n && n.__k || t.__k, a = [], o = [], xe(t, e = (!r && n || t).__k = oe(L, null, [e]), i || F, F, t.namespaceURI, !r && n ? [n] : i ? null : t.firstChild ? S.call(t.childNodes) : null, a, !r && n ? n : i ? i.__e : t.firstChild, r, o), Ce(a, e, o), e.props.children = null;
}
S = ne.slice, C = { __e: function(e, t, n, r) {
	...
	typeof e == "function" && (e = e(I({}, n), this.props)), e && I(n, e), e != null && this.__v && (t && this._sb.push(t), fe(this));
}, ce.prototype.forceUpdate = function(e) {
	this.__v && (this.__e = !0, e && this.__h.push(e), fe(this));
}, ce.prototype.render = L, E = [], O = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, k = function(e, t) {
	return e.__v.__b - t.__v.__b;
}, pe.__r = 0, A = Math.random().toString(8), j = "__d" + A, M = "__a" + A, ee = /(PointerCapture)$|Capture$/i, N = 0, te = be(!1), P = be(!0);
//#endregion
...
function Pe(e, t, n, r, i) {
	let a = je[t];
	if (!a) return !1;
	let { min: o, max: s, unit: c, optional: l, fallback: u } = a, d = `peach.number.${t}`, f = Me(Number(localStorage.getItem(d)), o, s, r > 0 ? r : u), p = document.createElement("div");
...
function Fe(e, t, n, r = "chart-no-axes-combined") {
...
var Be, z, Ve, He, Ue = 0, We = [], B = C, Ge = B.__b, Ke = B.__r, qe = B.diffed, Je = B.__c, Ye = B.unmount, Xe = B.__;
function Ze(e, t) {
	B.__h && B.__h(z, e, Ue || t), Ue = 0;
	var n = z.__H || (z.__H = {
		__: [],
		__h: []
	});
...
function Qe(e, t, n) {
	var r = Ze(Be++, 2);
	if (r.t = e, !r.__c && (r.__ = [n ? n(t) : ot(void 0, t), function(e) {
...
function H(e, t) {
	var n = Ze(Be++, 3);
	!B.__s && at(n.__H, t) && (n.__ = e, n.u = t, z.__H.__h.push(n));
}
function U(e, t) {
	var n = Ze(Be++, 4);
	!B.__s && at(n.__H, t) && (n.__ = e, n.u = t, z.__h.push(n));
}
function W(e) {
...
B.__b = function(e) {
	...
	Ke && Ke(e), Be = 0;
	var t = (z = e.__c).__H;
	t && (Ve === z ? (t.__h = [], z.__h = [], t.__.some(function(e) {
		e.__N && (e.__ = e.__N), e.u = e.__N = void 0;
	})) : (t.__h.some(rt), t.__h.some(it), t.__h = [], Be = 0)), Ve = z;
}, B.diffed = function(e) {
	qe && qe(e);
	var t = e.__c;
	t && t.__H && (t.__H.__h.length && (We.push(t) !== 1 && He === B.requestAnimationFrame || ((He = B.requestAnimationFrame) || nt)(et)), t.__H.__.some(function(e) {
		e.u &&= (e.__H = e.u, void 0);
	})), Ve = z = null;
}, B.__c = function(e, t) {
	t.some(function(e) {
		try {
			e.__h.some(rt), e.__h = e.__h.filter(function(e) {
				return !e.__ || it(e);
			});
		} catch (n) {
			t.some(function(e) {
...
async function K(e, t) {
	...
	if (!n.ok) throw new st(ct(r) || `请求失败（${n.status}）`, n.status);
	return r;
}
async function q(e, t, n = "POST", r) {
	...
	if (!i.ok) throw new st(ct(a) || `请求失败（${i.status}）`, i.status, a);
	return a;
}
//#endregion
//#region src/jobs.ts
function lt(e, t = 0, n = 0) {
	return n > 0 ? Ie(e, t, n) : p(e);
}
async function ut(e) {
...
function dt(e) {
	let t = e.note || ((e) => m(e, {
		label: "任务状态",
		variant: "error"
	})), n = e.loading || p, r = e.progress || ((e, t, n) => lt(n || `已处理 ${e} / ${t}`, e, t)), i = e.container || ((e) => `<section class="followtask" data-geist-fieldset aria-label="任务进度"><div class="geist-fieldset-content">${e}</div></section>`), a = document.createElement("div");
...
var pt = (e, t) => K("/api/library-processing", t), mt = {
...
function ht(e) {
	let t = mt[e.current_action || ""] || e.stage || "正在处理", n = e.waited_seconds ? ` · 已等待 ${e.waited_seconds} 秒` : "";
	return e.current_asset_name ? `当前：${e.current_asset_name} · ${t}${n}` : t + n;
}
function gt({ data: e, error: t, toast: n, onComplete: r, mode: i, monitor: a, preview: o }) {
	let [s, c] = V(e || { status: "idle" }), [l, u] = V(t), [d, p] = V(!1), [h, _] = V(!1), v = W(new AbortController()), b = W(0), x = W(s.status), S = W(null), C = d || s.status === "running";
	U(() => y(S.current, C), [C]);
	async function w() {
		let e = ++b.current;
		await ut({
			read: (e) => K("/api/library-processing", e),
			active: () => !v.current.signal.aborted && b.current === e,
	...
	if (i === "notice") {
		...
		let e = l || (s.status === "failed" ? "扫描与资料采集未完成" : ht(s) + (s.total ? ` · ${s.checked || 0} / ${s.total}` : ""));
		return /* @__PURE__ */ J("div", { dangerouslySetInnerHTML: { __html: g(e, {
	...
	return /* @__PURE__ */ J(L, { children: [/* @__PURE__ */ J("section", {
		...
		children: [/* @__PURE__ */ J("div", {
			...
			children: [
				...
				s.status === "running" && /* @__PURE__ */ J("div", {
					"aria-live": "polite",
					dangerouslySetInnerHTML: { __html: lt(s.total ? `${ht(s)} · ${s.checked || 0} / ${s.total} 个视频` : ht(s), s.checked, s.total) }
				})
			]
		}), /* @__PURE__ */ J("footer", {
		...
		children: [
			s.status === "running" && s.stalled && /* @__PURE__ */ J("div", {
				...
				dangerouslySetInnerHTML: { __html: m("这个项目处理时间较长，暂时没有新进展。可以继续等待，或在任务结束后重试未完成项。", {
					variant: "warning",
					label: "处理较慢",
					filled: !0
				}) }
			...
			(l || s.status === "failed") && /* @__PURE__ */ J("div", {
				...
				dangerouslySetInnerHTML: { __html: m(l || s.error || "处理未完成，请重试", {
					variant: "error",
					filled: !0,
			...
			h && /* @__PURE__ */ J("div", {
				...
				dangerouslySetInnerHTML: { __html: m(`已扫描 ${s.scanned || 0} 个文件，识别 ${s.identified || 0} 个番号，整理 ${s.candidates || 0} 组资料候选。`, {
					variant: "success",
					label: "处理完成"
				}) }
			})
...
var xt = "peach-taste-guide-dismissed";
function St(e, t) {
	b(e, ".taste-history-guide", "taste-guide-collapse");
	let n = e.querySelector(".taste-history-guide");
	n?.querySelector(".taste-guide-skip")?.addEventListener("click", () => {
		t.setItem(xt, "1"), n.remove();
	});
}
//#endregion
...
function wt() {
	...
	return /* @__PURE__ */ J("main", {
		...
		children: [
			...
			/* @__PURE__ */ J("nav", {
				"aria-label": "演示状态",
				children: Ct.map(([i, a]) => /* @__PURE__ */ J("button", {
					class: "geist-button",
					"aria-pressed": e === i,
					onClick: () => {
						t(i), r(n + 1);
			...
			/* @__PURE__ */ J("section", { children: [
				...
				e === "loading" ? /* @__PURE__ */ J(Y, { html: yt() }) : /* @__PURE__ */ J("div", {
					class: "cleanupgrid",
					children: /* @__PURE__ */ J("div", {
				...
				e === "complete" && /* @__PURE__ */ J(Y, { html: m("已完成扫描与资料采集", {
					variant: "success",
					label: "任务完成"
				}) }),
				e === "expired" && /* @__PURE__ */ J(Y, { html: m("任务状态已失效，请重新发起任务", { variant: "warning" }) }),
			...
			/* @__PURE__ */ J("section", { children: [/* @__PURE__ */ J("h2", { children: "关注检查与资源同步" }), /* @__PURE__ */ J("div", {
				...
				children: [/* @__PURE__ */ J("article", { children: [/* @__PURE__ */ J("h3", { children: "检查更新" }), /* @__PURE__ */ J(Y, { html: e === "disconnected" ? m("暂时无法读取进度，正在重新连接…", { label: "任务状态" }) : e === "failed" ? m("检查失败：来源连接超时", {
					variant: "error",
					actionLabel: "重试"
				}) : e === "running" || e === "retrying" || e === "reconnected" ? Ie(`${e === "retrying" ? "第 2/3 次尝试，8 秒后重试 · " : ""}已完成 ${o}/100 个来源`, o, 100) : e === "preparing" ? p("正在准备检查任务…") : m(e === "complete" ? "已完成检查" : e === "paused" ? "已暂停自动检查" : e === "expired" ? "任务状态已失效，请重新发起任务" : "等待开始", { variant: e === "complete" ? "success" : "secondary" }) })] }), /* @__PURE__ */ J("article", { children: [
					/* @__PURE__ */ J("h3", { children: "连接与恢复" }),
					/* @__PURE__ */ J(Y, { html: g(e === "disconnected" ? "暂时无法连接服务器，正在重连" : e === "reconnected" ? "连接已恢复，继续读取任务进度" : "连接正常", {
			...
			/* @__PURE__ */ J("section", { children: [/* @__PURE__ */ J("h2", { children: "错误与加载状态一览" }), /* @__PURE__ */ J("div", {
				class: "board-preview-grid",
				children: [
					/* @__PURE__ */ J("article", { children: [/* @__PURE__ */ J("h3", { children: "读取失败" }), /* @__PURE__ */ J(Y, { html: m("无法读取状态，请重试", {
						variant: "error",
						actionLabel: "重试"
					}) })] }),
					/* @__PURE__ */ J("article", { children: [/* @__PURE__ */ J("h3", { children: "来源离线" }), /* @__PURE__ */ J(Y, { html: m("媒体来源离线，请检查挂载状态", { variant: "warning" }) })] }),
					/* @__PURE__ */ J("article", { children: [/* @__PURE__ */ J("h3", { children: "没有待处理内容" }), /* @__PURE__ */ J(Y, { html: m("没有待处理内容", { variant: "secondary" }) })] }),
...
function Dt() {
	let e = (e) => {
		e.querySelectorAll("input[type=range]").forEach(Et), At(e), kt(e), jt(e);
	};
	e(document), new MutationObserver((t) => {
		for (let n of t) for (let t of n.addedNodes) t instanceof Element && (t.matches("input[type=range]") && Et(t), e(t));
	}).observe(document.body, {
		subtree: !0,
		childList: !0
	}), document.addEventListener("input", (e) => {
		e.target instanceof HTMLInputElement && e.target.type === "range" && Et(e.target);
	});
...
function Rt(e, t) {
	return Bt(e.source, t.source) || e.index - t.index;
}
function zt(e, t) {
	return Bt(e.target, t.target) || e.index - t.index;
}
function Bt(e, t) {
	return e.y0 - t.y0;
}
...
function qt() {
	let e = 0, t = 0, n = 1, r = 1, i = 24, a = 8, o, s = Ht, c = It, l, u, d = Ut, f = Wt, p = 6;
	function m() {
		let e = {
			nodes: d.apply(null, arguments),
			links: f.apply(null, arguments)
		};
		return h(e), g(e), _(e), v(e), x(e), Kt(e), e;
	}
	m.update = function(e) {
		return Kt(e), e;
	}, m.nodeId = function(e) {
		return arguments.length ? (s = typeof e == "function" ? e : Lt(e), m) : s;
	}, m.nodeAlign = function(e) {
		return arguments.length ? (c = typeof e == "function" ? e : Lt(e), m) : c;
		...
		return arguments.length ? (d = typeof e == "function" ? e : Lt(e), m) : d;
	}, m.links = function(e) {
		return arguments.length ? (f = typeof e == "function" ? e : Lt(e), m) : f;
	...
	function h({ nodes: e, links: t }) {
		...
		for (let [e, r] of t.entries()) {
			...
			typeof t != "object" && (t = r.source = Gt(n, t)), typeof i != "object" && (i = r.target = Gt(n, i)), t.sourceLinks.push(r), i.targetLinks.push(r);
		}
		if (u != null) for (let { sourceLinks: t, targetLinks: n } of e) t.sort(u), n.sort(u);
	}
	function g({ nodes: e }) {
		for (let t of e) t.value = t.fixedValue === void 0 ? Math.max(Ft(t.sourceLinks, Vt), Ft(t.targetLinks, Vt)) : t.fixedValue;
	}
	function _({ nodes: e }) {
	...
	function y({ nodes: t }) {
		let r = Nt(t, (e) => e.depth) + 1, a = (n - e - i) / (r - 1), o = Array(r);
		for (let n of t) {
	...
	function b(e) {
		let n = Pt(e, (e) => (r - t - (e.length - 1) * o) / Ft(e, Vt));
		for (let i of e) {
			let e = t;
			for (let t of i) {
	...
	function x(e) {
		let n = y(e);
		o = Math.min(a, (r - t) / (Nt(n, (e) => e.length) - 1)), b(n);
		for (let e = 0; e < p; ++e) {
	...
	function D({ sourceLinks: e, targetLinks: t }) {
		if (u === void 0) {
			...
			for (let { target: { targetLinks: t } } of e) t.sort(Rt);
		}
	}
	function O(e) {
		if (u === void 0) for (let { sourceLinks: t, targetLinks: n } of e) t.sort(zt), n.sort(Rt);
	}
	function k(e, t) {
...
var Jt = Math.PI, Yt = 2 * Jt, Xt = 1e-6, Zt = Yt - Xt;
function Qt() {
...
Qt.prototype = $t.prototype = {
	...
	arcTo: function(e, t, n, r, i) {
		...
		if (this._x1 === null) this._ += "M" + (this._x1 = e) + "," + (this._y1 = t);
			...
			if (!(Math.abs(u * s - c * l) > Xt) || !i) this._ += "L" + (this._x1 = e) + "," + (this._y1 = t);
			else {
				var f = n - a, p = r - o, m = s * s + c * c, h = f * f + p * p, g = Math.sqrt(m), _ = Math.sqrt(d), v = i * Math.tan((Jt - Math.acos((m + d - h) / (2 * g * _))) / 2), y = v / _, b = v / g;
				Math.abs(y - 1) > Xt && (this._ += "L" + (e + y * l) + "," + (t + y * u)), this._ += "A" + i + "," + i + ",0,0," + +(u * f > l * p) + "," + (this._x1 = e + b * s) + "," + (this._y1 = t + b * c);
			}
		}
	},
	arc: function(e, t, n, r, i, a) {
		...
		this._x1 === null ? this._ += "M" + c + "," + l : (Math.abs(this._x1 - c) > Xt || Math.abs(this._y1 - l) > Xt) && (this._ += "L" + c + "," + l), n && (d < 0 && (d = d % Yt + Yt), d > Zt ? this._ += "A" + n + "," + n + ",0,1," + u + "," + (e - o) + "," + (t - s) + "A" + n + "," + n + ",0,1," + u + "," + (this._x1 = c) + "," + (this._y1 = l) : d > Xt && (this._ += "A" + n + "," + n + ",0," + +(d >= Jt) + "," + u + "," + (this._x1 = e + n * Math.cos(i)) + "," + (this._y1 = t + n * Math.sin(i))));
	},
...
function sn(e) {
	var t = an, n = on, r = tn, i = nn, a = null;
	function o() {
		var o, s = rn.call(arguments), c = t.apply(this, s), l = n.apply(this, s);
		if (a ||= o = $t(), e(a, +r.apply(this, (s[0] = c, s)), +i.apply(this, s), +r.apply(this, (s[0] = l, s)), +i.apply(this, s)), o) return a = null, o + "" || null;
	}
	return o.source = function(e) {
		...
		return arguments.length ? (r = typeof e == "function" ? e : en(+e), o) : r;
	}, o.y = function(e) {
		return arguments.length ? (i = typeof e == "function" ? e : en(+e), o) : i;
...
function pn(e = []) {
	...
	}), o = n.reduce((e, t) => e + t.value, 0), s = fn(), c = a.links.map((e) => {
...
var hn = (e) => Number.isFinite(e) && e >= 0;
function gn(e, n, r = "个视频") {
	let i = e.filter((e) => hn(e.value));
	if (!i.length) return "";
...
function yn(e) {
	...
	for (let t of e.hours || []) Number.isInteger(t.weekday) && t.weekday >= 0 && t.weekday < 7 && Number.isInteger(t.hour) && t.hour >= 0 && t.hour < 24 && hn(t.count) && (n[t.weekday][t.hour] = (n[t.weekday][t.hour] || 0) + t.count);
	let r = Math.max(1, ...n.flat()), i = n.flat().reduce((e, t) => e + t, 0), a = n.map((e, t) => `<span class="board-heat-axis">${vn[t]}</span>${e.map((e, n) => `<button type="button" data-heat-value="${e}" data-heat-label="${vn[t]} ${n}:00" aria-label="${vn[t]} ${n}:00，${e} 次访问" style="--heat:${e ? Math.max(12, e / r * 100) : 0}%"></button>`).join("")}`).join(""), o = e.days.filter((e) => /^\d{4}-\d{2}-\d{2}$/.test(e.date) && hn(e.count)).sort((e, t) => e.date.localeCompare(t.date));
	if (!o.length) return "";
...
function Sn(e, t, n = "", r = "") {
	...
	return `<details class="sec${r ? " cat-" + xn(r) : ""}" data-sidebar-group="${xn(e)}"><summary role="button" class="board-section-toggle"><svg viewBox="0 0 24 24" aria-hidden="true"><use href="#i-chevron-right"/></svg><span>${xn(e)}</span></summary><div class="board-sidebar-body" id="${i}">${t}${n}</div></details>`;
}
function Cn(e) {
	...
	}), b(e, "details[data-sidebar-group]", "sidebar-collapse"), e.querySelectorAll(".board-section-toggle").forEach((e) => {
...
function En({ value: e, options: t, label: n, onChange: r, disabled: i = !1, className: a = "", fixed: o = !1 }) {
	...
	async function o(t, i, o) {
		if (!(n.current || r.current.signal.aborted)) {
			...
			try {
				...
				n.current = !1, r.current.signal.aborted || y(e.current, !1);
			}
		}
	}
	return {
...
function On({ id: e, titleId: t, title: n, help: r, error: i, children: a, footer: o, onSubmit: s, formRef: c, noValidate: l, warning: u }) {
...
function kn({ id: e, label: t, value: n, onInput: r, error: i, help: a, current: o = !1, disabled: s = !1 }) {
...
function An({ initial: e, receipt: t }) {
	let [n, r] = V(e), [i, a] = V(""), [o, s] = V(""), [c, l] = V(""), [u, d] = V(!1), [f, p] = V({}), h = W(null), g = W(null), { run: _, error: v, setError: y, busy: b } = Dn(g);
	return /* @__PURE__ */ J(On, {
		...
		onSubmit: async (e) => {
			...
			await _((e) => q("/api/configuration/access", {
				...
				let t = e instanceof st ? e.body : null, n = t?.errors || t?.detail?.errors;
				n ? p(n) : y(G(e));
			});
		},
		noValidate: !0,
		...
		children: [
			...
			n.mode === "locked" ? null : /* @__PURE__ */ J(L, { children: [/* @__PURE__ */ J(kn, {
				id: "access-password",
			...
			u && /* @__PURE__ */ J("div", { dangerouslySetInnerHTML: { __html: m("保存后，能连接到 Peach 的设备将直接访问馆藏。", {
				variant: "warning",
				label: "访问范围"
			}) } })
		]
...
function Mn({ initial: e, initialJob: t }) {
	let [n, r] = V(e), [i, a] = V(t || {
		state: "idle",
		progress: 0
	}), [o, s] = V(""), c = W(null), l = W(!0), d = W(!1), p = W(null);
	H(() => {
		y(p.current, jn.has(i.state));
	}, [i.state]), H(() => () => {
	...
	H(() => {
		...
		let e = new AbortController(), t, n = 0, o = async () => {
			...
			!e.signal.aborted && n < 120 && (t = setTimeout(o, jn.has(i.state) ? 1e3 : 3e4));
		};
		return t = setTimeout(o, jn.has(i.state) ? 1e3 : 3e4), () => {
			e.abort(), clearTimeout(t);
		};
	}, [i.state]);
	let _ = async (e) => {
		if (c.current || jn.has(i.state)) return;
		let t = new AbortController();
		c.current = t, d.current = !1, s(""), y(e, !0);
		try {
		...
		children: [/* @__PURE__ */ J("div", {
			...
			children: [
				...
				n.state === "available" && !o ? /* @__PURE__ */ J("div", {
					role: "status",
					dangerouslySetInnerHTML: { __html: m(n.message, { label: "有可用更新" }) }
				}) : /* @__PURE__ */ J("p", {
				...
				i.state === "idle" ? null : /* @__PURE__ */ J("div", {
					...
					children: [/* @__PURE__ */ J("p", {
						...
						/* @__PURE__ */ J("div", { dangerouslySetInnerHTML: { __html: h("更新准备进度：下载、校验、解压、准备安装", i.progress, 100, { stops: [
							{
								value: 65,
								label: "下载结束"
							},
...
function Nn({ initial: e, receipt: t }) {
	let [n, r] = V(e.mode), [i, a] = V(e.interval_hours), o = W(null), s = Dn(o, e.error), c = () => s.run((e) => q("/api/configuration/automatic-updates", {
		mode: n,
		interval_hours: i
	}, "POST", e), () => t("已保存自动更新设置"));
	return /* @__PURE__ */ J(On, {
...
function Pn({ initial: e, receipt: t }) {
	let [n, r] = V(e), [i, a] = V(e.mode), [o, s] = V(""), c = W(null), l = Dn(c), u = () => l.run((e) => q("/api/configuration/peach-proxy", {
		mode: i,
		proxy: o
	}, "POST", e), (e) => {
...
function In({ label: e, checked: t, disabled: n, change: r }) {
	return /* @__PURE__ */ J("label", {
		class: "configtoggle",
...
function Rn({ data: e }) {
	...
	return U(() => {
		...
		return n.replaceChildren(r), b(n, "details", "uninstall-data"), () => n.replaceChildren();
	}, [e]), /* @__PURE__ */ J("div", { ref: t });
}
function zn({ uninstall: e }) {
	let [t, n] = V(!1), [r, i] = V("");
	async function a() {
		await u({
			title: "卸载 Peach",
...
function Vn() {
	let e = W(null);
	return U(() => {
		e.current && b(e.current, "details", "clouddrive-guide");
	}, []), /* @__PURE__ */ J("div", {
		ref: e,
		class: "cloudguide",
		children: [/* @__PURE__ */ J("p", {
			...
			/* @__PURE__ */ J("div", {
				...
				children: /* @__PURE__ */ J("table", {
					...
					] }) }), /* @__PURE__ */ J("tbody", { children: Bn.map((e) => /* @__PURE__ */ J("tr", { children: [
						/* @__PURE__ */ J("th", {
							scope: "row",
							children: e.name
						}),
...
function Wn({ value: e, label: t, kind: n = "local", onChange: r }) {
	let [i, a] = V(e), o = W(null), s = W(null), [c, l] = Un(n), u = (e) => /* @__PURE__ */ J("span", {
		"aria-hidden": "true",
		dangerouslySetInnerHTML: { __html: v(e || c) }
	}), d = (e, t) => e ? t : l;
	return /* @__PURE__ */ J("div", {
		...
		children: [/* @__PURE__ */ J("button", {
			...
			children: [u(e), /* @__PURE__ */ J("span", { children: d(e, Hn.find(([t]) => t === e)?.[1] || l) })]
		}), /* @__PURE__ */ J("dialog", {
			ref: o,
			...
			children: [/* @__PURE__ */ J("div", {
				...
				children: [/* @__PURE__ */ J("h3", { children: "选择媒体库图标" }), /* @__PURE__ */ J("div", {
					...
					children: Hn.map(([e, n]) => /* @__PURE__ */ J("label", {
						title: d(e, n),
						class: i === e ? "selected" : "",
						children: [/* @__PURE__ */ J("input", {
							type: "radio",
...
var Gn = "/api/configuration", Kn = "/api/pick-folder", qn = 8e3, Jn = (e, t) => K(Gn, t), Yn = ({ html: e, class: t }) => /* @__PURE__ */ J("div", {
	class: t,
	dangerouslySetInnerHTML: { __html: e }
}), Xn = (e) => !(e instanceof st) || e.status !== 400 ? null : e.body?.errors ?? null;
function Zn({ facts: e }) {
	return /* @__PURE__ */ J("section", {
		class: "configfieldset",
		"data-geist-fieldset": !0,
		...
		children: /* @__PURE__ */ J("div", {
			class: "geist-fieldset-content",
			children: [/* @__PURE__ */ J(Yn, { html: f("configFactsTitle", "运行信息") }), /* @__PURE__ */ J("dl", {
				class: "configfacts",
...
function Qn({ data: e }) {
	...
	return t ? /* @__PURE__ */ J("section", {
		...
		children: [/* @__PURE__ */ J("div", {
			class: "geist-fieldset-content",
			children: [
				/* @__PURE__ */ J(Yn, { html: f("configMountsTitle", "挂载状态") }),
				/* @__PURE__ */ J("dl", {
					class: "configfacts",
					children: t.map((e) => /* @__PURE__ */ J(L, { children: [/* @__PURE__ */ J("dt", { children: [/* @__PURE__ */ J("span", {
						"aria-hidden": "true",
						dangerouslySetInnerHTML: { __html: v(s[e.location]) }
					}), {
						local: "本地磁盘",
						115: "CloudDrive · 115",
...
function $n({ value: e, label: t, onChange: n }) {
...
function er({ data: e, receipt: t }) {
	let n = e.media_sources?.filter((e) => [
		"local",
		"115",
		"pikpak"
	].includes(e.location)), [r, i] = V(n?.length ? n.map((e) => e.path) : e.media_dirs.length ? e.media_dirs : [""]), [a, o] = V(n?.map((e) => e.location) ?? []), [s, c] = V(n?.map((e) => e.root) ?? []), [l, u] = V(n?.map((e) => e.library || "") ?? []), [d, p] = V(n?.map((e) => e.library_icon || "") ?? []), [h, g] = V(String(e.port)), [_, v] = V(!1), [b, x] = V([]), [S, C] = V(""), [w, T] = V(""), [E, D] = V(null), [O, k] = V(null), A = W(!1), j = W(e.revision), M = W([]), ee = W(null);
	U(() => {
		O !== null && (M.current[O]?.focus(), k(null));
	}, [O]), H(() => {
		if (!E) return;
		let e = setTimeout(() => location.assign(E.url), qn);
	...
	let N = (e, t) => {
		...
		if (t.getAttribute("aria-busy") !== "true") {
			y(t, !0);
			try {
				let { path: t } = await q(Kn, { initial: r[e] ?? "" });
				t && (N(e, t), F(e, ""));
			} catch (t) {
				F(e, G(t));
			} finally {
	...
	return E ? /* @__PURE__ */ J("div", {
		...
		children: [/* @__PURE__ */ J("div", {
			class: "geist-fieldset-content",
			children: [
				/* @__PURE__ */ J(Yn, { html: f("configTitle", "这台电脑") }),
				/* @__PURE__ */ J("div", {
					class: "configfield",
					children: [
						/* @__PURE__ */ J("span", {
						...
						a.some((e) => e === "115" || e === "pikpak") ? /* @__PURE__ */ J(Vn, {}) : null,
...
function tr({ receipt: e, data: t, error: n }) {
	return n || !t ? /* @__PURE__ */ J(Yn, {
		class: "configpage",
		html: m(n || "没有读到配置", {
			variant: "error",
			label: "打不开配置"
		...
		children: [
			...
			t.editable ? /* @__PURE__ */ J(er, {
				data: t,
				receipt: e
			}) : /* @__PURE__ */ J(Yn, { html: m(t.notice, {
				variant: "secondary",
				label: "只读"
			}) }),
			/* @__PURE__ */ J(Qn, { data: t }),
			t.peach_proxy || t.access ? /* @__PURE__ */ J("h2", {
				class: "configgroup",
				children: "网络与访问"
			}) : null,
			t.peach_proxy ? /* @__PURE__ */ J(Pn, {
				initial: t.peach_proxy,
				receipt: e
			}) : null,
			t.access ? /* @__PURE__ */ J(An, {
				initial: t.access,
				receipt: e
			}) : null,
			/* @__PURE__ */ J("h2", {
			...
			t.automatic_updates ? /* @__PURE__ */ J(Nn, {
				initial: t.automatic_updates,
				receipt: e
			}) : null,
			t.updates ? /* @__PURE__ */ J(Mn, {
				initial: t.updates,
				initialJob: t.update_job
			}) : null,
			/* @__PURE__ */ J(Zn, { facts: t.facts }),
			t.uninstall ? /* @__PURE__ */ J(zn, { uninstall: t.uninstall }) : null
		]
	});
}
//#endregion
//#region node_modules/@preact/signals-core/dist/signals-core.module.js
var nr = Symbol.for("preact-signals");
function rr() {
	if (Z > 1) Z--;
	else {
		var e, t = !1;
		for ((function() {
			...
			var n = sr;
			for (sr = void 0, cr++; n !== void 0;) {
				var r = n.u;
				if (n.u = void 0, n.f &= -3, !(8 & n.f) && hr(n)) try {
					n.c();
				} catch (n) {
					t ||= (e = n, !0);
				}
...
var sr = void 0, Z = 0, cr = 0, lr = 0, ur = 0, dr = void 0, fr = 0;
function pr(e) {
	if (X !== void 0) {
		var t = e.n;
...
Q.prototype.brand = nr, Q.prototype.h = function() {
	return !0;
}, Q.prototype.S = function(e) {
	var t = this, n = this.t;
	n !== e && e.e === void 0 && (e.x = n, this.t = e, n === void 0 ? or(function() {
		var e;
		(e = t.W) == null || e.call(t);
	}) : n.e = e);
	...
	if (this.t !== void 0) {
		var n = e.e, r = e.x;
		n !== void 0 && (n.x = r, e.e = void 0), r !== void 0 && (r.e = n, e.x = void 0), e === this.t && (this.t = r, r === void 0 && or(function() {
			var e;
			(e = t.Z) == null || e.call(t);
		}));
	}
	...
	set: function(e) {
		if (e !== this.v) {
			if (cr > 100) throw Error("Cycle detected");
			(function(e) {
				Z !== 0 && cr === 0 && e.l !== ur && (e.l = ur, dr = {
					S: e,
					v: e.v,
					i: e.i,
					o: dr
				});
			})(this), this.v = e, this.i++, fr++, Z++;
			try {
...
function vr(e, t) {
	Q.call(this, void 0, t), this.x = e, this.s = void 0, this.g = fr - 1, this.f = 4;
}
vr.prototype = new Q(), vr.prototype.h = function() {
	if (this.f &= -3, 1 & this.f) return !1;
	if ((36 & this.f) == 32 || (this.f &= -5, this.g === fr)) return !0;
	if (this.g = fr, this.f |= 1, this.i > 0 && !hr(this)) return this.f &= -2, !0;
	var e = X;
	try {
		gr(this), X = this;
		var t = this.x();
...
}, Object.defineProperty(vr.prototype, "value", { get: function() {
...
function xr(e) {
	...
	e.x = void 0, e.s = void 0, br(e);
}
function Sr(e) {
	if (X !== this) throw Error("Out-of-order effect");
	_r(this), X = e, this.f &= -2, 8 & this.f && xr(this), rr();
}
function Cr(e, t) {
	this.x = e, this.m = void 0, this.s = void 0, this.u = void 0, this.f = 32, this.name = t?.name, ar && ar.push(this);
}
Cr.prototype.c = function() {
	...
	if (1 & this.f) throw Error("Cycle detected");
	this.f |= 1, this.f &= -9, br(this), gr(this), Z++;
	var e = X;
	return X = this, Sr.bind(this, e);
...
var Tr, Er, Dr = typeof window < "u" && !!window.__PREACT_SIGNALS_DEVTOOLS__, Or = [];
wr(function() {
	Tr = this.N;
})();
function kr(e, t) {
...
function jr(e) {
	...
	var i = $e(function() {
		...
		var i = yr(function() {
			...
			return !Array.isArray(i.value) && !T(i.value);
		}), o = wr(function() {
			if (this.N = Ir, a.value) {
				var t = i.value;
...
jr.displayName = "ReactiveTextNode", Object.defineProperties(Q.prototype, {
	constructor: {
		configurable: !0,
		value: void 0
	},
	...
	if (e(t), t.type !== L) {
		...
		}(r), typeof t.type == "function" ? t.type.displayName || t.type.name : ""))), Ar(n);
	}
}), kr("__e", function(e, t, n, r) {
	Ar(), e(t, n, r);
}), kr("diffed", function(e, t) {
	Ar();
	var n;
	if (typeof t.type == "string" && (n = t.__e)) {
		...
		if (r) for (var c in a || (a = {}, n.U = a), r) {
			var l = a[c], u = r[c];
			l === void 0 ? (l = Mr(n, c, u, i), a[c] = l) : l.o(u, i);
		}
	}
	e(t);
});
function Mr(e, t, n, r) {
	var i = t in e && e.ownerSVGElement === void 0, a = mr(n);
	return {
		o: function(e, t) {
			a.value = e, r = t;
		},
...
function Fr() {
	ir(function() {
		for (var e; e = Or.shift();) Tr.call(e);
	});
}
function Ir() {
	Or.push(this) === 1 && (C.requestAnimationFrame || Pr)(Fr);
}
//#endregion
//#region src/state/quality-goals.ts
var Lr = "/api/quality-goals?limit=200", Rr = {
	data: null,
	error: ""
}, zr = mr(Rr), Br = 0, Vr = yr(() => zr.value);
yr(() => zr.value.data?.total ?? null);
function Hr() {
	Br += 1, zr.value = Rr;
}
async function Ur(e) {
	...
	try {
		let n = await K(Lr, e);
		return t === Br && (zr.value = {
			data: n,
			error: ""
		}), n;
	} catch (n) {
		throw !e?.aborted && t === Br && (zr.value = {
			data: null,
			error: G(n)
		}), n;
	}
...
var Wr = (e, t) => Ur(t), Gr = (e) => e.has_cover ? `/cover?code=${encodeURIComponent(e.code ?? "")}` : `/poster?id=${e.id}&c=4`;
function Kr({ openItem: t, javTitleHtml: n, javDisplayName: a, srcBadge: o }) {
	let { data: s, error: c } = Vr.value;
	if (c) return /* @__PURE__ */ J("div", {
		class: "qualitylist",
		dangerouslySetInnerHTML: { __html: m(c, {
			variant: "error",
			label: "读取失败"
		}) }
	});
...
function Yr({ source: e, toast: t }) {
	let [r, i] = V(e), [a, o] = V(e.network), [s, c] = V(""), [l, u] = V(""), [d, p] = V("paste"), [h, g] = V(""), [_, v] = V(!1), [b, x] = V(""), [S, C] = V([]), w = W(null), T = W(null);
	U(() => {
		...
		children: /* @__PURE__ */ J("form", {
			...
			children: [/* @__PURE__ */ J("div", {
				...
				children: [
					...
					b && /* @__PURE__ */ J("div", {
						role: "alert",
						dangerouslySetInnerHTML: { __html: m(b, { variant: "error" }) }
					}),
					S.map((t) => /* @__PURE__ */ J("div", {
						role: "status",
						dangerouslySetInnerHTML: { __html: m(`${e.label}${t.label === "来源页面" ? "" : " 高清图片"}：${t.ok ? "可连接" : "不能连接"}` + (t.width ? ` · ${t.width} × ${t.height}` : "") + (t.message ? `。${t.message}` : ""), { variant: t.ok ? "success" : "error" }) }
					}, t.label))
				]
			}), /* @__PURE__ */ J("footer", {
				class: "geist-fieldset-footer",
...
function Xr({ data: e, error: t, toast: n }) {
	let [r, i] = V(""), [a, o] = V(!1), [s, c] = V(""), l = W(null);
	U(() => y(l.current, a), [a]);
	let u = W(new AbortController()), d = W(0);
	async function h(e = !1) {
		let t = ++d.current;
		await ut({
			read: (e) => K("/api/scraping/cover", e),
			active: () => !u.current.signal.aborted && t === d.current,
			render: (t) => {
	...
	return t ? /* @__PURE__ */ J("div", {
		role: "alert",
		dangerouslySetInnerHTML: { __html: m(t, { variant: "error" }) }
	}) : /* @__PURE__ */ J("div", {
		class: "scraping-page",
		children: [
			...
			/* @__PURE__ */ J("section", {
				...
				children: /* @__PURE__ */ J("div", {
					...
					children: [
						...
						s && /* @__PURE__ */ J("div", {
							role: "alert",
							dangerouslySetInnerHTML: { __html: m(s, { variant: "error" }) }
						})
					]
				})
			}),
			e?.sources.map((e) => /* @__PURE__ */ J(Yr, {
				source: e,
				toast: n
			}, e.source))
		]
...
var ei = (e = "") => /^https?:\/\//i.test(e) ? e : "";
function ti(e = "") {
	let n = ei(e) || (e.startsWith("/") && !e.startsWith("//") ? e : "");
...
function ni(e) {
	let n = ei(e.profile_url), r = (e.preview_assets || []).slice(0, 6), i = Math.max(0, Number(e.video_count || e.videos || 0));
...
function ii(e, t, n, r, i, a = i || !e.has(r)) {
...
function si({ count: e, label: t, all: n, summary: r, actions: i, locked: a = !1 }) {
...
function fi(e, t, n, r, i) {
	e.anchor = ii(e.selected, t, e.anchor, n, r, i);
}
...
function hi(e, t) {
	...
	let a = t.catalog || t.rows, o = ui(a, t.metadata);
	o.some((e) => e[0] === r.groupBy) || (r.groupBy = "candidates", r.filter = "");
	let s = di(a, r.groupBy);
	...
	let h = document.createElement("div");
	h.className = "reviewgroupby", h.innerHTML = _(o, r.groupBy, { label: "筛选分组方式" });
	let g = x(h.firstElementChild);
	...
	v.className = "reviewcategoryfilter", v.hidden = s.length < 2, v.innerHTML = _([[
		"",
		"全部分类",
		"list-filter"
	], ...s.map((e) => [
	...
	let j = p("取消选择");
	A.append(E, D, k, j, O), m.append(h, v, C);
	let M = e.querySelector(".reviewcontrols");
	M ? M.after(m) : n.before(m), e.append(A), n.classList.add("reviewgroups");
	let ee = () => {
		r.selected.clear(), r.anchor = null, P();
	};
	j.onclick = () => {
		r.busy || (ee(), C.focus({ preventScroll: !0 }));
	}, C.onclick = () => {
		if (r.busy) return;
	...
	for (let e of s) {
		...
		d.className = "reviewlist", o.append(s, u), a.append(o, d), n.append(a), u.onclick = () => {
			...
			oi(r.selected, e, !e.every((e) => r.selected.has(e))), P();
		}, N.push(() => {
		...
		for (let e of t) {
			...
			let o = (e, n) => {
				fi(r, l().map((e) => e.dataset.reviewKey), t, e, n), P();
			};
	...
	e.addEventListener("keydown", (t) => {
		r.busy || !e.contains(n) || (t.key === "Escape" && r.selected.size && (t.preventDefault(), t.stopPropagation(), ee()), (t.ctrlKey || t.metaKey) && t.key.toLowerCase() === "a" && !t.target.matches("textarea,input:not([type=\"checkbox\"]):not([type=\"radio\"])") && (t.preventDefault(), t.stopPropagation(), l().forEach((e) => r.selected.add(e.dataset.reviewKey)), P()));
	});
	let te = "";
	function P() {
		let e = u();
		C.textContent = e.length === l().length ? "清空当前选择" : r.filter ? "全选当前分类" : "全选本页", A.hidden = !e.length, si({
			count: E,
			label: `已选 ${e.length} 项`,
			summary: ai(r.selected, l().map((e) => e.dataset.reviewKey)),
			actions: [w, T]
		...
		if (a !== te) {
			te = a, D.innerHTML = _([["", i], ...n.map((e) => [e, e])], "", { label: "统一选择来源" });
			let e = x(D.firstElementChild);
			e.disabled = !n.length, e.addEventListener("change", () => {
				if (!(r.busy || !mi(d()).includes(e.value))) {
					for (let n of u()) {
	...
	async function F(n, i) {
		...
		r.busy = !0, O.textContent = `正在处理 0 / ${a.length}`, y(i, !0);
...
async function Ei(e, t) {
	...
	for (let t of wi) e[t] && n.set(t, e[t]);
...
function Mi(e, t) {
    ...
    ${r ? m(`将把找不到文件的 ${$(e.missing)} 项馆藏记录移入回收站，并清理 ${$(n.files)} 个闲置缓存。`, { label: "清理内容" }) : ""}
...
}, zi = () => Object.keys(Ri), Bi = /* @__PURE__ */ new Map();
async function Vi(e, t, n, r = {}) {
	...
	ke(oe(i.component, s), t);
}
var Hi = (e) => !!e && Bi.has(e);
function Ui(e) {
	let t = Bi.get(e);
	t && (t.controller.abort(), Bi.delete(e), t.painted && ke(null, e));
}
//#endregion
export { xt as TASTE_GUIDE_KEY, yn as activityChartsHtml, Ci as boardPageSkeleton, Me as boundedPreference, Di as catalogEmptyHtml, Ei as catalogSuggestions, vi as clampPage, yt as cleanupSkeletonHtml, _t as cloudLocations, vt as cloudPreferenceLocations, ci as createReviewSelection, pn as creatorSankeyHtml, Le as distributionChart, Ti as emptyCatalogLayout, Si as entitySkeletonHtml, dt as followJobProgress, di as groupReviewRows, ni as identityEvidenceHtml, Dt as initBoardControls, Hi as islandMounted, zi as islandNames, Ii as javImageKind, lt as jobActivityHtml, Ie as jobProgressHtml, bi as matchesFaceSource, Tt as mountBoardStatePreview, Vi as mountIsland, Pe as mountNumberSetting, xi as nativeImageFit, Fi as normalizeJavImage, Ni as normalizeJavLayout, Pi as normalizeJavPreferences, _i as pageCount, yi as paginationHtml, Ae as preferredDirection, ze as radarChart, gn as radialCardHtml, Re as rankedChart, $r as refreshStore, Mi as resourceScanHtml, ti as reviewImageHtml, oi as selectGroup, ii as selectRange, ai as selectionSummary, Oi as sidebarHasCatalogContent, Sn as sidebarSectionHtml, Ai as sidebarTagCounts, Fe as statCardBody, Qr as storeNames, Et as syncBoardRange, Li as syncJavImages, Ne as syncNumberSetting, si as syncSelectionToolbar, ki as syncSidebarSurface, bt as tasteHistoryGuideHtml, Tn as transitionTheme, Ui as unmountIsland, li as updateReviewSticky, ut as watchJob, bn as wireActivityCharts, mn as wireCreatorSankey, Mt as wireExpandableRanks, jt as wireGrowingCharts, _n as wireRadialCards, ri as wireReviewPictures, hi as wireReviewSelection, Cn as wireSidebarGroups, St as wireTasteHistoryGuide };
