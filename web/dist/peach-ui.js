...
import { LOC as u, faviconUrl as d, fmtDur as f, fmtSize as p } from "/js/core.js";
...
function ae(e) {
	if (e.__P && e.__d) {
		...
		a.__v = t.__v + 1, h.vnode && h.vnode(a), ge(e.__P, a, t, e.__n, e.__P.namespaceURI, 32 & t.__u ? [n] : null, r, n ?? P(t), !!(32 & t.__u), i), a.__v = t.__v, a.__.__k[a.__i] = a, ve(r, a, i), t.__e = t.__ = null, a.__e != n && oe(a);
	}
}
function oe(e) {
...
function se(e) {
	(!e.__d && (e.__d = !0) && v.push(e) && !ce.__r++ || y != h.debounceRendering) && ((y = h.debounceRendering) || b)(ce);
}
function ce() {
	try {
		for (var e, t = 1; v.length;) v.length > t && v.sort(x), e = v.shift(), t = v.length, ae(e);
	} finally {
		v.length = ce.__r = 0;
	}
}
function le(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (c = ue(n, t, _, c, v), d = 0; d < v; d++) (p = n.__k[d]) != null && (f = p.__i != -1 && _[p.__i] || k, p.__i = d, g = ge(e, p, f, i, a, o, s, c, l, u), m = p.__e, p.ref && f.ref != p.ref && (f.ref && xe(f.ref, null, p), u.push(p.ref, p.__c || m, p)), h == null && m != null && (h = m), 4 & p.__u ? (c = de(p, c, e), f.__e && (f.__e = null)) : typeof p.type == "function" && g !== void 0 ? c = g : m && (c = m.nextSibling), p.__u &= -7);
	return n.__e = h, c;
}
function ue(e, t, n, r, i) {
	var a, o, s, c, l, u = n.length, d = u, f = 0;
	for (e.__k = Array(i), a = 0; a < i; a++) (o = t[a]) != null && typeof o != "boolean" && typeof o != "function" ? (typeof o == "string" || typeof o == "number" || typeof o == "bigint" || o.constructor == String ? o = e.__k[a] = re(null, o, null, null, null) : j(o) ? o = e.__k[a] = re(N, { children: o }, null, null, null) : o.constructor === void 0 && o.__b > 0 ? o = e.__k[a] = re(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : e.__k[a] = o, c = a + f, o.__ = e, o.__b = e.__b + 1, s = null, (l = o.__i = fe(o, n, c, d)) != -1 && (d--, (s = n[l]) && (s.__u |= 2)), s == null || s.__v == null ? (l == -1 && (i > u ? f-- : i < u && f++), typeof o.type != "function" && (o.__u |= 4)) : l != c && (l == c - 1 ? f-- : l == c + 1 ? f++ : (l > c ? f-- : f++, o.__u |= 4))) : e.__k[a] = null;
	if (d) for (a = 0; a < u; a++) (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = P(s)), Se(s, s));
	return r;
}
function de(e, t, n) {
	var r, i;
...
function ge(e, t, n, r, i, a, o, s, c, l) {
	...
	n: if (typeof D == "function") {
		d = o.length;
		try {
			if (y = t.props, b = D.prototype && D.prototype.render, x = (u = D.contextType) && r[u.__c], S = u ? x ? x.props.value : u.__ : r, n.__c ? v = (f = t.__c = n.__c).__ = f.__E : (b ? t.__c = f = new D(y, S) : (t.__c = f = new ie(y, S), f.constructor = D, f.render = Ce), x && x.sub(f), f.state || (f.state = {}), f.__n = r, p = f.__d = !0, f.__h = [], f._sb = []), b && f.__s == null && (f.__s = f.state), b && D.getDerivedStateFromProps != null && (f.__s == f.state && (f.__s = M({}, f.__s)), M(f.__s, D.getDerivedStateFromProps(y, f.__s))), m = f.props, g = f.state, f.__v = t, p) b && D.getDerivedStateFromProps == null && f.componentWillMount != null && f.componentWillMount(), b && f.componentDidMount != null && f.__h.push(f.componentDidMount);
			else {
				if (b && D.getDerivedStateFromProps == null && y !== m && f.componentWillReceiveProps != null && f.componentWillReceiveProps(y, S), t.__v == n.__v || !f.__e && f.shouldComponentUpdate != null && !1 === f.shouldComponentUpdate(y, f.__s, S)) {
					t.__v != n.__v && (f.props = y, f.state = f.__s, f.__d = !1), t.__e = n.__e, t.__k = n.__k, t.__k.some(function(e) {
						e && (e.__ = t);
					}), A.push.apply(f.__h, f._sb), f._sb = [], f.__h.length && o.push(f), s = P(n);
					break n;
				}
			...
			while (f.__d && ++w < 25);
			f.state = f.__s, f.getChildContext != null && (r = M(M({}, r), f.getChildContext())), b && !p && f.getSnapshotBeforeUpdate != null && (_ = f.getSnapshotBeforeUpdate(m, g)), T = u != null && u.type === N && u.key == null ? ye(u.props.children) : u, s = le(e, j(T) ? T : [T], t, n, r, i, a, o, s, c, l), f.base = t.__e, t.__u &= -161, f.__h.length && o.push(f), v && (f.__E = f.__ = null);
		} catch (e) {
			...
			t.__k ??= n.__k || [], e.then || _e(t), h.__e(e, t, n);
		}
...
function ye(e) {
	return typeof e != "object" || !e || e.__b > 0 ? e : j(e) ? e.map(ye) : e.constructor === void 0 ? M({}, e) : null;
}
function be(e, t, n, r, i, a, o, s, c) {
	...
	if (b == null) v === y || s && e.data == y || (e.data = y);
		...
		for (l in v) p = v[l], l == "dangerouslySetInnerHTML" ? d = p : l == "children" || l in y || l == "value" && "defaultValue" in y || l == "checked" && "defaultChecked" in y || me(e, l, null, p, i);
		for (l in y) p = y[l], l == "children" ? f = p : l == "dangerouslySetInnerHTML" ? u = p : l == "value" ? g = p : l == "checked" ? _ = p : s && typeof p != "function" || v[l] === p || me(e, l, p, v[l], i);
		if (u) s || d && (u.__html == d.__html || u.__html == e.innerHTML) || (e.innerHTML = u.__html), t.__k = [];
		else if (d && (e.innerHTML = ""), le(t.type == "template" ? e.content : e, j(f) ? f : [f], t, n, r, b == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, a, o, a ? a[0] : n.__k && P(n, 0), s, c), a != null) for (l = a.length; l--;) te(a[l]);
...
function Se(e, t, n) {
	var r, i;
	if (h.unmount && h.unmount(e), (r = e.ref) && (r.current && r.current != e.__e || xe(r, null, t)), (r = e.__c) != null) {
...
function we(e, t, n) {
	var r, i, a, o;
	t == document && (t = document.documentElement), h.__ && h.__(e, t), i = (r = typeof n == "function") ? null : n && n.__k || t.__k, a = [], o = [], ge(t, e = (!r && n || t).__k = ne(N, null, [e]), i || k, k, t.namespaceURI, !r && n ? [n] : i ? null : t.firstChild ? m.call(t.childNodes) : null, a, !r && n ? n : i ? i.__e : t.firstChild, r, o), ve(a, e, o), e.props.children = null;
}
m = A.slice, h = { __e: function(e, t, n, r) {
	...
	typeof e == "function" && (e = e(M({}, n), this.props)), e && M(n, e), e != null && this.__v && (t && this._sb.push(t), se(this));
}, ie.prototype.forceUpdate = function(e) {
	this.__v && (this.__e = !0, e && this.__h.push(e), se(this));
}, ie.prototype.render = N, v = [], b = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, x = function(e, t) {
	return e.__v.__b - t.__v.__b;
}, ce.__r = 0, S = Math.random().toString(8), C = "__d" + S, w = "__a" + S, T = /(PointerCapture)$|Capture$/i, E = 0, D = he(!1), O = he(!0);
//#endregion
//#region src/api.ts
...
async function I(e, t) {
	...
	if (!n.ok) throw new Te(Ee(r) || `请求失败（${n.status}）`, n.status);
	return r;
}
async function L(e, t, n = "POST", r) {
	...
	if (!i.ok) throw new Te(Ee(a) || `请求失败（${i.status}）`, i.status, a);
	return a;
}
//#endregion
//#region node_modules/preact/hooks/dist/hooks.module.js
var R, z, De, Oe, ke = 0, Ae = [], B = h, je = B.__b, Me = B.__r, Ne = B.diffed, Pe = B.__c, Fe = B.unmount, Ie = B.__;
function Le(e, t) {
	B.__h && B.__h(z, e, ke || t), ke = 0;
	var n = z.__H || (z.__H = {
		__: [],
		__h: []
	});
...
B.__b = function(e) {
	...
	Me && Me(e), R = 0;
	var t = (z = e.__c).__H;
	t && (De === z ? (t.__h = [], z.__h = [], t.__.some(function(e) {
		e.__N && (e.__ = e.__N), e.u = e.__N = void 0;
	})) : (t.__h.some(Ue), t.__h.some(We), t.__h = [], R = 0)), De = z;
}, B.diffed = function(e) {
	Ne && Ne(e);
	var t = e.__c;
	t && t.__H && (t.__H.__h.length && (Ae.push(t) !== 1 && Oe === B.requestAnimationFrame || ((Oe = B.requestAnimationFrame) || He)(Be)), t.__H.__.some(function(e) {
...
function Ye({ initial: e, receipt: t }) {
	let [r, i] = V(e), [a, o] = V(""), [s, l] = V(""), [u, d] = V(""), [f, p] = V(!1), [m, h] = V(""), [g, _] = V({}), v = W(null), y = W(!1), b = W(null);
	return /* @__PURE__ */ G("form", {
		...
		onSubmit: async (e) => {
			...
			try {
				...
				let t = e instanceof Te ? e.body : null, n = t?.errors || t?.detail?.errors;
				n ? _(n) : h(F(e));
			} finally {
		...
		children: [/* @__PURE__ */ G("div", {
			...
			children: [
				...
				!f && r.mode !== "locked" ? /* @__PURE__ */ G(N, { children: [/* @__PURE__ */ G(Je, {
					id: "access-password",
...
function $e({ data: e, error: t, toast: o, onComplete: s, mode: l, monitor: u }) {
	...
	H(() => ((d.status === "running" || l === "notice" || u) && w(), () => y.current.abort()), []);
	async function T() {
		if (!C) {
			g(!0), m(""), v(!1);
			try {
	...
	return l === "notice" ? !p && d.status !== "running" && d.status !== "failed" ? null : /* @__PURE__ */ G("div", {
		...
		children: [
			...
			/* @__PURE__ */ G("div", {
				"aria-live": "polite",
				children: [
					d.status === "running" && /* @__PURE__ */ G(N, { children: [/* @__PURE__ */ G("div", { dangerouslySetInnerHTML: { __html: r(`${d.stage || "正在处理"}${d.total ? ` · ${d.checked || 0} / ${d.total}` : ""}`) } }), !!d.total && /* @__PURE__ */ G("div", { dangerouslySetInnerHTML: { __html: a(`已处理 ${d.checked || 0} / ${d.total} 个视频`, d.checked || 0, d.total) } })] }),
...
}), it = (e) => !(e instanceof Te) || e.status !== 400 ? null : e.body?.errors ?? null;
function at({ facts: e }) {
...
function ot({ data: t }) {
	let [r, i] = V(t.media_sources), [a, o] = V(""), l = W(null);
	H(() => () => l.current?.abort(), []);
	let u = async (e) => {
		if (l.current) return;
...
function ct({ data: e, receipt: t }) {
	let r = e.media_sources?.filter((e) => [
		...
		"115",
		"pikpak"
	].includes(e.location)), [a, o] = V(r?.length ? r.map((e) => e.path) : e.media_dirs.length ? e.media_dirs : [""]), [s, l] = V(r?.map((e) => e.location) ?? []), [u, d] = V(r?.map((e) => e.root) ?? []), [f, p] = V(String(e.port)), [m, h] = V(!1), [g, _] = V([]), [v, y] = V(""), [b, x] = V(""), [S, C] = V(null), [w, T] = V(null), E = W(!1), D = W(e.revision), O = W([]), k = W(null);
	U(() => {
...
function lt({ receipt: e, data: t, error: n }) {
	return n || !t ? /* @__PURE__ */ G(K, {
		...
		children: [
			...
			/* @__PURE__ */ G(at, { facts: t.facts }),
			/* @__PURE__ */ G(ot, { data: t })
		]
	});
}
//#endregion
...
function dt() {
	if (Y > 1) Y--;
		...
		for ((function() {
			...
			var n = mt;
			for (mt = void 0, ht++; n !== void 0;) {
				var r = n.u;
				if (n.u = void 0, n.f &= -3, !(8 & n.f) && St(n)) try {
					n.c();
				} catch (n) {
					t ||= (e = n, !0);
				}
...
var mt = void 0, Y = 0, ht = 0, gt = 0, _t = 0, vt = void 0, yt = 0;
function bt(e) {
	if (J !== void 0) {
		var t = e.n;
...
X.prototype.brand = ut, X.prototype.h = function() {
	...
	set: function(e) {
		if (e !== this.v) {
			...
			(function(e) {
				Y !== 0 && ht === 0 && e.l !== _t && (e.l = _t, vt = {
					S: e,
					v: e.v,
					i: e.i,
					o: vt
				});
			})(this), this.v = e, this.i++, yt++, Y++;
			try {
...
function Z(e, t) {
	X.call(this, void 0, t), this.x = e, this.s = void 0, this.g = yt - 1, this.f = 4;
}
Z.prototype = new X(), Z.prototype.h = function() {
	if (this.f &= -3, 1 & this.f) return !1;
	if ((36 & this.f) == 32 || (this.f &= -5, this.g === yt)) return !0;
	if (this.g = yt, this.f |= 1, this.i > 0 && !St(this)) return this.f &= -2, !0;
	var e = J;
	try {
		Ct(this), J = this;
		var t = this.x();
...
function Ot(e) {
	...
	wt(this), J = e, this.f &= -2, 8 & this.f && Dt(this), dt();
}
function Q(e, t) {
	this.x = e, this.m = void 0, this.s = void 0, this.u = void 0, this.f = 32, this.name = t?.name, q && q.push(this);
}
Q.prototype.c = function() {
	...
	if (1 & this.f) throw Error("Cycle detected");
	this.f |= 1, this.f &= -9, Et(this), Ct(this), Y++;
	var e = J;
	return J = this, Ot.bind(this, e);
...
var At, jt, Mt = typeof window < "u" && !!window.__PREACT_SIGNALS_DEVTOOLS__, Nt = [];
kt(function() {
	At = this.N;
})();
function $(e, t) {
...
Ft.displayName = "ReactiveTextNode", Object.defineProperties(X.prototype, {
	constructor: {
		configurable: !0,
		value: void 0
	},
	...
	if (e(t), t.type !== N) {
		...
		r && (r.__$f &= -2, (n = r.__$u) === void 0 && (r.__$u = n = function(e, t) {
			...
			return function() {
				var t;
				Mt && ((t = this.y) == null || t.call(this)), e.__$f |= 1, e.setState({});
			};
		}(r), typeof t.type == "function" ? t.type.displayName || t.type.name : ""))), Pt(n);
	}
...
function It(e, t, n, r) {
	var i = t in e && e.ownerSVGElement === void 0, a = xt(n);
	return {
		o: function(e, t) {
			a.value = e, r = t;
		},
...
function zt() {
	ft(function() {
		for (var e; e = Nt.shift();) At.call(e);
	});
}
function Bt() {
	Nt.push(this) === 1 && (h.requestAnimationFrame || Rt)(zt);
}
//#endregion
//#region src/state/quality-goals.ts
var Vt = "/api/quality-goals?limit=200", Ht = {
	data: null,
	error: ""
}, Ut = xt(Ht), Wt = 0, Gt = Tt(() => Ut.value);
Tt(() => Ut.value.data?.total ?? null);
function Kt() {
	Wt += 1, Ut.value = Ht;
}
async function qt(e) {
	...
	try {
		let n = await I(Vt, e);
		return t === Wt && (Ut.value = {
			data: n,
			error: ""
		}), n;
	} catch (n) {
		throw !e?.aborted && t === Wt && (Ut.value = {
			data: null,
			error: F(n)
		}), n;
	}
...
var Jt = (e, t) => qt(t), Yt = (e) => e.has_cover ? `/cover?code=${encodeURIComponent(e.code ?? "")}` : `/poster?id=${e.id}&c=4`;
function Xt({ openItem: e, javTitleHtml: n, javDisplayName: r, srcBadge: a }) {
	let { data: o, error: s } = Gt.value;
			...
			children: [/* @__PURE__ */ G("button", {
				...
				/* @__PURE__ */ G("p", {
					...
					children: [
						...
						/* @__PURE__ */ G("span", { children: f(t.duration) }),
						/* @__PURE__ */ G("span", { children: p(t.size ?? 0) })
					]
				}),
...
var Zt = (e, t) => I("/api/scraping", t);
function Qt({ value: e, onChange: t }) {
	let n = W(null), r = W(t);
...
function $t({ source: e, toast: t }) {
	let [r, a] = V(e), [o, s] = V(e.network), [l, u] = V(""), [f, p] = V(""), [m, h] = V(""), [g, _] = V("paste"), [v, y] = V(""), [b, x] = V(!1), [S, C] = V(""), [w, T] = V([]), E = W(null), D = W(null);
	U(() => {
		D.current?.querySelectorAll("footer button").forEach((e) => c(e, b));
	}, [b]);
	let O = W(new AbortController());
	H(() => () => O.current.abort(), []);
	async function k(n) {
		if (!b) {
			x(!0), C(""), T([]);
			try {
				if (n === "check") {
					let t = await L("/api/scraping/check", { source: e.source }, "POST", O.current.signal);
					O.current.signal.aborted || T(t.results);
				} else {
					let r = await L("/api/scraping/settings", {
						...
						cookies_text: m,
						revoke: n === "revoke"
					}, "POST", O.current.signal);
					O.current.signal.aborted || (a(r.saved), u(""), p(""), h(""), y(""), E.current && (E.current.value = ""), t(n === "revoke" ? "Cookie 已撤销" : "来源设置已保存"));
				}
			} catch (e) {
				O.current.signal.aborted || C(F(e));
			} finally {
				O.current.signal.aborted || x(!1);
			}
		}
	}
	return /* @__PURE__ */ G("section", {
			...
			children: [/* @__PURE__ */ G("div", {
				...
				children: [
					...
					e.accepts_cookie && /* @__PURE__ */ G(N, { children: [
						...
						g === "paste" ? /* @__PURE__ */ G("label", { children: ["Cookie", /* @__PURE__ */ G("input", {
							class: "geist-input",
							type: "password",
							autoComplete: "off",
							value: f,
								...
								children: [
									...
									/* @__PURE__ */ G("input", {
										...
										onChange: async (e) => {
											...
											if (h(""), t.size > 262144) {
												C("Cookie 文本超过 256 KiB"), e.currentTarget.value = "";
												return;
											}
											x(!0);
											try {
												let e = await t.text();
												O.current.signal.aborted || (h(e), y(t.name));
											} catch {
												O.current.signal.aborted || C("Cookie 文件未读取，请重新选择");
											} finally {
												O.current.signal.aborted || x(!1);
											}
										}
					...
					S && /* @__PURE__ */ G("div", {
						role: "alert",
						dangerouslySetInnerHTML: { __html: i(S, { variant: "error" }) }
					}),
					w.map((t) => /* @__PURE__ */ G("div", {
						role: "status",
				...
				children: [
					e.accepts_cookie && r.cookie_saved && /* @__PURE__ */ G("button", {
						class: "geist-button",
						type: "button",
						onClick: () => void k("revoke"),
						children: "撤销 Cookie"
					}),
					/* @__PURE__ */ G("button", {
						class: "geist-button",
						type: "button",
						onClick: () => void k("check"),
						children: "检查连接"
					}),
					/* @__PURE__ */ G("button", {
						class: "geist-button primary",
...
function en({ data: e, error: t, toast: r }) {
	let [a, o] = V(""), [s, l] = V(!1), [u, d] = V(""), f = W(null);
	U(() => c(f.current, s), [s]);
...
}, Dn = () => Object.keys(En), On = /* @__PURE__ */ new Map();
...
function An(e) {
	let t = On.get(e);
	t && (t.controller.abort(), On.delete(e), t.painted && we(null, e));
}
//#endregion
export { yn as TASTE_GUIDE_KEY, dn as catalogEmptyHtml, un as catalogSuggestions, _n as cleanupSkeletonHtml, hn as cloudLocations, gn as cloudPreferenceLocations, ln as emptyCatalogLayout, sn as entitySkeletonHtml, Ze as followJobProgress, Dn as islandNames, wn as javImageKind, an as matchesFaceSource, kn as mountIsland, on as nativeImageFit, Cn as normalizeJavImage, xn as normalizeJavLayout, Sn as normalizeJavPreferences, rn as refreshStore, fn as sidebarHasCatalogContent, mn as sidebarTagCounts, nn as storeNames, Tn as syncJavImages, pn as syncSidebarSurface, vn as tasteHistoryGuideHtml, An as unmountIsland, Xe as watchJob, bn as wireTasteHistoryGuide };
