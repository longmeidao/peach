...
function ce(e) {
	if (e.__P && e.__d) {
		...
		a.__v = t.__v + 1, v.vnode && v.vnode(a), ye(e.__P, a, t, e.__n, e.__P.namespaceURI, 32 & t.__u ? [n] : null, r, n ?? P(t), !!(32 & t.__u), i), a.__v = t.__v, a.__.__k[a.__i] = a, xe(r, a, i), t.__e = t.__ = null, a.__e != n && le(a);
	}
}
function le(e) {
...
function ue(e) {
	(!e.__d && (e.__d = !0) && x.push(e) && !de.__r++ || S != v.debounceRendering) && ((S = v.debounceRendering) || C)(de);
}
function de() {
	try {
		for (var e, t = 1; x.length;) x.length > t && x.sort(w), e = x.shift(), t = x.length, ce(e);
	} finally {
		x.length = de.__r = 0;
	}
}
function fe(e, t, n, r, i, a, o, s, c, l, u) {
	...
	for (c = pe(n, t, _, c, v), d = 0; d < v; d++) (p = n.__k[d]) != null && (f = p.__i != -1 && _[p.__i] || A, p.__i = d, g = ye(e, p, f, i, a, o, s, c, l, u), m = p.__e, p.ref && f.ref != p.ref && (f.ref && we(f.ref, null, p), u.push(p.ref, p.__c || m, p)), h == null && m != null && (h = m), 4 & p.__u ? (c = me(p, c, e), f.__e && (f.__e = null)) : typeof p.type == "function" && g !== void 0 ? c = g : m && (c = m.nextSibling), p.__u &= -7);
	return n.__e = h, c;
}
function pe(e, t, n, r, i) {
	var a, o, s, c, l, u = n.length, d = u, f = 0;
	for (e.__k = Array(i), a = 0; a < i; a++) (o = t[a]) != null && typeof o != "boolean" && typeof o != "function" ? (typeof o == "string" || typeof o == "number" || typeof o == "bigint" || o.constructor == String ? o = e.__k[a] = oe(null, o, null, null, null) : re(o) ? o = e.__k[a] = oe(N, { children: o }, null, null, null) : o.constructor === void 0 && o.__b > 0 ? o = e.__k[a] = oe(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : e.__k[a] = o, c = a + f, o.__ = e, o.__b = e.__b + 1, s = null, (l = o.__i = he(o, n, c, d)) != -1 && (d--, (s = n[l]) && (s.__u |= 2)), s == null || s.__v == null ? (l == -1 && (i > u ? f-- : i < u && f++), typeof o.type != "function" && (o.__u |= 4)) : l != c && (l == c - 1 ? f-- : l == c + 1 ? f++ : (l > c ? f-- : f++, o.__u |= 4))) : e.__k[a] = null;
	if (d) for (a = 0; a < u; a++) (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = P(s)), Te(s, s));
	return r;
}
function me(e, t, n) {
	var r, i;
...
function ye(e, t, n, r, i, a, o, s, c, l) {
	...
	n: if (typeof D == "function") {
		d = o.length;
		try {
			if (y = t.props, b = D.prototype && D.prototype.render, x = (u = D.contextType) && r[u.__c], S = u ? x ? x.props.value : u.__ : r, n.__c ? _ = (f = t.__c = n.__c).__ = f.__E : (b ? t.__c = f = new D(y, S) : (t.__c = f = new se(y, S), f.constructor = D, f.render = Ee), x && x.sub(f), f.state || (f.state = {}), f.__n = r, p = f.__d = !0, f.__h = [], f._sb = []), b && f.__s == null && (f.__s = f.state), b && D.getDerivedStateFromProps != null && (f.__s == f.state && (f.__s = M({}, f.__s)), M(f.__s, D.getDerivedStateFromProps(y, f.__s))), m = f.props, h = f.state, f.__v = t, p) b && D.getDerivedStateFromProps == null && f.componentWillMount != null && f.componentWillMount(), b && f.componentDidMount != null && f.__h.push(f.componentDidMount);
			else {
				if (b && D.getDerivedStateFromProps == null && y !== m && f.componentWillReceiveProps != null && f.componentWillReceiveProps(y, S), t.__v == n.__v || !f.__e && f.shouldComponentUpdate != null && !1 === f.shouldComponentUpdate(y, f.__s, S)) {
					t.__v != n.__v && (f.props = y, f.state = f.__s, f.__d = !1), t.__e = n.__e, t.__k = n.__k, t.__k.some(function(e) {
						e && (e.__ = t);
					}), j.push.apply(f.__h, f._sb), f._sb = [], f.__h.length && o.push(f), s = P(n);
					break n;
				}
			...
			while (f.__d && ++w < 25);
			f.state = f.__s, f.getChildContext != null && (r = M(M({}, r), f.getChildContext())), b && !p && f.getSnapshotBeforeUpdate != null && (g = f.getSnapshotBeforeUpdate(m, h)), T = u != null && u.type === N && u.key == null ? Se(u.props.children) : u, s = fe(e, re(T) ? T : [T], t, n, r, i, a, o, s, c, l), f.base = t.__e, t.__u &= -161, f.__h.length && o.push(f), _ && (f.__E = f.__ = null);
		} catch (e) {
			...
			t.__k ??= n.__k || [], e.then || be(t), v.__e(e, t, n);
		}
...
function Se(e) {
	return typeof e != "object" || !e || e.__b > 0 ? e : re(e) ? e.map(Se) : e.constructor === void 0 ? M({}, e) : null;
}
function Ce(e, t, n, r, i, a, o, s, c) {
	...
	if (b == null) g === y || s && e.data == y || (e.data = y);
		...
		for (l in g) p = g[l], l == "dangerouslySetInnerHTML" ? d = p : l == "children" || l in y || l == "value" && "defaultValue" in y || l == "checked" && "defaultChecked" in y || _e(e, l, null, p, i);
		for (l in y) p = y[l], l == "children" ? f = p : l == "dangerouslySetInnerHTML" ? u = p : l == "value" ? m = p : l == "checked" ? h = p : s && typeof p != "function" || g[l] === p || _e(e, l, p, g[l], i);
		if (u) s || d && (u.__html == d.__html || u.__html == e.innerHTML) || (e.innerHTML = u.__html), t.__k = [];
		else if (d && (e.innerHTML = ""), fe(t.type == "template" ? e.content : e, re(f) ? f : [f], t, n, r, b == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, a, o, a ? a[0] : n.__k && P(n, 0), s, c), a != null) for (l = a.length; l--;) ie(a[l]);
...
function De(e, t, n) {
	var r, i, a, o;
	t == document && (t = document.documentElement), v.__ && v.__(e, t), i = (r = typeof n == "function") ? null : n && n.__k || t.__k, a = [], o = [], ye(t, e = (!r && n || t).__k = ae(N, null, [e]), i || A, A, t.namespaceURI, !r && n ? [n] : i ? null : t.firstChild ? _.call(t.childNodes) : null, a, !r && n ? n : i ? i.__e : t.firstChild, r, o), xe(a, e, o), e.props.children = null;
}
...
}, se.prototype.render = N, x = [], C = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, w = function(e, t) {
	return e.__v.__b - t.__v.__b;
}, de.__r = 0, T = Math.random().toString(8), E = "__d" + T, D = "__a" + T, ee = /(PointerCapture)$|Capture$/i, O = 0, k = ve(!1), te = ve(!0);
//#endregion
...
var R, z, je, Me, Ne = 0, Pe = [], B = v, Fe = B.__b, Ie = B.__r, Le = B.diffed, Re = B.__c, ze = B.unmount, Be = B.__;
function Ve(e, t) {
	B.__h && B.__h(z, e, Ne || t), Ne = 0;
	var n = z.__H || (z.__H = {
		__: [],
		__h: []
	});
...
function H(e, t) {
	var n = Ve(R++, 3);
	!B.__s && Ye(n.__H, t) && (n.__ = e, n.u = t, z.__H.__h.push(n));
}
function U(e, t) {
	var n = Ve(R++, 4);
	!B.__s && Ye(n.__H, t) && (n.__ = e, n.u = t, z.__h.push(n));
}
function W(e) {
...
B.__b = function(e) {
	...
	Ie && Ie(e), R = 0;
	var t = (z = e.__c).__H;
	t && (je === z ? (t.__h = [], z.__h = [], t.__.some(function(e) {
		e.__N && (e.__ = e.__N), e.u = e.__N = void 0;
	})) : (t.__h.some(qe), t.__h.some(Je), t.__h = [], R = 0)), je = z;
}, B.diffed = function(e) {
	Le && Le(e);
	var t = e.__c;
	t && t.__H && (t.__H.__h.length && (Pe.push(t) !== 1 && Me === B.requestAnimationFrame || ((Me = B.requestAnimationFrame) || Ke)(We)), t.__H.__.some(function(e) {
	...
	return /* @__PURE__ */ G("form", {
		...
		children: [/* @__PURE__ */ G("div", {
			...
			children: [
				...
				!f && n.mode !== "locked" ? /* @__PURE__ */ G(N, { children: [/* @__PURE__ */ G(Qe, {
					id: "access-password",
...
function nt({ initial: e, receipt: t }) {
	let [n, r] = V(e), [a, o] = V(e.mode), [s, l] = V(""), [d, p] = V(""), m = W(!1), h = W(null), g = W(null), _ = W(new AbortController());
	H(() => () => _.current.abort(), []), U(() => {
		let t = h.current;
		t.innerHTML = c([
			["environment", "系统代理"],
	...
	async function v() {
		if (!m.current) {
			...
			try {
				...
				_.current.signal.aborted || p(F(e));
			} finally {
	...
	return /* @__PURE__ */ G("form", {
		...
		children: [/* @__PURE__ */ G("div", {
			class: "geist-fieldset-content",
			children: [
				/* @__PURE__ */ G("div", { dangerouslySetInnerHTML: { __html: i("peachProxyTitle", "Peach 代理") } }),
				/* @__PURE__ */ G("p", {
					class: "confighelp",
					children: "采集来源选择“Peach 代理”时共用此设置。"
				}),
				/* @__PURE__ */ G("div", { ref: h }),
				a === "proxy" && /* @__PURE__ */ G("div", {
					class: "configfield",
...
function it({ startup: e, receipt: t }) {
	let [n, r] = V(e.enabled), [a, o] = V(e.silent), [s, c] = V(""), l = W(!1), d = W(null);
	async function f() {
		if (!l.current) {
	...
	return /* @__PURE__ */ G("form", {
		...
		children: [/* @__PURE__ */ G("div", {
			class: "geist-fieldset-content",
			children: [
				/* @__PURE__ */ G("div", { dangerouslySetInnerHTML: { __html: i("startupTitle", "开机自启") } }),
				/* @__PURE__ */ G(rt, {
					label: "开机后启动 Peach",
					checked: n,
...
function ot({ uninstall: e }) {
	...
	return /* @__PURE__ */ G("section", {
		...
		children: [/* @__PURE__ */ G("div", {
			class: "geist-fieldset-content",
			children: [
				/* @__PURE__ */ G("div", { dangerouslySetInnerHTML: { __html: i("uninstallTitle", "卸载 Peach") } }),
...
var st = "/api/configuration", ct = "/api/pick-folder", lt = 8e3, ut = (e, t) => I(st, t), K = ({ html: e, class: t }) => /* @__PURE__ */ G("div", {
	class: t,
...
function ht({ data: e, receipt: t }) {
	let n = e.media_sources?.filter((e) => [
		...
		"115",
		"pikpak"
	].includes(e.location)), [r, a] = V(n?.length ? n.map((e) => e.path) : e.media_dirs.length ? e.media_dirs : [""]), [s, c] = V(n?.map((e) => e.location) ?? []), [l, d] = V(n?.map((e) => e.root) ?? []), [f, p] = V(String(e.port)), [m, h] = V(!1), [g, _] = V([]), [v, y] = V(""), [b, x] = V(""), [S, C] = V(null), [w, T] = V(null), E = W(!1), D = W(e.revision), ee = W([]), O = W(null);
	U(() => {
	...
	let k = (e, t) => {
		...
		if (t.getAttribute("aria-busy") !== "true") {
			u(t, !0);
			try {
				let { path: t } = await L(ct, { initial: r[e] ?? "" });
				t && (k(e, t), j(e, ""));
			} catch (t) {
				j(e, F(t));
			} finally {
...
function gt({ receipt: e, data: t, error: n }) {
	return n || !t ? /* @__PURE__ */ G(K, {
		...
		class: "configpage",
		children: [
			t.startup ? /* @__PURE__ */ G(it, {
				startup: t.startup,
				receipt: e
			}) : null,
			t.editable ? /* @__PURE__ */ G(ht, {
				data: t,
				receipt: e
			...
			/* @__PURE__ */ G(pt, { data: t }),
			t.peach_proxy ? /* @__PURE__ */ G(nt, {
				initial: t.peach_proxy,
				receipt: e
			}) : null,
			t.access ? /* @__PURE__ */ G($e, {
				initial: t.access,
				receipt: e
			}) : null,
			t.updates ? /* @__PURE__ */ G(tt, {
				initial: t.updates,
				initialJob: t.update_job
			}) : null,
			/* @__PURE__ */ G(ft, { facts: t.facts }),
			t.uninstall ? /* @__PURE__ */ G(ot, { uninstall: t.uninstall }) : null
		]
	});
}
//#endregion
...
function Ft(e) {
	...
	jt(this), J = e, this.f &= -2, 8 & this.f && Pt(this), vt();
}
function Q(e, t) {
			...
			children: [/* @__PURE__ */ G("button", {
				...
				/* @__PURE__ */ G("p", {
					...
					children: [
						...
						/* @__PURE__ */ G("span", { children: p[r.location] ?? r.location }),
						/* @__PURE__ */ G("span", { children: m(r.duration) }),
						/* @__PURE__ */ G("span", { children: h(r.size ?? 0) })
					]
				}),
...
function ln({ source: e, toast: t }) {
	let [n, r] = V(e), [a, s] = V(e.network), [c, l] = V(""), [d, f] = V(""), [p, m] = V("paste"), [h, g] = V(""), [_, v] = V(!1), [y, b] = V(""), [x, S] = V([]), C = W(null), w = W(null);
	U(() => {
			...
			children: [/* @__PURE__ */ G("div", {
				...
				children: [
					...
					/* @__PURE__ */ G("div", {
						...
						children: ["连接方式", /* @__PURE__ */ G(cn, {
							value: a,
							onChange: s
						})]
					}),
					a === "peach" && /* @__PURE__ */ G("a", {
...
var dn = (e, t) => I("/api/library-processing", t);
...
function Tn({ kind: e = "catalog", filtered: t = !1, jav: n = !1, configurable: i = !1, online: a = !1 } = {}) {
...
function In(e) {
	return {
		javLayout: Fn(e.javLayout),
		javImage: Ln(e.javLayout === "preview" ? "thumbnail" : e.javImage)
	};
}
function Ln(e) {
...
function Rn(e, t) {
	return e.is_jav && e.code && e.has_cover && (Ln(t) === "cover" || !e.has_thumb) ? "cover" : e.has_thumb ? "thumbnail" : "";
}
function zn(e, t) {
	e.querySelectorAll("img[data-jav-image]").forEach((e) => {
		let n = e.dataset.javCover || "", r = e.dataset.javThumb || "", i = !!(n && (Ln(t) === "cover" || !r)), a = i ? n : r;
...
}, Vn = () => Object.keys(Bn), Hn = /* @__PURE__ */ new Map();
...
function Wn(e) {
	let t = Hn.get(e);
	t && (t.controller.abort(), Hn.delete(e), t.painted && De(null, e));
}
//#endregion
export { Nn as TASTE_GUIDE_KEY, Tn as catalogEmptyHtml, wn as catalogSuggestions, jn as cleanupSkeletonHtml, kn as cloudLocations, An as cloudPreferenceLocations, gn as createReviewSelection, Cn as emptyCatalogLayout, xn as entitySkeletonHtml, on as followJobProgress, Vn as islandNames, Rn as javImageKind, yn as matchesFaceSource, Un as mountIsland, bn as nativeImageFit, Ln as normalizeJavImage, Fn as normalizeJavLayout, In as normalizeJavPreferences, Oe as preferredDirection, hn as refreshStore, En as sidebarHasCatalogContent, On as sidebarTagCounts, mn as storeNames, zn as syncJavImages, Dn as syncSidebarSurface, Mn as tasteHistoryGuideHtml, Wn as unmountIsland, an as watchJob, vn as wireReviewSelection, Pn as wireTasteHistoryGuide };
